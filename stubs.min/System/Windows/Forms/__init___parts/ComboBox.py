class ComboBox(ListControl,IComponent,IDisposable,IOleControl,IOleObject,IOleInPlaceObject,IOleInPlaceActiveObject,IOleWindow,IViewObject,IViewObject2,IPersist,IPersistStreamInit,IPersistPropertyBag,IPersistStorage,IQuickActivate,ISupportOleDropSource,IDropTarget,ISynchronizeInvoke,IWin32Window,IArrangedElement,IBindableComponent):
 ...
 def FindString(self,s,startIndex=None):
  ...
  FindString(self: ComboBox,s: str,startIndex: int) -> int
   ...
   Returns the index of the first item in the System.Windows.Forms.ComboBox beyond the specified 
   ...
   Returns: The zero-based index of the first item found; returns -1 if no match is found,or 0 if the s 
  ...
  FindString(self: ComboBox,s: str) -> int
   ...
   Returns the index of the first item in the System.Windows.Forms.ComboBox that starts with the 
 ...
 def ToString(self):
  ...
  ToString(self: ComboBox) -> str
   ...
   Returns: A System.String that represents the current System.Windows.Forms.ComboBox. The string includes 
...
Get: DataSource(self: ComboBox) -> object



Set: DataSource(self: ComboBox)=value
...
Get: SelectedIndex(self: ComboBox) -> int



Set: SelectedIndex(self: ComboBox)=value
