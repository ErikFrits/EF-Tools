class DomainUpDown(UpDownBase,IComponent,IDisposable,IOleControl,IOleObject,IOleInPlaceObject,IOleInPlaceActiveObject,IOleWindow,IViewObject,IViewObject2,IPersist,IPersistStreamInit,IPersistPropertyBag,IPersistStorage,IQuickActivate,ISupportOleDropSource,IDropTarget,ISynchronizeInvoke,IWin32Window,IArrangedElement,IBindableComponent,IContainerControl):
 """
 ...
 def CreateAccessibilityInstance(self,*args):
  """
  CreateAccessibilityInstance(self: DomainUpDown) -> AccessibleObject

  

   Creates a new accessibility object for the System.Windows.Forms.DomainUpDown control.

   Returns: A new System.Windows.Forms.DomainUpDown.DomainUpDownAccessibleObject for the control.
  """
  pass
 ...
 def OnChanged(self,*args):
  """
  OnChanged(self: DomainUpDown,source: object,e: EventArgs)
 ...
 def OnTextBoxKeyPress(self,*args):
  """
  OnTextBoxKeyPress(self: DomainUpDown,source: object,e: KeyPressEventArgs)
 ...
 def ToString(self):
  ...
  ToString(self: DomainUpDown) -> str
   ...
   Returns: A string that represents the current System.Windows.Forms.DomainUpDown.
  """
  pass
 def UpButton(self):
  """
  UpButton(self: DomainUpDown)
 ...
 def UpdateEditText(self,*args):
  """
  UpdateEditText(self: DomainUpDown)
...
"""
 ...
 Wrap=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 DomainItemAccessibleObject=None
 DomainUpDownAccessibleObject=None
 DomainUpDownItemCollection=None
 PaddingChanged=None
