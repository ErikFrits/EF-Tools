class DateTimePicker(Control,IComponent,IDisposable,IOleControl,IOleObject,IOleInPlaceObject,IOleInPlaceActiveObject,IOleWindow,IViewObject,IViewObject2,IPersist,IPersistStreamInit,IPersistPropertyBag,IPersistStorage,IQuickActivate,ISupportOleDropSource,IDropTarget,ISynchronizeInvoke,IWin32Window,IArrangedElement,IBindableComponent):
 ...
 def ToString(self):
  ...
  ToString(self: DateTimePicker) -> str
   ...
   Returns: A string that represents the current System.Windows.Forms.DateTimePicker. The string includes 
...
Get: BackColor(self: DateTimePicker) -> Color



Set: BackColor(self: DateTimePicker)=value
...
Get: BackgroundImage(self: DateTimePicker) -> Image



Set: BackgroundImage(self: DateTimePicker)=value
...
Get: BackgroundImageLayout(self: DateTimePicker) -> ImageLayout



Set: BackgroundImageLayout(self: DateTimePicker)=value
...
Get: ForeColor(self: DateTimePicker) -> Color



Set: ForeColor(self: DateTimePicker)=value
...
Get: Padding(self: DateTimePicker) -> Padding



Set: Padding(self: DateTimePicker)=value
...
Get: Text(self: DateTimePicker) -> str



Set: Text(self: DateTimePicker)=value
