class DataGridTextBox(TextBox,IComponent,IDisposable,IOleControl,IOleObject,IOleInPlaceObject,IOleInPlaceActiveObject,IOleWindow,IViewObject,IViewObject2,IPersist,IPersistStreamInit,IPersistPropertyBag,IPersistStorage,IQuickActivate,ISupportOleDropSource,IDropTarget,ISynchronizeInvoke,IWin32Window,IArrangedElement,IBindableComponent):
 """
 ...
 def OnKeyPress(self,*args):
  """
  OnKeyPress(self: DataGridTextBox,e: KeyPressEventArgs)
 ...
 def OnMouseWheel(self,*args):
  """
  OnMouseWheel(self: DataGridTextBox,e: MouseEventArgs)
 ...
 def ProcessKeyMessage(self,*args):
  """
  ProcessKeyMessage(self: DataGridTextBox,m: Message) -> (bool,Message)

  

   Indicates whether the key pressed is processed further (for example,to navigate,or escape). 
   ...
   m: A System.Windows.Forms.Message,passed by reference,that contains the key data.

   Returns: true if the key is consumed,false to if the key is further processed.
  """
  pass
 ...
 def SetClientSizeCore(self,*args):
  ...
  """
  pass
 def SetDataGrid(self,parentGrid):
  """
  SetDataGrid(self: DataGridTextBox,parentGrid: DataGrid)

   Sets the System.Windows.Forms.DataGrid to which this System.Windows.Forms.TextBox control 
   ...
   parentGrid: The System.Windows.Forms.DataGrid control that hosts the control.
  """
  pass
 ...
 def WndProc(self,*args):
  """
  WndProc(self: DataGridTextBox,m: Message) -> Message

  

   Raises the System.Windows.Forms.Control.WndProc(System.Windows.Forms.Message@) event.

  

   m: A System.Windows.Forms.Message that contains the event data.
  """
  pass
...
"""
 ...
 IsInEditOrNavigateMode=property(lambda self: object(),lambda self,v: None,lambda self: None)
