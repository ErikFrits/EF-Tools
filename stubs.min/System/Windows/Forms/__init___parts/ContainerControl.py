class ContainerControl(ScrollableControl,IComponent,IDisposable,IOleControl,IOleObject,IOleInPlaceObject,IOleInPlaceActiveObject,IOleWindow,IViewObject,IViewObject2,IPersist,IPersistStreamInit,IPersistPropertyBag,IPersistStorage,IQuickActivate,ISupportOleDropSource,IDropTarget,ISynchronizeInvoke,IWin32Window,IArrangedElement,IBindableComponent,IContainerControl):
 ...
 def UpdateZOrder(self,*args):
  ...
  """
  pass
 def Validate(self,checkAutoValidate=None):
  """
...
Get: ActiveControl(self: ContainerControl) -> Control



Set: ActiveControl(self: ContainerControl)=value

"""

 AutoScaleDimensions=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 AutoScaleMode=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 """Get: BindingContext(self: ContainerControl) -> BindingContext



Set: BindingContext(self: ContainerControl)=value
...
"""
 ...
 CurrentAutoScaleDimensions=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 ParentForm=property(lambda self: object(),lambda self,v: None,lambda self: None)
