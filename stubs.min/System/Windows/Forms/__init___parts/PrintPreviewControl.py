class PrintPreviewControl(Control,IComponent,IDisposable,IOleControl,IOleObject,IOleInPlaceObject,IOleInPlaceActiveObject,IOleWindow,IViewObject,IViewObject2,IPersist,IPersistStreamInit,IPersistPropertyBag,IPersistStorage,IQuickActivate,ISupportOleDropSource,IDropTarget,ISynchronizeInvoke,IWin32Window,IArrangedElement,IBindableComponent):
 ...
 def OnPaint(self,*args):
  """
  OnPaint(self: PrintPreviewControl,pevent: PaintEventArgs)
 ...
 def OnResize(self,*args):
  """
  OnResize(self: PrintPreviewControl,eventargs: EventArgs)
 ...
 def OnSizeChanged(self,*args):
  ...
  """
  pass
 def OnStartPageChanged(self,*args):
  """
 ...
 def ResetBackColor(self):
  """
  ResetBackColor(self: PrintPreviewControl)

   Resets the System.Windows.Forms.Control.BackColor property to 

    System.Drawing.SystemColors.AppWorkspace,which is the default color.
  """
  pass
 def ResetForeColor(self):
  """
  ResetForeColor(self: PrintPreviewControl)

   Resets the foreground color of the System.Windows.Forms.PrintPreviewControl to 

    System.Drawing.Color.White,which is the default color.
  """
  pass
 ...
 def WndProc(self,*args):
  """
  WndProc(self: PrintPreviewControl,m: Message) -> Message
 ...
 def __str__(self,*args):
  pass
 AutoZoom=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 """Get: RightToLeft(self: PrintPreviewControl) -> RightToLeft



Set: RightToLeft(self: PrintPreviewControl)=value
...
"""
 ...
 StartPage=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
Get: Text(self: PrintPreviewControl) -> str



Set: Text(self: PrintPreviewControl)=value
