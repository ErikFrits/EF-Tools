class MdiClient(Control,IComponent,IDisposable,IOleControl,IOleObject,IOleInPlaceObject,IOleInPlaceActiveObject,IOleWindow,IViewObject,IViewObject2,IPersist,IPersistStreamInit,IPersistPropertyBag,IPersistStorage,IQuickActivate,ISupportOleDropSource,IDropTarget,ISynchronizeInvoke,IWin32Window,IArrangedElement,IBindableComponent):
 """
 ...
 def CreateControlsInstance(self,*args):
  """ CreateControlsInstance(self: MdiClient) -> ControlCollection """
  pass
 ...
 def OnResize(self,*args):
  """ OnResize(self: MdiClient,e: EventArgs) """
  pass
 ...
 def ScaleControl(self,*args):
  """ ScaleControl(self: MdiClient,factor: SizeF,specified: BoundsSpecified) """
  pass
 def ScaleCore(self,*args):
  """ ScaleCore(self: MdiClient,dx: Single,dy: Single) """
  pass
 def Select(self):
  """
 ...
 def SetBoundsCore(self,*args):
  """ SetBoundsCore(self: MdiClient,x: int,y: int,width: int,height: int,specified: BoundsSpecified) """
  pass
 ...
 def WndProc(self,*args):
  """ WndProc(self: MdiClient,m: Message) -> Message """
  pass
...
Get: BackgroundImage(self: MdiClient) -> Image



Set: BackgroundImage(self: MdiClient)=value
...
Get: BackgroundImageLayout(self: MdiClient) -> ImageLayout



Set: BackgroundImageLayout(self: MdiClient)=value
