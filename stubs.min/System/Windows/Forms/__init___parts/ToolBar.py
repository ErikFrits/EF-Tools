...
Get: AutoSize(self: ToolBar) -> bool



Set: AutoSize(self: ToolBar)=value
...
Get: BackColor(self: ToolBar) -> Color



Set: BackColor(self: ToolBar)=value
...
Get: BackgroundImage(self: ToolBar) -> Image



Set: BackgroundImage(self: ToolBar)=value
...
Get: BackgroundImageLayout(self: ToolBar) -> ImageLayout



Set: BackgroundImageLayout(self: ToolBar)=value
...
Get: ForeColor(self: ToolBar) -> Color



Set: ForeColor(self: ToolBar)=value
...
Get: ImeMode(self: ToolBar) -> ImeMode



Set: ImeMode(self: ToolBar)=value
...
Get: RightToLeft(self: ToolBar) -> RightToLeft



Set: RightToLeft(self: ToolBar)=value
...
Get: TabStop(self: ToolBar) -> bool



Set: TabStop(self: ToolBar)=value
...
Get: Text(self: ToolBar) -> str



Set: Text(self: ToolBar)=value
