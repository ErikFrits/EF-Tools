class StatusStrip(ToolStrip,IComponent,IDisposable,IOleControl,IOleObject,IOleInPlaceObject,IOleInPlaceActiveObject,IOleWindow,IViewObject,IViewObject2,IPersist,IPersistStreamInit,IPersistPropertyBag,IPersistStorage,IQuickActivate,ISupportOleDropSource,IDropTarget,ISynchronizeInvoke,IWin32Window,IArrangedElement,IBindableComponent,ISupportToolStripPanel):
 """
 ...
 def CreateAccessibilityInstance(self,*args):
  """
  CreateAccessibilityInstance(self: StatusStrip) -> AccessibleObject
 ...
 def CreateDefaultItem(self,*args):
  """
  CreateDefaultItem(self: StatusStrip,text: str,image: Image,onClick: EventHandler) -> ToolStripItem

  

   Creates a default System.Windows.Forms.ToolStripStatusLabel with the specified text,image,and 

    event handler on a new System.Windows.Forms.StatusStrip instance.

  

  

   text: The text to use for the System.Windows.Forms.ToolStripStatusLabel. If the text parameter is a 

    hyphen (-),this method creates a System.Windows.Forms.ToolStripSeparator.

  

   image: The System.Drawing.Image to display on the System.Windows.Forms.ToolStripStatusLabel.

   onClick: An event handler that raises the System.Windows.Forms.Control.Click event when the 

    System.Windows.Forms.ToolStripStatusLabel is clicked.

  

   Returns: A 

    System.Windows.Forms.ToolStripStatusLabel.#ctor(System.String,System.Drawing.Image,System.EventHa

    ndler),or a System.Windows.Forms.ToolStripSeparator if the text parameter is a hyphen (-).
  """
  pass
 ...
 def Dispose(self):
  """
  Dispose(self: StatusStrip,disposing: bool)

   Releases the unmanaged resources used by the System.Windows.Forms.StatusStrip and optionally 
 ...
 def OnLayout(self,*args):
  """
  OnLayout(self: StatusStrip,levent: LayoutEventArgs)
 ...
 def OnPaintBackground(self,*args):
  """
  OnPaintBackground(self: StatusStrip,e: PaintEventArgs)
   ...
   e: A System.Windows.Forms.PaintEventArgs that contains information about the 
    ...
    System.Windows.Forms.StatusStrip to paint.
  """
  pass
 ...
 def OnSizeChanged(self,*args):
  ...
  """
  pass
 def OnSpringTableLayoutCore(self,*args):
  """
 ...
 def SetDisplayedItems(self,*args):
  """ SetDisplayedItems(self: StatusStrip) """
  pass
 ...
 def WndProc(self,*args):
  """
  WndProc(self: StatusStrip,m: Message) -> Message
...
Get: CanOverflow(self: StatusStrip) -> bool



Set: CanOverflow(self: StatusStrip)=value
...
Get: Dock(self: StatusStrip) -> DockStyle



Set: Dock(self: StatusStrip)=value
...
Get: GripStyle(self: StatusStrip) -> ToolStripGripStyle



Set: GripStyle(self: StatusStrip)=value
...
Get: LayoutStyle(self: StatusStrip) -> ToolStripLayoutStyle



Set: LayoutStyle(self: StatusStrip)=value
...
Get: ShowItemToolTips(self: StatusStrip) -> bool



Set: ShowItemToolTips(self: StatusStrip)=value
...
"""
 ...
 SizeGripBounds=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
Get: Stretch(self: StatusStrip) -> bool



Set: Stretch(self: StatusStrip)=value
