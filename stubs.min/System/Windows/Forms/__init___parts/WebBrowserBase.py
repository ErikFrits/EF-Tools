class WebBrowserBase(Control,IComponent,IDisposable,IOleControl,IOleObject,IOleInPlaceObject,IOleInPlaceActiveObject,IOleWindow,IViewObject,IViewObject2,IPersist,IPersistStreamInit,IPersistPropertyBag,IPersistStorage,IQuickActivate,ISupportOleDropSource,IDropTarget,ISynchronizeInvoke,IWin32Window,IArrangedElement,IBindableComponent):
 ...
 def DrawToBitmap(self,bitmap,targetBounds):
  """
  DrawToBitmap(self: WebBrowserBase,bitmap: Bitmap,targetBounds: Rectangle)
 ...
 def __str__(self,*args):
  pass
 ActiveXInstance=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
Get: AllowDrop(self: WebBrowserBase) -> bool



Set: AllowDrop(self: WebBrowserBase)=value
...
Get: BackColor(self: WebBrowserBase) -> Color



Set: BackColor(self: WebBrowserBase)=value
...
Get: BackgroundImage(self: WebBrowserBase) -> Image



Set: BackgroundImage(self: WebBrowserBase)=value
...
Get: BackgroundImageLayout(self: WebBrowserBase) -> ImageLayout



Set: BackgroundImageLayout(self: WebBrowserBase)=value
...
Get: Cursor(self: WebBrowserBase) -> Cursor



Set: Cursor(self: WebBrowserBase)=value
...
Get: Enabled(self: WebBrowserBase) -> bool



Set: Enabled(self: WebBrowserBase)=value
...
Get: Font(self: WebBrowserBase) -> Font



Set: Font(self: WebBrowserBase)=value
...
Get: ForeColor(self: WebBrowserBase) -> Color



Set: ForeColor(self: WebBrowserBase)=value
...
Get: ImeMode(self: WebBrowserBase) -> ImeMode



Set: ImeMode(self: WebBrowserBase)=value
...
Get: RightToLeft(self: WebBrowserBase) -> RightToLeft



Set: RightToLeft(self: WebBrowserBase)=value
...
"""
 ...
 """Set: Site(self: WebBrowserBase)=value
...
Get: Text(self: WebBrowserBase) -> str



Set: Text(self: WebBrowserBase)=value
...
Get: UseWaitCursor(self: WebBrowserBase) -> bool



Set: UseWaitCursor(self: WebBrowserBase)=value
