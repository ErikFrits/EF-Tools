class DataGridViewColumnHeaderCell(DataGridViewHeaderCell,ICloneable,IDisposable):
 """
 ...
 def Clone(self):
  """
  Clone(self: DataGridViewColumnHeaderCell) -> object
 ...
 def CreateAccessibilityInstance(self,*args):
  """
  CreateAccessibilityInstance(self: DataGridViewColumnHeaderCell) -> AccessibleObject

  

   Creates a new accessible object for the System.Windows.Forms.DataGridViewColumnHeaderCell.
 ...
 def GetContentBounds(self,rowIndex):
  """
  GetContentBounds(self: DataGridViewColumnHeaderCell,graphics: Graphics,cellStyle: DataGridViewCellStyle,rowIndex: int) -> Rectangle

  

   Returns the bounding rectangle that encloses the cell's content area,which is calculated using 

    the specified System.Drawing.Graphics object and cell style.
 ...
 def GetInheritedContextMenuStrip(self,rowIndex):
  """
  GetInheritedContextMenuStrip(self: DataGridViewColumnHeaderCell,rowIndex: int) -> ContextMenuStrip
   ...
   Returns: The System.Windows.Forms.ContextMenuStrip of the column headers if one exists; otherwise,the 
 ...
 def GetPreferredSize(self,*args):
  """
  GetPreferredSize(self: DataGridViewColumnHeaderCell,graphics: Graphics,cellStyle: DataGridViewCellStyle,rowIndex: int,constraintSize: Size) -> Size
 ...
 def ToString(self):
  """
  ToString(self: DataGridViewColumnHeaderCell) -> str
...
"""
 ...
 SortGlyphDirection=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 DataGridViewColumnHeaderCellAccessibleObject=None
