class UserControl(ContainerControl,IComponent,IDisposable,IOleControl,IOleObject,IOleInPlaceObject,IOleInPlaceActiveObject,IOleWindow,IViewObject,IViewObject2,IPersist,IPersistStreamInit,IPersistPropertyBag,IPersistStorage,IQuickActivate,ISupportOleDropSource,IDropTarget,ISynchronizeInvoke,IWin32Window,IArrangedElement,IBindableComponent,IContainerControl):
 """
 ...
 def ValidateChildren(self,validationConstraints=None):
  """
  ValidateChildren(self: UserControl,validationConstraints: ValidationConstraints) -> bool
  ...
  ValidateChildren(self: UserControl) -> bool
...
Get: AutoValidate(self: UserControl) -> AutoValidate



Set: AutoValidate(self: UserControl)=value
