...
"""
 ...
 """Gets or sets a value indicating whether the dialog box automatically sizes to its content.



Get: AutoSize(self: ThreadExceptionDialog) -> bool



Set: AutoSize(self: ThreadExceptionDialog)=value
