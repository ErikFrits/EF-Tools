class ToolStripOverflow(ToolStripDropDown,IComponent,IDisposable,IOleControl,IOleObject,IOleInPlaceObject,IOleInPlaceActiveObject,IOleWindow,IViewObject,IViewObject2,IPersist,IPersistStreamInit,IPersistPropertyBag,IPersistStorage,IQuickActivate,ISupportOleDropSource,IDropTarget,ISynchronizeInvoke,IWin32Window,IArrangedElement,IBindableComponent,ISupportToolStripPanel):
 """
 ...
 def CreateAccessibilityInstance(self,*args):
  """
  CreateAccessibilityInstance(self: ToolStripOverflow) -> AccessibleObject
 ...
 def OnLayout(self,*args):
  """
  OnLayout(self: ToolStripOverflow,e: LayoutEventArgs)
 ...
 def SetDisplayedItems(self,*args):
  """
  SetDisplayedItems(self: ToolStripOverflow)
