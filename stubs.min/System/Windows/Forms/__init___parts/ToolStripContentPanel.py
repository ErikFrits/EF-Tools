class ToolStripContentPanel(Panel,IComponent,IDisposable,IOleControl,IOleObject,IOleInPlaceObject,IOleInPlaceActiveObject,IOleWindow,IViewObject,IViewObject2,IPersist,IPersistStreamInit,IPersistPropertyBag,IPersistStorage,IQuickActivate,ISupportOleDropSource,IDropTarget,ISynchronizeInvoke,IWin32Window,IArrangedElement,IBindableComponent):
 """
 ...
 def OnHandleCreated(self,*args):
  """
  OnHandleCreated(self: ToolStripContentPanel,e: EventArgs)
 ...
 def OnPaintBackground(self,*args):
  """
  OnPaintBackground(self: ToolStripContentPanel,e: PaintEventArgs)
 ...
 def OnRendererChanged(self,*args):
  ...
  OnRendererChanged(self: ToolStripContentPanel,e: EventArgs)
   ...
   Raises the System.Windows.Forms.ToolStripContentPanel.RendererChanged event.
...
Get: AutoSize(self: ToolStripContentPanel) -> bool



Set: AutoSize(self: ToolStripContentPanel)=value
...
Get: AutoSizeMode(self: ToolStripContentPanel) -> AutoSizeMode



Set: AutoSizeMode(self: ToolStripContentPanel)=value
...
Get: TabStop(self: ToolStripContentPanel) -> bool



Set: TabStop(self: ToolStripContentPanel)=value
