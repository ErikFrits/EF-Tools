class ButtonBase(Control,IComponent,IDisposable,IOleControl,IOleObject,IOleInPlaceObject,IOleInPlaceActiveObject,IOleWindow,IViewObject,IViewObject2,IPersist,IPersistStreamInit,IPersistPropertyBag,IPersistStorage,IQuickActivate,ISupportOleDropSource,IDropTarget,ISynchronizeInvoke,IWin32Window,IArrangedElement,IBindableComponent):
 ...
 def GetPreferredSize(self,proposedSize):
  """
  GetPreferredSize(self: ButtonBase,proposedSize: Size) -> Size
 ...
 def OnMouseUp(self,*args):
  """
  OnMouseUp(self: ButtonBase,mevent: MouseEventArgs)
...
Get: AutoSize(self: ButtonBase) -> bool



Set: AutoSize(self: ButtonBase)=value
...
Get: BackColor(self: ButtonBase) -> Color



Set: BackColor(self: ButtonBase)=value
...
"""
 ...
 FlatAppearance=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
Get: ImeMode(self: ButtonBase) -> ImeMode



Set: ImeMode(self: ButtonBase)=value
...
"""
 ...
 """Get: Text(self: ButtonBase) -> str



Set: Text(self: ButtonBase)=value
...
"""
 ...
 UseVisualStyleBackColor=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 ButtonBaseAccessibleObject=None
 ImeModeChanged=None
