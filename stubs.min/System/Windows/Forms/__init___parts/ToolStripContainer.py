class ToolStripContainer(ContainerControl,IComponent,IDisposable,IOleControl,IOleObject,IOleInPlaceObject,IOleInPlaceActiveObject,IOleWindow,IViewObject,IViewObject2,IPersist,IPersistStreamInit,IPersistPropertyBag,IPersistStorage,IQuickActivate,ISupportOleDropSource,IDropTarget,ISynchronizeInvoke,IWin32Window,IArrangedElement,IBindableComponent,IContainerControl):
 ...
 def CreateControlsInstance(self,*args):
  """
  CreateControlsInstance(self: ToolStripContainer) -> ControlCollection

  

   Creates and returns a System.Windows.Forms.ToolStripContainer collection.

   Returns: A read-only System.Windows.Forms.ToolStripContainer collection.
  """
  pass
 ...
 def OnRightToLeftChanged(self,*args):
  """
  OnRightToLeftChanged(self: ToolStripContainer,e: EventArgs)
 ...
 def OnSizeChanged(self,*args):
  """
  OnSizeChanged(self: ToolStripContainer,e: EventArgs)
...
"""
 ...
 BottomToolStripPanel=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 BottomToolStripPanelVisible=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 ContentPanel=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 LeftToolStripPanel=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 LeftToolStripPanelVisible=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 RightToolStripPanel=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 RightToolStripPanelVisible=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 TopToolStripPanel=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 TopToolStripPanelVisible=property(lambda self: object(),lambda self,v: None,lambda self: None)
