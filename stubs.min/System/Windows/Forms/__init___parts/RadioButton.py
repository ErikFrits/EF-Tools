class RadioButton(ButtonBase,IComponent,IDisposable,IOleControl,IOleObject,IOleInPlaceObject,IOleInPlaceActiveObject,IOleWindow,IViewObject,IViewObject2,IPersist,IPersistStreamInit,IPersistPropertyBag,IPersistStorage,IQuickActivate,ISupportOleDropSource,IDropTarget,ISynchronizeInvoke,IWin32Window,IArrangedElement,IBindableComponent):
 ...
 def OnClick(self,*args):
  """
  OnClick(self: RadioButton,e: EventArgs)
 ...
 def OnEnter(self,*args):
  """
  OnEnter(self: RadioButton,e: EventArgs)
 ...
 def OnMouseUp(self,*args):
  """
  OnMouseUp(self: RadioButton,mevent: MouseEventArgs)
 ...
 def ProcessMnemonic(self,*args):
  """
  ProcessMnemonic(self: RadioButton,charCode: Char) -> bool

  

   Overrides the System.Windows.Forms.Control.ProcessMnemonic(System.Char) method.

  

   charCode: The character to process.

   Returns: true if the character was successfully processed; otherwise,false.
  """
  pass
...
Get: TextAlign(self: RadioButton) -> ContentAlignment



Set: TextAlign(self: RadioButton)=value
...
"""
 ...
 RadioButtonAccessibleObject=None
