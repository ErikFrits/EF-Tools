class TabControl(Control,IComponent,IDisposable,IOleControl,IOleObject,IOleInPlaceObject,IOleInPlaceActiveObject,IOleWindow,IViewObject,IViewObject2,IPersist,IPersistStreamInit,IPersistPropertyBag,IPersistStorage,IQuickActivate,ISupportOleDropSource,IDropTarget,ISynchronizeInvoke,IWin32Window,IArrangedElement,IBindableComponent):
 ...
 def DeselectTab(self,*__args):
  ...
  DeselectTab(self: TabControl,tabPageName: str)
   ...
   tabPageName: The System.Windows.Forms.Control.Name of the tab to deselect.

  DeselectTab(self: TabControl,tabPage: TabPage)

   Makes the tab following the specified System.Windows.Forms.TabPage the current tab.

  

   tabPage: The System.Windows.Forms.TabPage to deselect.

  DeselectTab(self: TabControl,index: int)
 ...
 def GetControl(self,index):
  ...
  GetControl(self: TabControl,index: int) -> Control
   ...
   index: The index of the System.Windows.Forms.TabPage to get.
 ...
 def GetItems(self,*args):
  ...
  GetItems(self: TabControl,baseType: Type) -> Array[object]
   ...
   Copies the System.Windows.Forms.TabPage controls in the System.Windows.Forms.TabControl to an 
   ...
   baseType: The System.Type of the array to create.

   Returns: The System.Windows.Forms.TabPage controls that belong to the System.Windows.Forms.TabControl as 
  ...
  GetItems(self: TabControl) -> Array[object]
   ...
   Returns: An array of System.Windows.Forms.TabPage controls that belong to the 
 ...
 def GetTabRect(self,index):
  ...
  GetTabRect(self: TabControl,index: int) -> Rectangle
   ...
   index: The zero-based index of the tab you want.
 ...
 def GetToolTipText(self,*args):
  ...
  GetToolTipText(self: TabControl,item: object) -> str
   ...
   Gets the ToolTip for the specified System.Windows.Forms.TabPage.

  

   item: The System.Windows.Forms.TabPage that owns the desired ToolTip.
 ...
 def SelectTab(self,*__args):
  ...
  SelectTab(self: TabControl,tabPageName: str)
   ...
   tabPageName: The System.Windows.Forms.Control.Name of the tab to select.

  SelectTab(self: TabControl,tabPage: TabPage)

   Makes the specified System.Windows.Forms.TabPage the current tab.

  

   tabPage: The System.Windows.Forms.TabPage to select.

  SelectTab(self: TabControl,index: int)
 ...
 def UpdateTabSelection(self,*args):
  ...
  UpdateTabSelection(self: TabControl,updateFocus: bool)
   ...
   Sets the System.Windows.Forms.TabPage.Visible property to true for the appropriate 
    ...
    System.Windows.Forms.TabPage control in the System.Windows.Forms.TabControl.TabPages collection.
...
Get: BackColor(self: TabControl) -> Color



Set: BackColor(self: TabControl)=value
...
Get: BackgroundImage(self: TabControl) -> Image



Set: BackgroundImage(self: TabControl)=value
...
Get: BackgroundImageLayout(self: TabControl) -> ImageLayout



Set: BackgroundImageLayout(self: TabControl)=value
...
Get: DisplayRectangle(self: TabControl) -> Rectangle
...
Get: ForeColor(self: TabControl) -> Color



Set: ForeColor(self: TabControl)=value
...
Get: Padding(self: TabControl) -> Point



Set: Padding(self: TabControl)=value
...
Get: Text(self: TabControl) -> str



Set: Text(self: TabControl)=value
