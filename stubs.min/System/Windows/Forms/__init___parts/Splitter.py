class Splitter(Control,IComponent,IDisposable,IOleControl,IOleObject,IOleInPlaceObject,IOleInPlaceActiveObject,IOleWindow,IViewObject,IViewObject2,IPersist,IPersistStreamInit,IPersistPropertyBag,IPersistStorage,IQuickActivate,ISupportOleDropSource,IDropTarget,ISynchronizeInvoke,IWin32Window,IArrangedElement,IBindableComponent):
 ...
 def OnKeyDown(self,*args):
  """
  OnKeyDown(self: Splitter,e: KeyEventArgs)
 ...
 def OnMouseDown(self,*args):
  """
  OnMouseDown(self: Splitter,e: MouseEventArgs)
 ...
 def OnMouseMove(self,*args):
  """
  OnMouseMove(self: Splitter,e: MouseEventArgs)
 ...
 def OnMouseUp(self,*args):
  """
  OnMouseUp(self: Splitter,e: MouseEventArgs)
 ...
 def OnSizeChanged(self,*args):
  ...
  """
  pass
 def OnSplitterMoved(self,*args):
  """
  OnSplitterMoved(self: Splitter,sevent: SplitterEventArgs)

   Raises the System.Windows.Forms.Splitter.SplitterMoved event. 

    System.Windows.Forms.Splitter.OnSplitterMoved(System.Windows.Forms.SplitterEventArgs) has been 

    replaced by 

    System.Windows.Forms.SplitContainer.OnSplitterMoved(System.Windows.Forms.SplitterEventArgs) and 
   ...
   sevent: A System.Windows.Forms.SplitterEventArgs that contains the event data.
  """
  pass
 def OnSplitterMoving(self,*args):
  """
  OnSplitterMoving(self: Splitter,sevent: SplitterEventArgs)

   Raises the System.Windows.Forms.Splitter.SplitterMoving event. 

    System.Windows.Forms.Splitter.OnSplitterMoving(System.Windows.Forms.SplitterEventArgs) has been 

    replaced by 

    System.Windows.Forms.SplitContainer.OnSplitterMoving(System.Windows.Forms.SplitterCancelEventArgs

    ) and is provided only for compatibility with previous versions.
 ...
 def SetBoundsCore(self,*args):
  """
  SetBoundsCore(self: Splitter,x: int,y: int,width: int,height: int,specified: BoundsSpecified)
 ...
 def ToString(self):
  ...
  ToString(self: Splitter) -> str
   ...
   Returns: A string that represents the current System.Windows.Forms.Splitter.
  """
  pass
...
Get: AllowDrop(self: Splitter) -> bool



Set: AllowDrop(self: Splitter)=value
...
Get: Anchor(self: Splitter) -> AnchorStyles



Set: Anchor(self: Splitter)=value
...
Get: BackgroundImage(self: Splitter) -> Image



Set: BackgroundImage(self: Splitter)=value
...
Get: BackgroundImageLayout(self: Splitter) -> ImageLayout



Set: BackgroundImageLayout(self: Splitter)=value

"""

 BorderStyle=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets the style of border for the control. System.Windows.Forms.Splitter.BorderStyle has been replaced by System.Windows.Forms.SplitContainer.BorderStyle and is provided only for compatibility with previous versions.
...
Get: Dock(self: Splitter) -> DockStyle



Set: Dock(self: Splitter)=value
...
Get: Font(self: Splitter) -> Font



Set: Font(self: Splitter)=value
...
Get: ForeColor(self: Splitter) -> Color



Set: ForeColor(self: Splitter)=value
...
Get: ImeMode(self: Splitter) -> ImeMode



Set: ImeMode(self: Splitter)=value
...
"""
 ...
 MinExtra=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets the minimum distance that must remain between the splitter control and the edge of the opposite side of the container (or the closest control docked to that side). System.Windows.Forms.Splitter.MinExtra has been replaced by similar properties in System.Windows.Forms.SplitContainer and is provided only for compatibility with previous versions.
...
"""
 ...
 """Gets or sets the minimum distance that must remain between the splitter control and the container edge that the control is docked to. System.Windows.Forms.Splitter.MinSize has been replaced by System.Windows.Forms.SplitContainer.Panel1MinSize and System.Windows.Forms.SplitContainer.Panel2MinSize and is provided only for compatibility with previous versions.
...
"""
 ...
 SplitPosition=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets the distance between the splitter control and the container edge that the control is docked to. System.Windows.Forms.Splitter.SplitPosition has been replaced by System.Windows.Forms.SplitContainer.Panel1MinSize and System.Windows.Forms.SplitContainer.Panel2MinSize and is provided only for compatibility with previous versions.
...
Get: TabStop(self: Splitter) -> bool



Set: TabStop(self: Splitter)=value
...
Get: Text(self: Splitter) -> str



Set: Text(self: Splitter)=value
