class GroupBox(Control,IComponent,IDisposable,IOleControl,IOleObject,IOleInPlaceObject,IOleInPlaceActiveObject,IOleWindow,IViewObject,IViewObject2,IPersist,IPersistStreamInit,IPersistPropertyBag,IPersistStorage,IQuickActivate,ISupportOleDropSource,IDropTarget,ISynchronizeInvoke,IWin32Window,IArrangedElement,IBindableComponent):
 ...
 def CreateAccessibilityInstance(self,*args):
  """
  CreateAccessibilityInstance(self: GroupBox) -> AccessibleObject

  

   Creates a new accessibility object for the System.Windows.Forms.GroupBox.

   Returns: A new System.Windows.Forms.AccessibleObject for the System.Windows.Forms.GroupBox.
  """
  pass
 ...
 def OnFontChanged(self,*args):
  """
  OnFontChanged(self: GroupBox,e: EventArgs)
 ...
 def OnPaint(self,*args):
  """
  OnPaint(self: GroupBox,e: PaintEventArgs)
 ...
 def ProcessMnemonic(self,*args):
  """
  ProcessMnemonic(self: GroupBox,charCode: Char) -> bool
 ...
 def ScaleControl(self,*args):
  """
  ScaleControl(self: GroupBox,factor: SizeF,specified: BoundsSpecified)

   Scales the System.Windows.Forms.GroupBox by the specified factor and scaling instruction.

  

   factor: The System.Drawing.SizeF that indicates the height and width of the scaled control.

   specified: One of the System.Windows.Forms.BoundsSpecified values that indicates how the control should be 
 ...
 def ToString(self):
  ...
  ToString(self: GroupBox) -> str
   ...
   Returns: A string that represents the current System.Windows.Forms.GroupBox.
  """
  pass
 ...
 def WndProc(self,*args):
  """
  WndProc(self: GroupBox,m: Message) -> Message
...
Get: AllowDrop(self: GroupBox) -> bool



Set: AllowDrop(self: GroupBox)=value
...
Get: AutoSize(self: GroupBox) -> bool



Set: AutoSize(self: GroupBox)=value

"""

 AutoSizeMode=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets how the System.Windows.Forms.GroupBox behaves when its System.Windows.Forms.Control.AutoSize property is enabled.
...
Get: DisplayRectangle(self: GroupBox) -> Rectangle
...
Get: TabStop(self: GroupBox) -> bool



Set: TabStop(self: GroupBox)=value
