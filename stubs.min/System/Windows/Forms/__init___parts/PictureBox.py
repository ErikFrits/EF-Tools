class PictureBox(Control,IComponent,IDisposable,IOleControl,IOleObject,IOleInPlaceObject,IOleInPlaceActiveObject,IOleWindow,IViewObject,IViewObject2,IPersist,IPersistStreamInit,IPersistPropertyBag,IPersistStorage,IQuickActivate,ISupportOleDropSource,IDropTarget,ISynchronizeInvoke,IWin32Window,IArrangedElement,IBindableComponent,ISupportInitialize):
 ...
 def Load(self,url=None):
  ...
  Load(self: PictureBox,url: str)
   ...
   url: The path for the image to display in the System.Windows.Forms.PictureBox.

  Load(self: PictureBox)

   Displays the image specified by the System.Windows.Forms.PictureBox.ImageLocation property of 
...
Get: AllowDrop(self: PictureBox) -> bool



Set: AllowDrop(self: PictureBox)=value
...
Get: CausesValidation(self: PictureBox) -> bool



Set: CausesValidation(self: PictureBox)=value
...
Get: Font(self: PictureBox) -> Font



Set: Font(self: PictureBox)=value
...
Get: ForeColor(self: PictureBox) -> Color



Set: ForeColor(self: PictureBox)=value
...
Get: ImeMode(self: PictureBox) -> ImeMode



Set: ImeMode(self: PictureBox)=value
...
Get: RightToLeft(self: PictureBox) -> RightToLeft



Set: RightToLeft(self: PictureBox)=value
...
Get: TabIndex(self: PictureBox) -> int



Set: TabIndex(self: PictureBox)=value
...
Get: TabStop(self: PictureBox) -> bool



Set: TabStop(self: PictureBox)=value
...
Get: Text(self: PictureBox) -> str



Set: Text(self: PictureBox)=value
