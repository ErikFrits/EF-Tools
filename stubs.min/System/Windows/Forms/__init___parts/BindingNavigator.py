class BindingNavigator(ToolStrip,IComponent,IDisposable,IOleControl,IOleObject,IOleInPlaceObject,IOleInPlaceActiveObject,IOleWindow,IViewObject,IViewObject2,IPersist,IPersistStreamInit,IPersistPropertyBag,IPersistStorage,IQuickActivate,ISupportOleDropSource,IDropTarget,ISynchronizeInvoke,IWin32Window,IArrangedElement,IBindableComponent,ISupportToolStripPanel,ISupportInitialize):
 """
 ...
 def BeginInit(self):
  """
  BeginInit(self: BindingNavigator)

   Disables updates to the System.Windows.Forms.ToolStripItem controls of the 

    System.Windows.Forms.BindingNavigator during the component's initialization.
  """
  pass
 ...
 def Dispose(self):
  """
  Dispose(self: BindingNavigator,disposing: bool)

   Releases the unmanaged resources used by the System.Windows.Forms.BindingNavigator and 
 ...
 def EndInit(self):
  """
  EndInit(self: BindingNavigator)

   Enables updates to the System.Windows.Forms.ToolStripItem controls of the 

    System.Windows.Forms.BindingNavigator after the component's initialization has concluded.
  """
  pass
 ...
 def OnQueryContinueDrag(self,*args):
  ...
  """
  pass
 def OnRefreshItems(self,*args):
  """
  OnRefreshItems(self: BindingNavigator)

   Raises the System.Windows.Forms.BindingNavigator.RefreshItems event.
  """
  pass
 ...
 def RecreateHandle(self,*args):
  ...
  """
  pass
 def RefreshItemsCore(self,*args):
  """
 ...
 def Validate(self):
  ...
  Validate(self: BindingNavigator) -> bool
   ...
   Returns: true if validation was successful and focus can shift to the 

    System.Windows.Forms.BindingNavigator; otherwise,false.
  """
  pass
 ...
 def __new__(self,*__args):
  ...
  __new__(cls: type,bindingSource: BindingSource)

  __new__(cls: type,container: IContainer)

  __new__(cls: type,addStandardItems: bool)
  """
  pass
 def __str__(self,*args):
  pass
 AddNewItem=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 BindingSource=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 CountItem=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 CountItemFormat=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets a string used to format the information displayed in the System.Windows.Forms.BindingNavigator.CountItem control.
...
"""
 ...
 DeleteItem=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 MoveFirstItem=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 MoveLastItem=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 MoveNextItem=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 MovePreviousItem=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 PositionItem=property(lambda self: object(),lambda self,v: None,lambda self: None)
