class FlowLayoutPanel(Panel,IComponent,IDisposable,IOleControl,IOleObject,IOleInPlaceObject,IOleInPlaceActiveObject,IOleWindow,IViewObject,IViewObject2,IPersist,IPersistStreamInit,IPersistPropertyBag,IPersistStorage,IQuickActivate,ISupportOleDropSource,IDropTarget,ISynchronizeInvoke,IWin32Window,IArrangedElement,IBindableComponent,IExtenderProvider):
 """
 ...
 def GetFlowBreak(self,control):
  ...
  GetFlowBreak(self: FlowLayoutPanel,control: Control) -> bool
   ...
   Returns a value that represents the flow-break setting of the 
 ...
 def SetFlowBreak(self,control,value):
  ...
  SetFlowBreak(self: FlowLayoutPanel,control: Control,value: bool)
   ...
   Sets the value that represents the flow-break setting of the 
