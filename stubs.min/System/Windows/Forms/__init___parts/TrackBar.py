class TrackBar(Control,IComponent,IDisposable,IOleControl,IOleObject,IOleInPlaceObject,IOleInPlaceActiveObject,IOleWindow,IViewObject,IViewObject2,IPersist,IPersistStreamInit,IPersistPropertyBag,IPersistStorage,IQuickActivate,ISupportOleDropSource,IDropTarget,ISynchronizeInvoke,IWin32Window,IArrangedElement,IBindableComponent,ISupportInitialize):
 """
 ...
 def BeginInit(self):
  """
  BeginInit(self: TrackBar)

   Begins the initialization of a System.Windows.Forms.TrackBar that is used on a form or used by 
 ...
 def EndInit(self):
  """
  EndInit(self: TrackBar)

   Ends the initialization of a System.Windows.Forms.TrackBar that is used on a form or used by 
 ...
 def IsInputKey(self,*args):
  """
  IsInputKey(self: TrackBar,keyData: Keys) -> bool
 ...
 def OnBackColorChanged(self,*args):
  """
  OnBackColorChanged(self: TrackBar,e: EventArgs)

   This method is called by the control when any property changes. Inheriting controls can override 

    this method to get property change notification on basic properties. Inheriting controls must 

    call base.propertyChanged.
 ...
 def OnHandleCreated(self,*args):
  """
  OnHandleCreated(self: TrackBar,e: EventArgs)

   Use the System.Windows.Forms.Control.OnHandleCreated(System.EventArgs) method.
 ...
 def OnMouseWheel(self,*args):
  """
  OnMouseWheel(self: TrackBar,e: MouseEventArgs)
 ...
 def OnRightToLeftLayoutChanged(self,*args):
  ...
  OnRightToLeftLayoutChanged(self: TrackBar,e: EventArgs)
   ...
   Raises the System.Windows.Forms.TrackBar.RightToLeftLayoutChanged event.
 ...
 def OnScroll(self,*args):
  ...
  OnScroll(self: TrackBar,e: EventArgs)
   ...
   Raises the System.Windows.Forms.TrackBar.Scroll event.
 ...
 def OnSystemColorsChanged(self,*args):
  """
  OnSystemColorsChanged(self: TrackBar,e: EventArgs)
 ...
 def SetBoundsCore(self,*args):
  """
  SetBoundsCore(self: TrackBar,x: int,y: int,width: int,height: int,specified: BoundsSpecified)
 ...
 def ToString(self):
  ...
  ToString(self: TrackBar) -> str
   ...
   Returns: A string that represents the current System.Windows.Forms.TrackBar.
  """
  pass
 ...
 def WndProc(self,*args):
  """
  WndProc(self: TrackBar,m: Message) -> Message
...
Get: AutoSize(self: TrackBar) -> bool



Set: AutoSize(self: TrackBar)=value
...
Get: BackgroundImage(self: TrackBar) -> Image



Set: BackgroundImage(self: TrackBar)=value
...
Get: BackgroundImageLayout(self: TrackBar) -> ImageLayout



Set: BackgroundImageLayout(self: TrackBar)=value
...
Get: Font(self: TrackBar) -> Font



Set: Font(self: TrackBar)=value
...
Get: ForeColor(self: TrackBar) -> Color



Set: ForeColor(self: TrackBar)=value
...
Get: ImeMode(self: TrackBar) -> ImeMode



Set: ImeMode(self: TrackBar)=value
...
Get: Padding(self: TrackBar) -> Padding



Set: Padding(self: TrackBar)=value
...
"""
 ...
 """Gets or sets the value added to or subtracted from the System.Windows.Forms.TrackBar.Value property when the scroll box is moved a small distance.
...
Get: Text(self: TrackBar) -> str



Set: Text(self: TrackBar)=value
...
"""
 ...
 TickStyle=property(lambda self: object(),lambda self,v: None,lambda self: None)
