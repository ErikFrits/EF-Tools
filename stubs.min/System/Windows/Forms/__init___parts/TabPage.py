class TabPage(Panel,IComponent,IDisposable,IOleControl,IOleObject,IOleInPlaceObject,IOleInPlaceActiveObject,IOleWindow,IViewObject,IViewObject2,IPersist,IPersistStreamInit,IPersistPropertyBag,IPersistStorage,IQuickActivate,ISupportOleDropSource,IDropTarget,ISynchronizeInvoke,IWin32Window,IArrangedElement,IBindableComponent):
 ...
 def GetStyle(self,*args):
  ...
  pass
 @staticmethod
 def GetTabPageOfComponent(comp):
  """
 ...
 def SetBoundsCore(self,*args):
  ...
  SetBoundsCore(self: TabPage,x: int,y: int,width: int,height: int,specified: BoundsSpecified)
   ...
   specified: A bitwise combination of System.Windows.Forms.BoundsSpecified values.
  """
  pass
...
Get: AutoSize(self: TabPage) -> bool



Set: AutoSize(self: TabPage)=value
...
Get: AutoSizeMode(self: TabPage) -> AutoSizeMode



Set: AutoSizeMode(self: TabPage)=value
...
"""
 ...
 """Gets or sets the key accessor for the image in the System.Windows.Forms.TabControl.ImageList of the associated System.Windows.Forms.TabControl.
...
Get: TabStop(self: TabPage) -> bool



Set: TabStop(self: TabPage)=value
...
Get: Text(self: TabPage) -> str



Set: Text(self: TabPage)=value
