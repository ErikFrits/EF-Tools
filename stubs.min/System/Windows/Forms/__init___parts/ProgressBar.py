class ProgressBar(Control,IComponent,IDisposable,IOleControl,IOleObject,IOleInPlaceObject,IOleInPlaceActiveObject,IOleWindow,IViewObject,IViewObject2,IPersist,IPersistStreamInit,IPersistPropertyBag,IPersistStorage,IQuickActivate,ISupportOleDropSource,IDropTarget,ISynchronizeInvoke,IWin32Window,IArrangedElement,IBindableComponent):
 """
 ...
 def OnBackColorChanged(self,*args):
  """
  OnBackColorChanged(self: ProgressBar,e: EventArgs)
 ...
 def OnForeColorChanged(self,*args):
  """
  OnForeColorChanged(self: ProgressBar,e: EventArgs)
 ...
 def OnHandleCreated(self,*args):
  """
  OnHandleCreated(self: ProgressBar,e: EventArgs)
 ...
 def OnHandleDestroyed(self,*args):
  """
  OnHandleDestroyed(self: ProgressBar,e: EventArgs)
 ...
 def OnRightToLeftLayoutChanged(self,*args):
  ...
  OnRightToLeftLayoutChanged(self: ProgressBar,e: EventArgs)
   ...
   Raises the System.Windows.Forms.ProgressBar.RightToLeftLayout event.
 ...
 def ResetForeColor(self):
  """
  ResetForeColor(self: ProgressBar)

   Resets the System.Windows.Forms.Control.ForeColor to its default value.
  """
  pass
 ...
 def ToString(self):
  ...
  ToString(self: ProgressBar) -> str
   ...
   Returns: A string that represents the current System.Windows.Forms.ProgressBar.
  """
  pass
...
Get: AllowDrop(self: ProgressBar) -> bool



Set: AllowDrop(self: ProgressBar)=value
...
Get: BackgroundImage(self: ProgressBar) -> Image



Set: BackgroundImage(self: ProgressBar)=value
...
Get: BackgroundImageLayout(self: ProgressBar) -> ImageLayout



Set: BackgroundImageLayout(self: ProgressBar)=value
...
Get: CausesValidation(self: ProgressBar) -> bool



Set: CausesValidation(self: ProgressBar)=value
...
Get: Font(self: ProgressBar) -> Font



Set: Font(self: ProgressBar)=value
...
Get: ImeMode(self: ProgressBar) -> ImeMode



Set: ImeMode(self: ProgressBar)=value
...
Get: Padding(self: ProgressBar) -> Padding



Set: Padding(self: ProgressBar)=value
...
Get: TabStop(self: ProgressBar) -> bool



Set: TabStop(self: ProgressBar)=value
...
Get: Text(self: ProgressBar) -> str



Set: Text(self: ProgressBar)=value
