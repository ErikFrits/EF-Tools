class Thumb(Control,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient):
 """
 ...
 def OnCreateAutomationPeer(self,*args):
  """
  OnCreateAutomationPeer(self: Thumb) -> AutomationPeer

  

   Creates an System.Windows.Automation.Peers.AutomationPeer for the 

    System.Windows.Controls.Primitives.Thumb control.

  

   Returns: A System.Windows.Automation.Peers.ThumbAutomationPeer for the 
...
"""
 ...
 IsDragging=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets whether the System.Windows.Controls.Primitives.Thumb control has logical focus and mouse capture and the left mouse button is pressed.



Get: IsDragging(self: Thumb) -> bool
...
"""
 ...
 DragCompleted=None
 DragCompletedEvent=None
 DragDelta=None
 DragDeltaEvent=None
 DragStarted=None
 DragStartedEvent=None
 IsDraggingProperty=None
