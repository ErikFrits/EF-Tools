class ToolBarPanel(StackPanel,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient,IAddChild,IScrollInfo,IStackMeasure):
 """
 Arranges System.Windows.Controls.ToolBar items inside a System.Windows.Controls.ToolBar.
 ...
 def ArrangeOverride(self,*args):
  """
  ArrangeOverride(self: ToolBarPanel,arrangeSize: Size) -> Size

  

   Arranges and sizes System.Windows.Controls.ToolBar items inside a 
   ...
   arrangeSize: The size that the System.Windows.Controls.Primitives.ToolBarPanel assumes to position its 
 ...
 def MeasureOverride(self,*args):
  """
  MeasureOverride(self: ToolBarPanel,constraint: Size) -> Size
   ...
   constraint: The measurement constraints; a System.Windows.Controls.Primitives.ToolBarPanel cannot return a 

    size larger than the constraint.
