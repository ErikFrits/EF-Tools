class DataGridCellsPresenter(ItemsControl,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient,IAddChild,IGeneratorHost,IContainItemStorage):
 """
 Used within the template of a System.Windows.Controls.DataGrid to specify the location in the control's visual tree where the cells are to be added.
 ...
 def ArrangeOverride(self,*args):
  """
  ArrangeOverride(self: DataGridCellsPresenter,finalSize: Size) -> Size
 ...
 def ClearContainerForItemOverride(self,*args):
  """
  ClearContainerForItemOverride(self: DataGridCellsPresenter,element: DependencyObject,item: object)

   Clears the container reference for the specified cell.

  

   element: The System.Windows.Controls.DataGridCell to clear.

   item: The data item. This value is not used.
  """
  pass
 def GetContainerForItemOverride(self,*args):
  """
  GetContainerForItemOverride(self: DataGridCellsPresenter) -> DependencyObject

  

   Returns a new System.Windows.Controls.DataGridCell instance to contain a cell value.

   Returns: A new System.Windows.Controls.DataGridCell instance.
  """
  pass
 ...
 def IsItemItsOwnContainerOverride(self,*args):
  """
  IsItemItsOwnContainerOverride(self: DataGridCellsPresenter,item: object) -> bool
 ...
 def MeasureOverride(self,*args):
  """
  MeasureOverride(self: DataGridCellsPresenter,availableSize: Size) -> Size
 ...
 def OnApplyTemplate(self):
  """ OnApplyTemplate(self: DataGridCellsPresenter) """
  pass
 ...
 def OnColumnsChanged(self,*args):
  """ OnColumnsChanged(self: DataGridCellsPresenter,columns: ObservableCollection[DataGridColumn],e: NotifyCollectionChangedEventArgs) """
  pass
 ...
 def OnItemChanged(self,*args):
  """
  OnItemChanged(self: DataGridCellsPresenter,oldItem: object,newItem: object)

   Updates the displayed cells when the 

    System.Windows.Controls.Primitives.DataGridCellsPresenter.Item property value has changed.

  

  

   oldItem: The previous value of the System.Windows.Controls.Primitives.DataGridCellsPresenter.Item 

    property.

  

   newItem: The new value of the System.Windows.Controls.Primitives.DataGridCellsPresenter.Item property.
  """
  pass
 ...
 def OnRender(self,*args):
  """
  OnRender(self: DataGridCellsPresenter,drawingContext: DrawingContext)

   Called by the layout system to draw a horizontal line below the cells if horizontal grid lines 
   ...
   drawingContext: The drawing instructions for the cells. This context is provided to the layout system.
  """
  pass
 ...
 def PrepareContainerForItemOverride(self,*args):
  """
  PrepareContainerForItemOverride(self: DataGridCellsPresenter,element: DependencyObject,item: object)

   Prepares the cell to display the specified item.

  

   element: The cell to prepare.
...
Get: Item(self: DataGridCellsPresenter) -> object
