class Selector(ItemsControl,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient,IAddChild,IGeneratorHost,IContainItemStorage):
 ...
 def AddLogicalChild(self,*args):
  ...
  pass
 @staticmethod
 def AddSelectedHandler(element,handler):
  """
  AddSelectedHandler(element: DependencyObject,handler: RoutedEventHandler)

   Adds a handler for the System.Windows.Controls.Primitives.Selector.Selected attached event.

  

   element: Element that listens to this event.
 ...
 def AddText(self,*args):
  ...
  pass
 @staticmethod
 def AddUnselectedHandler(element,handler):
  """
  AddUnselectedHandler(element: DependencyObject,handler: RoutedEventHandler)

   Adds a handler for the System.Windows.Controls.Primitives.Selector.Unselected attached event.
 ...
 def GetContainerForItemOverride(self,*args):
  ...
  pass
 @staticmethod
 def GetIsSelected(element):
  """
  GetIsSelected(element: DependencyObject) -> bool

  

   Gets the value of the System.Windows.Controls.Primitives.Selector.IsSelected�attached property 

    that indicates whether an item is selected.

  

  

   element: Object to query concerning the System.Windows.Controls.Primitives.Selector.IsSelected property.

   Returns: Boolean value,true if the System.Windows.Controls.Primitives.Selector.IsSelected property is 

    true.
  """
  pass
 @staticmethod
 def GetIsSelectionActive(element):
  """
  GetIsSelectionActive(element: DependencyObject) -> bool
   ...
   Returns: Value of the property,true if the keyboard focus is within the 
 ...
 def RemoveLogicalChild(self,*args):
  ...
  pass
 @staticmethod
 def RemoveSelectedHandler(element,handler):
  """
  RemoveSelectedHandler(element: DependencyObject,handler: RoutedEventHandler)

   Removes a handler for the System.Windows.Controls.Primitives.Selector.Selected attached event.
  ...
  pass
 @staticmethod
 def RemoveUnselectedHandler(element,handler):
  """
  RemoveUnselectedHandler(element: DependencyObject,handler: RoutedEventHandler)

   Removes a handler for the System.Windows.Controls.Primitives.Selector.Unselected attached event.
 ...
 def RemoveVisualChild(self,*args):
  ...
  pass
 @staticmethod
 def SetIsSelected(element,isSelected):
  """
  SetIsSelected(element: DependencyObject,isSelected: bool)

   Sets a property value that indicates whether an item in a 

    System.Windows.Controls.Primitives.Selector is selected.

  

  

   element: Object on which to set the property.

   isSelected: Value to set.
  """
  pass
...
"""
 ...
 """Gets or sets a value that indicates whether a System.Windows.Controls.Primitives.Selector should keep the System.Windows.Controls.Primitives.Selector.SelectedItem synchronized with the current item in the System.Windows.Controls.ItemsControl.Items property.



Get: IsSynchronizedWithCurrentItem(self: Selector) -> Nullable[bool]



Set: IsSynchronizedWithCurrentItem(self: Selector)=value
...
Get: SelectedIndex(self: Selector) -> int



Set: SelectedIndex(self: Selector)=value
...
Get: SelectedItem(self: Selector) -> object



Set: SelectedItem(self: Selector)=value

"""

 SelectedValue=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets the value of the System.Windows.Controls.Primitives.Selector.SelectedItem,obtained by using System.Windows.Controls.Primitives.Selector.SelectedValuePath.



Get: SelectedValue(self: Selector) -> object



Set: SelectedValue(self: Selector)=value
...
Get: SelectedValuePath(self: Selector) -> str



Set: SelectedValuePath(self: Selector)=value
...
"""
 ...
 IsSynchronizedWithCurrentItemProperty=None
 SelectedEvent=None
 SelectedIndexProperty=None
 SelectedItemProperty=None
 SelectedValuePathProperty=None
 SelectedValueProperty=None
