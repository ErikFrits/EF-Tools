class DocumentViewerBase(Control,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient,IAddChild,IServiceProvider):
 """ Provides a base class for viewers that are intended to display fixed or flow content (represented by a System.Windows.Documents.FixedDocument or System.Windows.Documents.FlowDocument,respectively). """
 ...
 def CancelPrint(self):
  """
  CancelPrint(self: DocumentViewerBase)
 ...
 def CanGoToPage(self,pageNumber):
  """
  CanGoToPage(self: DocumentViewerBase,pageNumber: int) -> bool

  

   Returns a value that indicates whether or the viewer is able to jump to the specified page 
   ...
   pageNumber: A page number to check for as a valid jump target.

   Returns: A Boolean value that indicates whether or the viewer is able to jump to the specified page 
 ...
 def FirstPage(self):
  """
  FirstPage(self: DocumentViewerBase)

   Causes the viewer to jump to the first page of the current document (represented by the 

    System.Windows.Controls.Primitives.DocumentViewerBase.Document property).
  """
  pass
 @staticmethod
 def GetIsMasterPage(element):
  """
  GetIsMasterPage(element: DependencyObject) -> bool

  

   Returns the value of the System.Windows.Controls.Primitives.DocumentViewerBase.IsMasterPage 
   ...
   element: A dependency object from which to retrieve the value of 

    System.Windows.Controls.Primitives.DocumentViewerBase.IsMasterPage.

  

   Returns: The value of the System.Windows.Controls.Primitives.DocumentViewerBase.IsMasterPage attached 

    property,read from the dependency object specified by element.
  """
  pass
 ...
 def GetPageViewsCollection(self,*args):
  """
  GetPageViewsCollection(self: DocumentViewerBase) -> (ReadOnlyCollection[DocumentPageView],bool)

  

   Creates and returns a new,read-only collection of 

    System.Windows.Controls.Primitives.DocumentPageView objects that are associated with the current 

    display document (represented by the 

    System.Windows.Controls.Primitives.DocumentViewerBase.Document property).

  

   Returns: A read-only collection of System.Windows.Controls.Primitives.DocumentPageView objects that are 

    associated with the current display document.
  """
  pass
 ...
 def GoToPage(self,pageNumber):
  """
  GoToPage(self: DocumentViewerBase,pageNumber: int)

   Causes the viewer to jump to a specified page number.

  

   pageNumber: The number of the page to jump to.
  """
  pass
 ...
 def LastPage(self):
  """
  LastPage(self: DocumentViewerBase)

   Causes the viewer to jump to the last page in the current document (represented by the 
 ...
 def NextPage(self):
  """
  NextPage(self: DocumentViewerBase)

   Causes the viewer to jump to the next page in the current document (represented by the 
 ...
 def OnApplyTemplate(self):
  """
  OnApplyTemplate(self: DocumentViewerBase)
 ...
 def OnBringIntoView(self,*args):
  """
  OnBringIntoView(self: DocumentViewerBase,element: DependencyObject,rect: Rect,pageNumber: int)

   Invoked whenever the System.Windows.FrameworkElement.RequestBringIntoView event reaches an 
   ...
   element: The element from which the System.Windows.FrameworkElement.RequestBringIntoView event originated.

   rect: A rectangular region,in the coordinate space of element,which should be made visible.

   pageNumber: The page number for the page that contains element.
  """
  pass
 ...
 def OnCreateAutomationPeer(self,*args):
  """
  OnCreateAutomationPeer(self: DocumentViewerBase) -> AutomationPeer

  

   Creates and returns an System.Windows.Automation.Peers.AutomationPeer object for this viewer.

   Returns: An System.Windows.Automation.Peers.AutomationPeer object for this viewer.
  """
  pass
 def OnDocumentChanged(self,*args):
  """
  OnDocumentChanged(self: DocumentViewerBase)

   Called whenever the System.Windows.Controls.Primitives.DocumentViewerBase.Document property is 
 ...
 def OnFirstPageCommand(self,*args):
  """
  OnFirstPageCommand(self: DocumentViewerBase)

   Handles the System.Windows.Input.NavigationCommands.FirstPage routed command.
  """
  pass
 ...
 def OnGoToPageCommand(self,*args):
  """
  OnGoToPageCommand(self: DocumentViewerBase,pageNumber: int)

   Handles the System.Windows.Input.NavigationCommands.GoToPage routed command.
 ...
 def OnLastPageCommand(self,*args):
  """
  OnLastPageCommand(self: DocumentViewerBase)

   Handles the System.Windows.Input.NavigationCommands.LastPage routed command.
  """
  pass
 ...
 def OnNextPageCommand(self,*args):
  """
  OnNextPageCommand(self: DocumentViewerBase)

   Handles the System.Windows.Input.NavigationCommands.NextPage routed command.
  """
  pass
 ...
 def OnPreviousPageCommand(self,*args):
  """
  OnPreviousPageCommand(self: DocumentViewerBase)

   Handles the System.Windows.Input.NavigationCommands.PreviousPage routed command.
  """
  pass
 ...
 def PreviousPage(self):
  """
  PreviousPage(self: DocumentViewerBase)

   Causes the viewer to jump to the previous page of the current document (represented by the 
 ...
 def Print(self):
  """
  Print(self: DocumentViewerBase)

   Invokes a standard Print dialog which can be used to print the contents of the viewer and 
 ...
 def RemoveVisualChild(self,*args):
  ...
  pass
 @staticmethod
 def SetIsMasterPage(element,value):
  """
  SetIsMasterPage(element: DependencyObject,value: bool)

   Sets the System.Windows.Controls.Primitives.DocumentViewerBase.IsMasterPage�attached property on 
   ...
   element: A dependency object on which to set the value of 
 ...
 """Gets a value that indicates whether or not the viewer can jump to the next page in the current System.Windows.Controls.Primitives.DocumentViewerBase.Document.



Get: CanGoToNextPage(self: DocumentViewerBase) -> bool
...
"""
 ...
 """Gets a value that indicates whether or not the viewer can jump to the previous page in the current System.Windows.Controls.Primitives.DocumentViewerBase.Document.



Get: CanGoToPreviousPage(self: DocumentViewerBase) -> bool
...
"""
 ...
 """Gets or sets a System.Windows.Documents.IDocumentPaginatorSource to be paginated and displayed by the viewer.



Get: Document(self: DocumentViewerBase) -> IDocumentPaginatorSource



Set: Document(self: DocumentViewerBase)=value
...
"""
 ...
 MasterPageNumber=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets the page number for the current master page.



Get: MasterPageNumber(self: DocumentViewerBase) -> int
...
"""
 ...
 """Gets the total number of pages in the current System.Windows.Controls.Primitives.DocumentViewerBase.Document.



Get: PageCount(self: DocumentViewerBase) -> int



"""

 PageViews=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets a read-only collection of the active System.Windows.Controls.Primitives.DocumentPageView objects contained within the viewer.



Get: PageViews(self: DocumentViewerBase) -> ReadOnlyCollection[DocumentPageView]
...
"""
 ...
 CanGoToNextPagePropertyKey=None
 CanGoToPreviousPageProperty=None
 CanGoToPreviousPagePropertyKey=None
 DocumentProperty=None
 IsMasterPageProperty=None
 MasterPageNumberProperty=None
 MasterPageNumberPropertyKey=None
 PageCountProperty=None
 PageCountPropertyKey=None
 PageViewsChanged=None
