class DataGridColumnHeader(ButtonBase,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient,IAddChild,ICommandSource,IProvideDataGridColumn):
 """
 ...
 def OnApplyTemplate(self):
  """
  OnApplyTemplate(self: DataGridColumnHeader)
 ...
 def OnClick(self,*args):
  """
  OnClick(self: DataGridColumnHeader)

   Raises the System.Windows.Controls.Primitives.ButtonBase.Click event and initiates sorting.
  """
  pass
 ...
 def OnCreateAutomationPeer(self,*args):
  """
  OnCreateAutomationPeer(self: DataGridColumnHeader) -> AutomationPeer

  

   Returns a new System.Windows.Automation.Peers.DataGridColumnHeaderAutomationPeer for this column 

    header.

  

   Returns: A new automation peer for this column header.
  """
  pass
 ...
 def OnLostMouseCapture(self,*args):
  """
  OnLostMouseCapture(self: DataGridColumnHeader,e: MouseEventArgs)
 ...
 def OnMouseLeftButtonDown(self,*args):
  """
  OnMouseLeftButtonDown(self: DataGridColumnHeader,e: MouseButtonEventArgs)
 ...
 def OnMouseLeftButtonUp(self,*args):
  """
  OnMouseLeftButtonUp(self: DataGridColumnHeader,e: MouseButtonEventArgs)
 ...
 def OnMouseMove(self,*args):
  """
  OnMouseMove(self: DataGridColumnHeader,e: MouseEventArgs)
 ...
 """Gets a value that indicates whether the user can click this column header to sort the System.Windows.Controls.DataGrid by the associated column.



Get: CanUserSort(self: DataGridColumnHeader) -> bool
...
Get: Column(self: DataGridColumnHeader) -> DataGridColumn
...
"""
 ...
 """Gets the display position of the column associated with this column header relative to the other columns in the System.Windows.Controls.DataGrid.



Get: DisplayIndex(self: DataGridColumnHeader) -> int
...
"""
 ...
 """Gets a value that indicates whether the column associated with this column header is prevented from scrolling horizontally.



Get: IsFrozen(self: DataGridColumnHeader) -> bool
...
"""
 ...
 SeparatorBrush=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets the System.Windows.Media.Brush used to paint the column header separator lines.



Get: SeparatorBrush(self: DataGridColumnHeader) -> Brush



Set: SeparatorBrush(self: DataGridColumnHeader)=value

"""

 SeparatorVisibility=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets the user interface (UI) visibility of the column header separator lines.



Get: SeparatorVisibility(self: DataGridColumnHeader) -> Visibility



Set: SeparatorVisibility(self: DataGridColumnHeader)=value

"""

 SortDirection=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets a value that indicates whether the System.Windows.Controls.DataGrid is sorted by the associated column and whether the column values are in ascending or descending order.



Get: SortDirection(self: DataGridColumnHeader) -> Nullable[ListSortDirection]
...
"""
 ...
 ColumnFloatingHeaderStyleKey=None
 ColumnHeaderDropSeparatorStyleKey=None
 DisplayIndexProperty=None
 IsFrozenProperty=None
 SeparatorBrushProperty=None
 SeparatorVisibilityProperty=None
