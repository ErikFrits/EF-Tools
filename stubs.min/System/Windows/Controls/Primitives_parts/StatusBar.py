class StatusBar(ItemsControl,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient,IAddChild,IGeneratorHost,IContainItemStorage):
 """
 ...
 def GetContainerForItemOverride(self,*args):
  """
  GetContainerForItemOverride(self: StatusBar) -> DependencyObject

  

   Creates a new System.Windows.Controls.Primitives.StatusBarItem.

   Returns: A new System.Windows.Controls.Primitives.StatusBarItem.
  """
  pass
 ...
 def IsItemItsOwnContainerOverride(self,*args):
  """
  IsItemItsOwnContainerOverride(self: StatusBar,item: object) -> bool
   ...
   item: The specified object to evaluate.

   Returns: Returns true if the item is (or is eligible to be) its own container; otherwise,false.
  """
  pass
 ...
 def OnCreateAutomationPeer(self,*args):
  """
  OnCreateAutomationPeer(self: StatusBar) -> AutomationPeer
   ...
   Returns: A System.Windows.Automation.Peers.StatusBarAutomationPeer for this 
 ...
 def PrepareContainerForItemOverride(self,*args):
  """
  PrepareContainerForItemOverride(self: StatusBar,element: DependencyObject,item: object)

   Prepares an item for display in the System.Windows.Controls.Primitives.StatusBar.

  

   element: The item to display in the System.Windows.Controls.Primitives.StatusBar.

   item: The content of the item to display.
  """
  pass
 ...
 def ShouldApplyItemContainerStyle(self,*args):
  """
  ShouldApplyItemContainerStyle(self: StatusBar,container: DependencyObject,item: object) -> bool

  

   Determines whether to apply the System.Windows.Style for an item in the 

    System.Windows.Controls.Primitives.StatusBar to an object.

  

  

   container: The container for the item.

   item: The object to evaluate.

   Returns: true if the item is not a System.Windows.Controls.Separator; otherwise,false.
  """
  pass
...
"""
 ...
 """Get: ItemContainerTemplateSelector(self: StatusBar) -> ItemContainerTemplateSelector



Set: ItemContainerTemplateSelector(self: StatusBar)=value
...
"""
 ...
 """Get: UsesItemContainerTemplate(self: StatusBar) -> bool



Set: UsesItemContainerTemplate(self: StatusBar)=value
