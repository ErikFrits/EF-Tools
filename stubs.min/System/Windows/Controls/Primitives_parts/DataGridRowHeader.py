class DataGridRowHeader(ButtonBase,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient,IAddChild,ICommandSource):
 """
 Represents an individual System.Windows.Controls.DataGrid row header.
 ...
 def MeasureOverride(self,*args):
  """
  MeasureOverride(self: DataGridRowHeader,availableSize: Size) -> Size

  

   Measures the children of a System.Windows.Controls.Primitives.DataGridRowHeader to prepare for 

    arranging them during the System.Windows.Controls.Control.ArrangeOverride(System.Windows.Size) 
   ...
   availableSize: The available size that this element can give to child elements. Indicates an upper limit that 

    child elements should not exceed.

  

   Returns: The size that the System.Windows.Controls.Primitives.DataGridRowHeader determines it needs 

    during layout,based on its calculations of child object allocated sizes.
  """
  pass
 ...
 def OnApplyTemplate(self):
  """
  OnApplyTemplate(self: DataGridRowHeader)
 ...
 def OnClick(self,*args):
  """
  OnClick(self: DataGridRowHeader)

   Raises the System.Windows.Controls.Primitives.ButtonBase.Click event and initiates row selection 
 ...
 def OnCreateAutomationPeer(self,*args):
  """
  OnCreateAutomationPeer(self: DataGridRowHeader) -> AutomationPeer

  

   Returns a new System.Windows.Automation.Peers.DataGridRowHeaderAutomationPeer for this row 

    header.

  

   Returns: A new automation peer for this row header.
  """
  pass
...
"""
 ...
 IsRowSelected=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets a value that indicates whether the row is selected.



Get: IsRowSelected(self: DataGridRowHeader) -> bool
...
"""
 ...
 """Gets or sets the System.Windows.Media.Brush used to paint the row header separator lines.



Get: SeparatorBrush(self: DataGridRowHeader) -> Brush



Set: SeparatorBrush(self: DataGridRowHeader)=value
...
Get: SeparatorVisibility(self: DataGridRowHeader) -> Visibility



Set: SeparatorVisibility(self: DataGridRowHeader)=value
