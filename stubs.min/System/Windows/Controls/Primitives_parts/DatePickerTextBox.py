class DatePickerTextBox(TextBox,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient,IAddChild,ITextBoxViewHost):
 """
 Represents the text input of a System.Windows.Controls.DatePicker.
 ...
 def OnApplyTemplate(self):
  """
  OnApplyTemplate(self: DatePickerTextBox)

   Builds the visual tree for the System.Windows.Controls.Primitives.DatePickerTextBox when a new 
 ...
 def OnGotFocus(self,*args):
  """ OnGotFocus(self: DatePickerTextBox,e: RoutedEventArgs) """
  pass
