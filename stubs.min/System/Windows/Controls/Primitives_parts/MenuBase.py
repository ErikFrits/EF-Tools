class MenuBase(ItemsControl,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient,IAddChild,IGeneratorHost,IContainItemStorage):
 ...
 def OnKeyDown(self,*args):
  """
  OnKeyDown(self: MenuBase,e: KeyEventArgs)
...
"""
 ...
 """Get: ItemContainerTemplateSelector(self: MenuBase) -> ItemContainerTemplateSelector



Set: ItemContainerTemplateSelector(self: MenuBase)=value
...
"""
 ...
 """Get: UsesItemContainerTemplate(self: MenuBase) -> bool



Set: UsesItemContainerTemplate(self: MenuBase)=value
