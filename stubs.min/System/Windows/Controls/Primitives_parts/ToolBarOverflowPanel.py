class ToolBarOverflowPanel(Panel,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient,IAddChild):
 """
 Used to arrange overflow System.Windows.Controls.ToolBar items.
 ...
 def ArrangeOverride(self,*args):
  """
  ArrangeOverride(self: ToolBarOverflowPanel,arrangeBounds: Size) -> Size

  

   Arranges and sizes the content of a System.Windows.Controls.Primitives.ToolBarOverflowPanel 
   ...
   arrangeBounds: Size that a toolbar overflow panel assumes to position child elements.

   Returns: The size of the System.Windows.Controls.Primitives.ToolBarOverflowPanel.
  """
  pass
 def CreateUIElementCollection(self,*args):
  """
  CreateUIElementCollection(self: ToolBarOverflowPanel,logicalParent: FrameworkElement) -> UIElementCollection
   ...
   logicalParent: Logical parent of the new collection.
 ...
 def MeasureOverride(self,*args):
  """
  MeasureOverride(self: ToolBarOverflowPanel,constraint: Size) -> Size

  

   Remeasures the System.Windows.Controls.Primitives.ToolBarOverflowPanel.

  

   constraint: Constraint size is an upper limit. The return value should not exceed this size.
...
"""
 ...
 WrapWidth=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets the recommended width for an overflow System.Windows.Controls.ToolBar before items flow to the next line.



Get: WrapWidth(self: ToolBarOverflowPanel) -> float



Set: WrapWidth(self: ToolBarOverflowPanel)=value

"""


 WrapWidthProperty=None
