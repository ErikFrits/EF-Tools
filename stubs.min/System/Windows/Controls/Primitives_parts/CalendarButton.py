class CalendarButton(Button,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient,IAddChild,ICommandSource):
 """
 Represents a month or year on a System.Windows.Controls.Calendar object.
 ...
 def OnCreateAutomationPeer(self,*args):
  """ OnCreateAutomationPeer(self: CalendarButton) -> AutomationPeer """
  pass
...
"""
 ...
 HasSelectedDays=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets a value that indicates whether this button represents a year or month that contains selected dates.



Get: HasSelectedDays(self: CalendarButton) -> bool
...
Get: IsInactive(self: CalendarButton) -> bool
