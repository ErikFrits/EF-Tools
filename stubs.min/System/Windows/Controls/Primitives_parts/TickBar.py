class TickBar(FrameworkElement,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient):
 """
 Represents a control that draws a set of tick marks for a System.Windows.Controls.Slider control.
 ...
 def OnRender(self,*args):
  """
  OnRender(self: TickBar,dc: DrawingContext)

   Draws the tick marks for a System.Windows.Controls.Slider control.

  

   dc: The System.Windows.Media.DrawingContext that is used to draw the ticks.
  """
  pass
...
"""
 ...
 Fill=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets the System.Windows.Media.Brush that is used to draw the tick marks.



Get: Fill(self: TickBar) -> Brush



Set: Fill(self: TickBar)=value
...
Get: IsDirectionReversed(self: TickBar) -> bool



Set: IsDirectionReversed(self: TickBar)=value
...
"""
 ...
 """Gets or sets whether the System.Windows.Controls.Primitives.TickBar displays a selection range.



Get: IsSelectionRangeEnabled(self: TickBar) -> bool



Set: IsSelectionRangeEnabled(self: TickBar)=value
...
Get: Maximum(self: TickBar) -> float



Set: Maximum(self: TickBar)=value
...
Get: Minimum(self: TickBar) -> float



Set: Minimum(self: TickBar)=value

"""

 Placement=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets where tick marks appear  relative to a System.Windows.Controls.Primitives.Track of a System.Windows.Controls.Slider control.



Get: Placement(self: TickBar) -> TickBarPlacement



Set: Placement(self: TickBar)=value

"""

 ReservedSpace=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets a space buffer for the area that contains the tick marks that are specified for a System.Windows.Controls.Primitives.TickBar.



Get: ReservedSpace(self: TickBar) -> float



Set: ReservedSpace(self: TickBar)=value
...
Get: SelectionEnd(self: TickBar) -> float



Set: SelectionEnd(self: TickBar)=value
...
Get: SelectionStart(self: TickBar) -> float



Set: SelectionStart(self: TickBar)=value
...
Get: TickFrequency(self: TickBar) -> float



Set: TickFrequency(self: TickBar)=value
...
Get: Ticks(self: TickBar) -> DoubleCollection



Set: Ticks(self: TickBar)=value
