class BulletDecorator(Decorator,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient,IAddChild):
 """
 ...
 def ArrangeOverride(self,*args):
  """
  ArrangeOverride(self: BulletDecorator,arrangeSize: Size) -> Size

  

   Overrides the default content arrangement behavior for the 

    System.Windows.Controls.Primitives.BulletDecorator control.

  

  

   arrangeSize: The available System.Windows.Size to use to lay out the content of the 

    System.Windows.Controls.Primitives.BulletDecorator control.

  

   Returns: The computed size of the System.Windows.Controls.Primitives.BulletDecorator control.
  """
  pass
 ...
 def GetVisualChild(self,*args):
  """
  GetVisualChild(self: BulletDecorator,index: int) -> Visual
   ...
   index: The specified index for the child element.

   Returns: The System.Windows.Media.Visual child element that is at the specified index.
  """
  pass
 ...
 def MeasureOverride(self,*args):
  """
  MeasureOverride(self: BulletDecorator,constraint: Size) -> Size

  

   Overrides the default measurement behavior for the objects of a 
   ...
   constraint: The upper System.Windows.Size limit of the System.Windows.Controls.Primitives.BulletDecorator.

   Returns: The required System.Windows.Size for the System.Windows.Controls.Primitives.BulletDecorator 

    control,based on the size of its System.Windows.Controls.Primitives.BulletDecorator.Bullet and 

    System.Windows.Controls.Decorator.Child objects.
  """
  pass
 ...
 def OnRender(self,*args):
  """
  OnRender(self: BulletDecorator,dc: DrawingContext)

   Renders the content of a System.Windows.Controls.Primitives.BulletDecorator control.

  

   dc: The System.Windows.Media.DrawingContext for the 
 ...
 """Gets or sets the background color for a System.Windows.Controls.Primitives.BulletDecorator control.



Get: Background(self: BulletDecorator) -> Brush



Set: Background(self: BulletDecorator)=value

"""

 Bullet=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets the object to use as the bullet in a System.Windows.Controls.Primitives.BulletDecorator.



Get: Bullet(self: BulletDecorator) -> UIElement



Set: Bullet(self: BulletDecorator)=value
...
"""
 ...
 """Gets an enumerator for the logical child elements of the System.Windows.Controls.Primitives.BulletDecorator control.
...
"""
 ...
 """Gets the number of visual child elements for the System.Windows.Controls.Primitives.BulletDecorator control.
