class DataGridDetailsPresenter(ContentPresenter,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient):
 """
 Used within the template of a System.Windows.Controls.DataGrid to specify the location in the control's visual tree where the row details are to be added.
 ...
 def ArrangeOverride(self,*args):
  """
  ArrangeOverride(self: DataGridDetailsPresenter,finalSize: Size) -> Size
 ...
 def MeasureOverride(self,*args):
  """
  MeasureOverride(self: DataGridDetailsPresenter,availableSize: Size) -> Size
 ...
 def OnCreateAutomationPeer(self,*args):
  """
  OnCreateAutomationPeer(self: DataGridDetailsPresenter) -> AutomationPeer

  

   Returns a new System.Windows.Automation.Peers.DataGridDetailsPresenterAutomationPeer for this 

    presenter.

  

   Returns: A new automation peer for this presenter.
  """
  pass
 ...
 def OnRender(self,*args):
  """
  OnRender(self: DataGridDetailsPresenter,drawingContext: DrawingContext)

   Called by the layout system to draw a horizontal line below the row details section if 
   ...
   drawingContext: The drawing instructions for the row details. This context is provided to the layout system.
  """
  pass
 ...
 def OnVisualParentChanged(self,*args):
  """
  OnVisualParentChanged(self: DataGridDetailsPresenter,oldParent: DependencyObject)
