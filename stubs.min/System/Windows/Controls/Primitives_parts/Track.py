class Track(FrameworkElement,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient):
 """
 Represents a control primitive that handles the positioning and sizing of a System.Windows.Controls.Primitives.Thumb control and two System.Windows.Controls.Primitives.RepeatButton controls that are used to set a System.Windows.Controls.Primitives.Track.Value.
 ...
 def ArrangeOverride(self,*args):
  """
  ArrangeOverride(self: Track,arrangeSize: Size) -> Size

  

   Creates the layout for the System.Windows.Controls.Primitives.Track.

  

   arrangeSize: The area that is provided for the System.Windows.Controls.Primitives.Track.

   Returns: The System.Windows.Size to use for the System.Windows.Controls.Primitives.Track content.
  """
  pass
 ...
 def GetVisualChild(self,*args):
  """
  GetVisualChild(self: Track,index: int) -> Visual

  

   Gets the child of the System.Windows.Controls.Primitives.Track at the specified index.

  

   index: The index of the child.

   Returns: Returns the object of the System.Windows.Controls.Primitives.Track at the specified index in the 

    list of visual child elements. The index must be a number between zero (0) and the value of the 

    System.Windows.Controls.Primitives.Track.VisualChildrenCount property minus one (1).
  """
  pass
 ...
 def MeasureOverride(self,*args):
  """
  MeasureOverride(self: Track,availableSize: Size) -> Size

  

   Measures the layout size that is required for the System.Windows.Controls.Primitives.Track and 
   ...
   availableSize: The size of the available space for the track.

   Returns: The layout System.Windows.Size that is required by the System.Windows.Controls.Primitives.Track.
  """
  pass
 ...
 def ShouldSerializeProperty(self,*args):
  ...
  """
  pass
 def ValueFromDistance(self,horizontal,vertical):
  """
  ValueFromDistance(self: Track,horizontal: float,vertical: float) -> float

  

   Calculates the change in the System.Windows.Controls.Primitives.Track.Value of the 

    System.Windows.Controls.Primitives.Track when the System.Windows.Controls.Primitives.Track.Thumb 
   ...
   horizontal: The horizontal displacement of the System.Windows.Controls.Primitives.Track.Thumb.

   vertical: The vertical displacement of the System.Windows.Controls.Primitives.Track.Thumb.

   Returns: The change in System.Windows.Controls.Primitives.Track.Value that corresponds to the 

    displacement of the System.Windows.Controls.Primitives.Track.Thumb of the 

    System.Windows.Controls.Primitives.Track.
  """
  pass
 def ValueFromPoint(self,pt):
  """
  ValueFromPoint(self: Track,pt: Point) -> float

  

   Calculates the distance from the System.Windows.Controls.Primitives.Thumb to a specified point 

    along the System.Windows.Controls.Primitives.Track.
   ...
   Returns: The distance between the System.Windows.Controls.Primitives.Track.Thumb and the specified pt 
 ...
 def __init__(self,*args):
  ...
  pass
 DecreaseRepeatButton=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets the System.Windows.Controls.Primitives.RepeatButton that decreases the System.Windows.Controls.Primitives.RangeBase.Value property of the System.Windows.Controls.Primitives.Track.



Get: DecreaseRepeatButton(self: Track) -> RepeatButton



Set: DecreaseRepeatButton(self: Track)=value
...
"""
 ...
 IncreaseRepeatButton=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets the System.Windows.Controls.Primitives.RepeatButton that increases the System.Windows.Controls.Primitives.RangeBase.Value property of the System.Windows.Controls.Primitives.Track class.



Get: IncreaseRepeatButton(self: Track) -> RepeatButton



Set: IncreaseRepeatButton(self: Track)=value
...
"""
 ...
 """Gets or sets whether the direction of increasing System.Windows.Controls.Primitives.Track.Value is reversed from the default direction.



Get: IsDirectionReversed(self: Track) -> bool



Set: IsDirectionReversed(self: Track)=value
...
"""
 ...
 """Gets or sets the maximum possible System.Windows.Controls.Primitives.Track.Value of the System.Windows.Controls.Primitives.Track.



Get: Maximum(self: Track) -> float



Set: Maximum(self: Track)=value

"""

 Minimum=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets the minimum possible System.Windows.Controls.Primitives.Track.Value of the System.Windows.Controls.Primitives.Track.



Get: Minimum(self: Track) -> float



Set: Minimum(self: Track)=value

"""

 Orientation=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets a value that indicates whether the System.Windows.Controls.Primitives.Track is displayed horizontally or vertically.



Get: Orientation(self: Track) -> Orientation



Set: Orientation(self: Track)=value
...
"""
 ...
 Thumb=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets the System.Windows.Controls.Primitives.Thumb control that is used to change the System.Windows.Controls.Primitives.Track.Value of a System.Windows.Controls.Primitives.Track.



Get: Thumb(self: Track) -> Thumb



Set: Thumb(self: Track)=value

"""

 Value=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets the current value of the System.Windows.Controls.Primitives.Track as determined by the position of the System.Windows.Controls.Primitives.Track.Thumb control.



Get: Value(self: Track) -> float



Set: Value(self: Track)=value

"""

 ViewportSize=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets the size of the part of the scrollable content that is visible.



Get: ViewportSize(self: Track) -> float



Set: ViewportSize(self: Track)=value
...
"""
 ...
 """Gets the number of child elements of a System.Windows.Controls.Primitives.Track.
...
"""
 ...
 MaximumProperty=None
 MinimumProperty=None
