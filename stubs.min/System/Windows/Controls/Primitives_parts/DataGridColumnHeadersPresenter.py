class DataGridColumnHeadersPresenter(ItemsControl,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient,IAddChild,IGeneratorHost,IContainItemStorage):
 """
 Used within the template of a System.Windows.Controls.DataGrid to specify the location in the control's visual tree where the column headers are to be added.
 ...
 def ArrangeOverride(self,*args):
  """
  ArrangeOverride(self: DataGridColumnHeadersPresenter,finalSize: Size) -> Size
 ...
 def ClearContainerForItemOverride(self,*args):
  """
  ClearContainerForItemOverride(self: DataGridColumnHeadersPresenter,element: DependencyObject,item: object)
 ...
 def GetContainerForItemOverride(self,*args):
  """
  GetContainerForItemOverride(self: DataGridColumnHeadersPresenter) -> DependencyObject

  

   Returns a new System.Windows.Controls.Primitives.DataGridColumnHeader instance to contain a 

    column header value.

  

   Returns: A new System.Windows.Controls.Primitives.DataGridColumnHeader instance.
  """
  pass
 def GetLayoutClip(self,*args):
  """
  GetLayoutClip(self: DataGridColumnHeadersPresenter,layoutSlotSize: Size) -> Geometry
   ...
   layoutSlotSize: The rendered size of the column header.
 ...
 def GetVisualChild(self,*args):
  """
  GetVisualChild(self: DataGridColumnHeadersPresenter,index: int) -> Visual
   ...
   index: The index of the System.Windows.Media.Visual child to return.
 ...
 def IsItemItsOwnContainerOverride(self,*args):
  """
  IsItemItsOwnContainerOverride(self: DataGridColumnHeadersPresenter,item: object) -> bool
 ...
 def MeasureOverride(self,*args):
  """
  MeasureOverride(self: DataGridColumnHeadersPresenter,availableSize: Size) -> Size
 ...
 def OnApplyTemplate(self):
  """ OnApplyTemplate(self: DataGridColumnHeadersPresenter) """
  pass
 ...
 def OnCreateAutomationPeer(self,*args):
  """
  OnCreateAutomationPeer(self: DataGridColumnHeadersPresenter) -> AutomationPeer

  

   Returns a new System.Windows.Automation.Peers.DataGridColumnHeadersPresenterAutomationPeer for 
 ...
 def PrepareContainerForItemOverride(self,*args):
  """
  PrepareContainerForItemOverride(self: DataGridColumnHeadersPresenter,element: DependencyObject,item: object)
...
"""
 ...
 """Gets the number of System.Windows.Media.Visual children in this presenter.
