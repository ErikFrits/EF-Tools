class TabPanel(Panel,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient,IAddChild):
 """
 Handles the layout of the System.Windows.Controls.TabItem objects on a System.Windows.Controls.TabControl.
 ...
 def ArrangeOverride(self,*args):
  """
  ArrangeOverride(self: TabPanel,arrangeSize: Size) -> Size

  

   Arranges and sizes the content of a System.Windows.Controls.Primitives.TabPanel object.

  

   arrangeSize: The size that a tab panel assumes to position child elements.

   Returns: The size of the tab panel.
  """
  pass
 ...
 def GetLayoutClip(self,*args):
  """
  GetLayoutClip(self: TabPanel,layoutSlotSize: Size) -> Geometry
   ...
   layoutSlotSize: The size of the panel.

   Returns: A size that is the layout size of the System.Windows.Controls.Primitives.TabPanel.
  """
  pass
 ...
 def MeasureOverride(self,*args):
  """
  MeasureOverride(self: TabPanel,constraint: Size) -> Size
