class GridViewRowPresenterBase(FrameworkElement,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient,IWeakEventListener):
 ...
 def ToString(self):
  """
  ToString(self: GridViewRowPresenterBase) -> str

  

   Returns a string representation of a System.Windows.Controls.Primitives.GridViewRowPresenterBase 

    object.

  

   Returns: A string that contains the type of the object and the number of columns.
  """
  pass
 ...
 """Gets or sets a System.Windows.Controls.GridViewColumnCollection.



Get: Columns(self: GridViewRowPresenterBase) -> GridViewColumnCollection



Set: Columns(self: GridViewRowPresenterBase)=value
