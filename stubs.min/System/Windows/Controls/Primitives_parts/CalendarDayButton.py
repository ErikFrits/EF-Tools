class CalendarDayButton(Button,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient,IAddChild,ICommandSource):
 """
 Represents a day on a System.Windows.Controls.Calendar.
 ...
 def OnCreateAutomationPeer(self,*args):
  """ OnCreateAutomationPeer(self: CalendarDayButton) -> AutomationPeer """
  pass
...
"""
 ...
 IsBlackedOut=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets a value that indicates whether the date is unavailable.



Get: IsBlackedOut(self: CalendarDayButton) -> bool
...
Get: IsHighlighted(self: CalendarDayButton) -> bool



"""

 IsInactive=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets a value that indicates whether this button represents a day that is not in the currently displayed month.



Get: IsInactive(self: CalendarDayButton) -> bool
...
Get: IsSelected(self: CalendarDayButton) -> bool



"""

 IsToday=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets a value that indicates whether the date represented by this button is the current date.



Get: IsToday(self: CalendarDayButton) -> bool
...
"""
 ...
 IsBlackedOutProperty=None
 IsHighlightedProperty=None
 IsInactiveProperty=None
 IsSelectedProperty=None
 IsTodayProperty=None
