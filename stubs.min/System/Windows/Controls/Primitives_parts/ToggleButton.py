class ToggleButton(ButtonBase,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient,IAddChild,ICommandSource):
 """
 ...
 def OnChecked(self,*args):
  """
  OnChecked(self: ToggleButton,e: RoutedEventArgs)

   Called when a System.Windows.Controls.Primitives.ToggleButton raises a 

    System.Windows.Controls.Primitives.ToggleButton.Checked event.

  

  

   e: The event data for the System.Windows.Controls.Primitives.ToggleButton.Checked event.
  """
  pass
 ...
 def OnCreateAutomationPeer(self,*args):
  """
  OnCreateAutomationPeer(self: ToggleButton) -> AutomationPeer

  

   Provides an appropriate System.Windows.Automation.Peers.ToggleButtonAutomationPeer 
 ...
 def OnToggle(self,*args):
  """
  OnToggle(self: ToggleButton)

   Called by the System.Windows.Controls.Primitives.ToggleButton.OnClick method to implement toggle 
 ...
 def ToString(self):
  """
  ToString(self: ToggleButton) -> str

  

   Returns the string representation of a System.Windows.Controls.Primitives.ToggleButton object.

   Returns: String representation of a System.Windows.Controls.Primitives.ToggleButton object.
  """
  pass
...
"""
 ...
 """Gets or sets whether the System.Windows.Controls.Primitives.ToggleButton is checked.



Get: IsChecked(self: ToggleButton) -> Nullable[bool]



Set: IsChecked(self: ToggleButton)=value
...
Get: IsThreeState(self: ToggleButton) -> bool



Set: IsThreeState(self: ToggleButton)=value
