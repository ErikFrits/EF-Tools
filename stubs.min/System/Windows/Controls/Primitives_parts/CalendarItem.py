class CalendarItem(Control,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient):
 """
 Represents the currently displayed month or year on a System.Windows.Controls.Calendar.
 ...
 def OnApplyTemplate(self):
  """
  OnApplyTemplate(self: CalendarItem)

   Builds the visual tree for the System.Windows.Controls.Primitives.CalendarItem when a new 
 ...
 def OnLostMouseCapture(self,*args):
  """ OnLostMouseCapture(self: CalendarItem,e: MouseEventArgs) """
  pass
 ...
 def OnMouseUp(self,*args):
  """ OnMouseUp(self: CalendarItem,e: MouseButtonEventArgs) """
  pass
...
"""
 ...
 DayTitleTemplateResourceKey=None
