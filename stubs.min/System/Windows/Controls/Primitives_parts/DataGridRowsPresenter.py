class DataGridRowsPresenter(VirtualizingStackPanel,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient,IAddChild,IScrollInfo,IStackMeasure):
 """
 Used within the template of a System.Windows.Controls.DataGrid to specify the location in the control's visual tree where the rows are to be added.
 ...
 def MeasureOverride(self,*args):
  """
  MeasureOverride(self: DataGridRowsPresenter,constraint: Size) -> Size
 ...
 def OnCleanUpVirtualizedItem(self,*args):
  """
  OnCleanUpVirtualizedItem(self: DataGridRowsPresenter,e: CleanUpVirtualizedItemEventArgs)

   Raises the System.Windows.Controls.VirtualizingStackPanel.CleanUpVirtualizedItem event for rows 
 ...
 def OnIsItemsHostChanged(self,*args):
  """
  OnIsItemsHostChanged(self: DataGridRowsPresenter,oldIsItemsHost: bool,newIsItemsHost: bool)
 ...
 def OnViewportSizeChanged(self,*args):
  """
  OnViewportSizeChanged(self: DataGridRowsPresenter,oldViewportSize: Size,newViewportSize: Size)
