class DocumentPageView(FrameworkElement,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient,IServiceProvider,IDisposable):
 """
 Represents a viewport for a paginated System.Windows.Documents.DocumentPage.
 ...
 def ArrangeOverride(self,*args):
  """
  ArrangeOverride(self: DocumentPageView,finalSize: Size) -> Size
   ...
   finalSize: The maximum size that the page view should use to arrange itself and its children.

   Returns: The actual size that the page view used to arrange itself and its children.
  """
  pass
 def Dispose(self,*args):
  """
  Dispose(self: DocumentPageView)

   Releases all resources used by the System.Windows.Controls.Primitives.DocumentPageView.
  """
  pass
 ...
 def GetService(self,*args):
  """
  GetService(self: DocumentPageView,serviceType: Type) -> object
 ...
 def GetVisualChild(self,*args):
  """
  GetVisualChild(self: DocumentPageView,index: int) -> Visual
   ...
   index: The index of the visual child to return.
 ...
 def MeasureOverride(self,*args):
  """
  MeasureOverride(self: DocumentPageView,availableSize: Size) -> Size

  

   Returns the available viewport size that can be given to display the current 

    System.Windows.Controls.Primitives.DocumentPageView.DocumentPage.

  

  

   availableSize: The maximum available size.

   Returns: The actual desired size.
  """
  pass
 ...
 def OnCreateAutomationPeer(self,*args):
  """
  OnCreateAutomationPeer(self: DocumentPageView) -> AutomationPeer
   ...
   Returns: The new System.Windows.Automation.Peers.DocumentPageViewAutomationPeer.
  """
  pass
 def OnDpiChanged(self,*args):
  """ OnDpiChanged(self: DocumentPageView,oldDpiScaleInfo: DpiScale,newDpiScaleInfo: DpiScale) """
  pass
...
"""
 ...
 """Gets the System.Windows.Documents.DocumentPage associated with this view.



Get: DocumentPage(self: DocumentPageView) -> DocumentPage
...
"""
 ...
 """Gets or sets the System.Windows.Documents.DocumentPaginator used to retrieve content pages for this view.



Get: DocumentPaginator(self: DocumentPageView) -> DocumentPaginator



Set: DocumentPaginator(self: DocumentPageView)=value
...
"""
 ...
 """Gets a value that indicates whether System.Windows.Controls.Primitives.DocumentPageView.Dispose has been called for this instance.
...
"""
 ...
 """Gets or sets the page number of the current page displayed.



Get: PageNumber(self: DocumentPageView) -> int



Set: PageNumber(self: DocumentPageView)=value

"""

 Stretch=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets a System.Windows.Media.Stretch enumeration that specifies how content should be stretched to fill the display page.



Get: Stretch(self: DocumentPageView) -> Stretch



Set: Stretch(self: DocumentPageView)=value

"""

 StretchDirection=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets a System.Windows.Controls.StretchDirection enumeration that specifies in what scaling directions System.Windows.Controls.Primitives.DocumentPageView.Stretch should be applied.



Get: StretchDirection(self: DocumentPageView) -> StretchDirection



Set: StretchDirection(self: DocumentPageView)=value
