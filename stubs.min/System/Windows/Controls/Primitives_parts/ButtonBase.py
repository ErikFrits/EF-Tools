class ButtonBase(ContentControl,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient,IAddChild,ICommandSource):
 ...
 def __str__(self,*args):
  pass
 ClickMode=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets when the System.Windows.Controls.Primitives.ButtonBase.Click event occurs.



Get: ClickMode(self: ButtonBase) -> ClickMode



Set: ClickMode(self: ButtonBase)=value
...
Get: Command(self: ButtonBase) -> ICommand



Set: Command(self: ButtonBase)=value

"""

 CommandParameter=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets the parameter to pass to the System.Windows.Controls.Primitives.ButtonBase.Command property.



Get: CommandParameter(self: ButtonBase) -> object



Set: CommandParameter(self: ButtonBase)=value
...
Get: CommandTarget(self: ButtonBase) -> IInputElement



Set: CommandTarget(self: ButtonBase)=value
...
"""
 ...
 """Gets a value that indicates whether a System.Windows.Controls.Primitives.ButtonBase is currently activated.



Get: IsPressed(self: ButtonBase) -> bool
