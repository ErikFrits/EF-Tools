class SelectiveScrollingGrid(Grid,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient,IAddChild):
 """
 ...
 def GetLayoutClip(self,*args):
  ...
  pass
 @staticmethod
 def GetSelectiveScrollingOrientation(obj):
  """
  GetSelectiveScrollingOrientation(obj: DependencyObject) -> SelectiveScrollingOrientation
   ...
   obj: The object whose scrolling orientation is retrieved.

   Returns: The direction that cells can scroll.
  """
  pass
 ...
 def RemoveVisualChild(self,*args):
  ...
  pass
 @staticmethod
 def SetSelectiveScrollingOrientation(obj,value):
  """
  SetSelectiveScrollingOrientation(obj: DependencyObject,value: SelectiveScrollingOrientation)

   Sets the direction that cells can scroll for a specified object.

  

   obj: The object whose scrolling orientation is set.

   value: The scrolling orientation.
  """
  pass
...
"""
 ...
 SelectiveScrollingOrientationProperty=None
