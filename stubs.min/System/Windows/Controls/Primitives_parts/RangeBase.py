class RangeBase(Control,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient):
 ...
 def ToString(self):
  """
  ToString(self: RangeBase) -> str

  

   Provides a string representation of a System.Windows.Controls.Primitives.RangeBase object.

   Returns: Returns the string representation of a System.Windows.Controls.Primitives.RangeBase object.
  """
  pass
...
"""
 ...
 """Gets or sets a value to be added to or subtracted from the System.Windows.Controls.Primitives.RangeBase.Value of a System.Windows.Controls.Primitives.RangeBase control.



Get: LargeChange(self: RangeBase) -> float



Set: LargeChange(self: RangeBase)=value
...
Get: Maximum(self: RangeBase) -> float



Set: Maximum(self: RangeBase)=value

"""

 Minimum=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets the System.Windows.Controls.Primitives.RangeBase.Minimum possible System.Windows.Controls.Primitives.RangeBase.Value of the range element.



Get: Minimum(self: RangeBase) -> float



Set: Minimum(self: RangeBase)=value

"""

 SmallChange=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets a System.Windows.Controls.Primitives.RangeBase.Value to be added to or subtracted from the System.Windows.Controls.Primitives.RangeBase.Value of a System.Windows.Controls.Primitives.RangeBase control.



Get: SmallChange(self: RangeBase) -> float



Set: SmallChange(self: RangeBase)=value
...
Get: Value(self: RangeBase) -> float



Set: Value(self: RangeBase)=value
...
"""
 ...
 LargeChangeProperty=None
 MaximumProperty=None
 MinimumProperty=None
 SmallChangeProperty=None
 ValueChanged=None
 ValueChangedEvent=None
 ValueProperty=None
