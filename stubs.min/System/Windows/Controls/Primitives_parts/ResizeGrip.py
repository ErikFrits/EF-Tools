class ResizeGrip(Control,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient):
 """
 Represents an implementation of a System.Windows.Controls.Primitives.Thumb control that enables a System.Windows.Window to change its size.
