class ContentControl(Control,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient,IAddChild):
 """
 ...
 def ShouldSerializeContent(self):
  """
  ShouldSerializeContent(self: ContentControl) -> bool
...
Get: Content(self: ContentControl) -> object



Set: Content(self: ContentControl)=value

"""

 ContentStringFormat=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets a composite string that specifies how to format the System.Windows.Controls.ContentControl.Content property if it is displayed as a string.



Get: ContentStringFormat(self: ContentControl) -> str



Set: ContentStringFormat(self: ContentControl)=value
...
Get: ContentTemplate(self: ContentControl) -> DataTemplate



Set: ContentTemplate(self: ContentControl)=value
...
Get: ContentTemplateSelector(self: ContentControl) -> DataTemplateSelector



Set: ContentTemplateSelector(self: ContentControl)=value
...
"""
 ...
 HasContent=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets a value that indicates whether the System.Windows.Controls.ContentControl contains content.



Get: HasContent(self: ContentControl) -> bool
