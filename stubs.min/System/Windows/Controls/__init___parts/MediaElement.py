class MediaElement(FrameworkElement,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient,IUriContext):
 """
 ...
 def ArrangeOverride(self,*args):
  """
  ArrangeOverride(self: MediaElement,finalSize: Size) -> Size

  

   Arranges and sizes a System.Windows.Controls.MediaElement control.

  

   finalSize: Size used to arrange the control.
 ...
 def MeasureOverride(self,*args):
  """
  MeasureOverride(self: MediaElement,availableSize: Size) -> Size

  

   Updates the System.Windows.UIElement.DesiredSize of the System.Windows.Controls.MediaElement. 

    This method is called by a parent System.Windows.UIElement. This is the first pass of layout.

  

  

   availableSize: The upper limit the element should not exceed.
 ...
 def OnCreateAutomationPeer(self,*args):
  """
  OnCreateAutomationPeer(self: MediaElement) -> AutomationPeer
   ...
   Returns: An System.Windows.Automation.Peers.AutomationPeer for this System.Windows.Controls.MediaElement.
  """
  pass
 ...
 def OnRender(self,*args):
  """
  OnRender(self: MediaElement,drawingContext: DrawingContext)

   Draws the content of a System.Windows.Media.DrawingContext object during the render pass of a 

    System.Windows.Controls.MediaElement control.

  

  

   drawingContext: The System.Windows.Media.DrawingContext to draw.
  """
  pass
 ...
 def __init__(self,*args):
  ...
  pass
 Balance=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets a ratio of volume across speakers.



Get: Balance(self: MediaElement) -> float



Set: Balance(self: MediaElement)=value

"""

 BufferingProgress=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets a value that indicates the percentage of buffering progress made.



Get: BufferingProgress(self: MediaElement) -> float



"""

 CanPause=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets a value indicating whether the media can be paused.



Get: CanPause(self: MediaElement) -> bool
...
"""
 ...
 """Gets or sets the clock associated with the System.Windows.Media.MediaTimeline that controls media playback.



Get: Clock(self: MediaElement) -> MediaClock



Set: Clock(self: MediaElement)=value
...
"""
 ...
 DownloadProgress=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets a percentage value indicating the amount of download completed for content located on a remote server.



Get: DownloadProgress(self: MediaElement) -> float



"""

 HasAudio=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets a value indicating whether the media has audio.



Get: HasAudio(self: MediaElement) -> bool
...
"""
 ...
 HasVideo=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets a value indicating whether the media has video.



Get: HasVideo(self: MediaElement) -> bool
...
"""
 ...
 IsBuffering=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Get a value indicating whether the media is buffering.



Get: IsBuffering(self: MediaElement) -> bool
...
"""
 ...
 IsMuted=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets a value indicating whether the audio is muted.



Get: IsMuted(self: MediaElement) -> bool



Set: IsMuted(self: MediaElement)=value

"""

 LoadedBehavior=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets the load behavior System.Windows.Controls.MediaState for the media.



Get: LoadedBehavior(self: MediaElement) -> MediaState



Set: LoadedBehavior(self: MediaElement)=value
...
Get: NaturalDuration(self: MediaElement) -> Duration



"""

 NaturalVideoHeight=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets the height of the video associated with the media.



Get: NaturalVideoHeight(self: MediaElement) -> int



"""

 NaturalVideoWidth=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets the width of the video associated with the media.



Get: NaturalVideoWidth(self: MediaElement) -> int
...
Get: Position(self: MediaElement) -> TimeSpan



Set: Position(self: MediaElement)=value

"""

 ScrubbingEnabled=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets a value that indicates whether the System.Windows.Controls.MediaElement will update frames for seek operations while paused.



Get: ScrubbingEnabled(self: MediaElement) -> bool



Set: ScrubbingEnabled(self: MediaElement)=value

"""

 Source=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets a media source on the System.Windows.Controls.MediaElement.



Get: Source(self: MediaElement) -> Uri



Set: Source(self: MediaElement)=value
...
Get: SpeedRatio(self: MediaElement) -> float



Set: SpeedRatio(self: MediaElement)=value

"""

 Stretch=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets a System.Windows.Media.Stretch value that describes how a System.Windows.Controls.MediaElement fills the destination rectangle.



Get: Stretch(self: MediaElement) -> Stretch



Set: Stretch(self: MediaElement)=value

"""

 StretchDirection=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets a value that determines the restrictions on scaling that are applied to the image.



Get: StretchDirection(self: MediaElement) -> StretchDirection



Set: StretchDirection(self: MediaElement)=value
...
"""
 ...
 UnloadedBehavior=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets the unload behavior System.Windows.Controls.MediaState for the media.



Get: UnloadedBehavior(self: MediaElement) -> MediaState



Set: UnloadedBehavior(self: MediaElement)=value
...
Get: Volume(self: MediaElement) -> float



Set: Volume(self: MediaElement)=value

"""


 BalanceProperty=None
 BufferingEnded=None
 BufferingEndedEvent=None
 BufferingStarted=None
 BufferingStartedEvent=None
 IsMutedProperty=None
 LoadedBehaviorProperty=None
 MediaEnded=None
 MediaEndedEvent=None
 MediaFailed=None
 MediaFailedEvent=None
 MediaOpened=None
 MediaOpenedEvent=None
 ScriptCommand=None
 ScriptCommandEvent=None
 ScrubbingEnabledProperty=None
 SourceProperty=None
 StretchDirectionProperty=None
 StretchProperty=None
 UnloadedBehaviorProperty=None
 VolumeProperty=None
