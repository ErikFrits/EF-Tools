class ScrollViewer(ContentControl,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient,IAddChild):
 """
 ...
 def ArrangeOverride(self,*args):
  """ ArrangeOverride(self: ScrollViewer,arrangeSize: Size) -> Size """
  pass
 @staticmethod
 def GetCanContentScroll(element):
  """
  GetCanContentScroll(element: DependencyObject) -> bool

  

   Gets the value of the System.Windows.Controls.ScrollViewer.CanContentScroll�dependency property 
   ...
   Returns: true if this element can scroll; otherwise,false.
  """
  pass
 @staticmethod
 def GetHorizontalScrollBarVisibility(element):
  """
  GetHorizontalScrollBarVisibility(element: DependencyObject) -> ScrollBarVisibility
   ...
   Returns: The value of the System.Windows.Controls.ScrollViewer.HorizontalScrollBarVisibility�dependency 

    property.
  """
  pass
 @staticmethod
 def GetIsDeferredScrollingEnabled(element):
  """
  GetIsDeferredScrollingEnabled(element: DependencyObject) -> bool

  

   Returns the value of the System.Windows.Controls.ScrollViewer.IsDeferredScrollingEnabled 
   ...
   element: The object from which to get System.Windows.Controls.ScrollViewer.IsDeferredScrollingEnabled.

   Returns: true if the content is stationary when the user drags the 

    System.Windows.Controls.Primitives.Thumb of a System.Windows.Controls.Primitives.ScrollBar; 
 ...
 def GetLayoutClip(self,*args):
  ...
  pass
 @staticmethod
 def GetPanningDeceleration(element):
  """
  GetPanningDeceleration(element: DependencyObject) -> float

  

   Returns the value of the System.Windows.Controls.ScrollViewer.PanningDeceleration property for 
   ...
   Returns: The rate System.Windows.Controls.ScrollViewer slows in device-independent units (1/96th inch per 

    unit) per squared millisecond.
  """
  pass
 @staticmethod
 def GetPanningMode(element):
  """
  GetPanningMode(element: DependencyObject) -> PanningMode

  

   Returns the value of the System.Windows.Controls.ScrollViewer.PanningMode property for the 
   ...
   Returns: A value that specifies how System.Windows.Controls.ScrollViewer reacts to touch manipulation.
  """
  pass
 @staticmethod
 def GetPanningRatio(element):
  """
  GetPanningRatio(element: DependencyObject) -> float

  

   Returns the value of the System.Windows.Controls.ScrollViewer.PanningRatio property for the 
   ...
   Returns: The ratio of scrolling offset to translate manipulation offset.
  """
  pass
 ...
 def GetUIParentCore(self,*args):
  ...
  pass
 @staticmethod
 def GetVerticalScrollBarVisibility(element):
  """
  GetVerticalScrollBarVisibility(element: DependencyObject) -> ScrollBarVisibility

  

   Gets the value of the System.Windows.Controls.ScrollViewer.VerticalScrollBarVisibility�
   ...
   Returns: The value of the System.Windows.Controls.ScrollViewer.VerticalScrollBarVisibility �dependency 
 ...
 def HitTestCore(self,*args):
  """
  HitTestCore(self: ScrollViewer,hitTestParameters: PointHitTestParameters) -> HitTestResult
   ...
   hitTestParameters: The parameters for hit testing within a visual object.
  ...
  """
  pass
 def InvalidateScrollInfo(self):
  """
  InvalidateScrollInfo(self: ScrollViewer)

   Called by an System.Windows.Controls.Primitives.IScrollInfo interface that is attached to a 

    System.Windows.Controls.ScrollViewer when the value of any scrolling property size changes. 
 ...
 def LineDown(self):
  """
  LineDown(self: ScrollViewer)

   Scrolls the System.Windows.Controls.ScrollViewer content downward by one line.
  """
  pass
 def LineLeft(self):
  """
  LineLeft(self: ScrollViewer)

   Scrolls the System.Windows.Controls.ScrollViewer content to the left by a predetermined amount.
  """
  pass
 def LineRight(self):
  """
  LineRight(self: ScrollViewer)

   Scrolls the System.Windows.Controls.ScrollViewer content to the right by a predetermined amount.
  """
  pass
 def LineUp(self):
  """
  LineUp(self: ScrollViewer)

   Scrolls the System.Windows.Controls.ScrollViewer content upward by one line.
  """
  pass
 ...
 def MeasureOverride(self,*args):
  """
  MeasureOverride(self: ScrollViewer,constraint: Size) -> Size

  

   Measures the content of a System.Windows.Controls.ScrollViewer element.

  

   constraint: The upper limit System.Windows.Size that should not be exceeded.

   Returns: The computed desired limit System.Windows.Size of the System.Windows.Controls.ScrollViewer 
 ...
 def OnApplyTemplate(self):
  """
  OnApplyTemplate(self: ScrollViewer)
 ...
 def OnCreateAutomationPeer(self,*args):
  """
  OnCreateAutomationPeer(self: ScrollViewer) -> AutomationPeer

  

   Provides an appropriate System.Windows.Automation.Peers.AutomationPeer implementation for this 

    control,as part of the Windows Presentation Foundation (WPF) automation infrastructure.

  

   Returns: An System.Windows.Automation.Peers.AutomationPeer.
  """
  pass
 ...
 def OnKeyDown(self,*args):
  """
  OnKeyDown(self: ScrollViewer,e: KeyEventArgs)

   Responds to specific keyboard input and invokes associated scrolling behavior.

  

   e: Required arguments for this event.
  """
  pass
 ...
 def OnManipulationCompleted(self,*args):
  """
  OnManipulationCompleted(self: ScrollViewer,e: ManipulationCompletedEventArgs)
 ...
 def OnManipulationDelta(self,*args):
  """
  OnManipulationDelta(self: ScrollViewer,e: ManipulationDeltaEventArgs)
 ...
 def OnManipulationInertiaStarting(self,*args):
  """
  OnManipulationInertiaStarting(self: ScrollViewer,e: ManipulationInertiaStartingEventArgs)
 ...
 def OnManipulationStarting(self,*args):
  """
  OnManipulationStarting(self: ScrollViewer,e: ManipulationStartingEventArgs)

   Called when the System.Windows.UIElement.ManipulationStarting event occurs.
 ...
 def OnMouseLeftButtonDown(self,*args):
  """
  OnMouseLeftButtonDown(self: ScrollViewer,e: MouseButtonEventArgs)

   Responds to a click of the left mouse button.

  

   e: Required arguments that describe this event.
  """
  pass
 ...
 def OnMouseWheel(self,*args):
  """
  OnMouseWheel(self: ScrollViewer,e: MouseWheelEventArgs)
 ...
 def OnRenderSizeChanged(self,*args):
  ...
  """
  pass
 def OnScrollChanged(self,*args):
  """
  OnScrollChanged(self: ScrollViewer,e: ScrollChangedEventArgs)

   Called when a change in scrolling state is detected,such as a change in scroll position,

    extent,or viewport size.

  

  

   e: The System.Windows.Controls.ScrollChangedEventArgs that contain information about the change in 
 ...
 def OnStylusSystemGesture(self,*args):
  """ OnStylusSystemGesture(self: ScrollViewer,e: StylusSystemGestureEventArgs) """
  pass
 ...
 def PageDown(self):
  """
  PageDown(self: ScrollViewer)

   Scrolls the System.Windows.Controls.ScrollViewer content downward by one page.
  """
  pass
 def PageLeft(self):
  """
  PageLeft(self: ScrollViewer)

   Scrolls the System.Windows.Controls.ScrollViewer content to the left by one page.
  """
  pass
 def PageRight(self):
  """
  PageRight(self: ScrollViewer)

   Scrolls the System.Windows.Controls.ScrollViewer content to the right by one page.
  """
  pass
 def PageUp(self):
  """
  PageUp(self: ScrollViewer)

   Scrolls the System.Windows.Controls.ScrollViewer content upward by one page.
  """
  pass
 ...
 def ScrollToBottom(self):
  """
  ScrollToBottom(self: ScrollViewer)

   Scrolls vertically to the end of the System.Windows.Controls.ScrollViewer content.
  """
  pass
 def ScrollToEnd(self):
  """
  ScrollToEnd(self: ScrollViewer)
 ...
 def ScrollToHome(self):
  """
  ScrollToHome(self: ScrollViewer)

   Scrolls vertically to the beginning of the System.Windows.Controls.ScrollViewer content.
  """
  pass
 def ScrollToHorizontalOffset(self,offset):
  """
  ScrollToHorizontalOffset(self: ScrollViewer,offset: float)

   Scrolls the content within the System.Windows.Controls.ScrollViewer to the specified horizontal 
   ...
   offset: The position that the content scrolls to.
  """
  pass
 def ScrollToLeftEnd(self):
  """
  ScrollToLeftEnd(self: ScrollViewer)

   Scrolls horizontally to the beginning of the System.Windows.Controls.ScrollViewer content.
  """
  pass
 def ScrollToRightEnd(self):
  """
  ScrollToRightEnd(self: ScrollViewer)

   Scrolls horizontally to the end of the System.Windows.Controls.ScrollViewer content.
  """
  pass
 def ScrollToTop(self):
  """
  ScrollToTop(self: ScrollViewer)
 ...
 def ScrollToVerticalOffset(self,offset):
  """
  ScrollToVerticalOffset(self: ScrollViewer,offset: float)

   Scrolls the content within the System.Windows.Controls.ScrollViewer to the specified vertical 
  ...
  pass
 @staticmethod
 def SetCanContentScroll(element,canContentScroll):
  """
  SetCanContentScroll(element: DependencyObject,canContentScroll: bool)

   Sets the value of the System.Windows.Controls.ScrollViewer.CanContentScroll�dependency property 
   ...
   element: The element on which to set the property value.

   canContentScroll: The property value to set.
  """
  pass
 @staticmethod
 def SetHorizontalScrollBarVisibility(element,horizontalScrollBarVisibility):
  """
  SetHorizontalScrollBarVisibility(element: DependencyObject,horizontalScrollBarVisibility: ScrollBarVisibility)
   ...
   horizontalScrollBarVisibility: The property value to set.
  """
  pass
 @staticmethod
 def SetIsDeferredScrollingEnabled(element,value):
  """
  SetIsDeferredScrollingEnabled(element: DependencyObject,value: bool)

   Sets the System.Windows.Controls.ScrollViewer.IsDeferredScrollingEnabled property for the 
   ...
   element: The object on which to set the System.Windows.Controls.ScrollViewer.IsDeferredScrollingEnabled 

    property.

  

   value: true to have the content remain stationary when the user drags the 
  ...
  pass
 @staticmethod
 def SetPanningDeceleration(element,value):
  """
  SetPanningDeceleration(element: DependencyObject,value: float)

   Sets the System.Windows.Controls.ScrollViewer.PanningDeceleration property for the specified 
   ...
   element: The object on which to set the System.Windows.Controls.ScrollViewer.PanningDeceleration property.

   value: The rate System.Windows.Controls.ScrollViewer slows in device-independent units (1/96th inch per 

    unit) per squared millisecond.
  """
  pass
 @staticmethod
 def SetPanningMode(element,panningMode):
  """
  SetPanningMode(element: DependencyObject,panningMode: PanningMode)

   Sets the System.Windows.Controls.ScrollViewer.PanningMode property for the specified object.

  

   element: The object on which to set the System.Windows.Controls.ScrollViewer.PanningMode property.

   panningMode: A value that specifies how System.Windows.Controls.ScrollViewer reacts to touch manipulation.
  """
  pass
 @staticmethod
 def SetPanningRatio(element,value):
  """
  SetPanningRatio(element: DependencyObject,value: float)

   Sets the System.Windows.Controls.ScrollViewer.PanningRatio property for the specified object.

  

   element: The object on which to set the System.Windows.Controls.ScrollViewer.PanningRatio property.

   value: The ratio of scrolling offset to translate manipulation offset.
  """
  pass
 @staticmethod
 def SetVerticalScrollBarVisibility(element,verticalScrollBarVisibility):
  """
  SetVerticalScrollBarVisibility(element: DependencyObject,verticalScrollBarVisibility: ScrollBarVisibility)

   Sets the value of the System.Windows.Controls.ScrollViewer.VerticalScrollBarVisibility�
   ...
   verticalScrollBarVisibility: The property value to set.
  """
  pass
 ...
 def __str__(self,*args):
  pass
 CanContentScroll=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
Get: CanContentScroll(self: ScrollViewer) -> bool



Set: CanContentScroll(self: ScrollViewer)=value

"""

 ComputedHorizontalScrollBarVisibility=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets a value that indicates whether the horizontal System.Windows.Controls.Primitives.ScrollBar is visible.



Get: ComputedHorizontalScrollBarVisibility(self: ScrollViewer) -> Visibility



"""

 ComputedVerticalScrollBarVisibility=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets a value that indicates whether the vertical System.Windows.Controls.Primitives.ScrollBar is visible.



Get: ComputedVerticalScrollBarVisibility(self: ScrollViewer) -> Visibility



"""

 ContentHorizontalOffset=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets the horizontal offset of the visible content.



Get: ContentHorizontalOffset(self: ScrollViewer) -> float



"""

 ContentVerticalOffset=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets the vertical offset of the visible content.



Get: ContentVerticalOffset(self: ScrollViewer) -> float
...
Get: ExtentHeight(self: ScrollViewer) -> float
...
Get: ExtentWidth(self: ScrollViewer) -> float
...
"""
 ...
 """Gets a value that indicates that a control has a System.Windows.Controls.ScrollViewer defined in its style that defines custom keyboard scrolling behavior.
...
Get: HorizontalOffset(self: ScrollViewer) -> float
...
Get: HorizontalScrollBarVisibility(self: ScrollViewer) -> ScrollBarVisibility



Set: HorizontalScrollBarVisibility(self: ScrollViewer)=value
...
"""
 ...
 IsDeferredScrollingEnabled=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets a value that indicates whether the content is stationary when the user drags the System.Windows.Controls.Primitives.Thumb of a System.Windows.Controls.Primitives.ScrollBar.



Get: IsDeferredScrollingEnabled(self: ScrollViewer) -> bool



Set: IsDeferredScrollingEnabled(self: ScrollViewer)=value
...
"""
 ...
 PanningDeceleration=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets the rate System.Windows.Controls.ScrollViewer slows in device-independent units (1/96th inch per unit) per squared millisecond when in inertia.



Get: PanningDeceleration(self: ScrollViewer) -> float



Set: PanningDeceleration(self: ScrollViewer)=value

"""

 PanningMode=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets the way System.Windows.Controls.ScrollViewer reacts to touch manipulation.



Get: PanningMode(self: ScrollViewer) -> PanningMode



Set: PanningMode(self: ScrollViewer)=value

"""

 PanningRatio=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets the ratio of scrolling offset to translate manipulation offset.



Get: PanningRatio(self: ScrollViewer) -> float



Set: PanningRatio(self: ScrollViewer)=value

"""

 ScrollableHeight=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets a value that represents the vertical size of the content element that can be scrolled.



Get: ScrollableHeight(self: ScrollViewer) -> float



"""

 ScrollableWidth=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets a value that represents the horizontal size of the content element that can be scrolled.



Get: ScrollableWidth(self: ScrollViewer) -> float



"""

 ScrollInfo=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets the element that implements the System.Windows.Controls.Primitives.IScrollInfo interface and provides values for scrolling properties of this System.Windows.Controls.ScrollViewer.
...
Get: VerticalOffset(self: ScrollViewer) -> float
...
"""
 ...
 """Gets or sets a value that indicates whether a vertical System.Windows.Controls.Primitives.ScrollBar should be displayed.



Get: VerticalScrollBarVisibility(self: ScrollViewer) -> ScrollBarVisibility



Set: VerticalScrollBarVisibility(self: ScrollViewer)=value
...
Get: ViewportHeight(self: ScrollViewer) -> float
...
Get: ViewportWidth(self: ScrollViewer) -> float
...
"""
 ...
 CanContentScrollProperty=None
 ComputedHorizontalScrollBarVisibilityProperty=None
 ComputedVerticalScrollBarVisibilityProperty=None
 ContentHorizontalOffsetProperty=None
 ContentVerticalOffsetProperty=None
 ExtentHeightProperty=None
 ExtentWidthProperty=None
 HorizontalOffsetProperty=None
 HorizontalScrollBarVisibilityProperty=None
 IsDeferredScrollingEnabledProperty=None
 PanningDecelerationProperty=None
 PanningModeProperty=None
 PanningRatioProperty=None
 ScrollableHeightProperty=None
 ScrollableWidthProperty=None
 ScrollChanged=None
 ScrollChangedEvent=None
 VerticalOffsetProperty=None
 VerticalScrollBarVisibilityProperty=None
 ViewportHeightProperty=None
 ViewportWidthProperty=None
