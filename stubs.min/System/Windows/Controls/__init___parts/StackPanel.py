class StackPanel(Panel,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient,IAddChild,IScrollInfo,IStackMeasure):
 """
 ...
 def ArrangeOverride(self,*args):
  """
  ArrangeOverride(self: StackPanel,arrangeSize: Size) -> Size
   ...
   Returns: The System.Windows.Size that represents the arranged size of this 
    ...
    System.Windows.Controls.StackPanel element and its child elements.
  """
  pass
 ...
 def MakeVisible(self,visual,rectangle):
  """
  MakeVisible(self: StackPanel,visual: Visual,rectangle: Rect) -> Rect

  

   Scrolls to the specified coordinates and makes that part of a System.Windows.Media.Visual 
   ...
   rectangle: The System.Windows.Rect that represents coordinate space within a visual.

   Returns: A System.Windows.Rect in the coordinate space that is made visible.
  """
  pass
 ...
 def MeasureOverride(self,*args):
  """
  MeasureOverride(self: StackPanel,constraint: Size) -> Size

  

   Measures the child elements of a System.Windows.Controls.StackPanel in anticipation of arranging 

    them during the System.Windows.Controls.StackPanel.ArrangeOverride(System.Windows.Size) pass.
 ...
 def MouseWheelDown(self):
  """
  MouseWheelDown(self: StackPanel)
 ...
 def MouseWheelLeft(self):
  """
  MouseWheelLeft(self: StackPanel)
 ...
 def MouseWheelRight(self):
  """
  MouseWheelRight(self: StackPanel)
 ...
 def SetHorizontalOffset(self,offset):
  """
  SetHorizontalOffset(self: StackPanel,offset: float)

   Sets the value of the System.Windows.Controls.StackPanel.HorizontalOffset property.

  

   offset: The value of the System.Windows.Controls.StackPanel.HorizontalOffset property.
  """
  pass
 def SetVerticalOffset(self,offset):
  """
  SetVerticalOffset(self: StackPanel,offset: float)

   Sets the value of the System.Windows.Controls.StackPanel.VerticalOffset property.

  

   offset: The value of the System.Windows.Controls.StackPanel.VerticalOffset property.
  """
  pass
 ...
 """Gets or sets a value that indicates whether a System.Windows.Controls.StackPanel can scroll in the horizontal dimension.



Get: CanHorizontallyScroll(self: StackPanel) -> bool



Set: CanHorizontallyScroll(self: StackPanel)=value
...
Get: CanVerticallyScroll(self: StackPanel) -> bool



Set: CanVerticallyScroll(self: StackPanel)=value
...
Get: ExtentHeight(self: StackPanel) -> float
...
Get: ExtentWidth(self: StackPanel) -> float
...
"""
 ...
 """Gets a value that indicates if this System.Windows.Controls.StackPanel has vertical or horizontal orientation.
...
Get: HorizontalOffset(self: StackPanel) -> float
...
"""
 ...
 """Gets a value that represents the System.Windows.Controls.Orientation of the System.Windows.Controls.StackPanel.
...
Get: Orientation(self: StackPanel) -> Orientation



Set: Orientation(self: StackPanel)=value

"""

 ScrollOwner=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets a value that identifies the container that controls scrolling behavior in this System.Windows.Controls.StackPanel.



Get: ScrollOwner(self: StackPanel) -> ScrollViewer



Set: ScrollOwner(self: StackPanel)=value
...
Get: VerticalOffset(self: StackPanel) -> float
...
Get: ViewportHeight(self: StackPanel) -> float
...
Get: ViewportWidth(self: StackPanel) -> float
