class DockPanel(Panel,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient,IAddChild):
 """
 ...
 def ArrangeOverride(self,*args):
  """
  ArrangeOverride(self: DockPanel,arrangeSize: Size) -> Size

  

   Arranges the content (child elements) of a System.Windows.Controls.DockPanel element.
   ...
   Returns: The System.Windows.Size that represents the arranged size of this 
    ...
    System.Windows.Controls.DockPanel element.
  """
  pass
 ...
 def GetDock(element):
  """
  GetDock(element: UIElement) -> Dock

  

   Gets the value of the System.Windows.Controls.DockPanel.Dock�attached property for a specified 
   ...
   Returns: The System.Windows.Controls.DockPanel.Dock property value for the element.
  """
  pass
 ...
 def MeasureOverride(self,*args):
  """
  MeasureOverride(self: DockPanel,constraint: Size) -> Size

  

   Measures the child elements of a System.Windows.Controls.DockPanel prior to arranging them 

    during the System.Windows.Controls.DockPanel.ArrangeOverride(System.Windows.Size) pass.
   ...
   Returns: A System.Windows.Size that represents the element size you want.
  """
  pass
 ...
 def RemoveVisualChild(self,*args):
  ...
  pass
 @staticmethod
 def SetDock(element,dock):
  """
  SetDock(element: UIElement,dock: Dock)

   Sets the value of the System.Windows.Controls.DockPanel.Dock�attached property to a specified 
   ...
   dock: The needed System.Windows.Controls.Dock value.
  """
  pass
...
"""
 ...
 LastChildFill=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets a value that indicates whether the last child element within a System.Windows.Controls.DockPanel stretches to fill the remaining available space.



Get: LastChildFill(self: DockPanel) -> bool



Set: LastChildFill(self: DockPanel)=value
