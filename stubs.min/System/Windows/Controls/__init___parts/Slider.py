class Slider(RangeBase,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient):
 """
 Represents a control that lets the user select from a range of values by moving a System.Windows.Controls.Primitives.Track.Thumb control along a System.Windows.Controls.Primitives.Track.
 ...
 def ArrangeOverride(self,*args):
  """
  ArrangeOverride(self: Slider,finalSize: Size) -> Size

  

   Arranges the content of a System.Windows.Controls.Slider and determines its System.Windows.Size.

  

   finalSize: The computed System.Windows.Size that is used to arrange the control.

   Returns: The computed System.Windows.Size of the System.Windows.Controls.Slider.
  """
  pass
 ...
 def OnCreateAutomationPeer(self,*args):
  """
  OnCreateAutomationPeer(self: Slider) -> AutomationPeer

  

   Creates an System.Windows.Automation.Peers.AutomationPeer for the System.Windows.Controls.Slider.

   Returns: A System.Windows.Automation.Peers.SliderAutomationPeer for the System.Windows.Controls.Slider.
  """
  pass
 def OnDecreaseLarge(self,*args):
  """
  OnDecreaseLarge(self: Slider)

   Responds to the System.Windows.Controls.Slider.DecreaseLarge command.
  """
  pass
 def OnDecreaseSmall(self,*args):
  """
  OnDecreaseSmall(self: Slider)

   Responds to a System.Windows.Controls.Slider.DecreaseSmall command.
  """
  pass
 ...
 def OnGotTouchCapture(self,*args):
  ...
  """
  pass
 def OnIncreaseLarge(self,*args):
  """
  OnIncreaseLarge(self: Slider)

   Responds to an System.Windows.Controls.Slider.IncreaseLarge command.
  """
  pass
 def OnIncreaseSmall(self,*args):
  """
  OnIncreaseSmall(self: Slider)

   Responds to an System.Windows.Controls.Slider.IncreaseSmall command.
  """
  pass
 ...
 def OnManipulationStarting(self,*args):
  ...
  """
  pass
 def OnMaximizeValue(self,*args):
  """
  OnMaximizeValue(self: Slider)

   Responds to the System.Windows.Controls.Slider.MaximizeValue command.
  """
  pass
 def OnMaximumChanged(self,*args):
  """
  OnMaximumChanged(self: Slider,oldMaximum: float,newMaximum: float)

   Responds to a change in the value of the System.Windows.Controls.Primitives.RangeBase.Maximum 
   ...
   oldMaximum: The old value of the System.Windows.Controls.Primitives.RangeBase.Maximum property.

   newMaximum: The new value of the System.Windows.Controls.Primitives.RangeBase.Maximum property.
  """
  pass
 def OnMinimizeValue(self,*args):
  """
  OnMinimizeValue(self: Slider)

   Responds to a System.Windows.Controls.Slider.MinimizeValue command.
  """
  pass
 def OnMinimumChanged(self,*args):
  """
  OnMinimumChanged(self: Slider,oldMinimum: float,newMinimum: float)

   Responds to a change in the value of the System.Windows.Controls.Primitives.RangeBase.Minimum 
   ...
   oldMinimum: The old value of the System.Windows.Controls.Primitives.RangeBase.Minimum property.

   newMinimum: The new value of the System.Windows.Controls.Primitives.RangeBase.Minimum property.
  """
  pass
 ...
 def OnPreviewMouseLeftButtonDown(self,*args):
  """
  OnPreviewMouseLeftButtonDown(self: Slider,e: MouseButtonEventArgs)

   Provides class handling for the System.Windows.ContentElement.PreviewMouseLeftButtonDown routed 
 ...
 def OnTextInput(self,*args):
  ...
  """
  pass
 def OnThumbDragCompleted(self,*args):
  """
  OnThumbDragCompleted(self: Slider,e: DragCompletedEventArgs)

   Provides class handling for the System.Windows.Controls.Primitives.Thumb.DragCompleted event 

    that occurs when the user stops dragging the System.Windows.Controls.Primitives.Thumb of the 
  ...
  """
  pass
 def OnThumbDragDelta(self,*args):
  """
  OnThumbDragDelta(self: Slider,e: DragDeltaEventArgs)

   Provides class handling for the System.Windows.Controls.Primitives.Thumb.DragDelta event that 

    occurs when the user drags the System.Windows.Controls.Primitives.Thumb of the 
  ...
  """
  pass
 def OnThumbDragStarted(self,*args):
  """
  OnThumbDragStarted(self: Slider,e: DragStartedEventArgs)

   Provides class handling for the System.Windows.Controls.Primitives.Thumb.DragStarted event that 

    occurs when the user starts to drag the System.Windows.Controls.Primitives.Thumb of the 
 ...
 def OnValueChanged(self,*args):
  """
  OnValueChanged(self: Slider,oldValue: float,newValue: float)

   Updates the current position of the System.Windows.Controls.Slider when the 
   ...
   oldValue: The old System.Windows.Controls.Primitives.RangeBase.Value of the System.Windows.Controls.Slider.

   newValue: The new System.Windows.Controls.Primitives.RangeBase.Value of the System.Windows.Controls.Slider.
  """
  pass
 ...
 def __str__(self,*args):
  pass
 AutoToolTipPlacement=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets whether a tooltip that contains the current value of the System.Windows.Controls.Slider displays when the System.Windows.Controls.Primitives.Track.Thumb is pressed. If a tooltip is displayed,this property also specifies the placement of the tooltip.



Get: AutoToolTipPlacement(self: Slider) -> AutoToolTipPlacement



Set: AutoToolTipPlacement(self: Slider)=value

"""

 AutoToolTipPrecision=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets the number of digits that are displayed to the right side of the decimal point for the System.Windows.Controls.Primitives.RangeBase.Value of the System.Windows.Controls.Slider in a tooltip.



Get: AutoToolTipPrecision(self: Slider) -> int



Set: AutoToolTipPrecision(self: Slider)=value
...
"""
 ...
 """Gets or sets the amount of time in milliseconds that a System.Windows.Controls.Primitives.RepeatButton waits,while it is pressed,before a command to move the System.Windows.Controls.Primitives.Thumb executes,such as a System.Windows.Controls.Slider.DecreaseLarge command.



Get: Delay(self: Slider) -> int



Set: Delay(self: Slider)=value
...
"""
 ...
 """Gets or sets the amount of time in milliseconds between increase or decrease commands when a user clicks the System.Windows.Controls.Primitives.RepeatButton of a System.Windows.Controls.Slider.



Get: Interval(self: Slider) -> int



Set: Interval(self: Slider)=value

"""

 IsDirectionReversed=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets the direction of increasing value.



Get: IsDirectionReversed(self: Slider) -> bool



Set: IsDirectionReversed(self: Slider)=value
...
"""
 ...
 IsMoveToPointEnabled=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets a value that indicates whether the System.Windows.Controls.Primitives.Track.Thumb of a System.Windows.Controls.Slider moves immediately to the location of the mouse click that occurs while the mouse pointer pauses on the System.Windows.Controls.Slider track.



Get: IsMoveToPointEnabled(self: Slider) -> bool



Set: IsMoveToPointEnabled(self: Slider)=value

"""

 IsSelectionRangeEnabled=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets a value that indicates whether the System.Windows.Controls.Slider displays a selection range along the System.Windows.Controls.Slider.



Get: IsSelectionRangeEnabled(self: Slider) -> bool



Set: IsSelectionRangeEnabled(self: Slider)=value

"""

 IsSnapToTickEnabled=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets a value that indicates whether the System.Windows.Controls.Slider automatically moves the System.Windows.Controls.Primitives.Track.Thumb to the closest tick mark.



Get: IsSnapToTickEnabled(self: Slider) -> bool



Set: IsSnapToTickEnabled(self: Slider)=value
...
"""
 ...
 """Gets or sets the orientation of a System.Windows.Controls.Slider.



Get: Orientation(self: Slider) -> Orientation



Set: Orientation(self: Slider)=value

"""

 SelectionEnd=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets the largest value of a specified selection for a System.Windows.Controls.Slider.



Get: SelectionEnd(self: Slider) -> float



Set: SelectionEnd(self: Slider)=value

"""

 SelectionStart=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets the smallest value of a specified selection for a System.Windows.Controls.Slider.



Get: SelectionStart(self: Slider) -> float



Set: SelectionStart(self: Slider)=value
...
Get: TickFrequency(self: Slider) -> float



Set: TickFrequency(self: Slider)=value

"""

 TickPlacement=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets the position of tick marks with respect to the System.Windows.Controls.Primitives.Track of the System.Windows.Controls.Slider.



Get: TickPlacement(self: Slider) -> TickPlacement



Set: TickPlacement(self: Slider)=value
...
Get: Ticks(self: Slider) -> DoubleCollection



Set: Ticks(self: Slider)=value
...
"""
 ...
 AutoToolTipPlacementProperty=None
 AutoToolTipPrecisionProperty=None
 DecreaseLarge=None
 DecreaseSmall=None
 DelayProperty=None
 IncreaseLarge=None
 IncreaseSmall=None
 IntervalProperty=None
 IsDirectionReversedProperty=None
 IsMoveToPointEnabledProperty=None
 IsSelectionRangeEnabledProperty=None
 IsSnapToTickEnabledProperty=None
 MaximizeValue=None
 MinimizeValue=None
 OrientationProperty=None
 SelectionEndProperty=None
 SelectionStartProperty=None
 TickFrequencyProperty=None
 TickPlacementProperty=None
 TicksProperty=None
