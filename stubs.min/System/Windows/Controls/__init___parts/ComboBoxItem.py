class ComboBoxItem(ListBoxItem,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient,IAddChild):
 """
 Implements a selectable item inside a System.Windows.Controls.ComboBox.
 ...
 def OnContentChanged(self,*args):
  """
  OnContentChanged(self: ComboBoxItem,oldContent: object,newContent: object)
 ...
 def OnCreateAutomationPeer(self,*args):
  """
  OnCreateAutomationPeer(self: ListBoxItem) -> AutomationPeer

  

   Provides an appropriate System.Windows.Automation.Peers.ListBoxItemAutomationPeer implementation 
 ...
 def OnGotKeyboardFocus(self,*args):
  """
  OnGotKeyboardFocus(self: ComboBoxItem,e: KeyboardFocusChangedEventArgs)
 ...
 def OnMouseEnter(self,*args):
  """
  OnMouseEnter(self: ComboBoxItem,e: MouseEventArgs)

   Responds to a System.Windows.UIElement.MouseEnter event.
 ...
 def OnMouseLeave(self,*args):
  """
  OnMouseLeave(self: ListBoxItem,e: MouseEventArgs)

   Called when the mouse leaves a System.Windows.Controls.ListBoxItem.
 ...
 def OnMouseLeftButtonDown(self,*args):
  """
  OnMouseLeftButtonDown(self: ComboBoxItem,e: MouseButtonEventArgs)
 ...
 def OnMouseLeftButtonUp(self,*args):
  """
  OnMouseLeftButtonUp(self: ComboBoxItem,e: MouseButtonEventArgs)
 ...
 def OnMouseRightButtonDown(self,*args):
  """
  OnMouseRightButtonDown(self: ListBoxItem,e: MouseButtonEventArgs)

   Called when the user presses the right mouse button over a System.Windows.Controls.ListBoxItem.
 ...
 def OnSelected(self,*args):
  """
  OnSelected(self: ListBoxItem,e: RoutedEventArgs)

   Called when the System.Windows.Controls.ListBoxItem is selected in a 
 ...
 def OnUnselected(self,*args):
  """
  OnUnselected(self: ListBoxItem,e: RoutedEventArgs)

   Called when the System.Windows.Controls.ListBoxItem is unselected in a 
 ...
 def OnVisualParentChanged(self,*args):
  """
  OnVisualParentChanged(self: ListBoxItem,oldParent: DependencyObject)

   Called when the visual parent of a list box item changes.

  

   oldParent: The previous System.Windows.FrameworkElement.Parent property of the 
...
Get: IsHighlighted(self: ComboBoxItem) -> bool
