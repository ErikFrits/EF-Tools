class TabControl(Selector,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient,IAddChild,IGeneratorHost,IContainItemStorage):
 """
 ...
 def GetContainerForItemOverride(self,*args):
  """
  GetContainerForItemOverride(self: TabControl) -> DependencyObject

  

   Creates or identifies the element used to display the specified item.

   Returns: A System.Windows.Controls.TabItem.
  """
  pass
 ...
 def IsItemItsOwnContainerOverride(self,*args):
  """
  IsItemItsOwnContainerOverride(self: TabControl,item: object) -> bool
   ...
   Returns: Returns true if the item is its own ItemContainer; otherwise,false.
  """
  pass
 ...
 def OnApplyTemplate(self):
  """
  OnApplyTemplate(self: TabControl)
 ...
 def OnCreateAutomationPeer(self,*args):
  """
  OnCreateAutomationPeer(self: TabControl) -> AutomationPeer

  

   Provides an appropriate System.Windows.Automation.Peers.TabControlAutomationPeer implementation 
 ...
 def OnInitialized(self,*args):
  """
  OnInitialized(self: TabControl,e: EventArgs)

   Called when System.Windows.FrameworkElement.IsInitialized is set to true.

  

   e: Provides data for the System.Windows.FrameworkElement.Initialized event.
  """
  pass
 ...
 def OnItemsChanged(self,*args):
  """
  OnItemsChanged(self: TabControl,e: NotifyCollectionChangedEventArgs)
 ...
 def OnKeyDown(self,*args):
  """
  OnKeyDown(self: TabControl,e: KeyEventArgs)

   Provides class handling for the System.Windows.ContentElement.KeyDown routed event that occurs 
   ...
   e: Provides data for System.Windows.Input.KeyEventArgs.
  """
  pass
 ...
 def OnSelectionChanged(self,*args):
  """
  OnSelectionChanged(self: TabControl,e: SelectionChangedEventArgs)

   Raises the System.Windows.Controls.Primitives.Selector.SelectionChanged routed event.

  

   e: Provides data for System.Windows.Controls.SelectionChangedEventArgs.
  """
  pass
 ...
 """Gets a composite string that specifies how to format the contents of the System.Windows.Controls.TabItem objects if they are displayed as strings.



Get: ContentStringFormat(self: TabControl) -> str



Set: ContentStringFormat(self: TabControl)=value

"""

 ContentTemplate=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets the System.Windows.DataTemplate to apply to any System.Windows.Controls.TabItem that does not have a System.Windows.Controls.ContentControl.ContentTemplate or System.Windows.Controls.ContentControl.ContentTemplateSelector property defined.



Get: ContentTemplate(self: TabControl) -> DataTemplate



Set: ContentTemplate(self: TabControl)=value

"""

 ContentTemplateSelector=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets a System.Windows.Controls.DataTemplateSelector that provides custom logic for choosing the template that is used to display the content of the control.



Get: ContentTemplateSelector(self: TabControl) -> DataTemplateSelector



Set: ContentTemplateSelector(self: TabControl)=value
...
"""
 ...
 SelectedContent=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets the content of the currently selected System.Windows.Controls.TabItem.



Get: SelectedContent(self: TabControl) -> object



"""

 SelectedContentStringFormat=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets a composite string that specifies how to format the content of the currently selected System.Windows.Controls.TabItem if it is displayed as a string.



Get: SelectedContentStringFormat(self: TabControl) -> str



"""

 SelectedContentTemplate=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets the System.Windows.DataTemplate of the currently selected item.



Get: SelectedContentTemplate(self: TabControl) -> DataTemplate



"""

 SelectedContentTemplateSelector=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets the System.Windows.Controls.DataTemplateSelector of the currently selected item.



Get: SelectedContentTemplateSelector(self: TabControl) -> DataTemplateSelector
...
"""
 ...
 TabStripPlacement=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets how tab headers align relative to the tab content.



Get: TabStripPlacement(self: TabControl) -> Dock



Set: TabStripPlacement(self: TabControl)=value
...
"""
 ...
 SelectedContentProperty=None
 SelectedContentStringFormatProperty=None
 SelectedContentTemplateProperty=None
 SelectedContentTemplateSelectorProperty=None
 TabStripPlacementProperty=None
