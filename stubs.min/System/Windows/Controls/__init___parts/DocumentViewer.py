class DocumentViewer(DocumentViewerBase,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient,IAddChild,IServiceProvider):
 """
 Represents a document viewing control that can host paginated System.Windows.Documents.FixedDocument content such as an System.Windows.Xps.Packaging.XpsDocument.
 ...
 def DecreaseZoom(self):
  """
  DecreaseZoom(self: DocumentViewer)
 ...
 def FitToHeight(self):
  """
  FitToHeight(self: DocumentViewer)

   Fits a single page to the height of the current viewport.
  """
  pass
 def FitToMaxPagesAcross(self,pagesAcross=None):
  """
  FitToMaxPagesAcross(self: DocumentViewer,pagesAcross: int)

   Fits the document to a specified maximum number of page widths.

  

   pagesAcross: The maximum number of pages to fit in the current 

    System.Windows.Controls.DocumentViewer.ExtentWidth.

  

  FitToMaxPagesAcross(self: DocumentViewer)

   Fits the document to the current System.Windows.Controls.DocumentViewer.MaxPagesAcross property 
 ...
 def FitToWidth(self):
  """
  FitToWidth(self: DocumentViewer)
 ...
 def GetLayoutClip(self,*args):
  ...
  """
  pass
 def GetMasterPageView(self,*args):
  """
  GetMasterPageView(self: DocumentViewerBase) -> DocumentPageView

  

   Returns the current master System.Windows.Controls.Primitives.DocumentPageView for this viewer.

   Returns: The current master System.Windows.Controls.Primitives.DocumentPageView for this viewer,or null 

    if no master System.Windows.Controls.Primitives.DocumentPageView can be found.
  """
  pass
 def GetPageViewsCollection(self,*args):
  """
  GetPageViewsCollection(self: DocumentViewer) -> (ReadOnlyCollection[DocumentPageView],bool)

  

   Returns a collection of System.Windows.Controls.Primitives.DocumentPageView elements that are 

    currently displayed.

  

   Returns: The collection of System.Windows.Controls.Primitives.DocumentPageView elements that are 

    currently displayed in the System.Windows.Controls.DocumentViewer control.
  """
  pass
 ...
 def IncreaseZoom(self):
  """
  IncreaseZoom(self: DocumentViewer)

   Zooms in on the document content by one zoom step.
  """
  pass
 def InvalidatePageViews(self,*args):
  """
  InvalidatePageViews(self: DocumentViewerBase)

   Causes the working System.Windows.Controls.Primitives.DocumentViewerBase.PageViews collection to 
 ...
 def OnApplyTemplate(self):
  """
  OnApplyTemplate(self: DocumentViewer)

   Responds to calls to the System.Windows.FrameworkElement.ApplyTemplate method.
  """
  pass
 def OnBringIntoView(self,*args):
  """
  OnBringIntoView(self: DocumentViewer,element: DependencyObject,rect: Rect,pageNumber: int)

   Responds to the 

    System.Windows.Controls.Primitives.DocumentViewerBase.OnBringIntoView(System.Windows.DependencyOb

    ject,System.Windows.Rect,System.Int32) method from the 

    System.Windows.Controls.Primitives.DocumentViewerBase implementation.

  

  

   element: The object to make visible.

   rect: The rectangular region of the element to make visible.

   pageNumber: The number of the page to be viewed.
  """
  pass
 def OnCancelPrintCommand(self,*args):
  """
  OnCancelPrintCommand(self: DocumentViewerBase)
 ...
 def OnCreateAutomationPeer(self,*args):
  """
  OnCreateAutomationPeer(self: DocumentViewer) -> AutomationPeer

  

   Creates and returns an System.Windows.Automation.Peers.AutomationPeer for this 

    System.Windows.Controls.DocumentViewer control.

  

   Returns: The new System.Windows.Automation.Peers.DocumentViewerAutomationPeer.
  """
  pass
 def OnDecreaseZoomCommand(self,*args):
  """
  OnDecreaseZoomCommand(self: DocumentViewer)

   Responds to calls to the System.Windows.Controls.DocumentViewer.DecreaseZoom method.
  """
  pass
 def OnDocumentChanged(self,*args):
  """
  OnDocumentChanged(self: DocumentViewer)

   Responds to calls when the document to display is changed.
  """
  pass
 def OnDpiChanged(self,*args):
  """ OnDpiChanged(self: DocumentViewerBase,oldDpiScaleInfo: DpiScale,newDpiScaleInfo: DpiScale) """
  pass
 ...
 def OnFindCommand(self,*args):
  """
  OnFindCommand(self: DocumentViewer)

   Responds to calls to the System.Windows.Controls.DocumentViewer.Find method.
  """
  pass
 def OnFirstPageCommand(self,*args):
  """
  OnFirstPageCommand(self: DocumentViewer)

   Responds to calls to the System.Windows.Controls.Primitives.DocumentViewerBase.FirstPage method.
  """
  pass
 def OnFitToHeightCommand(self,*args):
  """
  OnFitToHeightCommand(self: DocumentViewer)

   Responds to calls to the System.Windows.Controls.DocumentViewer.FitToHeight method.
  """
  pass
 def OnFitToMaxPagesAcrossCommand(self,*args):
  """
  OnFitToMaxPagesAcrossCommand(self: DocumentViewer,pagesAcross: int)

   Responds to calls to the 

    System.Windows.Controls.DocumentViewer.FitToMaxPagesAcross(System.Int32) method.

  

  

   pagesAcross: The number of pages to fit across the content area.

  OnFitToMaxPagesAcrossCommand(self: DocumentViewer)

   Responds to calls to the System.Windows.Controls.DocumentViewer.FitToMaxPagesAcross method.
  """
  pass
 def OnFitToWidthCommand(self,*args):
  """
  OnFitToWidthCommand(self: DocumentViewer)

   Responds to calls to the System.Windows.Controls.DocumentViewer.FitToWidth method.
  """
  pass
 ...
 def OnGotMouseCapture(self,*args):
  ...
  """
  pass
 def OnGoToPageCommand(self,*args):
  """
  OnGoToPageCommand(self: DocumentViewer,pageNumber: int)

   Responds to calls to the 

    System.Windows.Controls.Primitives.DocumentViewerBase.GoToPage(System.Int32) method.

  

  

   pageNumber: The page number to position to.
  """
  pass
 ...
 def OnIncreaseZoomCommand(self,*args):
  """
  OnIncreaseZoomCommand(self: DocumentViewer)

   Responds to calls to the System.Windows.Controls.DocumentViewer.IncreaseZoom method.
  """
  pass
 ...
 def OnKeyDown(self,*args):
  """
  OnKeyDown(self: DocumentViewer,e: KeyEventArgs)

   Responds to System.Windows.UIElement.KeyDown events.
 ...
 def OnKeyUp(self,*args):
  ...
  """
  pass
 def OnLastPageCommand(self,*args):
  """
  OnLastPageCommand(self: DocumentViewer)

   Responds to calls to the System.Windows.Controls.Primitives.DocumentViewerBase.LastPage method.
  """
  pass
 ...
 def OnManipulationStarting(self,*args):
  ...
  """
  pass
 def OnMasterPageNumberChanged(self,*args):
  """
  OnMasterPageNumberChanged(self: DocumentViewerBase)

   Called whenever the System.Windows.Controls.Primitives.DocumentViewerBase.MasterPageNumber 
 ...
 def OnMouseLeftButtonDown(self,*args):
  """
  OnMouseLeftButtonDown(self: DocumentViewer,e: MouseButtonEventArgs)

   Responds to System.Windows.UIElement.MouseLeftButtonDown events.
 ...
 def OnMouseWheel(self,*args):
  ...
  """
  pass
 def OnMoveDownCommand(self,*args):
  """
  OnMoveDownCommand(self: DocumentViewer)

   Responds to calls to the System.Windows.Controls.DocumentViewer.MoveDown method.
  """
  pass
 def OnMoveLeftCommand(self,*args):
  """
  OnMoveLeftCommand(self: DocumentViewer)

   Responds to calls to the System.Windows.Controls.DocumentViewer.MoveLeft method.
  """
  pass
 def OnMoveRightCommand(self,*args):
  """
  OnMoveRightCommand(self: DocumentViewer)

   Responds to calls to the System.Windows.Controls.DocumentViewer.MoveRight method.
  """
  pass
 def OnMoveUpCommand(self,*args):
  """
  OnMoveUpCommand(self: DocumentViewer)

   Responds to calls to the System.Windows.Controls.DocumentViewer.MoveUp method.
  """
  pass
 def OnNextPageCommand(self,*args):
  """
  OnNextPageCommand(self: DocumentViewer)

   Responds to calls to the System.Windows.Controls.Primitives.DocumentViewerBase.NextPage method.
  """
  pass
 def OnPageViewsChanged(self,*args):
  """
  OnPageViewsChanged(self: DocumentViewerBase)

   Called whenever the working set of System.Windows.Controls.Primitives.DocumentPageView objects 

    for this viewer (represented by the 

    System.Windows.Controls.Primitives.DocumentViewerBase.PageViews property) is modified.
  """
  pass
 ...
 def OnPreviewMouseWheel(self,*args):
  """
  OnPreviewMouseWheel(self: DocumentViewer,e: MouseWheelEventArgs)

   Responds to System.Windows.UIElement.PreviewMouseWheel events.
 ...
 def OnPreviewTouchUp(self,*args):
  ...
  """
  pass
 def OnPreviousPageCommand(self,*args):
  """
  OnPreviousPageCommand(self: DocumentViewer)

   Responds to calls to the System.Windows.Controls.Primitives.DocumentViewerBase.PreviousPage 
 ...
 def OnPrintCommand(self,*args):
  """
  OnPrintCommand(self: DocumentViewerBase)
 ...
 def OnRenderSizeChanged(self,*args):
  ...
  """
  pass
 def OnScrollPageDownCommand(self,*args):
  """
  OnScrollPageDownCommand(self: DocumentViewer)

   Responds to calls to the System.Windows.Controls.DocumentViewer.ScrollPageDown method.
  """
  pass
 def OnScrollPageLeftCommand(self,*args):
  """
  OnScrollPageLeftCommand(self: DocumentViewer)

   Responds to calls to the System.Windows.Controls.DocumentViewer.ScrollPageLeft method.
  """
  pass
 def OnScrollPageRightCommand(self,*args):
  """
  OnScrollPageRightCommand(self: DocumentViewer)

   Responds to calls to the System.Windows.Controls.DocumentViewer.ScrollPageRight method.
  """
  pass
 def OnScrollPageUpCommand(self,*args):
  """
  OnScrollPageUpCommand(self: DocumentViewer)

   Responds to calls to the System.Windows.Controls.DocumentViewer.ScrollPageUp method.
  """
  pass
 ...
 def OnTouchUp(self,*args):
  ...
  """
  pass
 def OnViewThumbnailsCommand(self,*args):
  """
  OnViewThumbnailsCommand(self: DocumentViewer)

   Responds to calls to the System.Windows.Controls.DocumentViewer.ViewThumbnails method.
  """
  pass
 ...
 def ScrollPageDown(self):
  """
  ScrollPageDown(self: DocumentViewer)
 ...
 def ScrollPageLeft(self):
  """
  ScrollPageLeft(self: DocumentViewer)
 ...
 def ScrollPageRight(self):
  """
  ScrollPageRight(self: DocumentViewer)
 ...
 def ScrollPageUp(self):
  """
  ScrollPageUp(self: DocumentViewer)
 ...
 def ShouldSerializeProperty(self,*args):
  ...
  """
  pass
 def ViewThumbnails(self):
  """
  ViewThumbnails(self: DocumentViewer)
 ...
 """Gets a value that indicates whether the System.Windows.Controls.DocumentViewer can zoom out more.



Get: CanDecreaseZoom(self: DocumentViewer) -> bool
...
"""
 ...
 """Gets a value that indicates whether the System.Windows.Controls.DocumentViewer can zoom in more.



Get: CanIncreaseZoom(self: DocumentViewer) -> bool



"""

 CanMoveDown=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets a value that indicates whether the System.Windows.Controls.DocumentViewer can move down more in the document.



Get: CanMoveDown(self: DocumentViewer) -> bool



"""

 CanMoveLeft=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets a value that indicates whether the System.Windows.Controls.DocumentViewer can move more to the left in the document.



Get: CanMoveLeft(self: DocumentViewer) -> bool



"""

 CanMoveRight=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets a value that indicates whether the System.Windows.Controls.DocumentViewer can move more to the right in the document.



Get: CanMoveRight(self: DocumentViewer) -> bool



"""

 CanMoveUp=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets a value that indicates whether the System.Windows.Controls.DocumentViewer can move up more in the document.



Get: CanMoveUp(self: DocumentViewer) -> bool
...
"""
 ...
 """Gets the overall vertical height of the paginated document.



Get: ExtentHeight(self: DocumentViewer) -> float
...
"""
 ...
 """Gets the overall horizontal width of the paginated document.



Get: ExtentWidth(self: DocumentViewer) -> float
...
Get: HorizontalOffset(self: DocumentViewer) -> float



Set: HorizontalOffset(self: DocumentViewer)=value

"""

 HorizontalPageSpacing=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets the horizontal space between pages.



Get: HorizontalPageSpacing(self: DocumentViewer) -> float



Set: HorizontalPageSpacing(self: DocumentViewer)=value
...
"""
 ...
 MaxPagesAcross=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets a value defining the maximum number of page columns to display.



Get: MaxPagesAcross(self: DocumentViewer) -> int



Set: MaxPagesAcross(self: DocumentViewer)=value

"""

 ShowPageBorders=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets a value that indicates whether drop-shadow page borders are displayed.



Get: ShowPageBorders(self: DocumentViewer) -> bool



Set: ShowPageBorders(self: DocumentViewer)=value
...
Get: VerticalOffset(self: DocumentViewer) -> float



Set: VerticalOffset(self: DocumentViewer)=value

"""

 VerticalPageSpacing=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets the vertical spacing between displayed pages.



Get: VerticalPageSpacing(self: DocumentViewer) -> float



Set: VerticalPageSpacing(self: DocumentViewer)=value
...
Get: ViewportHeight(self: DocumentViewer) -> float
...
Get: ViewportWidth(self: DocumentViewer) -> float
...
Get: Zoom(self: DocumentViewer) -> float



Set: Zoom(self: DocumentViewer)=value
...
"""
 ...
 CanMoveDownProperty=None
 CanMoveLeftProperty=None
 CanMoveRightProperty=None
 CanMoveUpProperty=None
 ExtentHeightProperty=None
 ExtentWidthProperty=None
 FitToHeightCommand=None
 FitToMaxPagesAcrossCommand=None
 FitToWidthCommand=None
 HorizontalOffsetProperty=None
 HorizontalPageSpacingProperty=None
 MaxPagesAcrossProperty=None
 ShowPageBordersProperty=None
 VerticalOffsetProperty=None
 VerticalPageSpacingProperty=None
 ViewportHeightProperty=None
 ViewportWidthProperty=None
 ViewThumbnailsCommand=None
 ZoomProperty=None
