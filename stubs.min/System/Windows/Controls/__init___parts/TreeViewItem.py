class TreeViewItem(HeaderedItemsControl,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient,IAddChild,IGeneratorHost,IContainItemStorage,IHierarchicalVirtualizationAndScrollInfo):
 """
 ...
 def ArrangeOverride(self,*args):
  """ ArrangeOverride(self: TreeViewItem,arrangeSize: Size) -> Size """
  pass
 ...
 def ExpandSubtree(self):
  """
  ExpandSubtree(self: TreeViewItem)

   Expands the System.Windows.Controls.TreeViewItem control and all its child 

    System.Windows.Controls.TreeViewItem elements.
  """
  pass
 def GetContainerForItemOverride(self,*args):
  """
  GetContainerForItemOverride(self: TreeViewItem) -> DependencyObject

  

   Creates a new System.Windows.Controls.TreeViewItem to use to display the object.

   Returns: A new System.Windows.Controls.TreeViewItem.
  """
  pass
 ...
 def IsItemItsOwnContainerOverride(self,*args):
  """
  IsItemItsOwnContainerOverride(self: TreeViewItem,item: object) -> bool

  

   Determines whether an object is a System.Windows.Controls.TreeViewItem.

  

   item: The object to evaluate.

   Returns: true if item is a System.Windows.Controls.TreeViewItem; otherwise,false.
  """
  pass
 ...
 def OnCollapsed(self,*args):
  """
  OnCollapsed(self: TreeViewItem,e: RoutedEventArgs)

   Raises a System.Windows.Controls.TreeViewItem.Collapsed event when the 

    System.Windows.Controls.TreeViewItem.IsExpanded property changes from true to false.
 ...
 def OnCreateAutomationPeer(self,*args):
  """
  OnCreateAutomationPeer(self: TreeViewItem) -> AutomationPeer

  

   Defines an System.Windows.Automation.Peers.AutomationPeer for the 

    System.Windows.Controls.TreeViewItem.

  

   Returns: A System.Windows.Automation.Peers.TreeViewItemAutomationPeer object for the 
 ...
 def OnExpanded(self,*args):
  """
  OnExpanded(self: TreeViewItem,e: RoutedEventArgs)

   Raises an System.Windows.Controls.TreeViewItem.Expanded event when the 

    System.Windows.Controls.TreeViewItem.IsExpanded property changes from false to true.
 ...
 def OnGotFocus(self,*args):
  """
  OnGotFocus(self: TreeViewItem,e: RoutedEventArgs)

   Provides class handling for the System.Windows.UIElement.GotFocus event.
 ...
 def OnItemsChanged(self,*args):
  """
  OnItemsChanged(self: TreeViewItem,e: NotifyCollectionChangedEventArgs)

   Provides class handling for the System.Windows.Controls.ItemContainerGenerator.ItemsChanged 
 ...
 def OnKeyDown(self,*args):
  """
  OnKeyDown(self: TreeViewItem,e: KeyEventArgs)

   Provides class handling for a System.Windows.UIElement.KeyDown event.
 ...
 def OnMouseLeftButtonDown(self,*args):
  """
  OnMouseLeftButtonDown(self: TreeViewItem,e: MouseButtonEventArgs)

   Provides class handling for a System.Windows.UIElement.MouseLeftButtonDown event.
 ...
 def OnSelected(self,*args):
  """
  OnSelected(self: TreeViewItem,e: RoutedEventArgs)

   Raises the System.Windows.Controls.TreeViewItem.Selected routed event when the 

    System.Windows.Controls.TreeViewItem.IsSelected property changes from false to true.
 ...
 def OnUnselected(self,*args):
  """
  OnUnselected(self: TreeViewItem,e: RoutedEventArgs)

   Raises the System.Windows.Controls.TreeViewItem.Unselected routed event when the 

    System.Windows.Controls.TreeViewItem.IsSelected property changes from true to false.
 ...
 def OnVisualParentChanged(self,*args):
  """
  OnVisualParentChanged(self: TreeViewItem,oldParent: DependencyObject)

   Responds to a change in the visual parent of a System.Windows.Controls.TreeViewItem.

  

   oldParent: The previous visual parent.
  """
  pass
...
"""
 ...
 """Gets or sets whether the nested items in a System.Windows.Controls.TreeViewItem are expanded or collapsed.



Get: IsExpanded(self: TreeViewItem) -> bool



Set: IsExpanded(self: TreeViewItem)=value

"""

 IsSelected=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets whether a System.Windows.Controls.TreeViewItem control is selected.



Get: IsSelected(self: TreeViewItem) -> bool



Set: IsSelected(self: TreeViewItem)=value

"""

 IsSelectionActive=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets a value that indicates whether the System.Windows.Controls.TreeViewItem has keyboard focus.



Get: IsSelectionActive(self: TreeViewItem) -> bool
