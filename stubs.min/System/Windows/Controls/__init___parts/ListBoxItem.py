class ListBoxItem(ContentControl,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient,IAddChild):
 """
 Represents a selectable item in a System.Windows.Controls.ListBox.
 ...
 def OnMouseEnter(self,*args):
  """
  OnMouseEnter(self: ListBoxItem,e: MouseEventArgs)

   Called when the mouse enters a System.Windows.Controls.ListBoxItem.
 ...
 def OnMouseLeftButtonDown(self,*args):
  """
  OnMouseLeftButtonDown(self: ListBoxItem,e: MouseButtonEventArgs)

   Called when the user presses the right mouse button over the System.Windows.Controls.ListBoxItem.
...
"""
 ...
 """Gets or sets a value that indicates whether a System.Windows.Controls.ListBoxItem is selected.



Get: IsSelected(self: ListBoxItem) -> bool



Set: IsSelected(self: ListBoxItem)=value
