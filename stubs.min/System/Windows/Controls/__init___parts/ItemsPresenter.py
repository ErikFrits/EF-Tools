class ItemsPresenter(FrameworkElement,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient):
 """
 ...
 def ArrangeOverride(self,*args):
  """
  ArrangeOverride(self: ItemsPresenter,arrangeSize: Size) -> Size

  

   Called to arrange and size the content of an System.Windows.Controls.ItemsPresenter object.

  

   arrangeSize: Computed size used to arrange the content.
 ...
 def MeasureOverride(self,*args):
  """
  MeasureOverride(self: ItemsPresenter,constraint: Size) -> Size

  

   Overrides the base class implementation of 

    System.Windows.FrameworkElement.MeasureOverride(System.Windows.Size) to measure the size of the 

    System.Windows.Controls.ItemsPresenter object and return proper sizes to the layout engine.
 ...
 def OnApplyTemplate(self):
  """
  OnApplyTemplate(self: ItemsPresenter)
 ...
 def OnTemplateChanged(self,*args):
  """
  OnTemplateChanged(self: ItemsPresenter,oldTemplate: ItemsPanelTemplate,newTemplate: ItemsPanelTemplate)

   Called when the control template changes.

  

   oldTemplate: Value of the old template.

   newTemplate: Value of the new template.
  """
  pass
