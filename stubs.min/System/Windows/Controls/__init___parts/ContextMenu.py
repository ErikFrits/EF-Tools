class ContextMenu(MenuBase,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient,IAddChild,IGeneratorHost,IContainItemStorage):
 """
 ...
 def HandleMouseButton(self,*args):
  """
  HandleMouseButton(self: MenuBase,e: MouseButtonEventArgs)

   Called when a mouse button is pressed or released.

  

   e: The event data for a mouse event.
  """
  pass
 ...
 def OnClosed(self,*args):
  """
  OnClosed(self: ContextMenu,e: RoutedEventArgs)

   Called when the System.Windows.Controls.ContextMenu.Closed event occurs.

  

   e: The event data for the System.Windows.Controls.ContextMenu.Closed event.
  """
  pass
 ...
 def OnCreateAutomationPeer(self,*args):
  """
  OnCreateAutomationPeer(self: ContextMenu) -> AutomationPeer

  

   Creates and returns a System.Windows.Automation.Peers.ContextMenuAutomationPeer object for this 

    System.Windows.Controls.ContextMenu.

  

   Returns: A System.Windows.Automation.Peers.ContextMenuAutomationPeer object for this 
 ...
 def OnIsKeyboardFocusWithinChanged(self,*args):
  """ OnIsKeyboardFocusWithinChanged(self: ContextMenu,e: DependencyPropertyChangedEventArgs) """
  pass
 ...
 def OnKeyDown(self,*args):
  """
  OnKeyDown(self: ContextMenu,e: KeyEventArgs)

   Called when a System.Windows.ContentElement.KeyDown event is raised by an object inside the 
 ...
 def OnKeyUp(self,*args):
  """
  OnKeyUp(self: ContextMenu,e: KeyEventArgs)

   Responds to the System.Windows.ContentElement.KeyUp event.
 ...
 def OnOpened(self,*args):
  """
  OnOpened(self: ContextMenu,e: RoutedEventArgs)

   Called when the System.Windows.Controls.ContextMenu.Opened event occurs.

  

   e: The event data for the System.Windows.Controls.ContextMenu.Opened event.
  """
  pass
 ...
 def OnVisualParentChanged(self,*args):
  """
  OnVisualParentChanged(self: ContextMenu,oldParent: DependencyObject)

   Called when a context menu's visual parent changes.

  

   oldParent: The object that the context menu was previously attached to.
  """
  pass
 ...
 def PrepareContainerForItemOverride(self,*args):
  """
  PrepareContainerForItemOverride(self: ContextMenu,element: DependencyObject,item: object)
 ...
 """Gets or sets a callback that indicates where a System.Windows.Controls.ContextMenu should be placed on the screen.



Get: CustomPopupPlacementCallback(self: ContextMenu) -> CustomPopupPlacementCallback



Set: CustomPopupPlacementCallback(self: ContextMenu)=value
...
Get: HasDropShadow(self: ContextMenu) -> bool



Set: HasDropShadow(self: ContextMenu)=value
...
Get: HorizontalOffset(self: ContextMenu) -> float



Set: HorizontalOffset(self: ContextMenu)=value
...
"""
 ...
 """Gets or sets a value that indicates whether the System.Windows.Controls.ContextMenu is visible.



Get: IsOpen(self: ContextMenu) -> bool



Set: IsOpen(self: ContextMenu)=value
...
"""
 ...
 """Gets or sets the System.Windows.Controls.ContextMenu.Placement property of a System.Windows.Controls.ContextMenu.



Get: Placement(self: ContextMenu) -> PlacementMode



Set: Placement(self: ContextMenu)=value
...
Get: PlacementRectangle(self: ContextMenu) -> Rect



Set: PlacementRectangle(self: ContextMenu)=value

"""

 PlacementTarget=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets the System.Windows.UIElement relative to which the System.Windows.Controls.ContextMenu is positioned when it opens.



Get: PlacementTarget(self: ContextMenu) -> UIElement



Set: PlacementTarget(self: ContextMenu)=value

"""

 StaysOpen=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets a value that indicates whether the System.Windows.Controls.ContextMenu should close automatically.



Get: StaysOpen(self: ContextMenu) -> bool



Set: StaysOpen(self: ContextMenu)=value
...
Get: VerticalOffset(self: ContextMenu) -> float



Set: VerticalOffset(self: ContextMenu)=value
