class Page(FrameworkElement,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient,IWindowService,IAddChild):
 """
 Encapsulates a page of content that can be navigated to and hosted by Windows Internet Explorer,System.Windows.Navigation.NavigationWindow,and System.Windows.Controls.Frame.
 ...
 def MeasureOverride(self,*args):
  ...
  MeasureOverride(self: Page,constraint: Size) -> Size
   ...
   Returns: A System.Windows.Size that is the actual size of the window. The method may return a larger 

    value,in which case the parent may need to add scroll bars.
  """
  pass
 ...
 def OnVisualParentChanged(self,*args):
  ...
  OnVisualParentChanged(self: Page,oldParent: DependencyObject)
   ...
   oldParent: The previous parent. Set to null if the System.Windows.DependencyObject did not have a previous 
 ...
 def ShouldSerializeProperty(self,*args):
  ...
  """
  pass
 def ShouldSerializeShowsNavigationUI(self):
  """
  ShouldSerializeShowsNavigationUI(self: Page) -> bool

  

   Allows derived classes to determine the serialization behavior of the 

    System.Windows.Controls.Page.ShowsNavigationUI property.
  ...
  """
  pass
 def ShouldSerializeTitle(self):
  """
  ShouldSerializeTitle(self: Page) -> bool

  

   Allows derived classes to determine the serialization behavior of the 

    System.Windows.Controls.Page.Title property.
  ...
  """
  pass
 def ShouldSerializeWindowHeight(self):
  """
  ShouldSerializeWindowHeight(self: Page) -> bool

  

   Allows derived classes to determine the serialization behavior of the 

    System.Windows.Controls.Page.WindowHeight property.
  ...
  """
  pass
 def ShouldSerializeWindowTitle(self):
  """
  ShouldSerializeWindowTitle(self: Page) -> bool

  

   Allows derived classes to determine the serialization behavior of the 

    System.Windows.Controls.Page.WindowTitle property.
  ...
  """
  pass
 def ShouldSerializeWindowWidth(self):
  """
  ShouldSerializeWindowWidth(self: Page) -> bool

  

   Allows derived classes to determine the serialization behavior of the 

    System.Windows.Controls.Page.WindowWidth property.
 ...
 """Gets or sets the background for a System.Windows.Controls.Page.



Get: Background(self: Page) -> Brush



Set: Background(self: Page)=value
...
Get: Content(self: Page) -> object



Set: Content(self: Page)=value
...
Get: FontFamily(self: Page) -> FontFamily



Set: FontFamily(self: Page)=value
...
Get: FontSize(self: Page) -> float



Set: FontSize(self: Page)=value

"""

 Foreground=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets the foreground for a System.Windows.Controls.Page.



Get: Foreground(self: Page) -> Brush



Set: Foreground(self: Page)=value
...
"""
 ...
 """Gets or sets a value that indicates whether the System.Windows.Controls.Page instance is retained in navigation history.



Get: KeepAlive(self: Page) -> bool



Set: KeepAlive(self: Page)=value
...
Get: NavigationService(self: Page) -> NavigationService



"""

 ShowsNavigationUI=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets a value that indicates whether the navigation UI of a System.Windows.Navigation.NavigationWindow�on Microsoft Internet Explorer 6�is visible.



Get: ShowsNavigationUI(self: Page) -> bool



Set: ShowsNavigationUI(self: Page)=value
...
"""
 ...
 """Gets or sets the control template for a System.Windows.Controls.Page.



Get: Template(self: Page) -> ControlTemplate



Set: Template(self: Page)=value

"""

 Title=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets the title of the System.Windows.Controls.Page.
...
"""
 ...
 WindowHeight=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets the height of the host System.Windows.Window or System.Windows.Navigation.NavigationWindow of a System.Windows.Controls.Page.



Get: WindowHeight(self: Page) -> float



Set: WindowHeight(self: Page)=value

"""

 WindowTitle=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
Get: WindowTitle(self: Page) -> str



Set: WindowTitle(self: Page)=value

"""

 WindowWidth=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets the width of the host System.Windows.Window or System.Windows.Navigation.NavigationWindow of a System.Windows.Controls.Page.



Get: WindowWidth(self: Page) -> float



Set: WindowWidth(self: Page)=value
