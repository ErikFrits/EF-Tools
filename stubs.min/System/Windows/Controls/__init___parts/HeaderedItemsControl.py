class HeaderedItemsControl(ItemsControl,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient,IAddChild,IGeneratorHost,IContainItemStorage):
 """
 ...
 def ToString(self):
  """
  ToString(self: HeaderedItemsControl) -> str
...
"""
 ...
 """Gets a value that indicates whether this System.Windows.Controls.HeaderedItemsControl has a header.



Get: HasHeader(self: HeaderedItemsControl) -> bool
...
Get: Header(self: HeaderedItemsControl) -> object



Set: Header(self: HeaderedItemsControl)=value

"""

 HeaderStringFormat=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets a composite string that specifies how to format the System.Windows.Controls.HeaderedItemsControl.Header property if it is displayed as a string.



Get: HeaderStringFormat(self: HeaderedItemsControl) -> str



Set: HeaderStringFormat(self: HeaderedItemsControl)=value
...
Get: HeaderTemplate(self: HeaderedItemsControl) -> DataTemplate



Set: HeaderTemplate(self: HeaderedItemsControl)=value
...
Get: HeaderTemplateSelector(self: HeaderedItemsControl) -> DataTemplateSelector



Set: HeaderTemplateSelector(self: HeaderedItemsControl)=value
