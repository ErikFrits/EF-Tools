class GridViewColumnHeader(ButtonBase,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient,IAddChild,ICommandSource):
 """
 Represents a column header for a System.Windows.Controls.GridViewColumn.
 ...
 def OnAccessKey(self,*args):
  """
  OnAccessKey(self: GridViewColumnHeader,e: AccessKeyEventArgs)

   Responds when the System.Windows.Controls.AccessText.AccessKey for the 

    System.Windows.Controls.GridViewColumnHeader is pressed.
 ...
 def OnApplyTemplate(self):
  """
  OnApplyTemplate(self: GridViewColumnHeader)

   Responds to the creation of the visual tree for the System.Windows.Controls.GridViewColumnHeader.
  """
  pass
 ...
 def OnClick(self,*args):
  """
  OnClick(self: GridViewColumnHeader)

   Provides class handling for the System.Windows.Controls.Primitives.ButtonBase.Click event for a 
 ...
 def OnCreateAutomationPeer(self,*args):
  """
  OnCreateAutomationPeer(self: GridViewColumnHeader) -> AutomationPeer

  

   Provides an System.Windows.Automation.Peers.AutomationPeer implementation for a 

    System.Windows.Controls.GridViewColumnHeader.

  

   Returns: A System.Windows.Automation.Peers.GridViewColumnHeaderAutomationPeer for this 
 ...
 def OnLostKeyboardFocus(self,*args):
  """
  OnLostKeyboardFocus(self: GridViewColumnHeader,e: KeyboardFocusChangedEventArgs)

   Provides class handling for the System.Windows.UIElement.LostKeyboardFocus event for a 
 ...
 def OnMouseEnter(self,*args):
  """
  OnMouseEnter(self: GridViewColumnHeader,e: MouseEventArgs)

   Provides class handling for the System.Windows.UIElement.MouseEnter event when the user pauses 

    the mouse pointer on the System.Windows.Controls.GridViewColumnHeader.
 ...
 def OnMouseLeave(self,*args):
  """
  OnMouseLeave(self: GridViewColumnHeader,e: MouseEventArgs)

   Provides class handling for the System.Windows.UIElement.MouseLeave event when the mouse moves 

    off the System.Windows.Controls.GridViewColumnHeader.
 ...
 def OnMouseLeftButtonDown(self,*args):
  """
  OnMouseLeftButtonDown(self: GridViewColumnHeader,e: MouseButtonEventArgs)

   Provides class handling for the System.Windows.UIElement.MouseLeftButtonDown event when the user 

    presses the left mouse button while pausing the mouse pointer on the 
 ...
 def OnMouseLeftButtonUp(self,*args):
  """
  OnMouseLeftButtonUp(self: GridViewColumnHeader,e: MouseButtonEventArgs)

   Provides class handling for the System.Windows.UIElement.MouseLeftButtonUp event when the user 

    releases the left mouse button while pausing the mouse pointer on the 
 ...
 def OnMouseMove(self,*args):
  """
  OnMouseMove(self: GridViewColumnHeader,e: MouseEventArgs)

   Provides class handling for the System.Windows.UIElement.MouseMove event that occurs when the 

    user moves the mouse within a System.Windows.Controls.GridViewColumnHeader.
 ...
 def OnRenderSizeChanged(self,*args):
  """
  OnRenderSizeChanged(self: GridViewColumnHeader,sizeInfo: SizeChangedInfo)

   Responds to a change in System.Windows.Controls.GridViewColumnHeader dimensions.

  

   sizeInfo: Information about the change in the size of the System.Windows.Controls.GridViewColumnHeader.
  """
  pass
 ...
 def ShouldSerializeProperty(self,*args):
  """
  ShouldSerializeProperty(self: GridViewColumnHeader,dp: DependencyProperty) -> bool

  

   Determines whether to serialize a System.Windows.DependencyProperty.

  

   dp: The dependency property.

   Returns: true if the System.Windows.DependencyProperty must be serialized; otherwise,false. The default 
 ...
 """Gets the System.Windows.Controls.GridViewColumn that is associated with the System.Windows.Controls.GridViewColumnHeader.



Get: Column(self: GridViewColumnHeader) -> GridViewColumn
...
"""
 ...
 """Gets the role of a System.Windows.Controls.GridViewColumnHeader.



Get: Role(self: GridViewColumnHeader) -> GridViewColumnHeaderRole
