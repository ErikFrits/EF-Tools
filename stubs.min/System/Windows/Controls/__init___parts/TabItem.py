class TabItem(HeaderedContentControl,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient,IAddChild):
 """
 Represents a selectable item inside a System.Windows.Controls.TabControl.
 ...
 def OnAccessKey(self,*args):
  """
  OnAccessKey(self: TabItem,e: AccessKeyEventArgs)

   Responds when an System.Windows.Controls.AccessText.AccessKey for a 

    System.Windows.Controls.TabControl is called.

  

  

   e: Provides data for System.Windows.Input.AccessKeyEventArgs.
  """
  pass
 ...
 def OnContentChanged(self,*args):
  """
  OnContentChanged(self: TabItem,oldContent: object,newContent: object)

   Called when the System.Windows.Controls.ContentControl.Content property changes.

  

   oldContent: Old value of the content property.

   newContent: New value of the content property.
  """
  pass
 ...
 def OnContentTemplateChanged(self,*args):
  """
  OnContentTemplateChanged(self: TabItem,oldContentTemplate: DataTemplate,newContentTemplate: DataTemplate)

   Called when the System.Windows.Controls.TabControl.ContentTemplate property changes.

  

   oldContentTemplate: Old value of the content template property.

   newContentTemplate: New value of the content template property.
  """
  pass
 def OnContentTemplateSelectorChanged(self,*args):
  """
  OnContentTemplateSelectorChanged(self: TabItem,oldContentTemplateSelector: DataTemplateSelector,newContentTemplateSelector: DataTemplateSelector)

   Called when the System.Windows.Controls.TabControl.ContentTemplateSelector property changes.

  

   oldContentTemplateSelector: Old value of the content template selector.

   newContentTemplateSelector: New value of the content template selector.
  """
  pass
 ...
 def OnCreateAutomationPeer(self,*args):
  """
  OnCreateAutomationPeer(self: TabItem) -> AutomationPeer

  

   Provides an appropriate System.Windows.Automation.Peers.TabItemAutomationPeer implementation for 
 ...
 def OnHeaderChanged(self,*args):
  ...
  OnHeaderChanged(self: HeaderedContentControl,oldHeader: object,newHeader: object)
   ...
   Called when the System.Windows.Controls.HeaderedContentControl.Header property of a 

    System.Windows.Controls.HeaderedContentControl changes.
 ...
 def OnHeaderStringFormatChanged(self,*args):
  ...
  OnHeaderStringFormatChanged(self: HeaderedContentControl,oldHeaderStringFormat: str,newHeaderStringFormat: str)
   ...
   Called when the System.Windows.Controls.HeaderedContentControl.HeaderStringFormat property 
   ...
   oldHeaderStringFormat: The old value of the System.Windows.Controls.HeaderedContentControl.HeaderStringFormat property.

   newHeaderStringFormat: The new value of the System.Windows.Controls.HeaderedContentControl.HeaderStringFormat property.
  """
  pass
 def OnHeaderTemplateChanged(self,*args):
  ...
  OnHeaderTemplateChanged(self: HeaderedContentControl,oldHeaderTemplate: DataTemplate,newHeaderTemplate: DataTemplate)
   ...
   Called when the System.Windows.Controls.HeaderedContentControl.HeaderTemplate property changes.

  

   oldHeaderTemplate: Old value of the System.Windows.Controls.HeaderedContentControl.HeaderTemplate property.

   newHeaderTemplate: New value of the System.Windows.Controls.HeaderedContentControl.HeaderTemplate property.
  """
  pass
 def OnHeaderTemplateSelectorChanged(self,*args):
  ...
  OnHeaderTemplateSelectorChanged(self: HeaderedContentControl,oldHeaderTemplateSelector: DataTemplateSelector,newHeaderTemplateSelector: DataTemplateSelector)
   ...
   Called when the System.Windows.Controls.HeaderedContentControl.HeaderTemplateSelector property 
   ...
   oldHeaderTemplateSelector: Old value of the System.Windows.Controls.HeaderedContentControl.HeaderTemplateSelector property.

   newHeaderTemplateSelector: New value of the System.Windows.Controls.HeaderedContentControl.HeaderTemplateSelector property.
  """
  pass
 ...
 def OnMouseLeftButtonDown(self,*args):
  """
  OnMouseLeftButtonDown(self: TabItem,e: MouseButtonEventArgs)

   Responds to the System.Windows.ContentElement.MouseLeftButtonDown event.

  

   e: Provides data for System.Windows.Input.MouseButtonEventArgs.
  """
  pass
 ...
 def OnPreviewGotKeyboardFocus(self,*args):
  """
  OnPreviewGotKeyboardFocus(self: TabItem,e: KeyboardFocusChangedEventArgs)

   Announces that the keyboard is focused on this element.

  

   e: Keyboard input event arguments.
  """
  pass
 ...
 def OnSelected(self,*args):
  """
  OnSelected(self: TabItem,e: RoutedEventArgs)

   Called to indicate that the System.Windows.Controls.TabItem.IsSelected property has changed to 
   ...
   e: The event data for the System.Windows.Controls.Primitives.Selector.Selected event.
  """
  pass
 ...
 def OnUnselected(self,*args):
  """
  OnUnselected(self: TabItem,e: RoutedEventArgs)
   ...
   e: The event data for the System.Windows.Controls.Primitives.Selector.Unselected event.
  """
  pass
...
"""
 ...
 """Gets or sets a value that indicates whether the System.Windows.Controls.TabItem is selected.



Get: IsSelected(self: TabItem) -> bool



Set: IsSelected(self: TabItem)=value
...
Get: TabStripPlacement(self: TabItem) -> Dock
