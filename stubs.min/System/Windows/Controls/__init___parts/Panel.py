class Panel(FrameworkElement,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient,IAddChild):
 ...
 def GetZIndex(element):
  ...
  GetZIndex(element: UIElement) -> int
   ...
   element: The element for which to retrieve the System.Windows.Controls.Panel.ZIndex value.
 ...
 def SetZIndex(element,value):
  ...
  SetZIndex(element: UIElement,value: int)
   ...
   element: The element on which to apply the property value.
 ...
 def ShouldSerializeChildren(self):
  ...
  ShouldSerializeChildren(self: Panel) -> bool
   ...
   Determines whether the System.Windows.Controls.Panel.Children collection of a panel should be 

    serialized.

  

   Returns: true if the System.Windows.Controls.Panel.Children collection should be serialized; otherwise,

    false. The System.Windows.Controls.Panel.Children collection is only serialized if it is not 
...
Get: Background(self: Panel) -> Brush



Set: Background(self: Panel)=value
...
Get: Children(self: Panel) -> UIElementCollection
...
Get: IsItemsHost(self: Panel) -> bool



Set: IsItemsHost(self: Panel)=value
