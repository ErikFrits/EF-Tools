class DataGridRow(Control,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient):
 """
 ...
 def ArrangeOverride(self,*args):
  """
  ArrangeOverride(self: DataGridRow,arrangeBounds: Size) -> Size
   ...
   arrangeBounds: The area that is available for the row.

   Returns: The actual area used by the row.
  """
  pass
 def GetIndex(self):
  """
  GetIndex(self: DataGridRow) -> int

  

   Returns the index of the row's data item within the System.Windows.Controls.ItemsControl.Items 

    collection of the System.Windows.Controls.DataGrid.

  

   Returns: The index of the row's data item,or -1 if the item was not found.
  """
  pass
 def GetLayoutClip(self,*args):
  ...
  pass
 @staticmethod
 def GetRowContainingElement(element):
  """
  GetRowContainingElement(element: FrameworkElement) -> DataGridRow

  

   Returns the System.Windows.Controls.DataGridRow that contains the specified element.

  

   element: An element contained in a row to be found.
 ...
 def OnChildDesiredSizeChanged(self,*args):
  ...
  """
  pass
 def OnColumnsChanged(self,*args):
  """ OnColumnsChanged(self: DataGridRow,columns: ObservableCollection[DataGridColumn],e: NotifyCollectionChangedEventArgs) """
  pass
 ...
 def OnCreateAutomationPeer(self,*args):
  """
  OnCreateAutomationPeer(self: DataGridRow) -> AutomationPeer

  

   Returns a new System.Windows.Automation.Peers.DataGridRowAutomationPeer for this row.

   Returns: A new automation peer for this row.
  """
  pass
 ...
 def OnHeaderChanged(self,*args):
  """
  OnHeaderChanged(self: DataGridRow,oldHeader: object,newHeader: object)

   Called when the value of the System.Windows.Controls.DataGridRow.Header property has changed.

  

   oldHeader: The previous value of the System.Windows.Controls.DataGridRow.Header property.

   newHeader: The new value of the System.Windows.Controls.DataGridRow.Header property.
  """
  pass
 ...
 def OnItemChanged(self,*args):
  """
  OnItemChanged(self: DataGridRow,oldItem: object,newItem: object)

   Updates the displayed cells when the System.Windows.Controls.DataGridRow.Item property value has 
   ...
   oldItem: The previous value of the System.Windows.Controls.DataGridRow.Item property.

   newItem: The new value of the System.Windows.Controls.DataGridRow.Item property.
  """
  pass
 ...
 def OnPropertyChanged(self,*args):
  """
  OnPropertyChanged(self: DataGridRow,e: DependencyPropertyChangedEventArgs)

   Invoked whenever the effective value of any dependency property on this 

    System.Windows.Controls.DataGridRow has been updated.
 ...
 def OnSelected(self,*args):
  """
  OnSelected(self: DataGridRow,e: RoutedEventArgs)

   Raises the System.Windows.Controls.DataGridRow.Selected event when the 

    System.Windows.Controls.DataGridRow.IsSelected property value changes to true.

  

  

   e: The event data,which is empty when this method is called by the 
 ...
 def OnTemplateChanged(self,*args):
  """
  OnTemplateChanged(self: DataGridRow,oldTemplate: ControlTemplate,newTemplate: ControlTemplate)
 ...
 def OnTouchUp(self,*args):
  ...
  """
  pass
 def OnUnselected(self,*args):
  """
  OnUnselected(self: DataGridRow,e: RoutedEventArgs)

   Raises the System.Windows.Controls.DataGridRow.Unselected event when the 

    System.Windows.Controls.DataGridRow.IsSelected property value changes to false.
 ...
 def __str__(self,*args):
  pass
 AlternationIndex=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets the index of the row within a set of alternating rows.



Get: AlternationIndex(self: DataGridRow) -> int
...
"""
 ...
 DetailsTemplate=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets the template that is used to display the details section of the row.



Get: DetailsTemplate(self: DataGridRow) -> DataTemplate



Set: DetailsTemplate(self: DataGridRow)=value

"""

 DetailsTemplateSelector=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets a template selector that provides custom logic for choosing a row details template.



Get: DetailsTemplateSelector(self: DataGridRow) -> DataTemplateSelector



Set: DetailsTemplateSelector(self: DataGridRow)=value

"""

 DetailsVisibility=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets a value that indicates when the details section of the row is displayed.



Get: DetailsVisibility(self: DataGridRow) -> Visibility



Set: DetailsVisibility(self: DataGridRow)=value
...
"""
 ...
 """Gets or sets an object that represents the row header contents.



Get: Header(self: DataGridRow) -> object



Set: Header(self: DataGridRow)=value
...
Get: HeaderStyle(self: DataGridRow) -> Style



Set: HeaderStyle(self: DataGridRow)=value
...
Get: HeaderTemplate(self: DataGridRow) -> DataTemplate



Set: HeaderTemplate(self: DataGridRow)=value

"""

 HeaderTemplateSelector=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets a template selector that provides custom logic for choosing a row header template.



Get: HeaderTemplateSelector(self: DataGridRow) -> DataTemplateSelector



Set: HeaderTemplateSelector(self: DataGridRow)=value
...
Get: IsEditing(self: DataGridRow) -> bool
...
"""
 ...
 IsNewItem=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Get: IsNewItem(self: DataGridRow) -> bool
...
Get: IsSelected(self: DataGridRow) -> bool



Set: IsSelected(self: DataGridRow)=value

"""

 Item=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets the data item that the row represents.



Get: Item(self: DataGridRow) -> object



Set: Item(self: DataGridRow)=value

"""

 ItemsPanel=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets the template that defines the panel that controls the layout of cells in the row.



Get: ItemsPanel(self: DataGridRow) -> ItemsPanelTemplate



Set: ItemsPanel(self: DataGridRow)=value
...
"""
 ...
 ValidationErrorTemplate=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets the template that is used to visually indicate an error in row validation.



Get: ValidationErrorTemplate(self: DataGridRow) -> ControlTemplate



Set: ValidationErrorTemplate(self: DataGridRow)=value
...
"""
 ...
 DetailsTemplateProperty=None
 DetailsTemplateSelectorProperty=None
 DetailsVisibilityProperty=None
 HeaderProperty=None
 HeaderStyleProperty=None
 HeaderTemplateProperty=None
 HeaderTemplateSelectorProperty=None
 IsEditingProperty=None
 IsNewItemProperty=None
 IsSelectedProperty=None
 ItemProperty=None
 ItemsPanelProperty=None
 Selected=None
 SelectedEvent=None
 Unselected=None
 UnselectedEvent=None
 ValidationErrorTemplateProperty=None
