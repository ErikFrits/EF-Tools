class DataGridCell(ContentControl,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient,IAddChild,IProvideDataGridColumn):
 """
 ...
 def ArrangeOverride(self,*args):
  """
  ArrangeOverride(self: DataGridCell,arrangeSize: Size) -> Size

  

   Determines the final size and placement of the cell content.

  

   arrangeSize: The maximum size that the cell can occupy.

   Returns: The final size of the control.
  """
  pass
 ...
 def MeasureOverride(self,*args):
  """
  MeasureOverride(self: DataGridCell,constraint: Size) -> Size

  

   Determines the desired size of the System.Windows.Controls.DataGridCell.

  

   constraint: The maximum size that the cell can occupy.

   Returns: The desired size of the System.Windows.Controls.DataGridCell.
  """
  pass
 ...
 def OnColumnChanged(self,*args):
  """
  OnColumnChanged(self: DataGridCell,oldColumn: DataGridColumn,newColumn: DataGridColumn)

   Called when the cell's System.Windows.Controls.DataGridCell.Column property changes.

  

   oldColumn: The old column definition.
 ...
 def OnCreateAutomationPeer(self,*args):
  """
  OnCreateAutomationPeer(self: DataGridCell) -> AutomationPeer

  

   Returns the automation peer for this System.Windows.Controls.DataGridCell.
 ...
 def OnInitialized(self,*args):
  ...
  """
  pass
 def OnIsEditingChanged(self,*args):
  """
  OnIsEditingChanged(self: DataGridCell,isEditing: bool)

   Called when the System.Windows.Controls.DataGridCell.IsEditing property changes.

  

   isEditing: The new value of the System.Windows.Controls.DataGridCell.IsEditing property.
  """
  pass
 ...
 def OnKeyDown(self,*args):
  """
  OnKeyDown(self: DataGridCell,e: KeyEventArgs)
 ...
 def OnPreviewKeyDown(self,*args):
  """ OnPreviewKeyDown(self: DataGridCell,e: KeyEventArgs) """
  pass
 ...
 def OnRender(self,*args):
  """
  OnRender(self: DataGridCell,drawingContext: DrawingContext)

   Draws the cell and the right side gridline.

  

   drawingContext: The drawing instructions for the cell.
  """
  pass
 ...
 def OnSelected(self,*args):
  """
  OnSelected(self: DataGridCell,e: RoutedEventArgs)

   Raises the System.Windows.Controls.DataGridCell.Selected event.
 ...
 def OnTextInput(self,*args):
  """
  OnTextInput(self: DataGridCell,e: TextCompositionEventArgs)
 ...
 def OnUnselected(self,*args):
  """
  OnUnselected(self: DataGridCell,e: RoutedEventArgs)

   Raises the System.Windows.Controls.DataGridCell.Unselected event.
...
Get: Column(self: DataGridCell) -> DataGridColumn
...
Get: IsEditing(self: DataGridCell) -> bool



Set: IsEditing(self: DataGridCell)=value
...
Get: IsReadOnly(self: DataGridCell) -> bool
...
Get: IsSelected(self: DataGridCell) -> bool



Set: IsSelected(self: DataGridCell)=value
