class GridViewHeaderRowPresenter(GridViewRowPresenterBase,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient,IWeakEventListener):
 """
 ...
 def ArrangeOverride(self,*args):
  """
  ArrangeOverride(self: GridViewHeaderRowPresenter,arrangeSize: Size) -> Size
   ...
   arrangeSize: The area that is available for the column header row.

   Returns: The actual System.Windows.Size for the column header row.
  """
  pass
 ...
 def GetVisualChild(self,*args):
  """
  GetVisualChild(self: GridViewRowPresenterBase,index: int) -> Visual
   ...
   Returns: A System.Windows.Media.Visual object that contains the child at the specified index.
  """
  pass
 ...
 def MeasureOverride(self,*args):
  """
  MeasureOverride(self: GridViewHeaderRowPresenter,constraint: Size) -> Size
   ...
   constraint: The amount of area that is available to display the column header row.

   Returns: The required System.Windows.Size for the column header row.
  """
  pass
 ...
 def OnCreateAutomationPeer(self,*args):
  """
  OnCreateAutomationPeer(self: GridViewHeaderRowPresenter) -> AutomationPeer

  

   Creates an System.Windows.Automation.Peers.AutomationPeer object for the column header row.

   Returns: A System.Windows.Automation.Peers.GridViewHeaderRowPresenterAutomationPeer object for this 
 ...
 def OnLostMouseCapture(self,*args):
  """
  OnLostMouseCapture(self: GridViewHeaderRowPresenter,e: MouseEventArgs)

   Provides class handling for the System.Windows.UIElement.LostMouseCapture event for the 
 ...
 def OnMouseLeftButtonDown(self,*args):
  """
  OnMouseLeftButtonDown(self: GridViewHeaderRowPresenter,e: MouseButtonEventArgs)

   Provides class handling for the System.Windows.UIElement.MouseLeftButtonDown event that occurs 

    when the user presses the left mouse button inside a 
 ...
 def OnMouseLeftButtonUp(self,*args):
  """
  OnMouseLeftButtonUp(self: GridViewHeaderRowPresenter,e: MouseButtonEventArgs)

   Provides class handling for the System.Windows.UIElement.MouseLeftButtonUp event that occurs 
 ...
 def OnMouseMove(self,*args):
  """
  OnMouseMove(self: GridViewHeaderRowPresenter,e: MouseEventArgs)
...
Get: AllowsColumnReorder(self: GridViewHeaderRowPresenter) -> bool



Set: AllowsColumnReorder(self: GridViewHeaderRowPresenter)=value

"""

 ColumnHeaderContainerStyle=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets the System.Windows.Style to use for the column headers.



Get: ColumnHeaderContainerStyle(self: GridViewHeaderRowPresenter) -> Style



Set: ColumnHeaderContainerStyle(self: GridViewHeaderRowPresenter)=value

"""

 ColumnHeaderContextMenu=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets a System.Windows.Controls.ContextMenu for the column headers.



Get: ColumnHeaderContextMenu(self: GridViewHeaderRowPresenter) -> ContextMenu



Set: ColumnHeaderContextMenu(self: GridViewHeaderRowPresenter)=value
...
Get: ColumnHeaderStringFormat(self: GridViewHeaderRowPresenter) -> str



Set: ColumnHeaderStringFormat(self: GridViewHeaderRowPresenter)=value
...
Get: ColumnHeaderTemplate(self: GridViewHeaderRowPresenter) -> DataTemplate



Set: ColumnHeaderTemplate(self: GridViewHeaderRowPresenter)=value

"""

 ColumnHeaderTemplateSelector=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets a System.Windows.Controls.DataTemplateSelector that provides logic that selects the data template to use to display a column header.



Get: ColumnHeaderTemplateSelector(self: GridViewHeaderRowPresenter) -> DataTemplateSelector



Set: ColumnHeaderTemplateSelector(self: GridViewHeaderRowPresenter)=value
...
Get: ColumnHeaderToolTip(self: GridViewHeaderRowPresenter) -> object



Set: ColumnHeaderToolTip(self: GridViewHeaderRowPresenter)=value
