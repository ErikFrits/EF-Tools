class Image(FrameworkElement,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient,IUriContext,IProvidePropertyFallback):
 """
 ...
 def ArrangeOverride(self,*args):
  """
  ArrangeOverride(self: Image,arrangeSize: Size) -> Size
   ...
   arrangeSize: The size used to arrange the control.
 ...
 def MeasureOverride(self,*args):
  """
  MeasureOverride(self: Image,constraint: Size) -> Size

  

   Updates the System.Windows.UIElement.DesiredSize of the image. This method is called by the 

    parent System.Windows.UIElement and is the first pass of layout.

  

  

   constraint: The size that the image should not exceed.

   Returns: The image's desired size.
  """
  pass
 ...
 def OnCreateAutomationPeer(self,*args):
  """
  OnCreateAutomationPeer(self: Image) -> AutomationPeer
   ...
   Returns: An System.Windows.Automation.Peers.AutomationPeer object for this System.Windows.Controls.Image.
  """
  pass
 def OnDpiChanged(self,*args):
  """ OnDpiChanged(self: Image,oldDpi: DpiScale,newDpi: DpiScale) """
  pass
 ...
 def OnRender(self,*args):
  """
  OnRender(self: Image,dc: DrawingContext)

   Renders the contents of an System.Windows.Controls.Image.

  

   dc: An instance of System.Windows.Media.DrawingContext used to render the control.
  """
  pass
...
Get: Source(self: Image) -> ImageSource



Set: Source(self: Image)=value

"""

 Stretch=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets a value that describes how an System.Windows.Controls.Image should be stretched to fill the destination rectangle.



Get: Stretch(self: Image) -> Stretch



Set: Stretch(self: Image)=value
...
Get: StretchDirection(self: Image) -> StretchDirection



Set: StretchDirection(self: Image)=value
