class InkCanvas(FrameworkElement,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient,IAddChild):
 ...
 def GetBottom(element):
  ...
  GetBottom(element: UIElement) -> float
   ...
   Gets the value of the System.Windows.Controls.InkCanvas.Bottom attached property for a given 
   ...
   element: The element of which to get the bottom property.
 ...
 def GetLeft(element):
  ...
  GetLeft(element: UIElement) -> float
   ...
   Gets the value of the System.Windows.Controls.InkCanvas.Left attached property for a given 
   ...
   element: The element of which to get the left property.
 ...
 def GetRight(element):
  ...
  GetRight(element: UIElement) -> float
   ...
   Gets the value of the System.Windows.Controls.InkCanvas.Right attached property for a given 
   ...
   element: The element of which to get the right property.
 ...
 def GetSelectedElements(self):
  ...
  GetSelectedElements(self: InkCanvas) -> ReadOnlyCollection[UIElement]
   ...
   Retrieves the System.Windows.FrameworkElement objects that are selected in the 
 ...
 def GetSelectedStrokes(self):
  ...
  GetSelectedStrokes(self: InkCanvas) -> StrokeCollection
   ...
   Retrieves a System.Windows.Ink.StrokeCollection that represents selected 

    System.Windows.Ink.Stroke objects on the System.Windows.Controls.InkCanvas.
 ...
 def GetSelectionBounds(self):
  ...
  GetSelectionBounds(self: InkCanvas) -> Rect
   ...
   Gets the bounds of the selected strokes and elements on the System.Windows.Controls.InkCanvas.
 ...
 def GetTop(element):
  ...
  GetTop(element: UIElement) -> float
   ...
   Gets the value of the System.Windows.Controls.InkCanvas.Top attached property for a given 
   ...
   element: The element of which to get the top property.
 ...
 def HitTestSelection(self,point):
  ...
  HitTestSelection(self: InkCanvas,point: Point) -> InkCanvasSelectionHitResult
   ...
   Returns a value that indicates which part of the selection adorner intersects or surrounds the 
   ...
   Returns: A value that indicates which part of the selection adorner intersects or surrounds a specified 
 ...
 def OnCreateAutomationPeer(self,*args):
  ...
  OnCreateAutomationPeer(self: InkCanvas) -> AutomationPeer
   ...
   Provides an appropriate System.Windows.Automation.Peers.InkCanvasAutomationPeer implementation 
 ...
 def Paste(self,point=None):
  ...
  Paste(self: InkCanvas,point: Point)
   ...
   point: The point at which to paste the strokes.

  Paste(self: InkCanvas)
 ...
 def SetBottom(element,length):
  ...
  SetBottom(element: UIElement,length: float)
   ...
   element: The element on which to set the bottom property.
 ...
 def SetLeft(element,length):
  ...
  SetLeft(element: UIElement,length: float)
   ...
   element: The element on which to set the left property.
 ...
 def SetRight(element,length):
  ...
  SetRight(element: UIElement,length: float)
   ...
   element: The element on which to set the right property.
 ...
 def SetTop(element,length):
  ...
  SetTop(element: UIElement,length: float)
   ...
   element: The element on which to set the top property.
...
Get: ActiveEditingMode(self: InkCanvas) -> InkCanvasEditingMode
...
Get: Background(self: InkCanvas) -> Brush



Set: Background(self: InkCanvas)=value
...
Get: Children(self: InkCanvas) -> UIElementCollection
...
Get: DefaultDrawingAttributes(self: InkCanvas) -> DrawingAttributes



Set: DefaultDrawingAttributes(self: InkCanvas)=value
...
Get: DefaultStylusPointDescription(self: InkCanvas) -> StylusPointDescription



Set: DefaultStylusPointDescription(self: InkCanvas)=value
...
Get: EditingMode(self: InkCanvas) -> InkCanvasEditingMode



Set: EditingMode(self: InkCanvas)=value
...
Get: EditingModeInverted(self: InkCanvas) -> InkCanvasEditingMode



Set: EditingModeInverted(self: InkCanvas)=value
...
Get: EraserShape(self: InkCanvas) -> StylusShape



Set: EraserShape(self: InkCanvas)=value
...
Get: IsGestureRecognizerAvailable(self: InkCanvas) -> bool
...
Get: MoveEnabled(self: InkCanvas) -> bool



Set: MoveEnabled(self: InkCanvas)=value
...
Get: PreferredPasteFormats(self: InkCanvas) -> IEnumerable[InkCanvasClipboardFormat]



Set: PreferredPasteFormats(self: InkCanvas)=value
...
Get: ResizeEnabled(self: InkCanvas) -> bool



Set: ResizeEnabled(self: InkCanvas)=value
...
Get: Strokes(self: InkCanvas) -> StrokeCollection



Set: Strokes(self: InkCanvas)=value
...
Get: UseCustomCursor(self: InkCanvas) -> bool



Set: UseCustomCursor(self: InkCanvas)=value
