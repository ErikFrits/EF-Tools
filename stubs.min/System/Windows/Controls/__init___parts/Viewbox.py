class Viewbox(Decorator,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient,IAddChild):
 """
 ...
 def ArrangeOverride(self,*args):
  """
  ArrangeOverride(self: Viewbox,arrangeSize: Size) -> Size
   ...
   arrangeSize: The System.Windows.Size this element uses to arrange its child elements.

   Returns: System.Windows.Size that represents the arranged size of this System.Windows.Controls.Viewbox 
 ...
 def GetVisualChild(self,*args):
  """
  GetVisualChild(self: Viewbox,index: int) -> Visual

  

   Gets a System.Windows.Media.Visual child at the specified index position.

  

   index: The index position of the wanted System.Windows.Media.Visual child.

   Returns: A System.Windows.Media.Visual child of the parent System.Windows.Controls.Viewbox element.
  """
  pass
 ...
 def MeasureOverride(self,*args):
  """
  MeasureOverride(self: Viewbox,constraint: Size) -> Size

  

   Measures the child elements of a System.Windows.Controls.Viewbox prior to arranging them during 

    the System.Windows.Controls.WrapPanel.ArrangeOverride(System.Windows.Size) pass.

  

  

   constraint: A System.Windows.Size limit that System.Windows.Controls.Viewbox cannot exceed.

   Returns: The System.Windows.Size that represents the element size you want.
  """
  pass
 ...
 """Gets or sets the single child of a System.Windows.Controls.Viewbox element.



Get: Child(self: Viewbox) -> UIElement



Set: Child(self: Viewbox)=value
...
"""
 ...
 """Gets an enumerator that can iterate the logical children of this System.Windows.Controls.Viewbox element.
...
"""
 ...
 """Gets or sets the System.Windows.Controls.Viewbox�System.Windows.Media.Stretch mode,which determines how content fits into the available space.



Get: Stretch(self: Viewbox) -> Stretch



Set: Stretch(self: Viewbox)=value

"""

 StretchDirection=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets the System.Windows.Controls.StretchDirection,which determines how scaling is applied to the contents of a System.Windows.Controls.Viewbox.



Get: StretchDirection(self: Viewbox) -> StretchDirection



Set: StretchDirection(self: Viewbox)=value
...
"""
 ...
 """Gets the number of child System.Windows.Media.Visual objects in this instance of System.Windows.Controls.Viewbox.
