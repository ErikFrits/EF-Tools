class GridSplitter(Thumb,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient):
 """
 Represents the control that redistributes space between columns or rows of a System.Windows.Controls.Grid control.
 ...
 def OnCreateAutomationPeer(self,*args):
  """
  OnCreateAutomationPeer(self: GridSplitter) -> AutomationPeer

  

   Creates the implementation of System.Windows.Automation.Peers.AutomationPeer for the 

    System.Windows.Controls.GridSplitter control.

  

   Returns: A new System.Windows.Automation.Peers.GridSplitterAutomationPeer for this 

    System.Windows.Controls.ToolTip control.
  """
  pass
 ...
 def OnDragEnter(self,*args):
  ...
  """
  pass
 def OnDraggingChanged(self,*args):
  """
  OnDraggingChanged(self: Thumb,e: DependencyPropertyChangedEventArgs)
 ...
 def OnKeyDown(self,*args):
  """
  OnKeyDown(self: GridSplitter,e: KeyEventArgs)
 ...
 def OnLostKeyboardFocus(self,*args):
  """
  OnLostKeyboardFocus(self: GridSplitter,e: KeyboardFocusChangedEventArgs)

   Called when the System.Windows.Controls.GridSplitter control loses keyboard focus.

  

   e: A System.Windows.Input.KeyboardFocusChangedEventArgs that contains the event data.
  """
  pass
 ...
 def OnMouseLeftButtonDown(self,*args):
  """
  OnMouseLeftButtonDown(self: Thumb,e: MouseButtonEventArgs)
 ...
 def OnMouseLeftButtonUp(self,*args):
  """
  OnMouseLeftButtonUp(self: Thumb,e: MouseButtonEventArgs)
 ...
 def OnMouseMove(self,*args):
  """
  OnMouseMove(self: Thumb,e: MouseEventArgs)
 ...
 def OnRenderSizeChanged(self,*args):
  """
  OnRenderSizeChanged(self: GridSplitter,sizeInfo: SizeChangedInfo)

   Responds to a change in the dimensions of the System.Windows.Controls.GridSplitter control.

  

   sizeInfo: Information about the change in size of the System.Windows.Controls.GridSplitter.
  """
  pass
...
"""
 ...
 DragIncrement=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets the minimum distance that a user must drag a mouse to resize rows or columns with a System.Windows.Controls.GridSplitter control.



Get: DragIncrement(self: GridSplitter) -> float



Set: DragIncrement(self: GridSplitter)=value
...
"""
 ...
 KeyboardIncrement=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets the distance that each press of an arrow key moves a System.Windows.Controls.GridSplitter control.



Get: KeyboardIncrement(self: GridSplitter) -> float



Set: KeyboardIncrement(self: GridSplitter)=value
...
"""
 ...
 PreviewStyle=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets the style that customizes the appearance,effects,or other style characteristics for the System.Windows.Controls.GridSplitter control preview indicator that is displayed when the System.Windows.Controls.GridSplitter.ShowsPreview property is set to true.



Get: PreviewStyle(self: GridSplitter) -> Style



Set: PreviewStyle(self: GridSplitter)=value

"""

 ResizeBehavior=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets which columns or rows are resized relative to the column or row for which the System.Windows.Controls.GridSplitter control is defined.



Get: ResizeBehavior(self: GridSplitter) -> GridResizeBehavior



Set: ResizeBehavior(self: GridSplitter)=value

"""

 ResizeDirection=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets a value that indicates whether the System.Windows.Controls.GridSplitter control resizes rows or columns.



Get: ResizeDirection(self: GridSplitter) -> GridResizeDirection



Set: ResizeDirection(self: GridSplitter)=value

"""

 ShowsPreview=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets a value that indicates whether the System.Windows.Controls.GridSplitter control updates the column or row size as the user drags the control.



Get: ShowsPreview(self: GridSplitter) -> bool



Set: ShowsPreview(self: GridSplitter)=value
...
"""
 ...
 DragIncrementProperty=None
 KeyboardIncrementProperty=None
 PreviewStyleProperty=None
 ResizeBehaviorProperty=None
 ResizeDirectionProperty=None
 ShowsPreviewProperty=None
