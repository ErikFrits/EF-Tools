class ToolBarTray(FrameworkElement,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient,IAddChild):
 """
 Represents the container that handles the layout of a System.Windows.Controls.ToolBar.
 ...
 def ArrangeOverride(self,*args):
  """
  ArrangeOverride(self: ToolBarTray,arrangeSize: Size) -> Size

  

   Called to arrange and size its System.Windows.Controls.ToolBar children.

  

   arrangeSize: The size that the System.Windows.Controls.ToolBarTray assumes to position its children.

   Returns: The size of the control.
  """
  pass
 @staticmethod
 def GetIsLocked(element):
  """
  GetIsLocked(element: DependencyObject) -> bool

  

   Reads the value of the System.Windows.Controls.ToolBarTray.IsLocked property from the specified 
   ...
   Returns: true if the toolbar cannot be moved inside the toolbar tray; otherwise,false. The default is 
 ...
 def GetVisualChild(self,*args):
  """
  GetVisualChild(self: ToolBarTray,index: int) -> Visual
   ...
   index: Index of the visual child.

   Returns: The index number of the visible child.
  """
  pass
 ...
 def MeasureOverride(self,*args):
  """
  MeasureOverride(self: ToolBarTray,constraint: Size) -> Size

  

   Called to remeasure a System.Windows.Controls.ToolBarTray.

  

   constraint: The measurement constraints; a System.Windows.Controls.ToolBarTray cannot return a size larger 
 ...
 def OnRender(self,*args):
  """
  OnRender(self: ToolBarTray,dc: DrawingContext)

   Called when a System.Windows.Controls.ToolBarTray is displayed to get the Drawing Context (DC) 

    to use to render the System.Windows.Controls.ToolBarTray.

  

  

   dc: Drawing context to use to render the System.Windows.Controls.ToolBarTray.
  """
  pass
 ...
 def RemoveVisualChild(self,*args):
  ...
  pass
 @staticmethod
 def SetIsLocked(element,value):
  """
  SetIsLocked(element: DependencyObject,value: bool)

   Writes the value of the System.Windows.Controls.ToolBarTray.IsLocked property to the specified 
 ...
 """Gets or sets a brush to use for the background color of the System.Windows.Controls.ToolBarTray.



Get: Background(self: ToolBarTray) -> Brush



Set: Background(self: ToolBarTray)=value
...
"""
 ...
 """Gets or sets a value that indicates whether a System.Windows.Controls.ToolBar can be moved inside a System.Windows.Controls.ToolBarTray.



Get: IsLocked(self: ToolBarTray) -> bool



Set: IsLocked(self: ToolBarTray)=value

"""

 LogicalChildren=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets an enumerator to the logical child elements of a System.Windows.Controls.ToolBarTray.
...
"""
 ...
 """Specifies the orientation of a System.Windows.Controls.ToolBarTray.



Get: Orientation(self: ToolBarTray) -> Orientation



Set: Orientation(self: ToolBarTray)=value
...
"""
 ...
 ToolBars=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets the collection of System.Windows.Controls.ToolBar elements in the System.Windows.Controls.ToolBarTray.



Get: ToolBars(self: ToolBarTray) -> Collection[ToolBar]
