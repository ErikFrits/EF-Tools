...
Get: Count(self: ColumnDefinitionCollection) -> int
...
Get: IsReadOnly(self: ColumnDefinitionCollection) -> bool
...
Get: IsSynchronized(self: ColumnDefinitionCollection) -> bool
...
Get: SyncRoot(self: ColumnDefinitionCollection) -> object
