class ToolTip(ContentControl,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient,IAddChild):
 """
 ...
 def OnClosed(self,*args):
  """
  OnClosed(self: ToolTip,e: RoutedEventArgs)

   Responds to the System.Windows.Controls.ToolTip.Closed event.
 ...
 def OnContentChanged(self,*args):
  """ OnContentChanged(self: ToolTip,oldContent: object,newContent: object) """
  pass
 ...
 def OnCreateAutomationPeer(self,*args):
  """
  OnCreateAutomationPeer(self: ToolTip) -> AutomationPeer
   ...
   Returns: A new System.Windows.Automation.Peers.ToolTipAutomationPeer for this 
 ...
 def OnOpened(self,*args):
  """
  OnOpened(self: ToolTip,e: RoutedEventArgs)

   Responds to the System.Windows.Controls.ToolTip.Opened event.
 ...
 def OnVisualParentChanged(self,*args):
  """
  OnVisualParentChanged(self: ToolTip,oldParent: DependencyObject)

   Responds to a change in the visual parent of a System.Windows.Controls.ToolTip.
 ...
 """Gets or sets the delegate handler method to use to position the System.Windows.Controls.ToolTip.



Get: CustomPopupPlacementCallback(self: ToolTip) -> CustomPopupPlacementCallback



Set: CustomPopupPlacementCallback(self: ToolTip)=value
...
Get: HasDropShadow(self: ToolTip) -> bool



Set: HasDropShadow(self: ToolTip)=value
...
Get: HorizontalOffset(self: ToolTip) -> float



Set: HorizontalOffset(self: ToolTip)=value
...
"""
 ...
 """Gets or sets a value that indicates whether a System.Windows.Controls.ToolTip is visible.



Get: IsOpen(self: ToolTip) -> bool



Set: IsOpen(self: ToolTip)=value
...
"""
 ...
 """Gets or sets the orientation of the System.Windows.Controls.ToolTip control when it opens,and specifies how the System.Windows.Controls.ToolTip control behaves when it overlaps screen boundaries.



Get: Placement(self: ToolTip) -> PlacementMode



Set: Placement(self: ToolTip)=value

"""

 PlacementRectangle=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets the rectangular area relative to which the System.Windows.Controls.ToolTip control is positioned when it opens.



Get: PlacementRectangle(self: ToolTip) -> Rect



Set: PlacementRectangle(self: ToolTip)=value

"""

 PlacementTarget=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets the System.Windows.UIElement relative to which the System.Windows.Controls.ToolTip is positioned when it opens.



Get: PlacementTarget(self: ToolTip) -> UIElement



Set: PlacementTarget(self: ToolTip)=value

"""

 StaysOpen=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets a value that indicates whether an open System.Windows.Controls.ToolTip remains open until the user clicks the mouse when the mouse is not over the System.Windows.Controls.ToolTip.



Get: StaysOpen(self: ToolTip) -> bool



Set: StaysOpen(self: ToolTip)=value
...
Get: VerticalOffset(self: ToolTip) -> float



Set: VerticalOffset(self: ToolTip)=value
