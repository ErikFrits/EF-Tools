class Control(FrameworkElement,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient):
 """
 Represents the base class for user interface (UI) elements that use a System.Windows.Controls.ControlTemplate to define their appearance.
...
Get: Background(self: Control) -> Brush



Set: Background(self: Control)=value
...
Get: BorderBrush(self: Control) -> Brush



Set: BorderBrush(self: Control)=value
...
Get: BorderThickness(self: Control) -> Thickness



Set: BorderThickness(self: Control)=value
...
Get: FontFamily(self: Control) -> FontFamily



Set: FontFamily(self: Control)=value
...
Get: FontSize(self: Control) -> float



Set: FontSize(self: Control)=value
...
Get: FontStretch(self: Control) -> FontStretch



Set: FontStretch(self: Control)=value
...
Get: FontStyle(self: Control) -> FontStyle



Set: FontStyle(self: Control)=value
...
Get: FontWeight(self: Control) -> FontWeight



Set: FontWeight(self: Control)=value
...
Get: Foreground(self: Control) -> Brush



Set: Foreground(self: Control)=value
...
"""
 ...
 HorizontalContentAlignment=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets the horizontal alignment of the control's content.



Get: HorizontalContentAlignment(self: Control) -> HorizontalAlignment



Set: HorizontalContentAlignment(self: Control)=value
...
"""
 ...
 IsTabStop=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets a value that indicates whether a control is included in tab navigation.



Get: IsTabStop(self: Control) -> bool



Set: IsTabStop(self: Control)=value
...
Get: Padding(self: Control) -> Thickness
...
Get: Template(self: Control) -> ControlTemplate



Set: Template(self: Control)=value

"""

 VerticalContentAlignment=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets the vertical alignment of the control's content.



Get: VerticalContentAlignment(self: Control) -> VerticalAlignment



Set: VerticalContentAlignment(self: Control)=value
...
"""
 ...
 HorizontalContentAlignmentProperty=None
 IsTabStopProperty=None
 MouseDoubleClick=None
 MouseDoubleClickEvent=None
 PaddingProperty=None
 PreviewMouseDoubleClick=None
 PreviewMouseDoubleClickEvent=None
 TabIndexProperty=None
 TemplateProperty=None
 VerticalContentAlignmentProperty=None
