class GridViewRowPresenter(GridViewRowPresenterBase,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient,IWeakEventListener):
 """
 ...
 def ArrangeOverride(self,*args):
  """
  ArrangeOverride(self: GridViewRowPresenter,arrangeSize: Size) -> Size

  

   Positions the content of a row according to the size of the corresponding 

    System.Windows.Controls.GridViewColumn objects.

  

  

   arrangeSize: The area to use to display the System.Windows.Controls.GridViewRowPresenter.Content.

   Returns: The actual System.Windows.Size that is used to display the 

    System.Windows.Controls.GridViewRowPresenter.Content.
  """
  pass
 ...
 def MeasureOverride(self,*args):
  """
  MeasureOverride(self: GridViewRowPresenter,constraint: Size) -> Size
   ...
   constraint: The maximum area to use to display the System.Windows.Controls.GridViewRowPresenter.Content.

   Returns: The actual System.Windows.Size of the area that displays the 
 ...
 def ToString(self):
  """
  ToString(self: GridViewRowPresenter) -> str

  

   Returns a string representation of the System.Windows.Controls.GridViewRowPresenter.Content.

   Returns: A string that shows the System.Windows.Controls.GridViewRowPresenter.Content.
  """
  pass
...
Get: Content(self: GridViewRowPresenter) -> object



Set: Content(self: GridViewRowPresenter)=value
