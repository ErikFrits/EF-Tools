class GroupItem(ContentControl,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient,IAddChild,IHierarchicalVirtualizationAndScrollInfo,IContainItemStorage):
 """
 ...
 def ArrangeOverride(self,*args):
  """ ArrangeOverride(self: GroupItem,arrangeSize: Size) -> Size """
  pass
 ...
 def OnApplyTemplate(self):
  """ OnApplyTemplate(self: GroupItem) """
  pass
 ...
 def OnCreateAutomationPeer(self,*args):
  """
  OnCreateAutomationPeer(self: GroupItem) -> AutomationPeer
