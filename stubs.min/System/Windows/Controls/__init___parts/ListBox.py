class ListBox(Selector,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient,IAddChild,IGeneratorHost,IContainItemStorage):
 """
 ...
 def GetContainerForItemOverride(self,*args):
  """
  GetContainerForItemOverride(self: ListBox) -> DependencyObject

  

   Creates or identifies the element used to display a specified item.

   Returns: A System.Windows.Controls.ListBoxItem.
  """
  pass
 ...
 def IsItemItsOwnContainerOverride(self,*args):
  """
  IsItemItsOwnContainerOverride(self: ListBox,item: object) -> bool
 ...
 def OnCreateAutomationPeer(self,*args):
  """
  OnCreateAutomationPeer(self: ListBox) -> AutomationPeer

  

   Provides an appropriate System.Windows.Automation.Peers.ListBoxAutomationPeer implementation for 
 ...
 def PrepareContainerForItemOverride(self,*args):
  """
  PrepareContainerForItemOverride(self: ListBox,element: DependencyObject,item: object)
 ...
 def RemoveVisualChild(self,*args):
  ...
  """
  pass
 def ScrollIntoView(self,item):
  """
  ScrollIntoView(self: ListBox,item: object)

   Causes the object to scroll into view.

  

   item: Object to scroll.
  """
  pass
 def SelectAll(self):
  """
  SelectAll(self: ListBox)

   Selects all the items in a System.Windows.Controls.ListBox.
  """
  pass
 ...
 def UnselectAll(self):
  """
  UnselectAll(self: ListBox)

   Clears all the selection in a System.Windows.Controls.ListBox.
  """
  pass
...
Get: SelectedItems(self: ListBox) -> IList
