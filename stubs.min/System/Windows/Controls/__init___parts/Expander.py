class Expander(HeaderedContentControl,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient,IAddChild):
 """
 ...
 def OnCollapsed(self,*args):
  """
  OnCollapsed(self: Expander)

   Raises the System.Windows.Controls.Expander.Collapsed event when the 

    System.Windows.Controls.Expander.IsExpanded property changes from true to false.
  """
  pass
 ...
 def OnCreateAutomationPeer(self,*args):
  """
  OnCreateAutomationPeer(self: Expander) -> AutomationPeer

  

   Creates the implementation of System.Windows.Automation.Peers.AutomationPeer for the 

    System.Windows.Controls.Expander control.

  

   Returns: A new System.Windows.Automation.Peers.ExpanderAutomationPeer for this 
 ...
 def OnExpanded(self,*args):
  """
  OnExpanded(self: Expander)

   Raises the System.Windows.Controls.Expander.Expanded event when the 

    System.Windows.Controls.Expander.IsExpanded property changes from false to true.
  """
  pass
...
"""
 ...
 ExpandDirection=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets the direction in which the System.Windows.Controls.Expander content window opens.



Get: ExpandDirection(self: Expander) -> ExpandDirection



Set: ExpandDirection(self: Expander)=value
...
"""
 ...
 """Gets or sets whether the System.Windows.Controls.Expander content window is visible.



Get: IsExpanded(self: Expander) -> bool



Set: IsExpanded(self: Expander)=value
