class Canvas(Panel,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient,IAddChild):
 """
 Defines an area within which you can explicitly position child elements by using coordinates that are relative to the System.Windows.Controls.Canvas area.
 ...
 def ArrangeOverride(self,*args):
  """
  ArrangeOverride(self: Canvas,arrangeSize: Size) -> Size
   ...
   arrangeSize: The size that this System.Windows.Controls.Canvas element should use to arrange its child 

    elements.

  

   Returns: A System.Windows.Size that represents the arranged size of this System.Windows.Controls.Canvas 
 ...
 def GetBottom(element):
  ...
  GetBottom(element: UIElement) -> float
   ...
   Returns the value of the System.Windows.Controls.Canvas.Bottom�attached property for a given 
   ...
   Returns: The System.Windows.Controls.Canvas.Bottom coordinate of the specified element.
  """
  pass
 def GetLayoutClip(self,*args):
  """
  GetLayoutClip(self: Canvas,layoutSlotSize: Size) -> Geometry
   ...
   layoutSlotSize: The available size of the element.
 ...
 def GetLeft(element):
  ...
  GetLeft(element: UIElement) -> float
   ...
   Gets the value of the System.Windows.Controls.Canvas.Left�attached property for a given 
   ...
   Returns: The System.Windows.Controls.Canvas.Left coordinate of the specified element.
  """
  pass
 @staticmethod
 def GetRight(element):
  ...
  GetRight(element: UIElement) -> float
   ...
   Gets the value of the System.Windows.Controls.Canvas.Right�attached property for a given 
   ...
   Returns: The System.Windows.Controls.Canvas.Right coordinate of the specified element.
  """
  pass
 ...
 def GetTop(element):
  ...
  GetTop(element: UIElement) -> float
   ...
   Gets the value of the System.Windows.Controls.Canvas.Top�attached property for a given 
   ...
   Returns: The System.Windows.Controls.Canvas.Top coordinate of the specified element.
  """
  pass
 ...
 def MeasureOverride(self,*args):
  """
  MeasureOverride(self: Canvas,constraint: Size) -> Size

  

   Measures the child elements of a System.Windows.Controls.Canvas in anticipation of arranging 

    them during the System.Windows.Controls.Canvas.ArrangeOverride(System.Windows.Size) pass.
   ...
   Returns: A System.Windows.Size that represents the size that is required to arrange child content.
  """
  pass
 ...
 def SetBottom(element,length):
  ...
  SetBottom(element: UIElement,length: float)
   ...
   Sets the value of the System.Windows.Controls.Canvas.Bottom�attached property for a given 
   ...
   length: Sets the System.Windows.Controls.Canvas.Bottom coordinate of the specified element.
  """
  pass
 @staticmethod
 def SetLeft(element,length):
  ...
  SetLeft(element: UIElement,length: float)
   ...
   Sets the value of the System.Windows.Controls.Canvas.Left�attached property for a given 
   ...
   length: Sets the System.Windows.Controls.Canvas.Left coordinate of the specified element.
  """
  pass
 @staticmethod
 def SetRight(element,length):
  ...
  SetRight(element: UIElement,length: float)
   ...
   Sets the value of the System.Windows.Controls.Canvas.Right�attached property for a given 
   ...
   length: Sets the System.Windows.Controls.Canvas.Right coordinate of the specified element.
  """
  pass
 @staticmethod
 def SetTop(element,length):
  ...
  SetTop(element: UIElement,length: float)
   ...
   Sets the value of the System.Windows.Controls.Canvas.Top�attached property for a given 
   ...
   length: Sets the System.Windows.Controls.Canvas.Top coordinate of the specified element.
  """
  pass
