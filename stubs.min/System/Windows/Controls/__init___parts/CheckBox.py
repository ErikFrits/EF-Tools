class CheckBox(ToggleButton,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient,IAddChild,ICommandSource):
 """
 ...
 def OnAccessKey(self,*args):
  """
  OnAccessKey(self: CheckBox,e: AccessKeyEventArgs)

   Called when the access key for a System.Windows.Controls.CheckBox is invoked.

  

   e: The System.Windows.Input.AccessKeyEventArgs that contains the event data.
  """
  pass
 ...
 def OnCreateAutomationPeer(self,*args):
  """
  OnCreateAutomationPeer(self: CheckBox) -> AutomationPeer

  

   Creates an System.Windows.Automation.Peers.AutomationPeer for the 

    System.Windows.Controls.CheckBox.

  

   Returns: An System.Windows.Automation.Peers.AutomationPeer for the System.Windows.Controls.CheckBox.
  """
  pass
 ...
 def OnKeyDown(self,*args):
  ...
  OnKeyDown(self: CheckBox,e: KeyEventArgs)
   ...
   Responds to a System.Windows.Controls.CheckBoxSystem.Windows.UIElement.KeyDown event.
