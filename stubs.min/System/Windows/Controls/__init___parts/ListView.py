class ListView(ListBox,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient,IAddChild,IGeneratorHost,IContainItemStorage):
 """
 ...
 def ClearContainerForItemOverride(self,*args):
  """
  ClearContainerForItemOverride(self: ListView,element: DependencyObject,item: object)
   ...
   element: The System.Windows.Controls.ListViewItem container to clear.

   item: The object that the System.Windows.Controls.ListViewItem contains.
  """
  pass
 def GetContainerForItemOverride(self,*args):
  """
  GetContainerForItemOverride(self: ListView) -> DependencyObject

  

   Creates and returns a new System.Windows.Controls.ListViewItem container.

   Returns: A new System.Windows.Controls.ListViewItem control.
  """
  pass
 ...
 def IsItemItsOwnContainerOverride(self,*args):
  """
  IsItemItsOwnContainerOverride(self: ListView,item: object) -> bool
   ...
   Returns: true if the item is a System.Windows.Controls.ListViewItem; otherwise,false.
  """
  pass
 ...
 def OnCreateAutomationPeer(self,*args):
  """
  OnCreateAutomationPeer(self: ListView) -> AutomationPeer
   ...
   Returns: Returns a System.Windows.Automation.Peers.ListViewAutomationPeer object for the 
 ...
 def OnIsMouseCapturedChanged(self,*args):
  """
  OnIsMouseCapturedChanged(self: ListBox,e: DependencyPropertyChangedEventArgs)

   Called when the System.Windows.UIElement.IsMouseCaptured property changes.

  

   e: Provides data for the System.Windows.DependencyPropertyChangedEventArgs.
  """
  pass
 ...
 def OnItemsChanged(self,*args):
  """
  OnItemsChanged(self: ListView,e: NotifyCollectionChangedEventArgs)

   Responds to an 

    System.Windows.Controls.ItemsControl.OnItemsChanged(System.Collections.Specialized.NotifyCollecti
 ...
 def OnKeyDown(self,*args):
  """
  OnKeyDown(self: ListBox,e: KeyEventArgs)
 ...
 def OnMouseMove(self,*args):
  """
  OnMouseMove(self: ListBox,e: MouseEventArgs)

   Called when a System.Windows.Controls.ListBox reports a mouse move.

  

   e: Provides data for System.Windows.Input.MouseEventArgs.
  """
  pass
 ...
 def OnSelectionChanged(self,*args):
  """
  OnSelectionChanged(self: ListBox,e: SelectionChangedEventArgs)
 ...
 def PrepareContainerForItemOverride(self,*args):
  """
  PrepareContainerForItemOverride(self: ListView,element: DependencyObject,item: object)

   Sets the styles,templates,and bindings for a System.Windows.Controls.ListViewItem.

  

   element: An object that is a System.Windows.Controls.ListViewItem or that can be converted into one.

   item: The object to use to create the System.Windows.Controls.ListViewItem.
  """
  pass
 ...
 def SetSelectedItems(self,*args):
  """
  SetSelectedItems(self: ListBox,selectedItems: IEnumerable) -> bool
   ...
   selectedItems: Collection of items to be selected.

   Returns: true if all items have been selected; otherwise,false.
  """
  pass
 ...
 def __str__(self,*args):
  pass
 AnchorItem=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 """Gets a value that indicates whether the System.Windows.Controls.ListBox supports scrolling.
...
Get: View(self: ListView) -> ViewBase
