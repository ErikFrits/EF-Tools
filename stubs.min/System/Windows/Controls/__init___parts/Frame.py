class Frame(ContentControl,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient,IAddChild,INavigator,INavigatorBase,INavigatorImpl,IJournalNavigationScopeHost,IDownloader,IJournalState,IUriContext):
 """
 ...
 def AddBackEntry(self,state):
  """
  AddBackEntry(self: Frame,state: CustomContentState)
   ...
   state: A System.Windows.Navigation.CustomContentState object that represents application-defined state 

    that is associated with a specific piece of content.
  """
  pass
 def AddChild(self,*args):
  """
  AddChild(self: Frame,value: object)
 ...
 def GoBack(self):
  ...
  GoBack(self: Frame)
   ...
   Navigates to the most recent item in back navigation history,if a System.Windows.Controls.Frame 
 ...
 def GoForward(self):
  """
  GoForward(self: Frame)

   Navigates to the most recent item in forward navigation history,if a 

    System.Windows.Controls.Frame manages its own navigation history.
  """
  pass
 ...
 def Navigate(self,*__args):
  """
  Navigate(self: Frame,content: object) -> bool
   ...
   Returns: true if navigation is not canceled; otherwise,false.

  Navigate(self: Frame,content: object,extraData: object) -> bool

  

   Navigates asynchronously to content that is contained by an object,and passes an object that 
  ...
  Navigate(self: Frame,source: Uri) -> bool
  ...
  Navigate(self: Frame,source: Uri,extraData: object) -> bool

  

   Navigates asynchronously to source content located at a uniform resource identifier (URI),and 

    passes an object that contains data to be used for processing during navigation.
 ...
 def OnContentChanged(self,*args):
  ...
  """
  pass
 def OnContentRendered(self,*args):
  """
  OnContentRendered(self: Frame,args: EventArgs)

   Raises the System.Windows.Controls.Frame.ContentRendered event.
 ...
 def OnCreateAutomationPeer(self,*args):
  """
  OnCreateAutomationPeer(self: Frame) -> AutomationPeer

  

   Creates and returns a System.Windows.Automation.Peers.NavigationWindowAutomationPeer object for 

    this System.Windows.Controls.Frame.

  

   Returns: A System.Windows.Automation.Peers.NavigationWindowAutomationPeer object for this 
 ...
 def RemoveBackEntry(self):
  """
  RemoveBackEntry(self: Frame) -> JournalEntry

  

   Removes the most recent journal entry from back history.

   Returns: The most recent System.Windows.Navigation.JournalEntry in back navigation history,if there is 
 ...
 def ShouldSerializeContent(self):
  """
  ShouldSerializeContent(self: Frame) -> bool

  

   Allows derived classes to determine the serialization behavior of the 

    System.Windows.Controls.ContentControl.Content property.

  

   Returns: true if the content should be serialized; otherwise,false.
  """
  pass
 ...
 def __str__(self,*args):
  pass
 BackStack=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Returns an System.Collections.IEnumerable that you use to enumerate the entries in back navigation history for a System.Windows.Controls.Frame.



Get: BackStack(self: Frame) -> IEnumerable
...
"""
 ...
 """Gets or sets the base uniform resource identifier (URI) for a System.Windows.Controls.Frame.
...
Get: CanGoForward(self: Frame) -> bool
...
Get: CurrentSource(self: Frame) -> Uri
...
"""
 ...
 ForwardStack=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets an System.Collections.IEnumerable that you use to enumerate the entries in forward navigation history for a System.Windows.Controls.Frame.



Get: ForwardStack(self: Frame) -> IEnumerable
...
"""
 ...
 JournalOwnership=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets whether a System.Windows.Controls.Frame is responsible for managing its own navigation history,or yields navigation history management to a parent navigator (System.Windows.Navigation.NavigationWindow,System.Windows.Controls.Frame).



Get: JournalOwnership(self: Frame) -> JournalOwnership



Set: JournalOwnership(self: Frame)=value
...
"""
 ...
 NavigationService=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets the System.Windows.Navigation.NavigationService that is used by this System.Windows.Controls.Frame to provide navigation services.



Get: NavigationService(self: Frame) -> NavigationService



"""

 NavigationUIVisibility=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets when the System.Windows.Controls.Frame can show its navigation UI.



Get: NavigationUIVisibility(self: Frame) -> NavigationUIVisibility



Set: NavigationUIVisibility(self: Frame)=value

"""

 SandboxExternalContent=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets whether a System.Windows.Controls.Frame isolates external Extensible Application Markup Language (XAML) content within a partial trust security sandbox (with the default Internet permission set).



Get: SandboxExternalContent(self: Frame) -> bool



Set: SandboxExternalContent(self: Frame)=value
...
Get: Source(self: Frame) -> Uri



Set: Source(self: Frame)=value
...
"""
 ...
 NavigationUIVisibilityProperty=None
