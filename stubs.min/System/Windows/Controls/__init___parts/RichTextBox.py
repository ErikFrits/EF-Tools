class RichTextBox(TextBoxBase,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient,IAddChild):
 """
 ...
 def GetLayoutClip(self,*args):
  ...
  """
  pass
 def GetNextSpellingErrorPosition(self,position,direction):
  """
  GetNextSpellingErrorPosition(self: RichTextBox,position: TextPointer,direction: LogicalDirection) -> TextPointer

  

   Returns a System.Windows.Documents.TextPointer that points to the next spelling error in the 

    contents of the System.Windows.Controls.RichTextBox.

  

  

   position: A System.Windows.Documents.TextPointer indicating a position from which to search for the next 

    spelling error.

  

   direction: A System.Windows.Documents.LogicalDirection in which to search for the next spelling error,

    starting at the specified posision.

  

   Returns: A System.Windows.Documents.TextPointer that points to the next spelling error in the contents of 

    the System.Windows.Controls.RichTextBox,or null if no next spelling error exists.
  """
  pass
 def GetPositionFromPoint(self,point,snapToText):
  """
  GetPositionFromPoint(self: RichTextBox,point: Point,snapToText: bool) -> TextPointer

  

   Returns a System.Windows.Documents.TextPointer that points to the insertion point closest to the 
   ...
   point: A System.Windows.Point object specifying the position to retrieve a 

    System.Windows.Documents.TextPointer for.

  

   snapToText: If true,this method always returns a System.Windows.Documents.TextPointer specifying the 

    closest insertion position for the System.Windows.Point specified,regardless or whether or not 

    the supplied System.Windows.Point is inside a character's bounding box.If false,this method 

    returns null if the specified System.Windows.Point does not fall within any character bounding 

    box.

  

   Returns: A System.Windows.Documents.TextPointer specifying the closest insertion position for the 

    supplied point,or null if snapToText is false and the supplied System.Windows.Point is not 

    within any character's bounding box. Note that the System.Windows.Documents.TextPointer returned 

    is usually the position between two characters. Use the 

    System.Windows.Documents.TextPointer.LogicalDirection property of the returned 

    System.Windows.Documents.TextPointer to determine which of the two characters the 

    System.Windows.Documents.TextPointer corresponds to.
  """
  pass
 def GetSpellingError(self,position):
  """
  GetSpellingError(self: RichTextBox,position: TextPointer) -> SpellingError

  

   Returns a System.Windows.Controls.SpellingError object associated with any spelling error at a 

    specified position in the contents of the System.Windows.Controls.RichTextBox.

  

  

   position: A System.Windows.Documents.TextPointer that specifies a position and logical direction that 

    resolves to a character to examine for a spelling error. Use the 

    System.Windows.Documents.TextPointer.LogicalDirection property of this 

    System.Windows.Documents.TextPointer to specify the direction of the character to examine.

  

   Returns: A System.Windows.Controls.SpellingError object containing the details of the spelling error 

    found at the character indicated by position,or null if no spelling error exists at the 

    specified character.
  """
  pass
 def GetSpellingErrorRange(self,position):
  """
  GetSpellingErrorRange(self: RichTextBox,position: TextPointer) -> TextRange

  

   Returns a System.Windows.Documents.TextRange object covering any misspelled word at a specified 

    position in the contents of the System.Windows.Controls.RichTextBox.
   ...
   Returns: A System.Windows.Documents.TextRange object covering any misspelled word that includes the 

    character specified by position,or null if no spelling error exists at the specified character.
  """
  pass
 ...
 def MeasureOverride(self,*args):
  """
  MeasureOverride(self: RichTextBox,constraint: Size) -> Size

  

   Called to re-measure the System.Windows.Controls.RichTextBox.

  

   constraint: A System.Windows.Size structure specifying constraints on the size of the 

    System.Windows.Controls.RichTextBox.

  

   Returns: A System.Windows.Size structure indicating the new size of the 
 ...
 def OnCreateAutomationPeer(self,*args):
  """
  OnCreateAutomationPeer(self: RichTextBox) -> AutomationPeer
 ...
 def OnDpiChanged(self,*args):
  """ OnDpiChanged(self: RichTextBox,oldDpiScaleInfo: DpiScale,newDpiScaleInfo: DpiScale) """
  pass
 ...
 def RemoveVisualChild(self,*args):
  ...
  """
  pass
 def ShouldSerializeDocument(self):
  """
  ShouldSerializeDocument(self: RichTextBox) -> bool

  

   Returns a value that indicates whether or not the effective value of the 

    System.Windows.Controls.RichTextBox.Document property should be serialized during serialization 

    of a System.Windows.Controls.RichTextBox object.

  

   Returns: true if the System.Windows.Controls.RichTextBox.Document property should be serialized; 
 ...
 def __init__(self,*args):
  ...
  pass
 @staticmethod
 def __new__(self,document=None):
  """
  __new__(cls: type)

  __new__(cls: type,document: FlowDocument)
  """
  pass
 def __str__(self,*args):
  pass
 CaretPosition=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets the position of the input caret.



Get: CaretPosition(self: RichTextBox) -> TextPointer



Set: CaretPosition(self: RichTextBox)=value
...
"""
 ...
 """Gets or sets the System.Windows.Documents.FlowDocument that represents the contents of the System.Windows.Controls.RichTextBox.



Get: Document(self: RichTextBox) -> FlowDocument



Set: Document(self: RichTextBox)=value
...
"""
 ...
 IsDocumentEnabled=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets a value that indicates whether the user can interact with System.Windows.UIElement and System.Windows.ContentElement objects within the System.Windows.Controls.RichTextBox.



Get: IsDocumentEnabled(self: RichTextBox) -> bool



Set: IsDocumentEnabled(self: RichTextBox)=value
...
"""
 ...
 """Gets a System.Windows.Documents.TextSelection object containing the current selection in the System.Windows.Controls.RichTextBox.



Get: Selection(self: RichTextBox) -> TextSelection
...
"""
 ...
 IsDocumentEnabledProperty=None
