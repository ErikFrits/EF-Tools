class Separator(Control,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient):
 """
 ...
 def OnCreateAutomationPeer(self,*args):
  """
  OnCreateAutomationPeer(self: Separator) -> AutomationPeer

  

   Provides an appropriate System.Windows.Automation.Peers.SeparatorAutomationPeer implementation 
