class FlowDocumentReader(Control,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient,IAddChild,IJournalState):
 ...
 def CanGoToPage(self,pageNumber):
  ...
  CanGoToPage(self: FlowDocumentReader,pageNumber: int) -> bool
   ...
   Returns a value that indicates whether or the System.Windows.Controls.FlowDocumentReader is able 

    to jump to the specified page number.
   ...
   Returns: true if the System.Windows.Controls.FlowDocumentReader is able to jump to the specified page 
 ...
 def OnInitialized(self,*args):
  ...
  OnInitialized(self: FlowDocumentReader,e: EventArgs)
   ...
   e: An System.EventArgs object containing the arguments associated with the 
 ...
 def OnIsKeyboardFocusWithinChanged(self,*args):
  ...
  OnIsKeyboardFocusWithinChanged(self: FlowDocumentReader,e: DependencyPropertyChangedEventArgs)
   ...
   e: A System.Windows.DependencyPropertyChangedEventArgs object containing the arguments associated 
 ...
 def OnSwitchViewingModeCommand(self,*args):
  ...
  OnSwitchViewingModeCommand(self: FlowDocumentReader,viewingMode: FlowDocumentReaderViewingMode)
   ...
   Handles the 
    ...
    System.Windows.Controls.FlowDocumentReader.SwitchViewingMode(System.Windows.Controls.FlowDocument

    ReaderViewingMode) routed command.

  

  

   viewingMode: One of the System.Windows.Controls.FlowDocumentReaderViewingMode values that specifies the 
...
Get: CanDecreaseZoom(self: FlowDocumentReader) -> bool
...
Get: CanGoToNextPage(self: FlowDocumentReader) -> bool
...
Get: CanGoToPreviousPage(self: FlowDocumentReader) -> bool
...
Get: CanIncreaseZoom(self: FlowDocumentReader) -> bool
...
Get: Document(self: FlowDocumentReader) -> FlowDocument



Set: Document(self: FlowDocumentReader)=value
...
Get: IsFindEnabled(self: FlowDocumentReader) -> bool



Set: IsFindEnabled(self: FlowDocumentReader)=value
...
Set: IsInactiveSelectionHighlightEnabled(self: FlowDocumentReader)=value
...
Get: IsPageViewEnabled(self: FlowDocumentReader) -> bool



Set: IsPageViewEnabled(self: FlowDocumentReader)=value
...
Get: IsPrintEnabled(self: FlowDocumentReader) -> bool



Set: IsPrintEnabled(self: FlowDocumentReader)=value
...
Get: IsScrollViewEnabled(self: FlowDocumentReader) -> bool



Set: IsScrollViewEnabled(self: FlowDocumentReader)=value
...
Get: IsTwoPageViewEnabled(self: FlowDocumentReader) -> bool



Set: IsTwoPageViewEnabled(self: FlowDocumentReader)=value
...
Get: MaxZoom(self: FlowDocumentReader) -> float



Set: MaxZoom(self: FlowDocumentReader)=value
...
Get: MinZoom(self: FlowDocumentReader) -> float



Set: MinZoom(self: FlowDocumentReader)=value
...
Get: PageCount(self: FlowDocumentReader) -> int
...
Get: PageNumber(self: FlowDocumentReader) -> int
...
Get: Selection(self: FlowDocumentReader) -> TextSelection
...
Get: SelectionBrush(self: FlowDocumentReader) -> Brush



Set: SelectionBrush(self: FlowDocumentReader)=value
...
Get: SelectionOpacity(self: FlowDocumentReader) -> float



Set: SelectionOpacity(self: FlowDocumentReader)=value
...
Get: ViewingMode(self: FlowDocumentReader) -> FlowDocumentReaderViewingMode



Set: ViewingMode(self: FlowDocumentReader)=value
...
Get: Zoom(self: FlowDocumentReader) -> float



Set: Zoom(self: FlowDocumentReader)=value
...
Get: ZoomIncrement(self: FlowDocumentReader) -> float



Set: ZoomIncrement(self: FlowDocumentReader)=value
