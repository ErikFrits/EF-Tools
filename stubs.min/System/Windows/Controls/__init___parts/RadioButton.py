class RadioButton(ToggleButton,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient,IAddChild,ICommandSource):
 """
 Represents a button that can be selected,but not cleared,by a user. The System.Windows.Controls.Primitives.ToggleButton.IsChecked property of a System.Windows.Controls.RadioButton can be set by clicking it,but it can only be cleared programmatically.
 ...
 def OnAccessKey(self,*args):
  """
  OnAccessKey(self: RadioButton,e: AccessKeyEventArgs)

   Called when the System.Windows.Controls.AccessText.AccessKey for a radio button is invoked.
 ...
 def OnChecked(self,*args):
  """
  OnChecked(self: RadioButton,e: RoutedEventArgs)

   Called when the System.Windows.Controls.Primitives.ToggleButton.IsChecked property becomes true.

  

   e: Provides data for System.Windows.RoutedEventArgs.
  """
  pass
 ...
 def OnCreateAutomationPeer(self,*args):
  """
  OnCreateAutomationPeer(self: RadioButton) -> AutomationPeer

  

   Provides an appropriate System.Windows.Automation.Peers.RadioButtonAutomationPeer implementation 
 ...
 def OnGotTouchCapture(self,*args):
  ...
  """
  pass
 def OnIndeterminate(self,*args):
  """
  OnIndeterminate(self: ToggleButton,e: RoutedEventArgs)

   Called when a System.Windows.Controls.Primitives.ToggleButton raises an 

    System.Windows.Controls.Primitives.ToggleButton.Indeterminate event.

  

  

   e: The event data for the System.Windows.Controls.Primitives.ToggleButton.Indeterminate event.
  """
  pass
 ...
 def OnToggle(self,*args):
  """
  OnToggle(self: RadioButton)

   Called by the System.Windows.Controls.Primitives.ToggleButton.OnClick method to implement a 

    System.Windows.Controls.RadioButton control's toggle behavior.
  """
  pass
 ...
 def OnUnchecked(self,*args):
  """
  OnUnchecked(self: ToggleButton,e: RoutedEventArgs)

   Called when a System.Windows.Controls.Primitives.ToggleButton raises an 

    System.Windows.Controls.Primitives.ToggleButton.Unchecked event.

  

  

   e: The event data for the System.Windows.Controls.Primitives.ToggleButton.Unchecked event.
  """
  pass
...
"""
 ...
 """Gets or sets the name that specifies which System.Windows.Controls.RadioButton controls are mutually exclusive.
