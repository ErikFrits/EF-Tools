class AdornedElementPlaceholder(FrameworkElement,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient,IAddChild):
 """
 Represents the element used in a System.Windows.Controls.ControlTemplate to specify where a decorated control is placed relative to other elements in the System.Windows.Controls.ControlTemplate.
 ...
 def ArrangeOverride(self,*args):
  """
  ArrangeOverride(self: AdornedElementPlaceholder,arrangeBounds: Size) -> Size

  

   Positions the first visual child object and returns the size in layout required by this 

    System.Windows.Controls.AdornedElementPlaceholder object.

  

  

   arrangeBounds: The size that this System.Windows.Controls.AdornedElementPlaceholder object should use to 

    arrange its child element.
 ...
 def GetVisualChild(self,*args):
  """
  GetVisualChild(self: AdornedElementPlaceholder,index: int) -> Visual

  

   Retrieves the System.Windows.Media.Visual child object at the specified index.

  

   index: The index that specifies the child object to retrieve.

   Returns: The visual child object at the specified index.
  """
  pass
 ...
 def MeasureOverride(self,*args):
  """
  MeasureOverride(self: AdornedElementPlaceholder,constraint: Size) -> Size

  

   Determines the size of the System.Windows.Controls.AdornedElementPlaceholder object.

  

   constraint: An upper limit value that the return value should not exceed.

   Returns: The desired size of this System.Windows.Controls.AdornedElementPlaceholder object.
  """
  pass
 ...
 def OnInitialized(self,*args):
  """
  OnInitialized(self: AdornedElementPlaceholder,e: EventArgs)

   Raises the System.Windows.FrameworkElement.IsInitialized event. This method is called when 
 ...
 def __init__(self,*args):
  ...
  pass
 AdornedElement=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets the System.Windows.UIElement that this System.Windows.Controls.AdornedElementPlaceholder object is reserving space for.



Get: AdornedElement(self: AdornedElementPlaceholder) -> UIElement
...
"""
 ...
 """Gets or sets the single child object of this System.Windows.Controls.AdornedElementPlaceholder object.



Get: Child(self: AdornedElementPlaceholder) -> UIElement



Set: Child(self: AdornedElementPlaceholder)=value
...
"""
 ...
 """Gets an enumerator for the logical child elements of this System.Windows.Controls.AdornedElementPlaceholder object.
