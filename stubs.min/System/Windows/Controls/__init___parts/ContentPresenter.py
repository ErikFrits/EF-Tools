class ContentPresenter(FrameworkElement,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient):
 """
 Displays the content of a System.Windows.Controls.ContentControl.
 ...
 def ArrangeOverride(self,*args):
  """
  ArrangeOverride(self: ContentPresenter,arrangeSize: Size) -> Size

  

   Positions the single child element and determines the content of a 

    System.Windows.Controls.ContentPresenter object.

  

  

   arrangeSize: The size that this System.Windows.Controls.ContentPresenter object should use to arrange its 

    child element.

  

   Returns: The actual size needed by the element.
  """
  pass
 ...
 def MeasureOverride(self,*args):
  """
  MeasureOverride(self: ContentPresenter,constraint: Size) -> Size

  

   Determines the size of the System.Windows.Controls.ContentPresenter object based on the sizing 

    properties,margin,and requested size of the child content.

  

  

   constraint: An upper limit value that the return value should not exceed.

   Returns: The size that is required to arrange child content.
  """
  pass
 ...
 def RemoveVisualChild(self,*args):
  ...
  """
  pass
 def ShouldSerializeContentTemplateSelector(self):
  """
  ShouldSerializeContentTemplateSelector(self: ContentPresenter) -> bool

  

   Returns a value that indicates whether serialization processes should serialize the effective 

    value of the System.Windows.Controls.ContentPresenter.ContentTemplateSelector property on 

    instances of this class.

  

   Returns: true if the System.Windows.Controls.ContentPresenter.ContentTemplateSelector property value 
...
Get: Content(self: ContentPresenter) -> object



Set: Content(self: ContentPresenter)=value

"""

 ContentSource=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets the base name to use during automatic aliasing.



Get: ContentSource(self: ContentPresenter) -> str



Set: ContentSource(self: ContentPresenter)=value

"""

 ContentStringFormat=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets a composite string that specifies how to format the System.Windows.Controls.ContentPresenter.Content property if it is displayed as a string.



Get: ContentStringFormat(self: ContentPresenter) -> str



Set: ContentStringFormat(self: ContentPresenter)=value

"""

 ContentTemplate=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets the template used to display the content of the control.



Get: ContentTemplate(self: ContentPresenter) -> DataTemplate



Set: ContentTemplate(self: ContentPresenter)=value

"""

 ContentTemplateSelector=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets the System.Windows.Controls.DataTemplateSelector,which allows the application writer to provide custom logic for choosing the template that is used to display the content of the control.



Get: ContentTemplateSelector(self: ContentPresenter) -> DataTemplateSelector



Set: ContentTemplateSelector(self: ContentPresenter)=value
...
"""
 ...
 RecognizesAccessKey=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets a value that indicates whether the System.Windows.Controls.ContentPresenter should use System.Windows.Controls.AccessText in its style.



Get: RecognizesAccessKey(self: ContentPresenter) -> bool



Set: RecognizesAccessKey(self: ContentPresenter)=value
...
"""
 ...
 ContentSourceProperty=None
 ContentStringFormatProperty=None
 ContentTemplateProperty=None
 ContentTemplateSelectorProperty=None
 RecognizesAccessKeyProperty=None
