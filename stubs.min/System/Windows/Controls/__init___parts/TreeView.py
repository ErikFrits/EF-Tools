class TreeView(ItemsControl,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient,IAddChild,IGeneratorHost,IContainItemStorage):
 """
 ...
 def ClearContainerForItemOverride(self,*args):
  ...
  """
  pass
 def ExpandSubtree(self,*args):
  """
  ExpandSubtree(self: TreeView,container: TreeViewItem) -> bool

  

   Expands the specified System.Windows.Controls.TreeViewItem control and all its child 
   ...
   container: The System.Windows.Controls.TreeViewItem to expand.

   Returns: true if the specified System.Windows.Controls.TreeViewItem and all its child elements were 
 ...
 def GetContainerForItemOverride(self,*args):
  """
  GetContainerForItemOverride(self: TreeView) -> DependencyObject

  

   Creates a System.Windows.Controls.TreeViewItem to use to display content.

   Returns: A new System.Windows.Controls.TreeViewItem to use as a container for content.
  """
  pass
 ...
 def IsItemItsOwnContainerOverride(self,*args):
  """
  IsItemItsOwnContainerOverride(self: TreeView,item: object) -> bool
 ...
 def OnCreateAutomationPeer(self,*args):
  """
  OnCreateAutomationPeer(self: TreeView) -> AutomationPeer
   ...
   Returns: A System.Windows.Automation.Peers.TreeViewAutomationPeer for the 
 ...
 def OnGotFocus(self,*args):
  """
  OnGotFocus(self: TreeView,e: RoutedEventArgs)
 ...
 def OnIsKeyboardFocusWithinChanged(self,*args):
  """
  OnIsKeyboardFocusWithinChanged(self: TreeView,e: DependencyPropertyChangedEventArgs)

   Provides class handling for an System.Windows.ContentElement.IsKeyboardFocusWithinChanged event 

    when the keyboard focus changes for a System.Windows.Controls.TreeView.
 ...
 def OnItemsChanged(self,*args):
  """
  OnItemsChanged(self: TreeView,e: NotifyCollectionChangedEventArgs)

   Provides class handling for an System.Windows.Controls.ItemContainerGenerator.ItemsChanged event 

    that occurs when there is a change in the System.Windows.Controls.ItemsControl.Items collection.
 ...
 def OnSelectedItemChanged(self,*args):
  """ OnSelectedItemChanged(self: TreeView,e: RoutedPropertyChangedEventArgs[object]) """
  pass
...
Get: SelectedItem(self: TreeView) -> object
...
"""
 ...
 """Gets the value of the property that is the specified by System.Windows.Controls.TreeView.SelectedValuePath for the System.Windows.Controls.TreeView.SelectedItem.



Get: SelectedValue(self: TreeView) -> object
...
"""
 ...
 """Gets or sets the path that is used to get the System.Windows.Controls.TreeView.SelectedValue of the System.Windows.Controls.TreeView.SelectedItem in a System.Windows.Controls.TreeView.



Get: SelectedValuePath(self: TreeView) -> str



Set: SelectedValuePath(self: TreeView)=value
