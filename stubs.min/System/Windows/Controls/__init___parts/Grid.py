class Grid(Panel,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient,IAddChild):
 """
 ...
 def ArrangeOverride(self,*args):
  """
  ArrangeOverride(self: Grid,arrangeSize: Size) -> Size
   ...
   arrangeSize: Specifies the size this System.Windows.Controls.Grid element should use to arrange its child 

    elements.

  

   Returns: System.Windows.Size that represents the arranged size of this Grid element and its children.
  """
  pass
 def CreateUIElementCollection(self,*args):
  ...
  pass
 @staticmethod
 def GetColumn(element):
  """
  GetColumn(element: UIElement) -> int

  

   Gets the value of the System.Windows.Controls.Grid.Column�attached property from a given 
   ...
   Returns: The value of the System.Windows.Controls.Grid.Column�attached property.
  """
  pass
 @staticmethod
 def GetColumnSpan(element):
  """
  GetColumnSpan(element: UIElement) -> int

  

   Gets the value of the System.Windows.Controls.Grid.ColumnSpan�attached property from a given 
   ...
   Returns: The value of the System.Windows.Controls.Grid.ColumnSpan�attached property.
  """
  pass
 @staticmethod
 def GetIsSharedSizeScope(element):
  """
  GetIsSharedSizeScope(element: UIElement) -> bool

  

   Gets the value of the System.Windows.Controls.Grid.IsSharedSizeScope�attached property from a 
   ...
   Returns: The value of the System.Windows.Controls.Grid.IsSharedSizeScope�attached property.
  """
  pass
 ...
 def GetRow(element):
  """
  GetRow(element: UIElement) -> int

  

   Gets the value of the System.Windows.Controls.Grid.Row�attached property from a given 
   ...
   Returns: The value of the System.Windows.Controls.Grid.Row�attached property.
  """
  pass
 @staticmethod
 def GetRowSpan(element):
  """
  GetRowSpan(element: UIElement) -> int

  

   Gets the value of the System.Windows.Controls.Grid.RowSpan�attached property from a given 
   ...
   Returns: The value of the System.Windows.Controls.Grid.RowSpan�attached property.
  """
  pass
 ...
 def GetVisualChild(self,*args):
  """
  GetVisualChild(self: Grid,index: int) -> Visual

  

   Gets the child System.Windows.Media.Visual at the specified index position.

  

   index: The zero-based index position of the desired System.Windows.Media.Visual.

   Returns: The child System.Windows.Media.Visual at the specified index position.
  """
  pass
 ...
 def MeasureOverride(self,*args):
  """
  MeasureOverride(self: Grid,constraint: Size) -> Size

  

   Measures the children of a System.Windows.Controls.Grid in anticipation of arranging them during 

    the System.Windows.Controls.Grid.ArrangeOverride(System.Windows.Size) pass.

  

  

   constraint: Indicates an upper limit size that should not be exceeded.

   Returns: System.Windows.Size that represents the required size to arrange child content.
  """
  pass
 ...
 def OnVisualChildrenChanged(self,*args):
  """
  OnVisualChildrenChanged(self: Grid,visualAdded: DependencyObject,visualRemoved: DependencyObject)

   Called when the visual children of a System.Windows.Controls.Grid element change.

  

   visualAdded: Identifies the visual child that's added.

   visualRemoved: Identifies the visual child that's removed.
  """
  pass
 ...
 def RemoveVisualChild(self,*args):
  ...
  pass
 @staticmethod
 def SetColumn(element,value):
  """
  SetColumn(element: UIElement,value: int)

   Sets the value of the System.Windows.Controls.Grid.Column�attached property to a given 
   ...
   element: The element on which to set the System.Windows.Controls.Grid.Column�attached property.

   value: The property value to set.
  """
  pass
 @staticmethod
 def SetColumnSpan(element,value):
  """
  SetColumnSpan(element: UIElement,value: int)

   Sets the value of the System.Windows.Controls.Grid.ColumnSpan�attached property to a given 
   ...
   element: The element on which to set the System.Windows.Controls.Grid.ColumnSpan�attached property.

   value: The property value to set.
  """
  pass
 @staticmethod
 def SetIsSharedSizeScope(element,value):
  """
  SetIsSharedSizeScope(element: UIElement,value: bool)

   Sets the value of the System.Windows.Controls.Grid.IsSharedSizeScope�attached property to a 
   ...
   element: The element on which to set the System.Windows.Controls.Grid.IsSharedSizeScope�attached property.

   value: The property value to set.
  """
  pass
 @staticmethod
 def SetRow(element,value):
  """
  SetRow(element: UIElement,value: int)

   Sets the value of the System.Windows.Controls.Grid.Row�attached property to a given 
  ...
  pass
 @staticmethod
 def SetRowSpan(element,value):
  """
  SetRowSpan(element: UIElement,value: int)

   Sets the value of the System.Windows.Controls.Grid.RowSpan�attached property to a given 
   ...
   element: The element on which to set the System.Windows.Controls.Grid.RowSpan�attached property.

   value: The property value to set.
  """
  pass
 def ShouldSerializeColumnDefinitions(self):
  """
  ShouldSerializeColumnDefinitions(self: Grid) -> bool

  

   Returns true if System.Windows.Controls.ColumnDefinitionCollection associated with this instance 

    of System.Windows.Controls.Grid is not empty.

  

   Returns: true if System.Windows.Controls.ColumnDefinitionCollection associated with this instance of 

    System.Windows.Controls.Grid is not empty; otherwise,false.
  """
  pass
 def ShouldSerializeProperty(self,*args):
  ...
  """
  pass
 def ShouldSerializeRowDefinitions(self):
  """
  ShouldSerializeRowDefinitions(self: Grid) -> bool

  

   Returns true if System.Windows.Controls.RowDefinitionCollection associated with this instance of 

    System.Windows.Controls.Grid is not empty.
 ...
 def __init__(self,*args):
  ...
  pass
 ColumnDefinitions=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets a System.Windows.Controls.ColumnDefinitionCollection defined on this instance of System.Windows.Controls.Grid.



Get: ColumnDefinitions(self: Grid) -> ColumnDefinitionCollection
...
"""
 ...
 """Gets an enumerator that can iterate the logical children of this System.Windows.Controls.Grid.
...
"""
 ...
 RowDefinitions=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets a System.Windows.Controls.RowDefinitionCollection defined on this instance of System.Windows.Controls.Grid.



Get: RowDefinitions(self: Grid) -> RowDefinitionCollection
...
"""
 ...
 """Gets or sets a value that indicates whether grid lines are visible within this System.Windows.Controls.Grid.



Get: ShowGridLines(self: Grid) -> bool



Set: ShowGridLines(self: Grid)=value
...
"""
 ...
 """Gets a value that represents the total number of System.Windows.Media.Visual children within this instance of System.Windows.Controls.Grid.
...
"""
 ...
 IsSharedSizeScopeProperty=None
 RowProperty=None
 RowSpanProperty=None
 ShowGridLinesProperty=None
