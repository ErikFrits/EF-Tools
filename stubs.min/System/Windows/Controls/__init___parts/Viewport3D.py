class Viewport3D(FrameworkElement,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient,IAddChild):
 """
 Renders the contained 3-D content within the 2-D layout bounds of the System.Windows.Controls.Viewport3D element.
 ...
 def ArrangeOverride(self,*args):
  """
  ArrangeOverride(self: Viewport3D,finalSize: Size) -> Size

  

   Causes the System.Windows.Controls.Viewport3D to arrange its visual content to fit a specified 
   ...
   finalSize: Size that System.Windows.Controls.Viewport3D will assume.

   Returns: The final size of the arranged System.Windows.Controls.Viewport3D.
  """
  pass
 ...
 def GetVisualChild(self,*args):
  """
  GetVisualChild(self: Viewport3D,index: int) -> Visual

  

   Gets the System.Windows.Media.Visual at a specified position in the 

    System.Windows.Controls.Viewport3D.Children collection of the 
   ...
   Returns: Visual at the specified position in the System.Windows.Controls.Viewport3D.Children collection.
  """
  pass
 ...
 def OnCreateAutomationPeer(self,*args):
  """
  OnCreateAutomationPeer(self: Viewport3D) -> AutomationPeer

  

   Creates and returns a System.Windows.Automation.Peers.Viewport3DAutomationPeer object for this 

    System.Windows.Controls.Viewport3D.

  

   Returns: System.Windows.Automation.Peers.Viewport3DAutomationPeer object for this 
 ...
 def __init__(self,*args):
  ...
  pass
 Camera=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets a camera object that projects the 3-D contents of the System.Windows.Controls.Viewport3D�to the 2-D surface of the System.Windows.Controls.Viewport3D.



Get: Camera(self: Viewport3D) -> Camera



Set: Camera(self: Viewport3D)=value

"""

 Children=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets a collection of the System.Windows.Media.Media3D.Visual3D children of the System.Windows.Controls.Viewport3D.



Get: Children(self: Viewport3D) -> Visual3DCollection
...
"""
 ...
 """Gets an integer that represents the number of System.Windows.Media.Visual objects in the System.Windows.Media.Media3D.ModelVisual3D.Children collection of the System.Windows.Media.Media3D.Visual3D.
