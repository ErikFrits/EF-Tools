class Decorator(FrameworkElement,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient,IAddChild):
 """
 Provides a base class for elements that apply effects onto or around a single child element,such as System.Windows.Controls.Border or System.Windows.Controls.Viewbox.
 ...
 def ArrangeOverride(self,*args):
  """
  ArrangeOverride(self: Decorator,arrangeSize: Size) -> Size
   ...
   arrangeSize: The System.Windows.Size this element uses to arrange its child content.

   Returns: The System.Windows.Size that represents the arranged size of this 

    System.Windows.Controls.Decorator element and its child.
  """
  pass
 ...
 def MeasureOverride(self,*args):
  """
  MeasureOverride(self: Decorator,constraint: Size) -> Size

  

   Measures the child element of a System.Windows.Controls.Decorator to prepare for arranging it 

    during the System.Windows.Controls.Decorator.ArrangeOverride(System.Windows.Size) pass.
   ...
   Returns: The target System.Windows.Size of the element.
  """
  pass
 ...
 """Gets or sets the single child element of a System.Windows.Controls.Decorator.



Get: Child(self: Decorator) -> UIElement



Set: Child(self: Decorator)=value
