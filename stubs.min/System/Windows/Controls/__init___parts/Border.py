class Border(Decorator,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient,IAddChild):
 """
 ...
 def ArrangeOverride(self,*args):
  """
  ArrangeOverride(self: Border,finalSize: Size) -> Size
   ...
   finalSize: The System.Windows.Size this element uses to arrange its child element.

   Returns: The System.Windows.Size that represents the arranged size of this System.Windows.Controls.Border 
 ...
 def GetVisualChild(self,*args):
  """
  GetVisualChild(self: Decorator,index: int) -> Visual

  

   Gets the child System.Windows.Media.Visual element at the specified index position.

  

   index: Index position of the child element.

   Returns: The child element at the specified index position.
  """
  pass
 ...
 def MeasureOverride(self,*args):
  """
  MeasureOverride(self: Border,constraint: Size) -> Size

  

   Measures the child elements of a System.Windows.Controls.Border before they are arranged during 

    the System.Windows.Controls.Border.ArrangeOverride(System.Windows.Size) pass.

  

  

   constraint: An upper System.Windows.Size limit that cannot be exceeded.

   Returns: The System.Windows.Size that represents the upper size limit of the element.
  """
  pass
 ...
 def OnRender(self,*args):
  """
  OnRender(self: Border,dc: DrawingContext)

   Draws the contents of a System.Windows.Media.DrawingContext object during the render pass of a 
   ...
   dc: The System.Windows.Media.DrawingContext that defines the object to be drawn.
  """
  pass
 ...
 """Gets or sets the System.Windows.Media.Brush that fills the area between the bounds of a System.Windows.Controls.Border.



Get: Background(self: Border) -> Brush



Set: Background(self: Border)=value
...
Get: BorderBrush(self: Border) -> Brush



Set: BorderBrush(self: Border)=value
...
Get: BorderThickness(self: Border) -> Thickness



Set: BorderThickness(self: Border)=value

"""

 CornerRadius=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets a value that represents the degree to which the corners of a System.Windows.Controls.Border are rounded.



Get: CornerRadius(self: Border) -> CornerRadius



Set: CornerRadius(self: Border)=value
...
"""
 ...
 """Gets or sets a System.Windows.Thickness value that describes the amount of space between a System.Windows.Controls.Border and its child element.



Get: Padding(self: Border) -> Thickness



Set: Padding(self: Border)=value
...
"""
 ...
 """Gets a value that is equal to the number of visual child elements of this instance of System.Windows.Controls.Decorator.
