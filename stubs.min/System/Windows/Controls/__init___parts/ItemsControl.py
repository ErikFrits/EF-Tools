class ItemsControl(Control,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient,IAddChild,IGeneratorHost,IContainItemStorage):
 """
 ...
 def BeginInit(self):
  """
  BeginInit(self: ItemsControl)

   Indicates that the initialization of the System.Windows.Controls.ItemsControl object is about to 
 ...
 def ClearContainerForItemOverride(self,*args):
  ...
  pass
 @staticmethod
 def ContainerFromElement(*__args):
  """
  ContainerFromElement(self: ItemsControl,element: DependencyObject) -> DependencyObject

  

   Returns the container that belongs to the current System.Windows.Controls.ItemsControl that owns 
   ...
   element: The element to return the container for.

   Returns: The container that belongs to the current System.Windows.Controls.ItemsControl that owns the 

    given element or null if no such container exists.

  

  ContainerFromElement(itemsControl: ItemsControl,element: DependencyObject) -> DependencyObject

  

   Returns the container that belongs to the specified System.Windows.Controls.ItemsControl that 
   ...
   itemsControl: The System.Windows.Controls.ItemsControl to return the container for.

   element: The element to return the container for.

   Returns: The container that belongs to the specified System.Windows.Controls.ItemsControl that owns the 

    given element,if itemsControl is not null. If itemsControl is null,returns the closest 

    container that belongs to any System.Windows.Controls.ItemsControl.
  """
  pass
 def EndInit(self):
  """
  EndInit(self: ItemsControl)

   Indicates that the initialization of the System.Windows.Controls.ItemsControl object is complete.
  """
  pass
 @staticmethod
 def GetAlternationIndex(element):
  """
  GetAlternationIndex(element: DependencyObject) -> int
   ...
   element: The object from which to get the System.Windows.Controls.ItemsControl.AlternationIndex.

   Returns: The value of the System.Windows.Controls.ItemsControl.AlternationIndex.
  """
  pass
 def GetContainerForItemOverride(self,*args):
  ...
  pass
 @staticmethod
 def GetItemsOwner(element):
  """
  GetItemsOwner(element: DependencyObject) -> ItemsControl

  

   Returns the System.Windows.Controls.ItemsControl that the specified element hosts items for.

  

   element: The host element.

   Returns: The System.Windows.Controls.ItemsControl that the specified element hosts items for,or null.
  """
  pass
 ...
 def HitTestCore(self,*args):
  ...
  """
  pass
 def IsItemItsOwnContainer(self,item):
  """ IsItemItsOwnContainer(self: ItemsControl,item: object) -> bool """
  pass
 def IsItemItsOwnContainerOverride(self,*args):
  ...
  pass
 @staticmethod
 def ItemsControlFromItemContainer(container):
  """
  ItemsControlFromItemContainer(container: DependencyObject) -> ItemsControl

  

   Returns the System.Windows.Controls.ItemsControl that owns the specified container element.

  

   container: The container element to return the System.Windows.Controls.ItemsControl for.
 ...
 def PrepareContainerForItemOverride(self,*args):
  """
  PrepareContainerForItemOverride(self: ItemsControl,element: DependencyObject,item: object)
 ...
 def ShouldApplyItemContainerStyle(self,*args):
  ...
  """
  pass
 def ShouldSerializeGroupStyle(self):
  """
  ShouldSerializeGroupStyle(self: ItemsControl) -> bool

  

   Returns a value that indicates whether serialization processes should serialize the effective 

    value of the System.Windows.Controls.ItemsControl.GroupStyle property.

  

   Returns: true if the System.Windows.Controls.ItemsControl.GroupStyle property value should be serialized; 

    otherwise,false.
  """
  pass
 def ShouldSerializeItems(self):
  """
  ShouldSerializeItems(self: ItemsControl) -> bool

  

   Returns a value that indicates whether serialization processes should serialize the effective 

    value of the System.Windows.Controls.ItemsControl.Items property.

  

   Returns: true if the System.Windows.Controls.ItemsControl.Items property value should be serialized; 
 ...
 def ToString(self):
  """
  ToString(self: ItemsControl) -> str
 ...
 """Gets or sets the number of alternating item containers in the System.Windows.Controls.ItemsControl,which enables alternating containers to have a unique appearance.



Get: AlternationCount(self: ItemsControl) -> int



Set: AlternationCount(self: ItemsControl)=value
...
Get: DisplayMemberPath(self: ItemsControl) -> str



Set: DisplayMemberPath(self: ItemsControl)=value

"""

 GroupStyle=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets a collection of System.Windows.Controls.GroupStyle objects that define the appearance of each level of groups.



Get: GroupStyle(self: ItemsControl) -> ObservableCollection[GroupStyle]



"""

 GroupStyleSelector=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets a method that enables you to provide custom selection logic for a System.Windows.Controls.GroupStyle to apply to each group in a collection.



Get: GroupStyleSelector(self: ItemsControl) -> GroupStyleSelector



Set: GroupStyleSelector(self: ItemsControl)=value
...
"""
 ...
 """Gets a value that indicates whether the System.Windows.Controls.ItemsControl contains items.



Get: HasItems(self: ItemsControl) -> bool
...
Get: IsGrouping(self: ItemsControl) -> bool



"""

 IsTextSearchCaseSensitive=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets a value that indicates whether case is a condition when searching for items.



Get: IsTextSearchCaseSensitive(self: ItemsControl) -> bool



Set: IsTextSearchCaseSensitive(self: ItemsControl)=value

"""

 IsTextSearchEnabled=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets a value that indicates whether System.Windows.Controls.TextSearch is enabled on the System.Windows.Controls.ItemsControl instance.



Get: IsTextSearchEnabled(self: ItemsControl) -> bool



Set: IsTextSearchEnabled(self: ItemsControl)=value

"""

 ItemBindingGroup=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets the System.Windows.Data.BindingGroup that is copied to each item in the System.Windows.Controls.ItemsControl.



Get: ItemBindingGroup(self: ItemsControl) -> BindingGroup



Set: ItemBindingGroup(self: ItemsControl)=value

"""

 ItemContainerGenerator=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets the System.Windows.Controls.ItemContainerGenerator that is associated with the control.



Get: ItemContainerGenerator(self: ItemsControl) -> ItemContainerGenerator
...
"""
 ...
 """Gets or sets the System.Windows.Style that is applied to the container element generated for each item.



Get: ItemContainerStyle(self: ItemsControl) -> Style



Set: ItemContainerStyle(self: ItemsControl)=value
...
Get: ItemContainerStyleSelector(self: ItemsControl) -> StyleSelector



Set: ItemContainerStyleSelector(self: ItemsControl)=value
...
Get: Items(self: ItemsControl) -> ItemCollection



"""

 ItemsPanel=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets the template that defines the panel that controls the layout of items.



Get: ItemsPanel(self: ItemsControl) -> ItemsPanelTemplate



Set: ItemsPanel(self: ItemsControl)=value
...
Get: ItemsSource(self: ItemsControl) -> IEnumerable



Set: ItemsSource(self: ItemsControl)=value

"""

 ItemStringFormat=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets a composite string that specifies how to format the items in the System.Windows.Controls.ItemsControl if they are displayed as strings.



Get: ItemStringFormat(self: ItemsControl) -> str



Set: ItemStringFormat(self: ItemsControl)=value
...
Get: ItemTemplate(self: ItemsControl) -> DataTemplate



Set: ItemTemplate(self: ItemsControl)=value
...
Get: ItemTemplateSelector(self: ItemsControl) -> DataTemplateSelector



Set: ItemTemplateSelector(self: ItemsControl)=value
...
"""
 ...
 AlternationCountProperty=None
 AlternationIndexProperty=None
 DisplayMemberPathProperty=None
 GroupStyleSelectorProperty=None
 HasItemsProperty=None
 IsGroupingProperty=None
 IsTextSearchCaseSensitiveProperty=None
 IsTextSearchEnabledProperty=None
 ItemBindingGroupProperty=None
 ItemContainerStyleProperty=None
 ItemContainerStyleSelectorProperty=None
 ItemsPanelProperty=None
 ItemsSourceProperty=None
 ItemStringFormatProperty=None
 ItemTemplateProperty=None
 ItemTemplateSelectorProperty=None
