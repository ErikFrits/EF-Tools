class DatePicker(Control,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient):
 """
 ...
 def OnApplyTemplate(self):
  """
  OnApplyTemplate(self: DatePicker)

   Builds the visual tree for the System.Windows.Controls.DatePicker control when a new template is 

    applied.
  """
  pass
 def OnCalendarClosed(self,*args):
  """
  OnCalendarClosed(self: DatePicker,e: RoutedEventArgs)

   Raises the System.Windows.Controls.DatePicker.CalendarClosed routed event.
  ...
  """
  pass
 def OnCalendarOpened(self,*args):
  """
  OnCalendarOpened(self: DatePicker,e: RoutedEventArgs)

   Raises the System.Windows.Controls.DatePicker.CalendarOpened routed event.
 ...
 def OnCreateAutomationPeer(self,*args):
  """
  OnCreateAutomationPeer(self: DatePicker) -> AutomationPeer

  

   Returns a System.Windows.Automation.Peers.DatePickerAutomationPeer for use by the automation 

    infrastructure.

  

   Returns: A System.Windows.Automation.Peers.DatePickerAutomationPeer for the 

    System.Windows.Controls.DatePicker object.
  """
  pass
 def OnDateValidationError(self,*args):
  """
  OnDateValidationError(self: DatePicker,e: DatePickerDateValidationErrorEventArgs)

   Raises the System.Windows.Controls.DatePicker.DateValidationError event.

  

   e: A System.Windows.Controls.DatePickerDateValidationErrorEventArgs that contains the event data.
  """
  pass
 ...
 def OnRenderSizeChanged(self,*args):
  ...
  """
  pass
 def OnSelectedDateChanged(self,*args):
  """
  OnSelectedDateChanged(self: DatePicker,e: SelectionChangedEventArgs)

   Raises the System.Windows.Controls.DatePicker.SelectedDateChanged routed event.
 ...
 def ToString(self):
  ...
  ToString(self: DatePicker) -> str
   ...
   Returns: A text representation of the selected date,or an empty string if 
    ...
    System.Windows.Controls.DatePicker.SelectedDate is null.
  """
  pass
...
Get: BlackoutDates(self: DatePicker) -> CalendarBlackoutDatesCollection



"""

 CalendarStyle=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets the style that is used when rendering the calendar.



Get: CalendarStyle(self: DatePicker) -> Style



Set: CalendarStyle(self: DatePicker)=value
...
Get: DisplayDate(self: DatePicker) -> DateTime



Set: DisplayDate(self: DatePicker)=value
...
Get: DisplayDateEnd(self: DatePicker) -> Nullable[DateTime]



Set: DisplayDateEnd(self: DatePicker)=value
...
Get: DisplayDateStart(self: DatePicker) -> Nullable[DateTime]



Set: DisplayDateStart(self: DatePicker)=value
...
Get: FirstDayOfWeek(self: DatePicker) -> DayOfWeek



Set: FirstDayOfWeek(self: DatePicker)=value
...
"""
 ...
 IsDropDownOpen=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets a value that indicates whether the drop-down System.Windows.Controls.Calendar is open or closed.



Get: IsDropDownOpen(self: DatePicker) -> bool



Set: IsDropDownOpen(self: DatePicker)=value
...
Get: IsTodayHighlighted(self: DatePicker) -> bool



Set: IsTodayHighlighted(self: DatePicker)=value
...
Get: SelectedDate(self: DatePicker) -> Nullable[DateTime]



Set: SelectedDate(self: DatePicker)=value

"""

 SelectedDateFormat=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets the format that is used to display the selected date.



Get: SelectedDateFormat(self: DatePicker) -> DatePickerFormat



Set: SelectedDateFormat(self: DatePicker)=value
...
"""
 ...
 """Gets the text that is displayed by the System.Windows.Controls.DatePicker,or sets the selected date.



Get: Text(self: DatePicker) -> str



Set: Text(self: DatePicker)=value
...
"""
 ...
 IsDropDownOpenProperty=None
 IsTodayHighlightedProperty=None
 SelectedDateChanged=None
 SelectedDateChangedEvent=None
 SelectedDateFormatProperty=None
