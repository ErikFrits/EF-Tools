class Label(ContentControl,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient,IAddChild):
 """
 ...
 def OnCreateAutomationPeer(self,*args):
  """
  OnCreateAutomationPeer(self: Label) -> AutomationPeer

  

   Provides an appropriate System.Windows.Automation.Peers.LabelAutomationPeer implementation for 
...
Get: Target(self: Label) -> UIElement



Set: Target(self: Label)=value
