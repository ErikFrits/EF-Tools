class StickyNoteControl(Control,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient,IAnnotationComponent):
 ...
 def OnApplyTemplate(self):
  """
  OnApplyTemplate(self: StickyNoteControl)
 ...
 def OnGotKeyboardFocus(self,*args):
  """ OnGotKeyboardFocus(self: StickyNoteControl,args: KeyboardFocusChangedEventArgs) """
  pass
 ...
 def OnIsKeyboardFocusWithinChanged(self,*args):
  """ OnIsKeyboardFocusWithinChanged(self: StickyNoteControl,args: DependencyPropertyChangedEventArgs) """
  pass
 ...
 def OnTemplateChanged(self,*args):
  """ OnTemplateChanged(self: StickyNoteControl,oldTemplate: ControlTemplate,newTemplate: ControlTemplate) """
  pass
 ...
 def __str__(self,*args):
  pass
 AnchorInfo=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets an object that provides information about the annotated object.



Get: AnchorInfo(self: StickyNoteControl) -> IAnchorInfo
...
Get: Author(self: StickyNoteControl) -> str



"""

 CaptionFontFamily=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets the font family of the caption for the System.Windows.Controls.StickyNoteControl.



Get: CaptionFontFamily(self: StickyNoteControl) -> FontFamily



Set: CaptionFontFamily(self: StickyNoteControl)=value

"""

 CaptionFontSize=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets the size of the font used for the caption of the System.Windows.Controls.StickyNoteControl.



Get: CaptionFontSize(self: StickyNoteControl) -> float



Set: CaptionFontSize(self: StickyNoteControl)=value

"""

 CaptionFontStretch=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets the degree to which the font used for the caption of the System.Windows.Controls.StickyNoteControl is stretched.



Get: CaptionFontStretch(self: StickyNoteControl) -> FontStretch



Set: CaptionFontStretch(self: StickyNoteControl)=value

"""

 CaptionFontStyle=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets the style of the font used for the caption of the System.Windows.Controls.StickyNoteControl.



Get: CaptionFontStyle(self: StickyNoteControl) -> FontStyle



Set: CaptionFontStyle(self: StickyNoteControl)=value

"""

 CaptionFontWeight=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets the weight of the font used for the caption of the System.Windows.Controls.StickyNoteControl.



Get: CaptionFontWeight(self: StickyNoteControl) -> FontWeight



Set: CaptionFontWeight(self: StickyNoteControl)=value
...
"""
 ...
 """Gets a value indicating whether the System.Windows.Controls.StickyNoteControl is active.



Get: IsActive(self: StickyNoteControl) -> bool
...
"""
 ...
 """Gets or sets a value indicating whether the System.Windows.Controls.StickyNoteControl is expanded.



Get: IsExpanded(self: StickyNoteControl) -> bool



Set: IsExpanded(self: StickyNoteControl)=value

"""

 IsMouseOverAnchor=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets a value indicating whether the mouse cursor is over the anchor of the System.Windows.Controls.StickyNoteControl.



Get: IsMouseOverAnchor(self: StickyNoteControl) -> bool
...
"""
 ...
 PenWidth=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets the width of the pen for an ink System.Windows.Controls.StickyNoteControl.



Get: PenWidth(self: StickyNoteControl) -> float



Set: PenWidth(self: StickyNoteControl)=value

"""

 StickyNoteType=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets a value that indicates whether the sticky note is text or ink.



Get: StickyNoteType(self: StickyNoteControl) -> StickyNoteType
...
"""
 ...
 AuthorProperty=None
 CaptionFontFamilyProperty=None
 CaptionFontSizeProperty=None
 CaptionFontStretchProperty=None
 CaptionFontStyleProperty=None
 CaptionFontWeightProperty=None
 DeleteNoteCommand=None
 InkCommand=None
 InkSchemaName=None
 IsActiveProperty=None
 IsExpandedProperty=None
 IsMouseOverAnchorProperty=None
 PenWidthProperty=None
 StickyNoteTypeProperty=None
 TextSchemaName=None
