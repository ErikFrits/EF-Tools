class AccessText(FrameworkElement,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient,IAddChild):
 """
 ...
 def ArrangeOverride(self,*args):
  """
  ArrangeOverride(self: AccessText,arrangeSize: Size) -> Size

  

   Arranges and sizes the content of an System.Windows.Controls.AccessText object.
 ...
 def GetVisualChild(self,*args):
  """
  GetVisualChild(self: AccessText,index: int) -> Visual
   ...
   index: The index of the visual child element to return.

   Returns: Returns an integer that represents the index of a visual child element.
  """
  pass
 ...
 def MeasureOverride(self,*args):
  """
  MeasureOverride(self: AccessText,constraint: Size) -> Size
   ...
   constraint: The maximum size limit for the control. The return value cannot exceed this size.

   Returns: The size of the control. Cannot exceed the maximum size limit for the control.
  """
  pass
 ...
 def __init__(self,*args):
  ...
  pass
 AccessKey=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Provides read-only access to the character that follows the first underline character.



Get: AccessKey(self: AccessText) -> Char
...
"""
 ...
 """Gets or sets the System.Windows.Media.Brush that fills the content area.



Get: Background(self: AccessText) -> Brush



Set: Background(self: AccessText)=value

"""

 BaselineOffset=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets a value that adjusts the baseline offset position of text in an System.Windows.Controls.AccessText element.



Get: BaselineOffset(self: AccessText) -> float



Set: BaselineOffset(self: AccessText)=value
...
"""
 ...
 """Gets or sets the font family to use with the System.Windows.Controls.AccessText element.



Get: FontFamily(self: AccessText) -> FontFamily



Set: FontFamily(self: AccessText)=value

"""

 FontSize=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets the font size to use with the System.Windows.Controls.AccessText element.



Get: FontSize(self: AccessText) -> float



Set: FontSize(self: AccessText)=value

"""

 FontStretch=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets a System.Windows.FontStretch property that selects a normal,condensed,or expanded font from a System.Windows.Media.FontFamily.



Get: FontStretch(self: AccessText) -> FontStretch



Set: FontStretch(self: AccessText)=value

"""

 FontStyle=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets the font style to use with the System.Windows.Controls.AccessText element.



Get: FontStyle(self: AccessText) -> FontStyle



Set: FontStyle(self: AccessText)=value

"""

 FontWeight=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets the font weight to use with the System.Windows.Controls.AccessText element.



Get: FontWeight(self: AccessText) -> FontWeight



Set: FontWeight(self: AccessText)=value

"""

 Foreground=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets the System.Windows.Media.Brush that draws the text content of the element.



Get: Foreground(self: AccessText) -> Brush



Set: Foreground(self: AccessText)=value
...
Get: LineHeight(self: AccessText) -> float



Set: LineHeight(self: AccessText)=value

"""

 LineStackingStrategy=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets how the System.Windows.Controls.AccessText.LineHeight property is enforced.



Get: LineStackingStrategy(self: AccessText) -> LineStackingStrategy



Set: LineStackingStrategy(self: AccessText)=value

"""

 LogicalChildren=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets an enumerator that iterates the logical child elements of the System.Windows.Controls.AccessText element.
...
"""
 ...
 """Gets or sets the text that is displayed by the System.Windows.Controls.AccessText element.



Get: Text(self: AccessText) -> str



Set: Text(self: AccessText)=value
...
Get: TextAlignment(self: AccessText) -> TextAlignment



Set: TextAlignment(self: AccessText)=value

"""

 TextDecorations=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets the decorations that are added to the text of an System.Windows.Controls.AccessText element.



Get: TextDecorations(self: AccessText) -> TextDecorationCollection



Set: TextDecorations(self: AccessText)=value

"""

 TextEffects=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets the effects that are added to the text of an System.Windows.Controls.AccessText element.



Get: TextEffects(self: AccessText) -> TextEffectCollection



Set: TextEffects(self: AccessText)=value

"""

 TextTrimming=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets how the textual content of an System.Windows.Controls.AccessText element is clipped if it overflows the line box.



Get: TextTrimming(self: AccessText) -> TextTrimming



Set: TextTrimming(self: AccessText)=value

"""

 TextWrapping=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets whether the textual content of an System.Windows.Controls.AccessText element is wrapped if it overflows the line box.



Get: TextWrapping(self: AccessText) -> TextWrapping



Set: TextWrapping(self: AccessText)=value
