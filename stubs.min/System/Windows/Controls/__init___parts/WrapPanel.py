class WrapPanel(Panel,IResource,IAnimatable,IInputElement,IFrameworkInputElement,ISupportInitialize,IHaveResources,IQueryAmbient,IAddChild):
 """
 ...
 def ArrangeOverride(self,*args):
  """
  ArrangeOverride(self: WrapPanel,finalSize: Size) -> Size
   ...
   finalSize: The System.Windows.Size that this element should use to arrange its child elements.

   Returns: The System.Windows.Size that represents the arranged size of this 

    System.Windows.Controls.WrapPanel element and its children.
  """
  pass
 ...
 def MeasureOverride(self,*args):
  """
  MeasureOverride(self: WrapPanel,constraint: Size) -> Size

  

   Measures the child elements of a System.Windows.Controls.WrapPanel in anticipation of arranging 

    them during the System.Windows.Controls.WrapPanel.ArrangeOverride(System.Windows.Size) pass.
...
"""
 ...
 """Gets or sets a value that specifies the height of all items that are contained within a System.Windows.Controls.WrapPanel.



Get: ItemHeight(self: WrapPanel) -> float



Set: ItemHeight(self: WrapPanel)=value

"""

 ItemWidth=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets a value that specifies the width of all items that are contained within a System.Windows.Controls.WrapPanel.



Get: ItemWidth(self: WrapPanel) -> float



Set: ItemWidth(self: WrapPanel)=value
...
Get: Orientation(self: WrapPanel) -> Orientation



Set: Orientation(self: WrapPanel)=value
...
"""
 ...
 ItemHeightProperty=None
 ItemWidthProperty=None
