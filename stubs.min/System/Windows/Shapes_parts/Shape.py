...
"""
 ...
 DefiningGeometry=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 GeometryTransform=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 RenderedGeometry=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 StrokeDashArray=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 StrokeDashCap=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 StrokeDashOffset=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 StrokeEndLineCap=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 StrokeLineJoin=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 StrokeMiterLimit=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 StrokeStartLineCap=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 StrokeThickness=property(lambda self: object(),lambda self,v: None,lambda self: None)
