class SplineInt16KeyFrame(Int16KeyFrame,ISealable,IKeyFrame):
 """
 Animates from the System.Int16 value of the previous key frame to its own System.Windows.Media.Animation.Int16KeyFrame.Value using splined interpolation.

 

 SplineInt16KeyFrame()

 SplineInt16KeyFrame(value: Int16)

 SplineInt16KeyFrame(value: Int16,keyTime: KeyTime)

 SplineInt16KeyFrame(value: Int16,keyTime: KeyTime,keySpline: KeySpline)
 """
 ...
 def CreateInstanceCore(self,*args):
  """
  CreateInstanceCore(self: SplineInt16KeyFrame) -> Freezable

  

   Creates a new instance of System.Windows.Media.Animation.SplineInt16KeyFrame.

   Returns: A new System.Windows.Media.Animation.SplineInt16KeyFrame.
  """
  pass
 ...
 def InterpolateValueCore(self,*args):
  """
  InterpolateValueCore(self: SplineInt16KeyFrame,baseValue: Int16,keyFrameProgress: float) -> Int16
 ...
 def __new__(self,value=None,keyTime=None,keySpline=None):
  ...
  __new__(cls: type,value: Int16,keyTime: KeyTime,keySpline: KeySpline)
  """
  pass
...
Get: KeySpline(self: SplineInt16KeyFrame) -> KeySpline



Set: KeySpline(self: SplineInt16KeyFrame)=value
