class LinearDoubleKeyFrame(DoubleKeyFrame,ISealable,IKeyFrame):
 """
 Animates from the System.Double value of the previous key frame to its own System.Windows.Media.Animation.DoubleKeyFrame.Value using linear interpolation.

 

 LinearDoubleKeyFrame()

 LinearDoubleKeyFrame(value: float)

 LinearDoubleKeyFrame(value: float,keyTime: KeyTime)
 """
 ...
 def CreateInstanceCore(self,*args):
  """
  CreateInstanceCore(self: LinearDoubleKeyFrame) -> Freezable

  

   Creates a new instance of System.Windows.Media.Animation.LinearDoubleKeyFrame.

   Returns: A new System.Windows.Media.Animation.LinearDoubleKeyFrame.
  """
  pass
 ...
 def InterpolateValueCore(self,*args):
  """
  InterpolateValueCore(self: LinearDoubleKeyFrame,baseValue: float,keyFrameProgress: float) -> float
