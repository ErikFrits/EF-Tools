class EasingRectKeyFrame(RectKeyFrame,ISealable,IKeyFrame):
 """
 A class that enables you to associate easing functions with a System.Windows.Media.Animation.RectAnimationUsingKeyFrames key frame animation.

 

 EasingRectKeyFrame()

 EasingRectKeyFrame(value: Rect)

 EasingRectKeyFrame(value: Rect,keyTime: KeyTime)

 EasingRectKeyFrame(value: Rect,keyTime: KeyTime,easingFunction: IEasingFunction)
 """
 ...
 def CreateInstanceCore(self,*args):
  """
  CreateInstanceCore(self: EasingRectKeyFrame) -> Freezable
 ...
 def InterpolateValueCore(self,*args):
  """
  InterpolateValueCore(self: EasingRectKeyFrame,baseValue: Rect,keyFrameProgress: float) -> Rect
 ...
 def __new__(self,value=None,keyTime=None,easingFunction=None):
  ...
  __new__(cls: type,value: Rect,keyTime: KeyTime,easingFunction: IEasingFunction)
  """
  pass
...
Get: EasingFunction(self: EasingRectKeyFrame) -> IEasingFunction



Set: EasingFunction(self: EasingRectKeyFrame)=value
