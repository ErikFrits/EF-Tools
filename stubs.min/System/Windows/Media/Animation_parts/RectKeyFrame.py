class RectKeyFrame(Freezable,ISealable,IKeyFrame):
 """ Abstract class that,when implemented,defines an animation segment with its own target value and interpolation method for a System.Windows.Media.Animation.RectAnimationUsingKeyFrames. """
 ...
 def InterpolateValue(self,baseValue,keyFrameProgress):
  """
  InterpolateValue(self: RectKeyFrame,baseValue: Rect,keyFrameProgress: float) -> Rect
 ...
 def InterpolateValueCore(self,*args):
  """
  InterpolateValueCore(self: RectKeyFrame,baseValue: Rect,keyFrameProgress: float) -> Rect
 ...
 """Gets or sets the time at which the key frame's target System.Windows.Media.Animation.RectKeyFrame.Value should be reached.



Get: KeyTime(self: RectKeyFrame) -> KeyTime



Set: KeyTime(self: RectKeyFrame)=value
...
Get: Value(self: RectKeyFrame) -> Rect



Set: Value(self: RectKeyFrame)=value
