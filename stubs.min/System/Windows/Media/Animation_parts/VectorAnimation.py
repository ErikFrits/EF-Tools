class VectorAnimation(VectorAnimationBase,ISealable,IAnimatable,IResource):
 """
 Animates the value of a System.Windows.Vector property between two target values using linear interpolation over a specified System.Windows.Media.Animation.Timeline.Duration.

 

 VectorAnimation()

 VectorAnimation(toValue: Vector,duration: Duration)

 VectorAnimation(toValue: Vector,duration: Duration,fillBehavior: FillBehavior)

 VectorAnimation(fromValue: Vector,toValue: Vector,duration: Duration)

 VectorAnimation(fromValue: Vector,toValue: Vector,duration: Duration,fillBehavior: FillBehavior)
 """
 ...
 def Clone(self):
  """
  Clone(self: VectorAnimation) -> VectorAnimation

  

   Creates a modifiable clone of this System.Windows.Media.Animation.VectorAnimation,making deep 
 ...
 def CreateInstanceCore(self,*args):
  """
  CreateInstanceCore(self: VectorAnimation) -> Freezable

  

   Creates a new instance of the System.Windows.Media.Animation.VectorAnimation.
 ...
 def GetCurrentValueCore(self,*args):
  """
  GetCurrentValueCore(self: VectorAnimation,defaultOriginValue: Vector,defaultDestinationValue: Vector,animationClock: AnimationClock) -> Vector

  

   Calculates a value that represents the current value of the property being animated,as 

    determined by the System.Windows.Media.Animation.VectorAnimation.
 ...
 def __new__(self,*__args):
  ...
  __new__(cls: type,toValue: Vector,duration: Duration)

  __new__(cls: type,toValue: Vector,duration: Duration,fillBehavior: FillBehavior)

  __new__(cls: type,fromValue: Vector,toValue: Vector,duration: Duration)

  __new__(cls: type,fromValue: Vector,toValue: Vector,duration: Duration,fillBehavior: FillBehavior)
  """
  pass
...
Get: By(self: VectorAnimation) -> Nullable[Vector]



Set: By(self: VectorAnimation)=value
...
Get: EasingFunction(self: VectorAnimation) -> IEasingFunction



Set: EasingFunction(self: VectorAnimation)=value
...
Get: From(self: VectorAnimation) -> Nullable[Vector]



Set: From(self: VectorAnimation)=value
...
Get: IsAdditive(self: VectorAnimation) -> bool



Set: IsAdditive(self: VectorAnimation)=value
...
Get: IsCumulative(self: VectorAnimation) -> bool



Set: IsCumulative(self: VectorAnimation)=value
...
Get: To(self: VectorAnimation) -> Nullable[Vector]



Set: To(self: VectorAnimation)=value
