class DecimalAnimationBase(AnimationTimeline,ISealable,IAnimatable,IResource):
 """ Abstract class that,when implemented,animates a System.Decimal value. """
 ...
 def Clone(self):
  """
  Clone(self: DecimalAnimationBase) -> DecimalAnimationBase

  

   Creates a modifiable clone of this System.Windows.Media.Animation.DecimalAnimationBase,making 
 ...
 def GetCurrentValue(self,defaultOriginValue,defaultDestinationValue,animationClock):
  """
  GetCurrentValue(self: DecimalAnimationBase,defaultOriginValue: Decimal,defaultDestinationValue: Decimal,animationClock: AnimationClock) -> Decimal
  ...
  GetCurrentValue(self: DecimalAnimationBase,defaultOriginValue: object,defaultDestinationValue: object,animationClock: AnimationClock) -> object
 ...
 def GetCurrentValueCore(self,*args):
  """
  GetCurrentValueCore(self: DecimalAnimationBase,defaultOriginValue: Decimal,defaultDestinationValue: Decimal,animationClock: AnimationClock) -> Decimal
...
Get: TargetPropertyType(self: DecimalAnimationBase) -> Type
