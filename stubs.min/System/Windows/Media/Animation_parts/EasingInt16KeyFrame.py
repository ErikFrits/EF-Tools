class EasingInt16KeyFrame(Int16KeyFrame,ISealable,IKeyFrame):
 """
 A class that enables you to associate easing functions with a System.Windows.Media.Animation.Int16AnimationUsingKeyFrames key frame animation.

 

 EasingInt16KeyFrame()

 EasingInt16KeyFrame(value: Int16)

 EasingInt16KeyFrame(value: Int16,keyTime: KeyTime)

 EasingInt16KeyFrame(value: Int16,keyTime: KeyTime,easingFunction: IEasingFunction)
 """
 ...
 def CreateInstanceCore(self,*args):
  """
  CreateInstanceCore(self: EasingInt16KeyFrame) -> Freezable
 ...
 def InterpolateValueCore(self,*args):
  """
  InterpolateValueCore(self: EasingInt16KeyFrame,baseValue: Int16,keyFrameProgress: float) -> Int16
 ...
 def __new__(self,value=None,keyTime=None,easingFunction=None):
  ...
  __new__(cls: type,value: Int16,keyTime: KeyTime,easingFunction: IEasingFunction)
  """
  pass
...
Get: EasingFunction(self: EasingInt16KeyFrame) -> IEasingFunction



Set: EasingFunction(self: EasingInt16KeyFrame)=value
