class LinearByteKeyFrame(ByteKeyFrame,ISealable,IKeyFrame):
 """
 Animates from the System.Byte value of the previous key frame to its own System.Windows.Media.Animation.ByteKeyFrame.Value using linear interpolation.

 

 LinearByteKeyFrame()

 LinearByteKeyFrame(value: Byte)

 LinearByteKeyFrame(value: Byte,keyTime: KeyTime)
 """
 ...
 def CreateInstanceCore(self,*args):
  """
  CreateInstanceCore(self: LinearByteKeyFrame) -> Freezable

  

   Creates a new instance of System.Windows.Media.Animation.LinearByteKeyFrame.

   Returns: A new System.Windows.Media.Animation.LinearByteKeyFrame.
  """
  pass
 ...
 def InterpolateValueCore(self,*args):
  """
  InterpolateValueCore(self: LinearByteKeyFrame,baseValue: Byte,keyFrameProgress: float) -> Byte
