class Vector3DAnimationUsingKeyFrames(Vector3DAnimationBase,ISealable,IAnimatable,IResource,IKeyFrameAnimation,IAddChild):
 ...
 def Clone(self):
  ...
  Clone(self: Vector3DAnimationUsingKeyFrames) -> Vector3DAnimationUsingKeyFrames
   ...
   Returns: A modifiable clone of this instance. The returned clone is effectively a deep copy of the 
    ...
    current object,although some copying might be deferred until necessary for improved 
 ...
 def CloneCore(self,*args):
  ...
  CloneCore(self: Vector3DAnimationUsingKeyFrames,sourceFreezable: Freezable)
   ...
   Makes the specified System.Windows.Media.Animation.Vector3DAnimationUsingKeyFrames a modifiable 
    ...
    clone (deep copy) of the current object using base (non-animated,non-databound) property 
 ...
 def CloneCurrentValue(self):
  ...
  CloneCurrentValue(self: Vector3DAnimationUsingKeyFrames) -> Vector3DAnimationUsingKeyFrames
   ...
   Creates a modifiable clone of this 
    ...
    System.Windows.Media.Animation.Vector3DAnimationUsingKeyFrames object,making deep copies of 

    this object's current values.
 ...
 def CloneCurrentValueCore(self,*args):
  ...
  CloneCurrentValueCore(self: Vector3DAnimationUsingKeyFrames,sourceFreezable: Freezable)
   ...
   Makes the specified System.Windows.Media.Animation.Vector3DAnimationUsingKeyFrames a modifiable 
    ...
    clone (deep copy) of the current object using current property values.
 ...
 def FreezeCore(self,*args):
  ...
  FreezeCore(self: Vector3DAnimationUsingKeyFrames,isChecking: bool) -> bool
   ...
   Makes this instance of System.Windows.Media.Animation.Vector3DAnimationUsingKeyFrames object 
 ...
 def GetAsFrozenCore(self,*args):
  ...
  GetAsFrozenCore(self: Vector3DAnimationUsingKeyFrames,source: Freezable)
   ...
   Makes this instance a clone of the specified 
    ...
    System.Windows.Media.Animation.Vector3DAnimationUsingKeyFrames object.
 ...
 def GetCurrentValueCore(self,*args):
  ...
  GetCurrentValueCore(self: Vector3DAnimationUsingKeyFrames,defaultOriginValue: Vector3D,defaultDestinationValue: Vector3D,animationClock: AnimationClock) -> Vector3D
   ...
   Calculates a value that represents the current value of the property being animated,as 
    ...
    determined by this instance of System.Windows.Media.Animation.Vector3DAnimationUsingKeyFrames.
 ...
 def ShouldSerializeKeyFrames(self):
  ...
  ShouldSerializeKeyFrames(self: Vector3DAnimationUsingKeyFrames) -> bool
   ...
   Returns true if the value of the 
    ...
    System.Windows.Media.Animation.Vector3DAnimationUsingKeyFrames.KeyFrames property of this 

    instance of System.Windows.Media.Animation.Vector3DAnimationUsingKeyFrames should be 
