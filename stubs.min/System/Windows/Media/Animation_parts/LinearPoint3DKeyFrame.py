class LinearPoint3DKeyFrame(Point3DKeyFrame,ISealable,IKeyFrame):
 """
 Animates from the System.Windows.Media.Media3D.Point3D value of the previous key frame to its own System.Windows.Media.Animation.Point3DKeyFrame.Value using linear interpolation.

 

 LinearPoint3DKeyFrame()

 LinearPoint3DKeyFrame(value: Point3D)

 LinearPoint3DKeyFrame(value: Point3D,keyTime: KeyTime)
 """
 ...
 def CreateInstanceCore(self,*args):
  """
  CreateInstanceCore(self: LinearPoint3DKeyFrame) -> Freezable

  

   Creates a new instance of System.Windows.Media.Animation.LinearPoint3DKeyFrame.

   Returns: A new System.Windows.Media.Animation.LinearPoint3DKeyFrame.
  """
  pass
 ...
 def InterpolateValueCore(self,*args):
  """
  InterpolateValueCore(self: LinearPoint3DKeyFrame,baseValue: Point3D,keyFrameProgress: float) -> Point3D
