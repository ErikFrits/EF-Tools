class ByteKeyFrame(Freezable,ISealable,IKeyFrame):
 """ Abstract class that,when implemented,defines an animation segment with its own target value and interpolation method for a System.Windows.Media.Animation.ByteAnimationUsingKeyFrames. """
 ...
 def InterpolateValue(self,baseValue,keyFrameProgress):
  """
  InterpolateValue(self: ByteKeyFrame,baseValue: Byte,keyFrameProgress: float) -> Byte
 ...
 def InterpolateValueCore(self,*args):
  """
  InterpolateValueCore(self: ByteKeyFrame,baseValue: Byte,keyFrameProgress: float) -> Byte
 ...
 """Gets or sets the time at which the key frame's target System.Windows.Media.Animation.ByteKeyFrame.Value should be reached.



Get: KeyTime(self: ByteKeyFrame) -> KeyTime



Set: KeyTime(self: ByteKeyFrame)=value
...
Get: Value(self: ByteKeyFrame) -> Byte



Set: Value(self: ByteKeyFrame)=value
