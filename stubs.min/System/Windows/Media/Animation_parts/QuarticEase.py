class QuarticEase(EasingFunctionBase,ISealable,IEasingFunction):
 """
 ...
 def CreateInstanceCore(self,*args):
  """
  CreateInstanceCore(self: QuarticEase) -> Freezable
 ...
 def EaseInCore(self,*args):
  """
  EaseInCore(self: QuarticEase,normalizedTime: float) -> float
