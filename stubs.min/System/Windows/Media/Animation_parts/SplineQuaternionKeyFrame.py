class SplineQuaternionKeyFrame(QuaternionKeyFrame,ISealable,IKeyFrame):
 """
 Animates from the System.Windows.Media.Media3D.Quaternion value of the previous key frame to its own System.Windows.Media.Animation.QuaternionKeyFrame.Value using splined interpolation.

 

 SplineQuaternionKeyFrame()

 SplineQuaternionKeyFrame(value: Quaternion)

 SplineQuaternionKeyFrame(value: Quaternion,keyTime: KeyTime)

 SplineQuaternionKeyFrame(value: Quaternion,keyTime: KeyTime,keySpline: KeySpline)
 """
 ...
 def CreateInstanceCore(self,*args):
  """
  CreateInstanceCore(self: SplineQuaternionKeyFrame) -> Freezable

  

   Creates a new instance of System.Windows.Media.Animation.SplineQuaternionKeyFrame.

   Returns: A new System.Windows.Media.Animation.SplineQuaternionKeyFrame.
  """
  pass
 ...
 def InterpolateValueCore(self,*args):
  """
  InterpolateValueCore(self: SplineQuaternionKeyFrame,baseValue: Quaternion,keyFrameProgress: float) -> Quaternion

  

   Interpolates,in a splined fashion,between the previous key frame value and the value of the 

    current key frame,using the supplied progress increment.
 ...
 def __new__(self,value=None,keyTime=None,keySpline=None):
  ...
  __new__(cls: type,value: Quaternion,keyTime: KeyTime,keySpline: KeySpline)
  """
  pass
...
Get: KeySpline(self: SplineQuaternionKeyFrame) -> KeySpline



Set: KeySpline(self: SplineQuaternionKeyFrame)=value

"""

 UseShortestPath=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets a value that indicates whether the animation uses spherical linear interpolation to calculate the shortest arc between positions.



Get: UseShortestPath(self: SplineQuaternionKeyFrame) -> bool



Set: UseShortestPath(self: SplineQuaternionKeyFrame)=value
