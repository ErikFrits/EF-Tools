class VectorAnimationUsingKeyFrames(VectorAnimationBase,ISealable,IAnimatable,IResource,IKeyFrameAnimation,IAddChild):
 """
 Animates the value of a System.Windows.Vector property along a set of System.Windows.Media.Animation.VectorAnimationUsingKeyFrames.KeyFrames.
 ...
 def AddChild(self,*args):
  """
  AddChild(self: VectorAnimationUsingKeyFrames,child: object)

   Adds a child System.Windows.Media.Animation.VectorKeyFrame to this 
 ...
 def AddText(self,*args):
  """
  AddText(self: VectorAnimationUsingKeyFrames,childText: str)
   ...
   childText: The text added to the System.Windows.Media.Animation.VectorAnimationUsingKeyFrames.
  """
  pass
 ...
 def Clone(self):
  """
  Clone(self: VectorAnimationUsingKeyFrames) -> VectorAnimationUsingKeyFrames

  

   Creates a modifiable clone of this System.Windows.Media.Animation.VectorAnimationUsingKeyFrames,
 ...
 def CloneCore(self,*args):
  """
  CloneCore(self: VectorAnimationUsingKeyFrames,sourceFreezable: Freezable)

   Makes this instance a deep copy of the specified 

    System.Windows.Media.Animation.VectorAnimationUsingKeyFrames. When copying dependency 
   ...
   sourceFreezable: The System.Windows.Media.Animation.VectorAnimationUsingKeyFrames to clone.
  """
  pass
 def CloneCurrentValue(self):
  """
  CloneCurrentValue(self: VectorAnimationUsingKeyFrames) -> VectorAnimationUsingKeyFrames
 ...
 def CloneCurrentValueCore(self,*args):
  """
  CloneCurrentValueCore(self: VectorAnimationUsingKeyFrames,sourceFreezable: Freezable)

   Makes this instance a modifiable deep copy of the specified 

    System.Windows.Media.Animation.VectorAnimationUsingKeyFrames using current property values. 
 ...
 def CreateInstanceCore(self,*args):
  """
  CreateInstanceCore(self: VectorAnimationUsingKeyFrames) -> Freezable

  

   Creates a new instance of System.Windows.Media.Animation.VectorAnimationUsingKeyFrames.

   Returns: A new instance of System.Windows.Media.Animation.VectorAnimationUsingKeyFrames.
  """
  pass
 def FreezeCore(self,*args):
  """
  FreezeCore(self: VectorAnimationUsingKeyFrames,isChecking: bool) -> bool

  

   Makes this instance of System.Windows.Media.Animation.VectorAnimationUsingKeyFrames object 
 ...
 def GetAsFrozenCore(self,*args):
  """
  GetAsFrozenCore(self: VectorAnimationUsingKeyFrames,source: Freezable)

   Makes this instance a clone of the specified 

    System.Windows.Media.Animation.VectorAnimationUsingKeyFrames object.

  

  

   source: The System.Windows.Media.Animation.VectorAnimationUsingKeyFrames object to clone.
  """
  pass
 def GetCurrentValueAsFrozenCore(self,*args):
  """
  GetCurrentValueAsFrozenCore(self: VectorAnimationUsingKeyFrames,source: Freezable)

   Makes this instance a frozen clone of the specified 

    System.Windows.Media.Animation.VectorAnimationUsingKeyFrames. Resource references,data 
   ...
   source: The System.Windows.Media.Animation.VectorAnimationUsingKeyFrames to copy and freeze.
  """
  pass
 def GetCurrentValueCore(self,*args):
  """
  GetCurrentValueCore(self: VectorAnimationUsingKeyFrames,defaultOriginValue: Vector,defaultDestinationValue: Vector,animationClock: AnimationClock) -> Vector

  

   Calculates a value that represents the current value of the property being animated,as 

    determined by this instance of System.Windows.Media.Animation.VectorAnimationUsingKeyFrames.
 ...
 def GetNaturalDurationCore(self,*args):
  """
  GetNaturalDurationCore(self: VectorAnimationUsingKeyFrames,clock: Clock) -> Duration
 ...
 def OnChanged(self,*args):
  """
  OnChanged(self: VectorAnimationUsingKeyFrames)

   Called when the current System.Windows.Media.Animation.VectorAnimationUsingKeyFrames object is 
 ...
 def ShouldSerializeKeyFrames(self):
  """
  ShouldSerializeKeyFrames(self: VectorAnimationUsingKeyFrames) -> bool
...
Get: IsAdditive(self: VectorAnimationUsingKeyFrames) -> bool



Set: IsAdditive(self: VectorAnimationUsingKeyFrames)=value
...
Get: IsCumulative(self: VectorAnimationUsingKeyFrames) -> bool



Set: IsCumulative(self: VectorAnimationUsingKeyFrames)=value

"""

 KeyFrames=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets the collection of System.Windows.Media.Animation.VectorKeyFrame objects that define the animation.



Get: KeyFrames(self: VectorAnimationUsingKeyFrames) -> VectorKeyFrameCollection



Set: KeyFrames(self: VectorAnimationUsingKeyFrames)=value
