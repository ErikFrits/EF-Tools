class BooleanAnimationBase(AnimationTimeline,ISealable,IAnimatable,IResource):
 """ Abstract class that,when implemented,animates a System.Boolean value. """
 ...
 def Clone(self):
  """
  Clone(self: BooleanAnimationBase) -> BooleanAnimationBase

  

   Creates a modifiable clone of this System.Windows.Media.Animation.BooleanAnimationBase,making 
 ...
 def GetCurrentValue(self,defaultOriginValue,defaultDestinationValue,animationClock):
  """
  GetCurrentValue(self: BooleanAnimationBase,defaultOriginValue: bool,defaultDestinationValue: bool,animationClock: AnimationClock) -> bool
  ...
  GetCurrentValue(self: BooleanAnimationBase,defaultOriginValue: object,defaultDestinationValue: object,animationClock: AnimationClock) -> object
 ...
 def GetCurrentValueCore(self,*args):
  """
  GetCurrentValueCore(self: BooleanAnimationBase,defaultOriginValue: bool,defaultDestinationValue: bool,animationClock: AnimationClock) -> bool
...
Get: TargetPropertyType(self: BooleanAnimationBase) -> Type
