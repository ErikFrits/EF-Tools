class BackEase(EasingFunctionBase,ISealable,IEasingFunction):
 """
 ...
 def CreateInstanceCore(self,*args):
  """
  CreateInstanceCore(self: BackEase) -> Freezable
 ...
 def EaseInCore(self,*args):
  """
  EaseInCore(self: BackEase,normalizedTime: float) -> float
 ...
 def __init__(self,*args):
  ...
  pass
 Amplitude=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets the amplitude of retraction associated with a System.Windows.Media.Animation.BackEase animation.



Get: Amplitude(self: BackEase) -> float



Set: Amplitude(self: BackEase)=value

"""


 AmplitudeProperty=None
