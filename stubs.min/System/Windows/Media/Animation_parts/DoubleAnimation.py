class DoubleAnimation(DoubleAnimationBase,ISealable,IAnimatable,IResource):
 """
 Animates the value of a  System.Double property between two target values using   linear interpolation over a specified System.Windows.Media.Animation.Timeline.Duration.

 

 DoubleAnimation()

 DoubleAnimation(toValue: float,duration: Duration)

 DoubleAnimation(toValue: float,duration: Duration,fillBehavior: FillBehavior)

 DoubleAnimation(fromValue: float,toValue: float,duration: Duration)

 DoubleAnimation(fromValue: float,toValue: float,duration: Duration,fillBehavior: FillBehavior)
 """
 ...
 def Clone(self):
  """
  Clone(self: DoubleAnimation) -> DoubleAnimation

  

   Creates a modifiable clone of this System.Windows.Media.Animation.DoubleAnimation,making deep 
 ...
 def CreateInstanceCore(self,*args):
  """
  CreateInstanceCore(self: DoubleAnimation) -> Freezable

  

   Creates a new instance of the System.Windows.Media.Animation.DoubleAnimation.
 ...
 def GetCurrentValueCore(self,*args):
  """
  GetCurrentValueCore(self: DoubleAnimation,defaultOriginValue: float,defaultDestinationValue: float,animationClock: AnimationClock) -> float

  

   Calculates a value that represents the current value of the property being animated,as 

    determined by the System.Windows.Media.Animation.DoubleAnimation.
 ...
 def __new__(self,*__args):
  ...
  __new__(cls: type,toValue: float,duration: Duration)

  __new__(cls: type,toValue: float,duration: Duration,fillBehavior: FillBehavior)

  __new__(cls: type,fromValue: float,toValue: float,duration: Duration)

  __new__(cls: type,fromValue: float,toValue: float,duration: Duration,fillBehavior: FillBehavior)
  """
  pass
...
Get: By(self: DoubleAnimation) -> Nullable[float]



Set: By(self: DoubleAnimation)=value
...
Get: EasingFunction(self: DoubleAnimation) -> IEasingFunction



Set: EasingFunction(self: DoubleAnimation)=value
...
Get: From(self: DoubleAnimation) -> Nullable[float]



Set: From(self: DoubleAnimation)=value
...
Get: IsAdditive(self: DoubleAnimation) -> bool



Set: IsAdditive(self: DoubleAnimation)=value
...
Get: IsCumulative(self: DoubleAnimation) -> bool



Set: IsCumulative(self: DoubleAnimation)=value
...
Get: To(self: DoubleAnimation) -> Nullable[float]



Set: To(self: DoubleAnimation)=value
