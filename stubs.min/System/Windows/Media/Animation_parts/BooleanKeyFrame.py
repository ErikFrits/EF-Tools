class BooleanKeyFrame(Freezable,ISealable,IKeyFrame):
 """ Abstract class that,when implemented,defines a segment with its own target value and interpolation method for a System.Windows.Media.Animation.BooleanAnimationUsingKeyFrames. """
 ...
 def InterpolateValue(self,baseValue,keyFrameProgress):
  """
  InterpolateValue(self: BooleanKeyFrame,baseValue: bool,keyFrameProgress: float) -> bool
 ...
 def InterpolateValueCore(self,*args):
  """
  InterpolateValueCore(self: BooleanKeyFrame,baseValue: bool,keyFrameProgress: float) -> bool
 ...
 """Gets or sets the time at which the key frame's target System.Windows.Media.Animation.BooleanKeyFrame.Value should be reached



Get: KeyTime(self: BooleanKeyFrame) -> KeyTime



Set: KeyTime(self: BooleanKeyFrame)=value
...
Get: Value(self: BooleanKeyFrame) -> bool



Set: Value(self: BooleanKeyFrame)=value
