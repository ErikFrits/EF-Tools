class PointAnimationBase(AnimationTimeline,ISealable,IAnimatable,IResource):
 """ Abstract class that,when implemented,animates a System.Windows.Point value. """
 ...
 def Clone(self):
  """
  Clone(self: PointAnimationBase) -> PointAnimationBase

  

   Creates a modifiable clone of this System.Windows.Media.Animation.PointAnimationBase,making 
 ...
 def GetCurrentValue(self,defaultOriginValue,defaultDestinationValue,animationClock):
  """
  GetCurrentValue(self: PointAnimationBase,defaultOriginValue: Point,defaultDestinationValue: Point,animationClock: AnimationClock) -> Point
  ...
  GetCurrentValue(self: PointAnimationBase,defaultOriginValue: object,defaultDestinationValue: object,animationClock: AnimationClock) -> object
 ...
 def GetCurrentValueCore(self,*args):
  """
  GetCurrentValueCore(self: PointAnimationBase,defaultOriginValue: Point,defaultDestinationValue: Point,animationClock: AnimationClock) -> Point
...
Get: TargetPropertyType(self: PointAnimationBase) -> Type
