class EasingDecimalKeyFrame(DecimalKeyFrame,ISealable,IKeyFrame):
 """
 An abstract class that enables you to associate easing functions with a System.Windows.Media.Animation.DecimalAnimationUsingKeyFrames key frame animation.

 

 EasingDecimalKeyFrame()

 EasingDecimalKeyFrame(value: Decimal)

 EasingDecimalKeyFrame(value: Decimal,keyTime: KeyTime)

 EasingDecimalKeyFrame(value: Decimal,keyTime: KeyTime,easingFunction: IEasingFunction)
 """
 ...
 def CreateInstanceCore(self,*args):
  """
  CreateInstanceCore(self: EasingDecimalKeyFrame) -> Freezable
 ...
 def InterpolateValueCore(self,*args):
  """
  InterpolateValueCore(self: EasingDecimalKeyFrame,baseValue: Decimal,keyFrameProgress: float) -> Decimal
 ...
 def __new__(self,value=None,keyTime=None,easingFunction=None):
  ...
  __new__(cls: type,value: Decimal,keyTime: KeyTime,easingFunction: IEasingFunction)
  """
  pass
...
Get: EasingFunction(self: EasingDecimalKeyFrame) -> IEasingFunction



Set: EasingFunction(self: EasingDecimalKeyFrame)=value
