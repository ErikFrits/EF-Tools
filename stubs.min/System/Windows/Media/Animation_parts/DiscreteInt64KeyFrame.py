class DiscreteInt64KeyFrame(Int64KeyFrame,ISealable,IKeyFrame):
 """
 Animates from the System.Int64 value of the previous key frame to its own System.Windows.Media.Animation.Int64KeyFrame.Value using discrete interpolation.

 

 DiscreteInt64KeyFrame()

 DiscreteInt64KeyFrame(value: Int64)

 DiscreteInt64KeyFrame(value: Int64,keyTime: KeyTime)
 """
 ...
 def CreateInstanceCore(self,*args):
  """
  CreateInstanceCore(self: DiscreteInt64KeyFrame) -> Freezable

  

   Creates a new instance of System.Windows.Media.Animation.DiscreteInt64KeyFrame.

   Returns: A new System.Windows.Media.Animation.DiscreteInt64KeyFrame.
  """
  pass
 ...
 def InterpolateValueCore(self,*args):
  """
  InterpolateValueCore(self: DiscreteInt64KeyFrame,baseValue: Int64,keyFrameProgress: float) -> Int64
