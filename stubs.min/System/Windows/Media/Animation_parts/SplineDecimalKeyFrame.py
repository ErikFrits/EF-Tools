class SplineDecimalKeyFrame(DecimalKeyFrame,ISealable,IKeyFrame):
 ...
 SplineDecimalKeyFrame(value: Decimal)

 SplineDecimalKeyFrame(value: Decimal,keyTime: KeyTime)
 ...
 def CreateInstanceCore(self,*args):
  ...
  CreateInstanceCore(self: SplineDecimalKeyFrame) -> Freezable
   ...
   Creates a new instance of System.Windows.Media.Animation.SplineDecimalKeyFrame.
...
Get: KeySpline(self: SplineDecimalKeyFrame) -> KeySpline



Set: KeySpline(self: SplineDecimalKeyFrame)=value
