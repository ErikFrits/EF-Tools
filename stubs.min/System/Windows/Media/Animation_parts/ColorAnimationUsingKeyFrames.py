class ColorAnimationUsingKeyFrames(ColorAnimationBase,ISealable,IAnimatable,IResource,IKeyFrameAnimation,IAddChild):
 ...
 def CloneCore(self,*args):
  ...
  CloneCore(self: ColorAnimationUsingKeyFrames,sourceFreezable: Freezable)
   ...
   Makes this instance a deep copy of the specified 
    ...
    System.Windows.Media.Animation.ColorAnimationUsingKeyFrames. When copying dependency properties,
 ...
 def CloneCurrentValueCore(self,*args):
  ...
  CloneCurrentValueCore(self: ColorAnimationUsingKeyFrames,sourceFreezable: Freezable)
   ...
   Makes this instance a modifiable deep copy of the specified 
    ...
    System.Windows.Media.Animation.ColorAnimationUsingKeyFrames using current property values. 
 ...
 def CreateInstanceCore(self,*args):
  ...
  CreateInstanceCore(self: ColorAnimationUsingKeyFrames) -> Freezable
   ...
   Creates a new instance of System.Windows.Media.Animation.ColorAnimationUsingKeyFrames.
 ...
 def FreezeCore(self,*args):
  ...
  FreezeCore(self: ColorAnimationUsingKeyFrames,isChecking: bool) -> bool
   ...
   Makes this instance of System.Windows.Media.Animation.ColorAnimationUsingKeyFrames object 
 ...
 def GetAsFrozenCore(self,*args):
  ...
  GetAsFrozenCore(self: ColorAnimationUsingKeyFrames,source: Freezable)
   ...
   Makes this instance a clone of the specified 
    ...
    System.Windows.Media.Animation.ColorAnimationUsingKeyFrames object.
 ...
 def GetCurrentValueAsFrozenCore(self,*args):
  ...
  GetCurrentValueAsFrozenCore(self: ColorAnimationUsingKeyFrames,source: Freezable)
   ...
   Makes this instance a frozen clone of the specified 
    ...
    System.Windows.Media.Animation.ColorAnimationUsingKeyFrames. Resource references,data bindings,
 ...
 def GetCurrentValueCore(self,*args):
  ...
  GetCurrentValueCore(self: ColorAnimationUsingKeyFrames,defaultOriginValue: Color,defaultDestinationValue: Color,animationClock: AnimationClock) -> Color
   ...
   Calculates a value that represents the current value of the property being animated,as 
    ...
    determined by this instance of System.Windows.Media.Animation.ColorAnimationUsingKeyFrames.
 ...
 def ShouldSerializeKeyFrames(self):
  ...
  ShouldSerializeKeyFrames(self: ColorAnimationUsingKeyFrames) -> bool
   ...
   Returns true if the value of the 
    ...
    System.Windows.Media.Animation.ColorAnimationUsingKeyFrames.KeyFrames property of this instance 

    of System.Windows.Media.Animation.ColorAnimationUsingKeyFrames should be value-serialized.
...
Get: IsAdditive(self: ColorAnimationUsingKeyFrames) -> bool



Set: IsAdditive(self: ColorAnimationUsingKeyFrames)=value
...
Get: IsCumulative(self: ColorAnimationUsingKeyFrames) -> bool



Set: IsCumulative(self: ColorAnimationUsingKeyFrames)=value
...
Get: KeyFrames(self: ColorAnimationUsingKeyFrames) -> ColorKeyFrameCollection
