class MatrixAnimationUsingPath(MatrixAnimationBase,ISealable,IAnimatable,IResource):
 ...
 def Clone(self):
  ...
  Clone(self: MatrixAnimationUsingPath) -> MatrixAnimationUsingPath
   ...
   Creates a modifiable clone of this System.Windows.Media.Animation.MatrixAnimationUsingPath,
 ...
 def CreateInstanceCore(self,*args):
  ...
  CreateInstanceCore(self: MatrixAnimationUsingPath) -> Freezable
   ...
   Creates a new instance of the System.Windows.Media.Animation.MatrixAnimationUsingPath.
 ...
 def GetCurrentValueCore(self,*args):
  ...
  GetCurrentValueCore(self: MatrixAnimationUsingPath,defaultOriginValue: Matrix,defaultDestinationValue: Matrix,animationClock: AnimationClock) -> Matrix
   ...
   Calculates a value that represents the current value of the property being animated,as 
    ...
    determined by the System.Windows.Media.Animation.MatrixAnimationUsingPath.
...
Get: DoesRotateWithTangent(self: MatrixAnimationUsingPath) -> bool



Set: DoesRotateWithTangent(self: MatrixAnimationUsingPath)=value
...
Get: IsAdditive(self: MatrixAnimationUsingPath) -> bool



Set: IsAdditive(self: MatrixAnimationUsingPath)=value
...
Get: IsAngleCumulative(self: MatrixAnimationUsingPath) -> bool



Set: IsAngleCumulative(self: MatrixAnimationUsingPath)=value
...
Get: IsOffsetCumulative(self: MatrixAnimationUsingPath) -> bool



Set: IsOffsetCumulative(self: MatrixAnimationUsingPath)=value
...
Get: PathGeometry(self: MatrixAnimationUsingPath) -> PathGeometry



Set: PathGeometry(self: MatrixAnimationUsingPath)=value
