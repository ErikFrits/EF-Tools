class LinearRotation3DKeyFrame(Rotation3DKeyFrame,ISealable,IKeyFrame):
 """
 Animates from the System.Windows.Media.Media3D.Rotation3D value of the previous key frame to its own System.Windows.Media.Animation.Rotation3DKeyFrame.Value using linear interpolation.

 

 LinearRotation3DKeyFrame()

 LinearRotation3DKeyFrame(value: Rotation3D)

 LinearRotation3DKeyFrame(value: Rotation3D,keyTime: KeyTime)
 """
 ...
 def CreateInstanceCore(self,*args):
  """
  CreateInstanceCore(self: LinearRotation3DKeyFrame) -> Freezable

  

   Creates a new instance of System.Windows.Media.Animation.LinearRotation3DKeyFrame.

   Returns: A new System.Windows.Media.Animation.LinearRotation3DKeyFrame.
  """
  pass
 ...
 def InterpolateValueCore(self,*args):
  """
  InterpolateValueCore(self: LinearRotation3DKeyFrame,baseValue: Rotation3D,keyFrameProgress: float) -> Rotation3D
