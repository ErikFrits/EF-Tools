class DiscreteVector3DKeyFrame(Vector3DKeyFrame,ISealable,IKeyFrame):
 """
 Animates from the System.Windows.Media.Media3D.Vector3D value of the previous key frame to its own System.Windows.Media.Animation.Vector3DKeyFrame.Value using discrete interpolation.

 

 DiscreteVector3DKeyFrame()

 DiscreteVector3DKeyFrame(value: Vector3D)

 DiscreteVector3DKeyFrame(value: Vector3D,keyTime: KeyTime)
 """
 ...
 def CreateInstanceCore(self,*args):
  """
  CreateInstanceCore(self: DiscreteVector3DKeyFrame) -> Freezable

  

   Creates a new instance of System.Windows.Media.Animation.DiscreteVector3DKeyFrame.

   Returns: A new System.Windows.Media.Animation.DiscreteVector3DKeyFrame.
  """
  pass
 ...
 def InterpolateValueCore(self,*args):
  """
  InterpolateValueCore(self: DiscreteVector3DKeyFrame,baseValue: Vector3D,keyFrameProgress: float) -> Vector3D
