class DiscreteObjectKeyFrame(ObjectKeyFrame,ISealable,IKeyFrame):
 """
 Animates from the System.Object value of the previous key frame to its own System.Windows.Media.Animation.ObjectKeyFrame.Value using discrete interpolation.
 ...
 DiscreteObjectKeyFrame(value: object,keyTime: KeyTime)
 """
 ...
 def CreateInstanceCore(self,*args):
  """
  CreateInstanceCore(self: DiscreteObjectKeyFrame) -> Freezable

  

   Creates a new instance of System.Windows.Media.Animation.DiscreteObjectKeyFrame.

   Returns: A new System.Windows.Media.Animation.DiscreteObjectKeyFrame.
  """
  pass
 ...
 def InterpolateValueCore(self,*args):
  """
  InterpolateValueCore(self: DiscreteObjectKeyFrame,baseValue: object,keyFrameProgress: float) -> object
