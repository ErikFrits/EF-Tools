class Rotation3DAnimationBase(AnimationTimeline,ISealable,IAnimatable,IResource):
 """ Abstract class that,when implemented,animates a System.Windows.Media.Media3D.Rotation3D value. """
 ...
 def Clone(self):
  """
  Clone(self: Rotation3DAnimationBase) -> Rotation3DAnimationBase

  

   Creates a modifiable clone of this System.Windows.Media.Animation.Rotation3DAnimationBase,
 ...
 def GetCurrentValue(self,defaultOriginValue,defaultDestinationValue,animationClock):
  """
  GetCurrentValue(self: Rotation3DAnimationBase,defaultOriginValue: Rotation3D,defaultDestinationValue: Rotation3D,animationClock: AnimationClock) -> Rotation3D
   ...
   defaultOriginValue: The origin value provided to the animation if the animation does not have its own start value. 
    ...
    If this animation is the first in a composition chain it will be the base value of the property 

    being animated; otherwise it will be the value returned by the previous animation in the chain.
  ...
  GetCurrentValue(self: Rotation3DAnimationBase,defaultOriginValue: object,defaultDestinationValue: object,animationClock: AnimationClock) -> object
 ...
 def GetCurrentValueCore(self,*args):
  """
  GetCurrentValueCore(self: Rotation3DAnimationBase,defaultOriginValue: Rotation3D,defaultDestinationValue: Rotation3D,animationClock: AnimationClock) -> Rotation3D
...
Get: TargetPropertyType(self: Rotation3DAnimationBase) -> Type
