class LinearSingleKeyFrame(SingleKeyFrame,ISealable,IKeyFrame):
 """
 Animates from the System.Single value of the previous key frame to its own System.Windows.Media.Animation.SingleKeyFrame.Value using linear interpolation.

 

 LinearSingleKeyFrame()

 LinearSingleKeyFrame(value: Single)

 LinearSingleKeyFrame(value: Single,keyTime: KeyTime)
 """
 ...
 def CreateInstanceCore(self,*args):
  """
  CreateInstanceCore(self: LinearSingleKeyFrame) -> Freezable

  

   Creates a new instance of System.Windows.Media.Animation.LinearSingleKeyFrame.

   Returns: A new System.Windows.Media.Animation.LinearSingleKeyFrame.
  """
  pass
 ...
 def InterpolateValueCore(self,*args):
  """
  InterpolateValueCore(self: LinearSingleKeyFrame,baseValue: Single,keyFrameProgress: float) -> Single
