class DoubleAnimationUsingKeyFrames(DoubleAnimationBase,ISealable,IAnimatable,IResource,IKeyFrameAnimation,IAddChild):
 ...
 def Clone(self):
  ...
  Clone(self: DoubleAnimationUsingKeyFrames) -> DoubleAnimationUsingKeyFrames
   ...
   Creates a modifiable clone of this System.Windows.Media.Animation.DoubleAnimationUsingKeyFrames,
 ...
 def CloneCore(self,*args):
  ...
  CloneCore(self: DoubleAnimationUsingKeyFrames,sourceFreezable: Freezable)
   ...
   Makes this instance a deep copy of the specified 
    ...
    System.Windows.Media.Animation.DoubleAnimationUsingKeyFrames. When copying dependency 
 ...
 def CloneCurrentValueCore(self,*args):
  ...
  CloneCurrentValueCore(self: DoubleAnimationUsingKeyFrames,sourceFreezable: Freezable)
   ...
   Makes this instance a modifiable deep copy of the specified 
    ...
    System.Windows.Media.Animation.DoubleAnimationUsingKeyFrames using current property values. 
 ...
 def CreateInstanceCore(self,*args):
  ...
  CreateInstanceCore(self: DoubleAnimationUsingKeyFrames) -> Freezable
   ...
   Creates a new instance of System.Windows.Media.Animation.DoubleAnimationUsingKeyFrames.
 ...
 def FreezeCore(self,*args):
  ...
  FreezeCore(self: DoubleAnimationUsingKeyFrames,isChecking: bool) -> bool
   ...
   Makes this instance of System.Windows.Media.Animation.DoubleAnimationUsingKeyFrames object 
 ...
 def GetAsFrozenCore(self,*args):
  ...
  GetAsFrozenCore(self: DoubleAnimationUsingKeyFrames,source: Freezable)
   ...
   Makes this instance a clone of the specified 
    ...
    System.Windows.Media.Animation.DoubleAnimationUsingKeyFrames object.
 ...
 def GetCurrentValueAsFrozenCore(self,*args):
  ...
  GetCurrentValueAsFrozenCore(self: DoubleAnimationUsingKeyFrames,source: Freezable)
   ...
   Makes this instance a frozen clone of the specified 
    ...
    System.Windows.Media.Animation.DoubleAnimationUsingKeyFrames. Resource references,data 
 ...
 def GetCurrentValueCore(self,*args):
  ...
  GetCurrentValueCore(self: DoubleAnimationUsingKeyFrames,defaultOriginValue: float,defaultDestinationValue: float,animationClock: AnimationClock) -> float
   ...
   Calculates a value that represents the current value of the property being animated,as 
    ...
    determined by this instance of System.Windows.Media.Animation.DoubleAnimationUsingKeyFrames.
 ...
 def ShouldSerializeKeyFrames(self):
  ...
  ShouldSerializeKeyFrames(self: DoubleAnimationUsingKeyFrames) -> bool
   ...
   Returns true if the value of the 
    ...
    System.Windows.Media.Animation.DoubleAnimationUsingKeyFrames.KeyFrames property of this instance 

    of System.Windows.Media.Animation.DoubleAnimationUsingKeyFrames should be value-serialized.
...
Get: IsAdditive(self: DoubleAnimationUsingKeyFrames) -> bool



Set: IsAdditive(self: DoubleAnimationUsingKeyFrames)=value
...
Get: IsCumulative(self: DoubleAnimationUsingKeyFrames) -> bool



Set: IsCumulative(self: DoubleAnimationUsingKeyFrames)=value
...
Get: KeyFrames(self: DoubleAnimationUsingKeyFrames) -> DoubleKeyFrameCollection
