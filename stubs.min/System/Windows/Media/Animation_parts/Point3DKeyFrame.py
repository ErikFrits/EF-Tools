class Point3DKeyFrame(Freezable,ISealable,IKeyFrame):
 """ Abstract class that,when implemented,defines an animation segment with its own target value and interpolation method for a System.Windows.Media.Animation.Point3DAnimationUsingKeyFrames. """
 ...
 def InterpolateValue(self,baseValue,keyFrameProgress):
  """
  InterpolateValue(self: Point3DKeyFrame,baseValue: Point3D,keyFrameProgress: float) -> Point3D
 ...
 def InterpolateValueCore(self,*args):
  """
  InterpolateValueCore(self: Point3DKeyFrame,baseValue: Point3D,keyFrameProgress: float) -> Point3D
 ...
 """Gets or sets the time at which the key frame's target System.Windows.Media.Animation.Point3DKeyFrame.Value should be reached.



Get: KeyTime(self: Point3DKeyFrame) -> KeyTime



Set: KeyTime(self: Point3DKeyFrame)=value
...
Get: Value(self: Point3DKeyFrame) -> Point3D



Set: Value(self: Point3DKeyFrame)=value
