class SplineVectorKeyFrame(VectorKeyFrame,ISealable,IKeyFrame):
 """
 Animates from the System.Windows.Vector value of the previous key frame to its own System.Windows.Media.Animation.VectorKeyFrame.Value using splined interpolation.

 

 SplineVectorKeyFrame()

 SplineVectorKeyFrame(value: Vector)

 SplineVectorKeyFrame(value: Vector,keyTime: KeyTime)

 SplineVectorKeyFrame(value: Vector,keyTime: KeyTime,keySpline: KeySpline)
 """
 ...
 def CreateInstanceCore(self,*args):
  """
  CreateInstanceCore(self: SplineVectorKeyFrame) -> Freezable

  

   Creates a new instance of System.Windows.Media.Animation.SplineVectorKeyFrame.

   Returns: A new System.Windows.Media.Animation.SplineVectorKeyFrame.
  """
  pass
 ...
 def InterpolateValueCore(self,*args):
  """
  InterpolateValueCore(self: SplineVectorKeyFrame,baseValue: Vector,keyFrameProgress: float) -> Vector
 ...
 def __new__(self,value=None,keyTime=None,keySpline=None):
  ...
  __new__(cls: type,value: Vector,keyTime: KeyTime,keySpline: KeySpline)
  """
  pass
...
Get: KeySpline(self: SplineVectorKeyFrame) -> KeySpline



Set: KeySpline(self: SplineVectorKeyFrame)=value
