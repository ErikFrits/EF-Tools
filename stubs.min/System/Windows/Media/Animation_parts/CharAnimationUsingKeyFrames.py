class CharAnimationUsingKeyFrames(CharAnimationBase,ISealable,IAnimatable,IResource,IKeyFrameAnimation,IAddChild):
 ...
 def Clone(self):
  ...
  Clone(self: CharAnimationUsingKeyFrames) -> CharAnimationUsingKeyFrames
   ...
   Creates a modifiable clone of this System.Windows.Media.Animation.CharAnimationUsingKeyFrames,
 ...
 def CloneCore(self,*args):
  ...
  CloneCore(self: CharAnimationUsingKeyFrames,sourceFreezable: Freezable)
   ...
   Makes this instance a deep copy of the specified 
    ...
    System.Windows.Media.Animation.CharAnimationUsingKeyFrames. When copying dependency properties,
 ...
 def CloneCurrentValueCore(self,*args):
  ...
  CloneCurrentValueCore(self: CharAnimationUsingKeyFrames,sourceFreezable: Freezable)
   ...
   Makes this instance a modifiable deep copy of the specified 
    ...
    System.Windows.Media.Animation.CharAnimationUsingKeyFrames using current property values. 
 ...
 def CreateInstanceCore(self,*args):
  ...
  CreateInstanceCore(self: CharAnimationUsingKeyFrames) -> Freezable
   ...
   Creates a new instance of System.Windows.Media.Animation.CharAnimationUsingKeyFrames.
 ...
 def FreezeCore(self,*args):
  ...
  FreezeCore(self: CharAnimationUsingKeyFrames,isChecking: bool) -> bool
   ...
   Makes this instance of System.Windows.Media.Animation.CharAnimationUsingKeyFrames object 
 ...
 def GetAsFrozenCore(self,*args):
  ...
  GetAsFrozenCore(self: CharAnimationUsingKeyFrames,source: Freezable)
   ...
   Makes this instance a clone of the specified 
    ...
    System.Windows.Media.Animation.CharAnimationUsingKeyFrames object.
 ...
 def GetCurrentValueAsFrozenCore(self,*args):
  ...
  GetCurrentValueAsFrozenCore(self: CharAnimationUsingKeyFrames,source: Freezable)
   ...
   Makes this instance a frozen clone of the specified 
    ...
    System.Windows.Media.Animation.CharAnimationUsingKeyFrames. Resource references,data bindings,
 ...
 def GetCurrentValueCore(self,*args):
  ...
  GetCurrentValueCore(self: CharAnimationUsingKeyFrames,defaultOriginValue: Char,defaultDestinationValue: Char,animationClock: AnimationClock) -> Char
   ...
   Calculates a value that represents the current value of the property being animated,as 
    ...
    determined by this instance of System.Windows.Media.Animation.CharAnimationUsingKeyFrames.
 ...
 def ShouldSerializeKeyFrames(self):
  ...
  ShouldSerializeKeyFrames(self: CharAnimationUsingKeyFrames) -> bool
   ...
   Returns true if the value of the 
    ...
    System.Windows.Media.Animation.CharAnimationUsingKeyFrames.KeyFrames property of this instance 

    of System.Windows.Media.Animation.CharAnimationUsingKeyFrames should be value-serialized.
...
Get: KeyFrames(self: CharAnimationUsingKeyFrames) -> CharKeyFrameCollection
