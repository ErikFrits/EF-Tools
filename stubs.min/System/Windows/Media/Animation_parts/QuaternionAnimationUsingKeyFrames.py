class QuaternionAnimationUsingKeyFrames(QuaternionAnimationBase,ISealable,IAnimatable,IResource,IKeyFrameAnimation,IAddChild):
 """
 Animates the value of a System.Windows.Media.Media3D.Quaternion property along a set of System.Windows.Media.Animation.QuaternionAnimationUsingKeyFrames.KeyFrames over a specified System.Windows.Media.Animation.Timeline.Duration.
 ...
 def AddChild(self,*args):
  """
  AddChild(self: QuaternionAnimationUsingKeyFrames,child: object)

   Adds a child System.Windows.Media.Animation.QuaternionKeyFrame to this 
 ...
 def AddText(self,*args):
  """
  AddText(self: QuaternionAnimationUsingKeyFrames,childText: str)
   ...
   childText: The text added to the System.Windows.Media.Animation.QuaternionAnimationUsingKeyFrames.
  """
  pass
 ...
 def Clone(self):
  """
  Clone(self: QuaternionAnimationUsingKeyFrames) -> QuaternionAnimationUsingKeyFrames

  

   Creates a modifiable clone of this 

    System.Windows.Media.Animation.QuaternionAnimationUsingKeyFrames,making deep copies of this 
 ...
 def CloneCore(self,*args):
  """
  CloneCore(self: QuaternionAnimationUsingKeyFrames,sourceFreezable: Freezable)

   Makes this instance a deep copy of the specified 

    System.Windows.Media.Animation.QuaternionAnimationUsingKeyFrames. When copying dependency 
   ...
   sourceFreezable: The System.Windows.Media.Animation.QuaternionAnimationUsingKeyFrames to clone.
  """
  pass
 def CloneCurrentValue(self):
  """
  CloneCurrentValue(self: QuaternionAnimationUsingKeyFrames) -> QuaternionAnimationUsingKeyFrames

  

   Creates a modifiable clone of this 

    System.Windows.Media.Animation.QuaternionAnimationUsingKeyFrames object,making deep copies of 
 ...
 def CloneCurrentValueCore(self,*args):
  """
  CloneCurrentValueCore(self: QuaternionAnimationUsingKeyFrames,sourceFreezable: Freezable)

   Makes this instance a clone of the specified 

    System.Windows.Media.Animation.QuaternionAnimationUsingKeyFrames object.

  

  

   sourceFreezable: The System.Windows.Media.Animation.QuaternionAnimationUsingKeyFrames object to clone.
  """
  pass
 ...
 def CreateInstanceCore(self,*args):
  """
  CreateInstanceCore(self: QuaternionAnimationUsingKeyFrames) -> Freezable

  

   Creates a new instance of System.Windows.Media.Animation.QuaternionAnimationUsingKeyFrames.

   Returns: A new instance of System.Windows.Media.Animation.QuaternionAnimationUsingKeyFrames.
  """
  pass
 def FreezeCore(self,*args):
  """
  FreezeCore(self: QuaternionAnimationUsingKeyFrames,isChecking: bool) -> bool
 ...
 def GetAsFrozenCore(self,*args):
  """
  GetAsFrozenCore(self: QuaternionAnimationUsingKeyFrames,source: Freezable)
   ...
   source: The System.Windows.Media.Animation.QuaternionAnimationUsingKeyFrames object to clone.
  """
  pass
 def GetCurrentValueAsFrozenCore(self,*args):
  """
  GetCurrentValueAsFrozenCore(self: QuaternionAnimationUsingKeyFrames,source: Freezable)

   Makes this instance a frozen clone of the specified 

    System.Windows.Media.Animation.QuaternionAnimationUsingKeyFrames. Resource references,data 
   ...
   source: The System.Windows.Media.Animation.QuaternionAnimationUsingKeyFrames to copy and freeze.
  """
  pass
 def GetCurrentValueCore(self,*args):
  """
  GetCurrentValueCore(self: QuaternionAnimationUsingKeyFrames,defaultOriginValue: Quaternion,defaultDestinationValue: Quaternion,animationClock: AnimationClock) -> Quaternion

  

   Calculates a value that represents the current value of the property being animated,as 

    determined by this instance of System.Windows.Media.Animation.QuaternionAnimationUsingKeyFrames.
 ...
 def GetNaturalDurationCore(self,*args):
  """
  GetNaturalDurationCore(self: QuaternionAnimationUsingKeyFrames,clock: Clock) -> Duration
 ...
 def OnChanged(self,*args):
  """
  OnChanged(self: QuaternionAnimationUsingKeyFrames)

   Called when the current System.Windows.Media.Animation.QuaternionAnimationUsingKeyFrames object 
 ...
 def ShouldSerializeKeyFrames(self):
  """
  ShouldSerializeKeyFrames(self: QuaternionAnimationUsingKeyFrames) -> bool

  

   Returns true if the value of the 

    System.Windows.Media.Animation.QuaternionAnimationUsingKeyFrames.KeyFrames property of this 

    instance of System.Windows.Media.Animation.QuaternionAnimationUsingKeyFrames should be 
...
Get: IsAdditive(self: QuaternionAnimationUsingKeyFrames) -> bool



Set: IsAdditive(self: QuaternionAnimationUsingKeyFrames)=value
...
Get: IsCumulative(self: QuaternionAnimationUsingKeyFrames) -> bool



Set: IsCumulative(self: QuaternionAnimationUsingKeyFrames)=value

"""

 KeyFrames=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets the collection of System.Windows.Media.Animation.QuaternionKeyFrame objects that define the animation.



Get: KeyFrames(self: QuaternionAnimationUsingKeyFrames) -> QuaternionKeyFrameCollection



Set: KeyFrames(self: QuaternionAnimationUsingKeyFrames)=value
