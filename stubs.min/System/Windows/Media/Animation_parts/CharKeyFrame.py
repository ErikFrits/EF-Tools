class CharKeyFrame(Freezable,ISealable,IKeyFrame):
 """ Abstract class that,when implemented,defines an animation segment with its own target value and interpolation method for a System.Windows.Media.Animation.CharAnimationUsingKeyFrames. """
 ...
 def InterpolateValue(self,baseValue,keyFrameProgress):
  """
  InterpolateValue(self: CharKeyFrame,baseValue: Char,keyFrameProgress: float) -> Char
 ...
 def InterpolateValueCore(self,*args):
  """
  InterpolateValueCore(self: CharKeyFrame,baseValue: Char,keyFrameProgress: float) -> Char
 ...
 """Gets or sets the time at which the key frame's target System.Windows.Media.Animation.CharKeyFrame.Value should be reached.



Get: KeyTime(self: CharKeyFrame) -> KeyTime



Set: KeyTime(self: CharKeyFrame)=value
...
Get: Value(self: CharKeyFrame) -> Char



Set: Value(self: CharKeyFrame)=value
