class DiscreteSizeKeyFrame(SizeKeyFrame,ISealable,IKeyFrame):
 """
 Animates from the System.Windows.Size value of the previous key frame to its own System.Windows.Media.Animation.SizeKeyFrame.Value using discrete interpolation.

 

 DiscreteSizeKeyFrame()

 DiscreteSizeKeyFrame(value: Size)

 DiscreteSizeKeyFrame(value: Size,keyTime: KeyTime)
 """
 ...
 def CreateInstanceCore(self,*args):
  """
  CreateInstanceCore(self: DiscreteSizeKeyFrame) -> Freezable

  

   Creates a new instance of System.Windows.Media.Animation.DiscreteSizeKeyFrame.

   Returns: A new System.Windows.Media.Animation.DiscreteSizeKeyFrame.
  """
  pass
 ...
 def InterpolateValueCore(self,*args):
  """
  InterpolateValueCore(self: DiscreteSizeKeyFrame,baseValue: Size,keyFrameProgress: float) -> Size
