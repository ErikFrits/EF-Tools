class MatrixAnimationUsingKeyFrames(MatrixAnimationBase,ISealable,IAnimatable,IResource,IKeyFrameAnimation,IAddChild):
 """
 Animates the value of a System.Windows.Media.Matrix property along a set of System.Windows.Media.Animation.MatrixAnimationUsingKeyFrames.KeyFrames.
 ...
 def AddChild(self,*args):
  """
  AddChild(self: MatrixAnimationUsingKeyFrames,child: object)

   Adds a child System.Windows.Media.Animation.MatrixKeyFrame to this 
 ...
 def AddText(self,*args):
  """
  AddText(self: MatrixAnimationUsingKeyFrames,childText: str)
   ...
   childText: The text added to the System.Windows.Media.Animation.MatrixAnimationUsingKeyFrames.
  """
  pass
 ...
 def Clone(self):
  """
  Clone(self: MatrixAnimationUsingKeyFrames) -> MatrixAnimationUsingKeyFrames

  

   Creates a modifiable clone of this System.Windows.Media.Animation.MatrixAnimationUsingKeyFrames,
 ...
 def CloneCore(self,*args):
  """
  CloneCore(self: MatrixAnimationUsingKeyFrames,sourceFreezable: Freezable)

   Makes this instance a deep copy of the specified 

    System.Windows.Media.Animation.MatrixAnimationUsingKeyFrames. When copying dependency 
   ...
   sourceFreezable: The System.Windows.Media.Animation.MatrixAnimationUsingKeyFrames to clone.
  """
  pass
 def CloneCurrentValue(self):
  """
  CloneCurrentValue(self: MatrixAnimationUsingKeyFrames) -> MatrixAnimationUsingKeyFrames
 ...
 def CloneCurrentValueCore(self,*args):
  """
  CloneCurrentValueCore(self: MatrixAnimationUsingKeyFrames,sourceFreezable: Freezable)

   Makes this instance a modifiable deep copy of the specified 

    System.Windows.Media.Animation.MatrixAnimationUsingKeyFrames using current property values. 
 ...
 def CreateInstanceCore(self,*args):
  """
  CreateInstanceCore(self: MatrixAnimationUsingKeyFrames) -> Freezable

  

   Creates a new instance of System.Windows.Media.Animation.MatrixAnimationUsingKeyFrames.

   Returns: A new instance of System.Windows.Media.Animation.MatrixAnimationUsingKeyFrames.
  """
  pass
 def FreezeCore(self,*args):
  """
  FreezeCore(self: MatrixAnimationUsingKeyFrames,isChecking: bool) -> bool

  

   Makes this instance of System.Windows.Media.Animation.MatrixAnimationUsingKeyFrames object 
 ...
 def GetAsFrozenCore(self,*args):
  """
  GetAsFrozenCore(self: MatrixAnimationUsingKeyFrames,source: Freezable)

   Makes this instance a clone of the specified 

    System.Windows.Media.Animation.MatrixAnimationUsingKeyFrames object.

  

  

   source: The System.Windows.Media.Animation.MatrixAnimationUsingKeyFrames object to clone.
  """
  pass
 def GetCurrentValueAsFrozenCore(self,*args):
  """
  GetCurrentValueAsFrozenCore(self: MatrixAnimationUsingKeyFrames,source: Freezable)

   Makes this instance a frozen clone of the specified 

    System.Windows.Media.Animation.MatrixAnimationUsingKeyFrames. Resource references,data 
   ...
   source: The System.Windows.Media.Animation.MatrixAnimationUsingKeyFrames to copy and freeze.
  """
  pass
 def GetCurrentValueCore(self,*args):
  """
  GetCurrentValueCore(self: MatrixAnimationUsingKeyFrames,defaultOriginValue: Matrix,defaultDestinationValue: Matrix,animationClock: AnimationClock) -> Matrix

  

   Calculates the current output value of this 
 ...
 def GetNaturalDurationCore(self,*args):
  """
  GetNaturalDurationCore(self: MatrixAnimationUsingKeyFrames,clock: Clock) -> Duration
 ...
 def OnChanged(self,*args):
  """
  OnChanged(self: MatrixAnimationUsingKeyFrames)

   Called when the current System.Windows.Media.Animation.MatrixAnimationUsingKeyFrames object is 
 ...
 def ShouldSerializeKeyFrames(self):
  """
  ShouldSerializeKeyFrames(self: MatrixAnimationUsingKeyFrames) -> bool

  

   Returns true if the value of the 

    System.Windows.Media.Animation.MatrixAnimationUsingKeyFrames.KeyFrames property of this instance 

    of System.Windows.Media.Animation.MatrixAnimationUsingKeyFrames should be value-serialized.
 ...
 """Gets or sets the collection of System.Windows.Media.Animation.MatrixKeyFrame objects that define the animation.



Get: KeyFrames(self: MatrixAnimationUsingKeyFrames) -> MatrixKeyFrameCollection



Set: KeyFrames(self: MatrixAnimationUsingKeyFrames)=value
