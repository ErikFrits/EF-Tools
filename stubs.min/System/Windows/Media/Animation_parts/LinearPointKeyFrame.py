class LinearPointKeyFrame(PointKeyFrame,ISealable,IKeyFrame):
 """
 Animates from the System.Windows.Point value of the previous key frame to its own System.Windows.Media.Animation.PointKeyFrame.Value using linear interpolation.

 

 LinearPointKeyFrame()

 LinearPointKeyFrame(value: Point)

 LinearPointKeyFrame(value: Point,keyTime: KeyTime)
 """
 ...
 def CreateInstanceCore(self,*args):
  """
  CreateInstanceCore(self: LinearPointKeyFrame) -> Freezable

  

   Creates a new instance of System.Windows.Media.Animation.LinearPointKeyFrame.

   Returns: A new System.Windows.Media.Animation.LinearPointKeyFrame.
  """
  pass
 ...
 def InterpolateValueCore(self,*args):
  """
  InterpolateValueCore(self: LinearPointKeyFrame,baseValue: Point,keyFrameProgress: float) -> Point
