class EasingInt64KeyFrame(Int64KeyFrame,ISealable,IKeyFrame):
 """
 A class that enables you to associate easing functions with a System.Windows.Media.Animation.Int64AnimationUsingKeyFrames key frame animation.

 

 EasingInt64KeyFrame()

 EasingInt64KeyFrame(value: Int64)

 EasingInt64KeyFrame(value: Int64,keyTime: KeyTime)

 EasingInt64KeyFrame(value: Int64,keyTime: KeyTime,easingFunction: IEasingFunction)
 """
 ...
 def CreateInstanceCore(self,*args):
  """
  CreateInstanceCore(self: EasingInt64KeyFrame) -> Freezable
 ...
 def InterpolateValueCore(self,*args):
  """
  InterpolateValueCore(self: EasingInt64KeyFrame,baseValue: Int64,keyFrameProgress: float) -> Int64
 ...
 def __new__(self,value=None,keyTime=None,easingFunction=None):
  ...
  __new__(cls: type,value: Int64,keyTime: KeyTime,easingFunction: IEasingFunction)
  """
  pass
...
Get: EasingFunction(self: EasingInt64KeyFrame) -> IEasingFunction



Set: EasingFunction(self: EasingInt64KeyFrame)=value
