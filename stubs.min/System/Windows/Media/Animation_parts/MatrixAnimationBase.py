class MatrixAnimationBase(AnimationTimeline,ISealable,IAnimatable,IResource):
 """ Abstract class that,when implemented,animates a System.Windows.Media.Matrix value. """
 ...
 def Clone(self):
  """
  Clone(self: MatrixAnimationBase) -> MatrixAnimationBase

  

   Creates a modifiable clone of this System.Windows.Media.Animation.MatrixAnimationBase,making 
 ...
 def GetCurrentValue(self,defaultOriginValue,defaultDestinationValue,animationClock):
  """
  GetCurrentValue(self: MatrixAnimationBase,defaultOriginValue: Matrix,defaultDestinationValue: Matrix,animationClock: AnimationClock) -> Matrix
  ...
  GetCurrentValue(self: MatrixAnimationBase,defaultOriginValue: object,defaultDestinationValue: object,animationClock: AnimationClock) -> object
 ...
 def GetCurrentValueCore(self,*args):
  """
  GetCurrentValueCore(self: MatrixAnimationBase,defaultOriginValue: Matrix,defaultDestinationValue: Matrix,animationClock: AnimationClock) -> Matrix
...
Get: TargetPropertyType(self: MatrixAnimationBase) -> Type
