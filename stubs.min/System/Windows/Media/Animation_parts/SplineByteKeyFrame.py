class SplineByteKeyFrame(ByteKeyFrame,ISealable,IKeyFrame):
 """
 Animates from the System.Byte value of the previous key frame to its own System.Windows.Media.Animation.ByteKeyFrame.Value using splined interpolation.

 

 SplineByteKeyFrame()

 SplineByteKeyFrame(value: Byte)

 SplineByteKeyFrame(value: Byte,keyTime: KeyTime)

 SplineByteKeyFrame(value: Byte,keyTime: KeyTime,keySpline: KeySpline)
 """
 ...
 def CreateInstanceCore(self,*args):
  """
  CreateInstanceCore(self: SplineByteKeyFrame) -> Freezable

  

   Creates a new instance of System.Windows.Media.Animation.SplineByteKeyFrame.

   Returns: A new System.Windows.Media.Animation.SplineByteKeyFrame.
  """
  pass
 ...
 def InterpolateValueCore(self,*args):
  """
  InterpolateValueCore(self: SplineByteKeyFrame,baseValue: Byte,keyFrameProgress: float) -> Byte
 ...
 def __new__(self,value=None,keyTime=None,keySpline=None):
  ...
  __new__(cls: type,value: Byte,keyTime: KeyTime)

  __new__(cls: type,value: Byte,keyTime: KeyTime,keySpline: KeySpline)
  """
  pass
...
Get: KeySpline(self: SplineByteKeyFrame) -> KeySpline



Set: KeySpline(self: SplineByteKeyFrame)=value
