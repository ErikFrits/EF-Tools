class SingleKeyFrame(Freezable,ISealable,IKeyFrame):
 """ Abstract class that,when implemented,defines an animation segment with its own target value and interpolation method for a System.Windows.Media.Animation.SingleAnimationUsingKeyFrames. """
 ...
 def InterpolateValue(self,baseValue,keyFrameProgress):
  """
  InterpolateValue(self: SingleKeyFrame,baseValue: Single,keyFrameProgress: float) -> Single
 ...
 def InterpolateValueCore(self,*args):
  """
  InterpolateValueCore(self: SingleKeyFrame,baseValue: Single,keyFrameProgress: float) -> Single
 ...
 """Gets or sets the time at which the key frame's target System.Windows.Media.Animation.SingleKeyFrame.Value should be reached.



Get: KeyTime(self: SingleKeyFrame) -> KeyTime



Set: KeyTime(self: SingleKeyFrame)=value
...
Get: Value(self: SingleKeyFrame) -> Single



Set: Value(self: SingleKeyFrame)=value
