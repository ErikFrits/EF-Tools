class ByteAnimationBase(AnimationTimeline,ISealable,IAnimatable,IResource):
 """ Abstract class that,when implemented,animates a System.Byte value. """
 ...
 def Clone(self):
  """
  Clone(self: ByteAnimationBase) -> ByteAnimationBase

  

   Creates a modifiable clone of this System.Windows.Media.Animation.ByteAnimationBase,making deep 
 ...
 def GetCurrentValue(self,defaultOriginValue,defaultDestinationValue,animationClock):
  """
  GetCurrentValue(self: ByteAnimationBase,defaultOriginValue: Byte,defaultDestinationValue: Byte,animationClock: AnimationClock) -> Byte
  ...
  GetCurrentValue(self: ByteAnimationBase,defaultOriginValue: object,defaultDestinationValue: object,animationClock: AnimationClock) -> object
 ...
 def GetCurrentValueCore(self,*args):
  """
  GetCurrentValueCore(self: ByteAnimationBase,defaultOriginValue: Byte,defaultDestinationValue: Byte,animationClock: AnimationClock) -> Byte
...
Get: TargetPropertyType(self: ByteAnimationBase) -> Type
