class ByteAnimation(ByteAnimationBase,ISealable,IAnimatable,IResource):
 ...
 def Clone(self):
  ...
  Clone(self: ByteAnimation) -> ByteAnimation
   ...
   Creates a modifiable clone of this System.Windows.Media.Animation.ByteAnimation,making deep 
 ...
 def GetCurrentValueCore(self,*args):
  ...
  GetCurrentValueCore(self: ByteAnimation,defaultOriginValue: Byte,defaultDestinationValue: Byte,animationClock: AnimationClock) -> Byte
   ...
   Calculates a value that represents the current value of the property being animated,as 
    ...
    determined by the System.Windows.Media.Animation.ByteAnimation.
