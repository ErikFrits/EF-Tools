class DiscreteRotation3DKeyFrame(Rotation3DKeyFrame,ISealable,IKeyFrame):
 """
 Animates from the System.Windows.Media.Media3D.Rotation3D value of the previous key frame to its own System.Windows.Media.Animation.Rotation3DKeyFrame.Value using discrete interpolation.

 

 DiscreteRotation3DKeyFrame()

 DiscreteRotation3DKeyFrame(value: Rotation3D)

 DiscreteRotation3DKeyFrame(value: Rotation3D,keyTime: KeyTime)
 """
 ...
 def CreateInstanceCore(self,*args):
  """
  CreateInstanceCore(self: DiscreteRotation3DKeyFrame) -> Freezable

  

   Creates a new instance of the System.Windows.Media.Animation.DiscreteRotation3DKeyFrame class.

   Returns: A new System.Windows.Media.Animation.DiscreteRotation3DKeyFrame.
  """
  pass
 ...
 def InterpolateValueCore(self,*args):
  """
  InterpolateValueCore(self: DiscreteRotation3DKeyFrame,baseValue: Rotation3D,keyFrameProgress: float) -> Rotation3D

  

   Computes a discrete interpolation between the previous key frame value and the value of the 
