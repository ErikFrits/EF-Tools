class SizeAnimation(SizeAnimationBase,ISealable,IAnimatable,IResource):
 """
 Animates the value of a  System.Windows.Size property between two target values using   linear interpolation over a specified System.Windows.Media.Animation.Timeline.Duration.

 

 SizeAnimation()

 SizeAnimation(toValue: Size,duration: Duration)

 SizeAnimation(toValue: Size,duration: Duration,fillBehavior: FillBehavior)

 SizeAnimation(fromValue: Size,toValue: Size,duration: Duration)

 SizeAnimation(fromValue: Size,toValue: Size,duration: Duration,fillBehavior: FillBehavior)
 """
 ...
 def Clone(self):
  """
  Clone(self: SizeAnimation) -> SizeAnimation

  

   Creates a modifiable clone of this System.Windows.Media.Animation.SizeAnimation,making deep 
 ...
 def CreateInstanceCore(self,*args):
  """
  CreateInstanceCore(self: SizeAnimation) -> Freezable

  

   Creates a new instance of the System.Windows.Media.Animation.SizeAnimation.
 ...
 def GetCurrentValueCore(self,*args):
  """
  GetCurrentValueCore(self: SizeAnimation,defaultOriginValue: Size,defaultDestinationValue: Size,animationClock: AnimationClock) -> Size

  

   Calculates a value that represents the current value of the property being animated,as 

    determined by the System.Windows.Media.Animation.SizeAnimation.
 ...
 def __new__(self,*__args):
  ...
  __new__(cls: type,toValue: Size,duration: Duration)

  __new__(cls: type,toValue: Size,duration: Duration,fillBehavior: FillBehavior)

  __new__(cls: type,fromValue: Size,toValue: Size,duration: Duration)

  __new__(cls: type,fromValue: Size,toValue: Size,duration: Duration,fillBehavior: FillBehavior)
  """
  pass
...
Get: By(self: SizeAnimation) -> Nullable[Size]



Set: By(self: SizeAnimation)=value
...
Get: EasingFunction(self: SizeAnimation) -> IEasingFunction



Set: EasingFunction(self: SizeAnimation)=value
...
Get: From(self: SizeAnimation) -> Nullable[Size]



Set: From(self: SizeAnimation)=value
...
Get: IsAdditive(self: SizeAnimation) -> bool



Set: IsAdditive(self: SizeAnimation)=value
...
Get: IsCumulative(self: SizeAnimation) -> bool



Set: IsCumulative(self: SizeAnimation)=value
...
Get: To(self: SizeAnimation) -> Nullable[Size]



Set: To(self: SizeAnimation)=value
