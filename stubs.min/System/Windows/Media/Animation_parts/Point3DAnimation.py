class Point3DAnimation(Point3DAnimationBase,ISealable,IAnimatable,IResource):
 """
 Animates the value of a System.Windows.Media.Media3D.Point3D property using linear interpolation between two values.

 

 Point3DAnimation()

 Point3DAnimation(toValue: Point3D,duration: Duration)

 Point3DAnimation(toValue: Point3D,duration: Duration,fillBehavior: FillBehavior)

 Point3DAnimation(fromValue: Point3D,toValue: Point3D,duration: Duration)

 Point3DAnimation(fromValue: Point3D,toValue: Point3D,duration: Duration,fillBehavior: FillBehavior)
 """
 ...
 def Clone(self):
  """
  Clone(self: Point3DAnimation) -> Point3DAnimation

  

   Creates a modifiable clone of this System.Windows.Media.Animation.Point3DAnimation,making deep 
 ...
 def CreateInstanceCore(self,*args):
  """
  CreateInstanceCore(self: Point3DAnimation) -> Freezable

  

   Creates a new instance of the System.Windows.Media.Animation.Point3DAnimation.

   Returns: The Point3Danimation is created with all properties set to their default value.
  """
  pass
 ...
 def GetCurrentValueCore(self,*args):
  """
  GetCurrentValueCore(self: Point3DAnimation,defaultOriginValue: Point3D,defaultDestinationValue: Point3D,animationClock: AnimationClock) -> Point3D

  

   Calculates a value that represents the current value of the property being animated,as 

    determined by the System.Windows.Media.Animation.Point3DAnimation.
 ...
 def __new__(self,*__args):
  ...
  __new__(cls: type,toValue: Point3D,duration: Duration)

  __new__(cls: type,toValue: Point3D,duration: Duration,fillBehavior: FillBehavior)

  __new__(cls: type,fromValue: Point3D,toValue: Point3D,duration: Duration)

  __new__(cls: type,fromValue: Point3D,toValue: Point3D,duration: Duration,fillBehavior: FillBehavior)
  """
  pass
...
Get: By(self: Point3DAnimation) -> Nullable[Point3D]



Set: By(self: Point3DAnimation)=value
...
Get: EasingFunction(self: Point3DAnimation) -> IEasingFunction



Set: EasingFunction(self: Point3DAnimation)=value
...
Get: From(self: Point3DAnimation) -> Nullable[Point3D]



Set: From(self: Point3DAnimation)=value
...
Get: IsAdditive(self: Point3DAnimation) -> bool



Set: IsAdditive(self: Point3DAnimation)=value
...
Get: IsCumulative(self: Point3DAnimation) -> bool



Set: IsCumulative(self: Point3DAnimation)=value
...
Get: To(self: Point3DAnimation) -> Nullable[Point3D]



Set: To(self: Point3DAnimation)=value
