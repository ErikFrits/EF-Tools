class EasingPoint3DKeyFrame(Point3DKeyFrame,ISealable,IKeyFrame):
 """
 A class that enables you to associate easing functions with a System.Windows.Media.Animation.Point3DAnimationUsingKeyFrames key frame animation.

 

 EasingPoint3DKeyFrame()

 EasingPoint3DKeyFrame(value: Point3D)

 EasingPoint3DKeyFrame(value: Point3D,keyTime: KeyTime)

 EasingPoint3DKeyFrame(value: Point3D,keyTime: KeyTime,easingFunction: IEasingFunction)
 """
 ...
 def CreateInstanceCore(self,*args):
  """
  CreateInstanceCore(self: EasingPoint3DKeyFrame) -> Freezable
 ...
 def InterpolateValueCore(self,*args):
  """
  InterpolateValueCore(self: EasingPoint3DKeyFrame,baseValue: Point3D,keyFrameProgress: float) -> Point3D
 ...
 def __new__(self,value=None,keyTime=None,easingFunction=None):
  ...
  __new__(cls: type,value: Point3D,keyTime: KeyTime,easingFunction: IEasingFunction)
  """
  pass
...
Get: EasingFunction(self: EasingPoint3DKeyFrame) -> IEasingFunction



Set: EasingFunction(self: EasingPoint3DKeyFrame)=value
