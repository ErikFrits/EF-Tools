class DiscreteQuaternionKeyFrame(QuaternionKeyFrame,ISealable,IKeyFrame):
 """
 Animates from the System.Windows.Media.Media3D.Quaternion value of the previous key frame to its own System.Windows.Media.Animation.QuaternionKeyFrame.Value using discrete interpolation.

 

 DiscreteQuaternionKeyFrame()

 DiscreteQuaternionKeyFrame(value: Quaternion)

 DiscreteQuaternionKeyFrame(value: Quaternion,keyTime: KeyTime)
 """
 ...
 def CreateInstanceCore(self,*args):
  """
  CreateInstanceCore(self: DiscreteQuaternionKeyFrame) -> Freezable

  

   Creates a new instance of System.Windows.Media.Animation.DiscreteQuaternionKeyFrame.

   Returns: A new System.Windows.Media.Animation.DiscreteQuaternionKeyFrame.
  """
  pass
 ...
 def InterpolateValueCore(self,*args):
  """
  InterpolateValueCore(self: DiscreteQuaternionKeyFrame,baseValue: Quaternion,keyFrameProgress: float) -> Quaternion
