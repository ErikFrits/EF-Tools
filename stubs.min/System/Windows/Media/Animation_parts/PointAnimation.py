class PointAnimation(PointAnimationBase,ISealable,IAnimatable,IResource):
 """
 Animates the value of a System.Windows.Point property between two target values using   linear interpolation over a specified System.Windows.Media.Animation.Timeline.Duration.

 

 PointAnimation()

 PointAnimation(toValue: Point,duration: Duration)

 PointAnimation(toValue: Point,duration: Duration,fillBehavior: FillBehavior)

 PointAnimation(fromValue: Point,toValue: Point,duration: Duration)

 PointAnimation(fromValue: Point,toValue: Point,duration: Duration,fillBehavior: FillBehavior)
 """
 ...
 def Clone(self):
  """
  Clone(self: PointAnimation) -> PointAnimation

  

   Creates a modifiable clone of this System.Windows.Media.Animation.PointAnimation,making deep 
 ...
 def CreateInstanceCore(self,*args):
  """
  CreateInstanceCore(self: PointAnimation) -> Freezable

  

   Creates a new instance of the System.Windows.Media.Animation.PointAnimation.
 ...
 def GetCurrentValueCore(self,*args):
  """
  GetCurrentValueCore(self: PointAnimation,defaultOriginValue: Point,defaultDestinationValue: Point,animationClock: AnimationClock) -> Point

  

   Calculates a value that represents the current value of the property being animated,as 

    determined by the System.Windows.Media.Animation.PointAnimation.
 ...
 def __new__(self,*__args):
  ...
  __new__(cls: type,toValue: Point,duration: Duration)

  __new__(cls: type,toValue: Point,duration: Duration,fillBehavior: FillBehavior)

  __new__(cls: type,fromValue: Point,toValue: Point,duration: Duration)

  __new__(cls: type,fromValue: Point,toValue: Point,duration: Duration,fillBehavior: FillBehavior)
  """
  pass
...
Get: By(self: PointAnimation) -> Nullable[Point]



Set: By(self: PointAnimation)=value
...
Get: EasingFunction(self: PointAnimation) -> IEasingFunction



Set: EasingFunction(self: PointAnimation)=value
...
Get: From(self: PointAnimation) -> Nullable[Point]



Set: From(self: PointAnimation)=value
...
Get: IsAdditive(self: PointAnimation) -> bool



Set: IsAdditive(self: PointAnimation)=value
...
Get: IsCumulative(self: PointAnimation) -> bool



Set: IsCumulative(self: PointAnimation)=value
...
Get: To(self: PointAnimation) -> Nullable[Point]



Set: To(self: PointAnimation)=value
