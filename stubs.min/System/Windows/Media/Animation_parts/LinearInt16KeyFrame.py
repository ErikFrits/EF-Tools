class LinearInt16KeyFrame(Int16KeyFrame,ISealable,IKeyFrame):
 """
 Animates from the System.Int16 value of the previous key frame to its own System.Windows.Media.Animation.Int16KeyFrame.Value using linear interpolation.

 

 LinearInt16KeyFrame()

 LinearInt16KeyFrame(value: Int16)

 LinearInt16KeyFrame(value: Int16,keyTime: KeyTime)
 """
 ...
 def CreateInstanceCore(self,*args):
  """
  CreateInstanceCore(self: LinearInt16KeyFrame) -> Freezable

  

   Creates a new instance of System.Windows.Media.Animation.LinearInt16KeyFrame.

   Returns: A new System.Windows.Media.Animation.LinearInt16KeyFrame.
  """
  pass
 ...
 def InterpolateValueCore(self,*args):
  """
  InterpolateValueCore(self: LinearInt16KeyFrame,baseValue: Int16,keyFrameProgress: float) -> Int16
