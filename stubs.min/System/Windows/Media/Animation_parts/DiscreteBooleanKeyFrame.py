class DiscreteBooleanKeyFrame(BooleanKeyFrame,ISealable,IKeyFrame):
 """
 Animates from the System.Boolean value of the previous key frame to its own System.Windows.Media.Animation.BooleanKeyFrame.Value using discrete interpolation.

 

 DiscreteBooleanKeyFrame()

 DiscreteBooleanKeyFrame(value: bool)

 DiscreteBooleanKeyFrame(value: bool,keyTime: KeyTime)
 """
 ...
 def CreateInstanceCore(self,*args):
  """
  CreateInstanceCore(self: DiscreteBooleanKeyFrame) -> Freezable

  

   Creates a new instance of System.Windows.Media.Animation.DiscreteBooleanKeyFrame.

   Returns: A new System.Windows.Media.Animation.DiscreteBooleanKeyFrame.
  """
  pass
 ...
 def InterpolateValueCore(self,*args):
  """
  InterpolateValueCore(self: DiscreteBooleanKeyFrame,baseValue: bool,keyFrameProgress: float) -> bool
 ...
 def __new__(self,value=None,keyTime=None):
  ...
  __new__(cls: type,value: bool,keyTime: KeyTime)
  """
  pass
