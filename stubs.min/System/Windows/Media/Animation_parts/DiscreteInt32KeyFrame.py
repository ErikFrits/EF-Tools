class DiscreteInt32KeyFrame(Int32KeyFrame,ISealable,IKeyFrame):
 """
 Animates from the System.Int32 value of the previous key frame to its own System.Windows.Media.Animation.Int32KeyFrame.Value using discrete interpolation.

 

 DiscreteInt32KeyFrame()

 DiscreteInt32KeyFrame(value: int)

 DiscreteInt32KeyFrame(value: int,keyTime: KeyTime)
 """
 ...
 def CreateInstanceCore(self,*args):
  """
  CreateInstanceCore(self: DiscreteInt32KeyFrame) -> Freezable

  

   Creates a new instance of System.Windows.Media.Animation.DiscreteInt32KeyFrame.

   Returns: A new System.Windows.Media.Animation.DiscreteInt32KeyFrame.
  """
  pass
 ...
 def InterpolateValueCore(self,*args):
  """
  InterpolateValueCore(self: DiscreteInt32KeyFrame,baseValue: int,keyFrameProgress: float) -> int
