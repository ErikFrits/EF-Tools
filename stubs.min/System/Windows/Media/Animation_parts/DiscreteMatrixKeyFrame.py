class DiscreteMatrixKeyFrame(MatrixKeyFrame,ISealable,IKeyFrame):
 """
 Animates from the System.Windows.Media.Matrix value of the previous key frame to its own System.Windows.Media.Animation.MatrixKeyFrame.Value using discrete interpolation.
 ...
 DiscreteMatrixKeyFrame(value: Matrix,keyTime: KeyTime)
 """
 ...
 def CreateInstanceCore(self,*args):
  """
  CreateInstanceCore(self: DiscreteMatrixKeyFrame) -> Freezable

  

   Creates a new instance of System.Windows.Media.Animation.DiscreteMatrixKeyFrame.

   Returns: A new System.Windows.Media.Animation.DiscreteMatrixKeyFrame.
  """
  pass
 ...
 def InterpolateValueCore(self,*args):
  """
  InterpolateValueCore(self: DiscreteMatrixKeyFrame,baseValue: Matrix,keyFrameProgress: float) -> Matrix
