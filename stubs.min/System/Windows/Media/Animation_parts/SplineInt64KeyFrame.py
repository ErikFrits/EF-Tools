class SplineInt64KeyFrame(Int64KeyFrame,ISealable,IKeyFrame):
 """
 Animates from the System.Int64 value of the previous key frame to its own System.Windows.Media.Animation.Int64KeyFrame.Value using splined interpolation.

 

 SplineInt64KeyFrame()

 SplineInt64KeyFrame(value: Int64)

 SplineInt64KeyFrame(value: Int64,keyTime: KeyTime)

 SplineInt64KeyFrame(value: Int64,keyTime: KeyTime,keySpline: KeySpline)
 """
 ...
 def CreateInstanceCore(self,*args):
  """
  CreateInstanceCore(self: SplineInt64KeyFrame) -> Freezable

  

   Creates a new instance of System.Windows.Media.Animation.SplineInt64KeyFrame.

   Returns: A new System.Windows.Media.Animation.SplineInt64KeyFrame.
  """
  pass
 ...
 def InterpolateValueCore(self,*args):
  """
  InterpolateValueCore(self: SplineInt64KeyFrame,baseValue: Int64,keyFrameProgress: float) -> Int64
 ...
 def __new__(self,value=None,keyTime=None,keySpline=None):
  ...
  __new__(cls: type,value: Int64,keyTime: KeyTime)

  __new__(cls: type,value: Int64,keyTime: KeyTime,keySpline: KeySpline)
  """
  pass
...
Get: KeySpline(self: SplineInt64KeyFrame) -> KeySpline



Set: KeySpline(self: SplineInt64KeyFrame)=value
