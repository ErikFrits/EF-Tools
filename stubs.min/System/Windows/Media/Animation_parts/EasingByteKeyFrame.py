class EasingByteKeyFrame(ByteKeyFrame,ISealable,IKeyFrame):
 """
 A class that enables you to associate easing functions with a System.Windows.Media.Animation.ByteAnimationUsingKeyFrames key frame animation.

 

 EasingByteKeyFrame()

 EasingByteKeyFrame(value: Byte)

 EasingByteKeyFrame(value: Byte,keyTime: KeyTime)

 EasingByteKeyFrame(value: Byte,keyTime: KeyTime,easingFunction: IEasingFunction)
 """
 ...
 def CreateInstanceCore(self,*args):
  """
  CreateInstanceCore(self: EasingByteKeyFrame) -> Freezable
 ...
 def InterpolateValueCore(self,*args):
  """
  InterpolateValueCore(self: EasingByteKeyFrame,baseValue: Byte,keyFrameProgress: float) -> Byte
 ...
 def __new__(self,value=None,keyTime=None,easingFunction=None):
  ...
  __new__(cls: type,value: Byte,keyTime: KeyTime,easingFunction: IEasingFunction)
  """
  pass
...
Get: EasingFunction(self: EasingByteKeyFrame) -> IEasingFunction



Set: EasingFunction(self: EasingByteKeyFrame)=value
