class DecimalAnimation(DecimalAnimationBase,ISealable,IAnimatable,IResource):
 """
 Animates the value of a  System.Decimal property between two target values using   linear interpolation over a specified System.Windows.Media.Animation.Timeline.Duration.

 

 DecimalAnimation()

 DecimalAnimation(toValue: Decimal,duration: Duration)

 DecimalAnimation(toValue: Decimal,duration: Duration,fillBehavior: FillBehavior)

 DecimalAnimation(fromValue: Decimal,toValue: Decimal,duration: Duration)

 DecimalAnimation(fromValue: Decimal,toValue: Decimal,duration: Duration,fillBehavior: FillBehavior)
 """
 ...
 def Clone(self):
  """
  Clone(self: DecimalAnimation) -> DecimalAnimation

  

   Creates a modifiable clone of this System.Windows.Media.Animation.DecimalAnimation,making deep 
 ...
 def CreateInstanceCore(self,*args):
  """
  CreateInstanceCore(self: DecimalAnimation) -> Freezable

  

   Creates a new instance of the System.Windows.Media.Animation.DecimalAnimation.
 ...
 def GetCurrentValueCore(self,*args):
  """
  GetCurrentValueCore(self: DecimalAnimation,defaultOriginValue: Decimal,defaultDestinationValue: Decimal,animationClock: AnimationClock) -> Decimal

  

   Calculates a value that represents the current value of the property being animated,as 

    determined by the System.Windows.Media.Animation.DecimalAnimation.
 ...
 def __new__(self,*__args):
  ...
  __new__(cls: type,toValue: Decimal,duration: Duration)

  __new__(cls: type,toValue: Decimal,duration: Duration,fillBehavior: FillBehavior)

  __new__(cls: type,fromValue: Decimal,toValue: Decimal,duration: Duration)

  __new__(cls: type,fromValue: Decimal,toValue: Decimal,duration: Duration,fillBehavior: FillBehavior)
  """
  pass
...
Get: By(self: DecimalAnimation) -> Nullable[Decimal]



Set: By(self: DecimalAnimation)=value
...
Get: EasingFunction(self: DecimalAnimation) -> IEasingFunction



Set: EasingFunction(self: DecimalAnimation)=value
...
Get: From(self: DecimalAnimation) -> Nullable[Decimal]



Set: From(self: DecimalAnimation)=value
...
Get: IsAdditive(self: DecimalAnimation) -> bool



Set: IsAdditive(self: DecimalAnimation)=value
...
Get: IsCumulative(self: DecimalAnimation) -> bool



Set: IsCumulative(self: DecimalAnimation)=value
...
Get: To(self: DecimalAnimation) -> Nullable[Decimal]



Set: To(self: DecimalAnimation)=value
