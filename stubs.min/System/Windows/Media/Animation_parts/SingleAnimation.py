class SingleAnimation(SingleAnimationBase,ISealable,IAnimatable,IResource):
 """
 Animates the value of a  System.Single property between two target values using   linear interpolation over a specified System.Windows.Media.Animation.Timeline.Duration.

 

 SingleAnimation()

 SingleAnimation(toValue: Single,duration: Duration)

 SingleAnimation(toValue: Single,duration: Duration,fillBehavior: FillBehavior)

 SingleAnimation(fromValue: Single,toValue: Single,duration: Duration)

 SingleAnimation(fromValue: Single,toValue: Single,duration: Duration,fillBehavior: FillBehavior)
 """
 ...
 def Clone(self):
  """
  Clone(self: SingleAnimation) -> SingleAnimation

  

   Creates a modifiable clone of this System.Windows.Media.Animation.SingleAnimation,making deep 
 ...
 def CreateInstanceCore(self,*args):
  """
  CreateInstanceCore(self: SingleAnimation) -> Freezable

  

   Creates a new instance of the System.Windows.Media.Animation.PointAnimationUsingKeyFrames.
 ...
 def GetCurrentValueCore(self,*args):
  """
  GetCurrentValueCore(self: SingleAnimation,defaultOriginValue: Single,defaultDestinationValue: Single,animationClock: AnimationClock) -> Single

  

   Calculates a value that represents the current value of the property being animated,as 

    determined by the System.Windows.Media.Animation.SingleAnimation.
 ...
 def __new__(self,*__args):
  ...
  __new__(cls: type,toValue: Single,duration: Duration)

  __new__(cls: type,toValue: Single,duration: Duration,fillBehavior: FillBehavior)

  __new__(cls: type,fromValue: Single,toValue: Single,duration: Duration)

  __new__(cls: type,fromValue: Single,toValue: Single,duration: Duration,fillBehavior: FillBehavior)
  """
  pass
...
Get: By(self: SingleAnimation) -> Nullable[Single]



Set: By(self: SingleAnimation)=value
...
Get: EasingFunction(self: SingleAnimation) -> IEasingFunction



Set: EasingFunction(self: SingleAnimation)=value
...
Get: From(self: SingleAnimation) -> Nullable[Single]



Set: From(self: SingleAnimation)=value
...
Get: IsAdditive(self: SingleAnimation) -> bool



Set: IsAdditive(self: SingleAnimation)=value
...
Get: IsCumulative(self: SingleAnimation) -> bool



Set: IsCumulative(self: SingleAnimation)=value
...
Get: To(self: SingleAnimation) -> Nullable[Single]



Set: To(self: SingleAnimation)=value
