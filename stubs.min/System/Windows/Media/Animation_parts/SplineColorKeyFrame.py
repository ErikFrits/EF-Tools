class SplineColorKeyFrame(ColorKeyFrame,ISealable,IKeyFrame):
 """
 Animates from the System.Windows.Media.Color value of the previous key frame to its own System.Windows.Media.Animation.ColorKeyFrame.Value using splined interpolation.

 

 SplineColorKeyFrame()

 SplineColorKeyFrame(value: Color)

 SplineColorKeyFrame(value: Color,keyTime: KeyTime)

 SplineColorKeyFrame(value: Color,keyTime: KeyTime,keySpline: KeySpline)
 """
 ...
 def CreateInstanceCore(self,*args):
  """
  CreateInstanceCore(self: SplineColorKeyFrame) -> Freezable

  

   Creates a new instance of System.Windows.Media.Animation.SplineColorKeyFrame.

   Returns: A new System.Windows.Media.Animation.SplineColorKeyFrame.
  """
  pass
 ...
 def InterpolateValueCore(self,*args):
  """
  InterpolateValueCore(self: SplineColorKeyFrame,baseValue: Color,keyFrameProgress: float) -> Color
 ...
 def __new__(self,value=None,keyTime=None,keySpline=None):
  ...
  __new__(cls: type,value: Color)

  __new__(cls: type,value: Color,keyTime: KeyTime)

  __new__(cls: type,value: Color,keyTime: KeyTime,keySpline: KeySpline)
  """
  pass
...
Get: KeySpline(self: SplineColorKeyFrame) -> KeySpline



Set: KeySpline(self: SplineColorKeyFrame)=value
