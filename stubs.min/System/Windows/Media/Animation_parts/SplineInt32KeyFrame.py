class SplineInt32KeyFrame(Int32KeyFrame,ISealable,IKeyFrame):
 """
 Animates from the System.Int32 value of the previous key frame to its own System.Windows.Media.Animation.Int32KeyFrame.Value using splined interpolation.

 

 SplineInt32KeyFrame()

 SplineInt32KeyFrame(value: int)

 SplineInt32KeyFrame(value: int,keyTime: KeyTime)

 SplineInt32KeyFrame(value: int,keyTime: KeyTime,keySpline: KeySpline)
 """
 ...
 def CreateInstanceCore(self,*args):
  """
  CreateInstanceCore(self: SplineInt32KeyFrame) -> Freezable

  

   Creates a new instance of System.Windows.Media.Animation.SplineInt32KeyFrame.

   Returns: A new System.Windows.Media.Animation.SplineInt32KeyFrame.
  """
  pass
 ...
 def InterpolateValueCore(self,*args):
  """
  InterpolateValueCore(self: SplineInt32KeyFrame,baseValue: int,keyFrameProgress: float) -> int
 ...
 def __new__(self,value=None,keyTime=None,keySpline=None):
  ...
  __new__(cls: type,value: int,keyTime: KeyTime)

  __new__(cls: type,value: int,keyTime: KeyTime,keySpline: KeySpline)
  """
  pass
...
Get: KeySpline(self: SplineInt32KeyFrame) -> KeySpline



Set: KeySpline(self: SplineInt32KeyFrame)=value
