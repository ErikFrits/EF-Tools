class SplineSingleKeyFrame(SingleKeyFrame,ISealable,IKeyFrame):
 """
 Animates from the System.Single value of the previous key frame to its own System.Windows.Media.Animation.SingleKeyFrame.Value using splined interpolation.

 

 SplineSingleKeyFrame()

 SplineSingleKeyFrame(value: Single)

 SplineSingleKeyFrame(value: Single,keyTime: KeyTime)

 SplineSingleKeyFrame(value: Single,keyTime: KeyTime,keySpline: KeySpline)
 """
 ...
 def CreateInstanceCore(self,*args):
  """
  CreateInstanceCore(self: SplineSingleKeyFrame) -> Freezable

  

   Creates a new instance of System.Windows.Media.Animation.SplineSingleKeyFrame.

   Returns: A new System.Windows.Media.Animation.SplineSingleKeyFrame.
  """
  pass
 ...
 def __new__(self,value=None,keyTime=None,keySpline=None):
  ...
  __new__(cls: type,value: Single,keyTime: KeyTime)

  __new__(cls: type,value: Single,keyTime: KeyTime,keySpline: KeySpline)
  """
  pass
...
Get: KeySpline(self: SplineSingleKeyFrame) -> KeySpline



Set: KeySpline(self: SplineSingleKeyFrame)=value
