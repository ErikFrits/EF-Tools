...
Get: KeyTime(self: QuaternionKeyFrame) -> KeyTime



Set: KeyTime(self: QuaternionKeyFrame)=value
...
Get: Value(self: QuaternionKeyFrame) -> Quaternion



Set: Value(self: QuaternionKeyFrame)=value
