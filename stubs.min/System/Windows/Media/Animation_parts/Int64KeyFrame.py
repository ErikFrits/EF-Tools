class Int64KeyFrame(Freezable,ISealable,IKeyFrame):
 """ Abstract class that,when implemented,defines an animation segment with its own target value and interpolation method for a System.Windows.Media.Animation.Int64AnimationUsingKeyFrames. """
 ...
 def InterpolateValue(self,baseValue,keyFrameProgress):
  """
  InterpolateValue(self: Int64KeyFrame,baseValue: Int64,keyFrameProgress: float) -> Int64
 ...
 def InterpolateValueCore(self,*args):
  """
  InterpolateValueCore(self: Int64KeyFrame,baseValue: Int64,keyFrameProgress: float) -> Int64
 ...
 """Gets or sets the time at which the key frame's target System.Windows.Media.Animation.Int64KeyFrame.Value should be reached.



Get: KeyTime(self: Int64KeyFrame) -> KeyTime



Set: KeyTime(self: Int64KeyFrame)=value
...
Get: Value(self: Int64KeyFrame) -> Int64



Set: Value(self: Int64KeyFrame)=value
