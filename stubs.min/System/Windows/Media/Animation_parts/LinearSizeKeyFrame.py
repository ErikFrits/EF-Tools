class LinearSizeKeyFrame(SizeKeyFrame,ISealable,IKeyFrame):
 """
 Animates from the System.Windows.Size value of the previous key frame to its own System.Windows.Media.Animation.SizeKeyFrame.Value using linear interpolation.

 

 LinearSizeKeyFrame()

 LinearSizeKeyFrame(value: Size)

 LinearSizeKeyFrame(value: Size,keyTime: KeyTime)
 """
 ...
 def CreateInstanceCore(self,*args):
  """
  CreateInstanceCore(self: LinearSizeKeyFrame) -> Freezable

  

   Creates a new instance of System.Windows.Media.Animation.LinearSizeKeyFrame.

   Returns: A new System.Windows.Media.Animation.LinearSizeKeyFrame.
  """
  pass
 ...
 def InterpolateValueCore(self,*args):
  """
  InterpolateValueCore(self: LinearSizeKeyFrame,baseValue: Size,keyFrameProgress: float) -> Size
