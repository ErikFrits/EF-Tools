class QuinticEase(EasingFunctionBase,ISealable,IEasingFunction):
 """
 ...
 def CreateInstanceCore(self,*args):
  """
  CreateInstanceCore(self: QuinticEase) -> Freezable
 ...
 def EaseInCore(self,*args):
  """
  EaseInCore(self: QuinticEase,normalizedTime: float) -> float
