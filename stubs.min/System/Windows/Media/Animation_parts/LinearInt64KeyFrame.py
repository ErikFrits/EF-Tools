class LinearInt64KeyFrame(Int64KeyFrame,ISealable,IKeyFrame):
 """
 Animates from the System.Int64 value of the previous key frame to its own System.Windows.Media.Animation.Int64KeyFrame.Value using linear interpolation.

 

 LinearInt64KeyFrame()

 LinearInt64KeyFrame(value: Int64)

 LinearInt64KeyFrame(value: Int64,keyTime: KeyTime)
 """
 ...
 def CreateInstanceCore(self,*args):
  """
  CreateInstanceCore(self: LinearInt64KeyFrame) -> Freezable

  

   Creates a new instance of System.Windows.Media.Animation.LinearInt64KeyFrame.

   Returns: A new System.Windows.Media.Animation.LinearInt64KeyFrame.
  """
  pass
 ...
 def InterpolateValueCore(self,*args):
  """
  InterpolateValueCore(self: LinearInt64KeyFrame,baseValue: Int64,keyFrameProgress: float) -> Int64
