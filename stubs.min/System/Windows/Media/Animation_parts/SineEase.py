class SineEase(EasingFunctionBase,ISealable,IEasingFunction):
 """
 ...
 def CreateInstanceCore(self,*args):
  """
  CreateInstanceCore(self: SineEase) -> Freezable
 ...
 def EaseInCore(self,*args):
  """
  EaseInCore(self: SineEase,normalizedTime: float) -> float
