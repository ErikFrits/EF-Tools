class Int32AnimationBase(AnimationTimeline,ISealable,IAnimatable,IResource):
 """ Abstract class that,when implemented,animates a System.Int32 value. """
 ...
 def Clone(self):
  """
  Clone(self: Int32AnimationBase) -> Int32AnimationBase

  

   Creates a modifiable clone of this System.Windows.Media.Animation.Int32AnimationBase,making 
 ...
 def GetCurrentValue(self,defaultOriginValue,defaultDestinationValue,animationClock):
  """
  GetCurrentValue(self: Int32AnimationBase,defaultOriginValue: int,defaultDestinationValue: int,animationClock: AnimationClock) -> int
  ...
  GetCurrentValue(self: Int32AnimationBase,defaultOriginValue: object,defaultDestinationValue: object,animationClock: AnimationClock) -> object
 ...
 def GetCurrentValueCore(self,*args):
  """
  GetCurrentValueCore(self: Int32AnimationBase,defaultOriginValue: int,defaultDestinationValue: int,animationClock: AnimationClock) -> int
...
Get: TargetPropertyType(self: Int32AnimationBase) -> Type
