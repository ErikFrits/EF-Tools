class SplineRectKeyFrame(RectKeyFrame,ISealable,IKeyFrame):
 """
 Animates from the System.Windows.Rect value of the previous key frame to its own System.Windows.Media.Animation.RectKeyFrame.Value using splined interpolation.

 

 SplineRectKeyFrame()

 SplineRectKeyFrame(value: Rect)

 SplineRectKeyFrame(value: Rect,keyTime: KeyTime)

 SplineRectKeyFrame(value: Rect,keyTime: KeyTime,keySpline: KeySpline)
 """
 ...
 def CreateInstanceCore(self,*args):
  """
  CreateInstanceCore(self: SplineRectKeyFrame) -> Freezable

  

   Creates a new instance of System.Windows.Media.Animation.SplineRectKeyFrame.

   Returns: A new System.Windows.Media.Animation.SplineRectKeyFrame.
  """
  pass
 ...
 def InterpolateValueCore(self,*args):
  """
  InterpolateValueCore(self: SplineRectKeyFrame,baseValue: Rect,keyFrameProgress: float) -> Rect
 ...
 def __new__(self,value=None,keyTime=None,keySpline=None):
  ...
  __new__(cls: type,value: Rect)

  __new__(cls: type,value: Rect,keyTime: KeyTime)

  __new__(cls: type,value: Rect,keyTime: KeyTime,keySpline: KeySpline)
  """
  pass
...
Get: KeySpline(self: SplineRectKeyFrame) -> KeySpline



Set: KeySpline(self: SplineRectKeyFrame)=value
