class LinearDecimalKeyFrame(DecimalKeyFrame,ISealable,IKeyFrame):
 """
 Animates from the System.Decimal value of the previous key frame to its own System.Windows.Media.Animation.DecimalKeyFrame.Value using linear interpolation.

 

 LinearDecimalKeyFrame()

 LinearDecimalKeyFrame(value: Decimal)

 LinearDecimalKeyFrame(value: Decimal,keyTime: KeyTime)
 """
 ...
 def CreateInstanceCore(self,*args):
  """
  CreateInstanceCore(self: LinearDecimalKeyFrame) -> Freezable

  

   Creates a new instance of System.Windows.Media.Animation.LinearDecimalKeyFrame.

   Returns: A new System.Windows.Media.Animation.LinearDecimalKeyFrame.
  """
  pass
 ...
 def InterpolateValueCore(self,*args):
  """
  InterpolateValueCore(self: LinearDecimalKeyFrame,baseValue: Decimal,keyFrameProgress: float) -> Decimal
 ...
 def __new__(self,value=None,keyTime=None):
  ...
  __new__(cls: type,value: Decimal,keyTime: KeyTime)
  """
  pass
