class EasingVector3DKeyFrame(Vector3DKeyFrame,ISealable,IKeyFrame):
 ...
 EasingVector3DKeyFrame(value: Vector3D)

 EasingVector3DKeyFrame(value: Vector3D,keyTime: KeyTime)
...
Get: EasingFunction(self: EasingVector3DKeyFrame) -> IEasingFunction



Set: EasingFunction(self: EasingVector3DKeyFrame)=value
