class DiscreteDecimalKeyFrame(DecimalKeyFrame,ISealable,IKeyFrame):
 """
 Animates from the System.Decimal value of the previous key frame to its own System.Windows.Media.Animation.DecimalKeyFrame.Value using discrete interpolation.

 

 DiscreteDecimalKeyFrame()

 DiscreteDecimalKeyFrame(value: Decimal)

 DiscreteDecimalKeyFrame(value: Decimal,keyTime: KeyTime)
 """
 ...
 def CreateInstanceCore(self,*args):
  """
  CreateInstanceCore(self: DiscreteDecimalKeyFrame) -> Freezable

  

   Creates a new instance of System.Windows.Media.Animation.DiscreteDecimalKeyFrame.

   Returns: A new System.Windows.Media.Animation.DiscreteDecimalKeyFrame.
  """
  pass
 ...
 def InterpolateValueCore(self,*args):
  """
  InterpolateValueCore(self: DiscreteDecimalKeyFrame,baseValue: Decimal,keyFrameProgress: float) -> Decimal
