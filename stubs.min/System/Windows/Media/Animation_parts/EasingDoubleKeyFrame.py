class EasingDoubleKeyFrame(DoubleKeyFrame,ISealable,IKeyFrame):
 """
 A class that enables you to associate easing functions with a System.Windows.Media.Animation.DoubleAnimationUsingKeyFrames key frame animation.

 

 EasingDoubleKeyFrame()

 EasingDoubleKeyFrame(value: float)

 EasingDoubleKeyFrame(value: float,keyTime: KeyTime)

 EasingDoubleKeyFrame(value: float,keyTime: KeyTime,easingFunction: IEasingFunction)
 """
 ...
 def CreateInstanceCore(self,*args):
  """
  CreateInstanceCore(self: EasingDoubleKeyFrame) -> Freezable
 ...
 def InterpolateValueCore(self,*args):
  """
  InterpolateValueCore(self: EasingDoubleKeyFrame,baseValue: float,keyFrameProgress: float) -> float
 ...
 def __new__(self,value=None,keyTime=None,easingFunction=None):
  ...
  __new__(cls: type,value: float,keyTime: KeyTime,easingFunction: IEasingFunction)
  """
  pass
...
Get: EasingFunction(self: EasingDoubleKeyFrame) -> IEasingFunction



Set: EasingFunction(self: EasingDoubleKeyFrame)=value
