class Int16KeyFrameCollection(Freezable,ISealable,IList,ICollection,IEnumerable):
 ...
 def Clone(self):
  ...
  Clone(self: Int16KeyFrameCollection) -> Int16KeyFrameCollection
   ...
   Creates a modifiable clone of this System.Windows.Media.Animation.Int16KeyFrameCollection,
 ...
 def CloneCore(self,*args):
  ...
  CloneCore(self: Int16KeyFrameCollection,sourceFreezable: Freezable)
   ...
   Makes this instance a deep copy of the specified 
    ...
    System.Windows.Media.Animation.Int16KeyFrameCollection. When copying dependency properties,this 
 ...
 def CloneCurrentValueCore(self,*args):
  ...
  CloneCurrentValueCore(self: Int16KeyFrameCollection,sourceFreezable: Freezable)
   ...
   Makes this instance a modifiable deep copy of the specified 
    ...
    System.Windows.Media.Animation.Int16KeyFrameCollection using current property values. Resource 
 ...
 def CopyTo(self,array,index):
  ...
  CopyTo(self: Int16KeyFrameCollection,array: Array[Int16KeyFrame],index: int)
   ...
   Copies all of the System.Windows.Media.Animation.Int16KeyFrame objects in a collection to a 
 ...
 def FreezeCore(self,*args):
  ...
  FreezeCore(self: Int16KeyFrameCollection,isChecking: bool) -> bool
   ...
   Makes this instance of System.Windows.Media.Animation.Int16KeyFrameCollection read-only or 
 ...
 def GetAsFrozenCore(self,*args):
  ...
  GetAsFrozenCore(self: Int16KeyFrameCollection,sourceFreezable: Freezable)
   ...
   Makes this instance a clone of the specified 
    ...
    System.Windows.Media.Animation.Int16KeyFrameCollection object.
 ...
 def GetCurrentValueAsFrozenCore(self,*args):
  ...
  GetCurrentValueAsFrozenCore(self: Int16KeyFrameCollection,sourceFreezable: Freezable)
   ...
   Makes this instance a frozen clone of the specified 
    ...
    System.Windows.Media.Animation.Int16KeyFrameCollection. Resource references,data bindings,and 
 ...
 def IndexOf(self,keyFrame):
  ...
  IndexOf(self: Int16KeyFrameCollection,keyFrame: Int16KeyFrame) -> int
   ...
   Searches for the specified System.Windows.Media.Animation.Int16KeyFrame and returns the 
 ...
 def Insert(self,index,keyFrame):
  ...
  Insert(self: Int16KeyFrameCollection,index: int,keyFrame: Int16KeyFrame)
   ...
   Inserts a System.Windows.Media.Animation.Int16KeyFrame into a specific location within the 
 ...
 def RemoveAt(self,index):
  ...
  RemoveAt(self: Int16KeyFrameCollection,index: int)
   ...
   Removes the System.Windows.Media.Animation.Int16KeyFrame at the specified index position from 
