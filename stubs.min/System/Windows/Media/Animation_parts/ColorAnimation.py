class ColorAnimation(ColorAnimationBase,ISealable,IAnimatable,IResource):
 """
 Animates the value of a  System.Windows.Media.Color property between two target values using   linear interpolation over a specified System.Windows.Media.Animation.Timeline.Duration.
 ...
 ColorAnimation(fromValue: Color,toValue: Color,duration: Duration,fillBehavior: FillBehavior)
 """
 ...
 def Clone(self):
  """
  Clone(self: ColorAnimation) -> ColorAnimation

  

   Creates a modifiable clone of this System.Windows.Media.Animation.ColorAnimation,making deep 
 ...
 def CreateInstanceCore(self,*args):
  """
  CreateInstanceCore(self: ColorAnimation) -> Freezable

  

   Creates a new instance of the System.Windows.Media.Animation.ColorAnimation.
 ...
 def GetCurrentValueCore(self,*args):
  """
  GetCurrentValueCore(self: ColorAnimation,defaultOriginValue: Color,defaultDestinationValue: Color,animationClock: AnimationClock) -> Color

  

   Calculates a value that represents the current value of the property being animated,as 

    determined by the System.Windows.Media.Animation.ColorAnimation.
 ...
 def __new__(self,*__args):
  ...
  __new__(cls: type,toValue: Color,duration: Duration)

  __new__(cls: type,toValue: Color,duration: Duration,fillBehavior: FillBehavior)

  __new__(cls: type,fromValue: Color,toValue: Color,duration: Duration)

  __new__(cls: type,fromValue: Color,toValue: Color,duration: Duration,fillBehavior: FillBehavior)
  """
  pass
...
Get: By(self: ColorAnimation) -> Nullable[Color]



Set: By(self: ColorAnimation)=value
...
Get: EasingFunction(self: ColorAnimation) -> IEasingFunction



Set: EasingFunction(self: ColorAnimation)=value
...
Get: From(self: ColorAnimation) -> Nullable[Color]



Set: From(self: ColorAnimation)=value
...
Get: IsAdditive(self: ColorAnimation) -> bool



Set: IsAdditive(self: ColorAnimation)=value
...
Get: IsCumulative(self: ColorAnimation) -> bool



Set: IsCumulative(self: ColorAnimation)=value
...
Get: To(self: ColorAnimation) -> Nullable[Color]



Set: To(self: ColorAnimation)=value
