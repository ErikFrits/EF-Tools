class SplinePoint3DKeyFrame(Point3DKeyFrame,ISealable,IKeyFrame):
 """
 Animates from the System.Windows.Media.Media3D.Point3D value of the previous key frame to its own System.Windows.Media.Animation.Point3DKeyFrame.Value using splined interpolation.

 

 SplinePoint3DKeyFrame()

 SplinePoint3DKeyFrame(value: Point3D)

 SplinePoint3DKeyFrame(value: Point3D,keyTime: KeyTime)

 SplinePoint3DKeyFrame(value: Point3D,keyTime: KeyTime,keySpline: KeySpline)
 """
 ...
 def CreateInstanceCore(self,*args):
  """
  CreateInstanceCore(self: SplinePoint3DKeyFrame) -> Freezable

  

   Creates a new instance of System.Windows.Media.Animation.SplinePoint3DKeyFrame.

   Returns: A new System.Windows.Media.Animation.SplinePoint3DKeyFrame.
  """
  pass
 ...
 def InterpolateValueCore(self,*args):
  """
  InterpolateValueCore(self: SplinePoint3DKeyFrame,baseValue: Point3D,keyFrameProgress: float) -> Point3D
 ...
 def __new__(self,value=None,keyTime=None,keySpline=None):
  ...
  __new__(cls: type,value: Point3D,keyTime: KeyTime)

  __new__(cls: type,value: Point3D,keyTime: KeyTime,keySpline: KeySpline)
  """
  pass
...
Get: KeySpline(self: SplinePoint3DKeyFrame) -> KeySpline



Set: KeySpline(self: SplinePoint3DKeyFrame)=value
