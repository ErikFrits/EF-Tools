class DiscreteStringKeyFrame(StringKeyFrame,ISealable,IKeyFrame):
 """
 Animates from the System.String value of the previous key frame to its own System.Windows.Media.Animation.StringKeyFrame.Value using discrete interpolation.

 

 DiscreteStringKeyFrame()

 DiscreteStringKeyFrame(value: str)

 DiscreteStringKeyFrame(value: str,keyTime: KeyTime)
 """
 ...
 def CreateInstanceCore(self,*args):
  """
  CreateInstanceCore(self: DiscreteStringKeyFrame) -> Freezable

  

   Creates a new instance of System.Windows.Media.Animation.DiscreteStringKeyFrame.

   Returns: A new System.Windows.Media.Animation.DiscreteStringKeyFrame.
  """
  pass
 ...
 def InterpolateValueCore(self,*args):
  """
  InterpolateValueCore(self: DiscreteStringKeyFrame,baseValue: str,keyFrameProgress: float) -> str
