class DiscreteCharKeyFrame(CharKeyFrame,ISealable,IKeyFrame):
 """
 Animates from the System.Char value of the previous key frame to its own System.Windows.Media.Animation.CharKeyFrame.Value using discrete interpolation.

 

 DiscreteCharKeyFrame()

 DiscreteCharKeyFrame(value: Char)

 DiscreteCharKeyFrame(value: Char,keyTime: KeyTime)
 """
 ...
 def CreateInstanceCore(self,*args):
  """
  CreateInstanceCore(self: DiscreteCharKeyFrame) -> Freezable

  

   Creates a new instance of System.Windows.Media.Animation.DiscreteCharKeyFrame.

   Returns: A new System.Windows.Media.Animation.DiscreteCharKeyFrame.
  """
  pass
 ...
 def InterpolateValueCore(self,*args):
  """
  InterpolateValueCore(self: DiscreteCharKeyFrame,baseValue: Char,keyFrameProgress: float) -> Char
 ...
 def __new__(self,value=None,keyTime=None):
  ...
  __new__(cls: type,value: Char,keyTime: KeyTime)
  """
  pass
