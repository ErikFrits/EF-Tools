class SizeAnimationBase(AnimationTimeline,ISealable,IAnimatable,IResource):
 """ Abstract class that,when implemented,animates a System.Windows.Size value. """
 ...
 def Clone(self):
  """
  Clone(self: SizeAnimationBase) -> SizeAnimationBase

  

   Creates a modifiable clone of this System.Windows.Media.Animation.SizeAnimationBase,making deep 
 ...
 def GetCurrentValue(self,defaultOriginValue,defaultDestinationValue,animationClock):
  """
  GetCurrentValue(self: SizeAnimationBase,defaultOriginValue: Size,defaultDestinationValue: Size,animationClock: AnimationClock) -> Size
  ...
  GetCurrentValue(self: SizeAnimationBase,defaultOriginValue: object,defaultDestinationValue: object,animationClock: AnimationClock) -> object
 ...
 def GetCurrentValueCore(self,*args):
  """
  GetCurrentValueCore(self: SizeAnimationBase,defaultOriginValue: Size,defaultDestinationValue: Size,animationClock: AnimationClock) -> Size
...
Get: TargetPropertyType(self: SizeAnimationBase) -> Type
