class LinearVector3DKeyFrame(Vector3DKeyFrame,ISealable,IKeyFrame):
 """
 Animates from the System.Windows.Media.Media3D.Vector3D value of the previous key frame to its own System.Windows.Media.Animation.Vector3DKeyFrame.Value using linear interpolation.

 

 LinearVector3DKeyFrame()

 LinearVector3DKeyFrame(value: Vector3D)

 LinearVector3DKeyFrame(value: Vector3D,keyTime: KeyTime)
 """
 ...
 def CreateInstanceCore(self,*args):
  """
  CreateInstanceCore(self: LinearVector3DKeyFrame) -> Freezable

  

   Creates a new instance of System.Windows.Media.Animation.LinearVector3DKeyFrame.

   Returns: A new System.Windows.Media.Animation.LinearVector3DKeyFrame.
  """
  pass
 ...
 def InterpolateValueCore(self,*args):
  """
  InterpolateValueCore(self: LinearVector3DKeyFrame,baseValue: Vector3D,keyFrameProgress: float) -> Vector3D
