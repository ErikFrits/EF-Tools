class Vector3DAnimation(Vector3DAnimationBase,ISealable,IAnimatable,IResource):
 """
 ...
 Vector3DAnimation(toValue: Vector3D,duration: Duration)

 Vector3DAnimation(toValue: Vector3D,duration: Duration,fillBehavior: FillBehavior)

 Vector3DAnimation(fromValue: Vector3D,toValue: Vector3D,duration: Duration)

 Vector3DAnimation(fromValue: Vector3D,toValue: Vector3D,duration: Duration,fillBehavior: FillBehavior)
 """
 ...
 def Clone(self):
  """
  Clone(self: Vector3DAnimation) -> Vector3DAnimation
 ...
 def CreateInstanceCore(self,*args):
  """
  CreateInstanceCore(self: Vector3DAnimation) -> Freezable

  

   Creates a new instance of the System.Windows.Media.Animation.Vector3DAnimation.
 ...
 def GetCurrentValueCore(self,*args):
  """
  GetCurrentValueCore(self: Vector3DAnimation,defaultOriginValue: Vector3D,defaultDestinationValue: Vector3D,animationClock: AnimationClock) -> Vector3D

  

   Calculates a value that represents the current value of the property being animated,as 

    determined by the System.Windows.Media.Animation.Vector3DAnimation.
 ...
 def __new__(self,*__args):
  ...
  __new__(cls: type,toValue: Vector3D,duration: Duration)

  __new__(cls: type,toValue: Vector3D,duration: Duration,fillBehavior: FillBehavior)

  __new__(cls: type,fromValue: Vector3D,toValue: Vector3D,duration: Duration)

  __new__(cls: type,fromValue: Vector3D,toValue: Vector3D,duration: Duration,fillBehavior: FillBehavior)
  """
  pass
...
Get: By(self: Vector3DAnimation) -> Nullable[Vector3D]



Set: By(self: Vector3DAnimation)=value
...
Get: EasingFunction(self: Vector3DAnimation) -> IEasingFunction



Set: EasingFunction(self: Vector3DAnimation)=value
...
Get: From(self: Vector3DAnimation) -> Nullable[Vector3D]



Set: From(self: Vector3DAnimation)=value
...
Get: IsAdditive(self: Vector3DAnimation) -> bool



Set: IsAdditive(self: Vector3DAnimation)=value
...
Get: IsCumulative(self: Vector3DAnimation) -> bool



Set: IsCumulative(self: Vector3DAnimation)=value
...
Get: To(self: Vector3DAnimation) -> Nullable[Vector3D]



Set: To(self: Vector3DAnimation)=value
