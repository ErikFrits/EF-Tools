class SizeKeyFrame(Freezable,ISealable,IKeyFrame):
 """ Abstract class that,when implemented,defines an animation segment with its own target value and interpolation method for a System.Windows.Media.Animation.SizeAnimationUsingKeyFrames. """
 ...
 def InterpolateValue(self,baseValue,keyFrameProgress):
  """
  InterpolateValue(self: SizeKeyFrame,baseValue: Size,keyFrameProgress: float) -> Size
 ...
 def InterpolateValueCore(self,*args):
  """
  InterpolateValueCore(self: SizeKeyFrame,baseValue: Size,keyFrameProgress: float) -> Size
 ...
 """Gets or sets the time at which the key frame's target System.Windows.Media.Animation.SizeKeyFrame.Value should be reached.



Get: KeyTime(self: SizeKeyFrame) -> KeyTime



Set: KeyTime(self: SizeKeyFrame)=value
...
Get: Value(self: SizeKeyFrame) -> Size



Set: Value(self: SizeKeyFrame)=value
