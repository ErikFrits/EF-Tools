class LinearQuaternionKeyFrame(QuaternionKeyFrame,ISealable,IKeyFrame):
 """
 Animates from the System.Windows.Media.Media3D.Quaternion value of the previous key frame to its own System.Windows.Media.Animation.QuaternionKeyFrame.Value using linear interpolation.

 

 LinearQuaternionKeyFrame()

 LinearQuaternionKeyFrame(value: Quaternion)

 LinearQuaternionKeyFrame(value: Quaternion,keyTime: KeyTime)
 """
 ...
 def CreateInstanceCore(self,*args):
  """
  CreateInstanceCore(self: LinearQuaternionKeyFrame) -> Freezable

  

   Creates a new instance of System.Windows.Media.Animation.LinearQuaternionKeyFrame.

   Returns: A new System.Windows.Media.Animation.LinearQuaternionKeyFrame.
  """
  pass
 ...
 def InterpolateValueCore(self,*args):
  """
  InterpolateValueCore(self: LinearQuaternionKeyFrame,baseValue: Quaternion,keyFrameProgress: float) -> Quaternion

  

   Interpolates,in a linear fashion,between the previous key frame value and the value of the 
 ...
 """Gets or sets a Boolean value that indicates whether the animation uses spherical linear interpolation to calculate the shortest arc between positions. This is a�dependency property.



Get: UseShortestPath(self: LinearQuaternionKeyFrame) -> bool



Set: UseShortestPath(self: LinearQuaternionKeyFrame)=value
