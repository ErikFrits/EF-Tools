class Vector3DAnimationBase(AnimationTimeline,ISealable,IAnimatable,IResource):
 """ Abstract class that represents an animated System.Windows.Media.Media3D.Vector3D value. """
 ...
 def Clone(self):
  """
  Clone(self: Vector3DAnimationBase) -> Vector3DAnimationBase

  

   Creates a modifiable clone of this System.Windows.Media.Animation.Vector3DAnimationBase,making 
 ...
 def GetCurrentValue(self,defaultOriginValue,defaultDestinationValue,animationClock):
  """
  GetCurrentValue(self: Vector3DAnimationBase,defaultOriginValue: Vector3D,defaultDestinationValue: Vector3D,animationClock: AnimationClock) -> Vector3D
  ...
  GetCurrentValue(self: Vector3DAnimationBase,defaultOriginValue: object,defaultDestinationValue: object,animationClock: AnimationClock) -> object
 ...
 def GetCurrentValueCore(self,*args):
  """
  GetCurrentValueCore(self: Vector3DAnimationBase,defaultOriginValue: Vector3D,defaultDestinationValue: Vector3D,animationClock: AnimationClock) -> Vector3D
...
Get: TargetPropertyType(self: Vector3DAnimationBase) -> Type
