class EasingInt32KeyFrame(Int32KeyFrame,ISealable,IKeyFrame):
 """
 A class that enables you to associate easing functions with a System.Windows.Media.Animation.Int32AnimationUsingKeyFrames key frame animation.

 

 EasingInt32KeyFrame()

 EasingInt32KeyFrame(value: int)

 EasingInt32KeyFrame(value: int,keyTime: KeyTime)

 EasingInt32KeyFrame(value: int,keyTime: KeyTime,easingFunction: IEasingFunction)
 """
 ...
 def CreateInstanceCore(self,*args):
  """
  CreateInstanceCore(self: EasingInt32KeyFrame) -> Freezable
 ...
 def InterpolateValueCore(self,*args):
  """
  InterpolateValueCore(self: EasingInt32KeyFrame,baseValue: int,keyFrameProgress: float) -> int
 ...
 def __new__(self,value=None,keyTime=None,easingFunction=None):
  ...
  __new__(cls: type,value: int,keyTime: KeyTime,easingFunction: IEasingFunction)
  """
  pass
...
Get: EasingFunction(self: EasingInt32KeyFrame) -> IEasingFunction



Set: EasingFunction(self: EasingInt32KeyFrame)=value
