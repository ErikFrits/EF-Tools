class SplineRotation3DKeyFrame(Rotation3DKeyFrame,ISealable,IKeyFrame):
 """
 Animates from the System.Windows.Media.Media3D.Rotation3D value of the previous key frame to its own System.Windows.Media.Animation.Rotation3DKeyFrame.Value using splined interpolation.

 

 SplineRotation3DKeyFrame()

 SplineRotation3DKeyFrame(value: Rotation3D)

 SplineRotation3DKeyFrame(value: Rotation3D,keyTime: KeyTime)

 SplineRotation3DKeyFrame(value: Rotation3D,keyTime: KeyTime,keySpline: KeySpline)
 """
 ...
 def CreateInstanceCore(self,*args):
  """
  CreateInstanceCore(self: SplineRotation3DKeyFrame) -> Freezable

  

   Creates a new instance of System.Windows.Media.Animation.SplineRotation3DKeyFrame.

   Returns: A new System.Windows.Media.Animation.SplineRotation3DKeyFrame.
  """
  pass
 ...
 def InterpolateValueCore(self,*args):
  """
  InterpolateValueCore(self: SplineRotation3DKeyFrame,baseValue: Rotation3D,keyFrameProgress: float) -> Rotation3D

  

   Uses splined interpolation to transition between the previous key frame value and the value of 
 ...
 def __new__(self,value=None,keyTime=None,keySpline=None):
  ...
  __new__(cls: type,value: Rotation3D)

  __new__(cls: type,value: Rotation3D,keyTime: KeyTime)

  __new__(cls: type,value: Rotation3D,keyTime: KeyTime,keySpline: KeySpline)
  """
  pass
...
Get: KeySpline(self: SplineRotation3DKeyFrame) -> KeySpline



Set: KeySpline(self: SplineRotation3DKeyFrame)=value
