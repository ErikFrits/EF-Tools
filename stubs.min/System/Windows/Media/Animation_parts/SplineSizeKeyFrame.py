class SplineSizeKeyFrame(SizeKeyFrame,ISealable,IKeyFrame):
 """
 Animates from the System.Windows.Size value of the previous key frame to its own System.Windows.Media.Animation.SizeKeyFrame.Value using splined interpolation.

 

 SplineSizeKeyFrame()

 SplineSizeKeyFrame(value: Size)

 SplineSizeKeyFrame(value: Size,keyTime: KeyTime)

 SplineSizeKeyFrame(value: Size,keyTime: KeyTime,keySpline: KeySpline)
 """
 ...
 def CreateInstanceCore(self,*args):
  """
  CreateInstanceCore(self: SplineSizeKeyFrame) -> Freezable

  

   Creates a new instance of System.Windows.Media.Animation.SplineSizeKeyFrame.

   Returns: A new System.Windows.Media.Animation.SplineSizeKeyFrame.
  """
  pass
 ...
 def InterpolateValueCore(self,*args):
  """
  InterpolateValueCore(self: SplineSizeKeyFrame,baseValue: Size,keyFrameProgress: float) -> Size
 ...
 def __new__(self,value=None,keyTime=None,keySpline=None):
  ...
  __new__(cls: type,value: Size)

  __new__(cls: type,value: Size,keyTime: KeyTime)

  __new__(cls: type,value: Size,keyTime: KeyTime,keySpline: KeySpline)
  """
  pass
...
Get: KeySpline(self: SplineSizeKeyFrame) -> KeySpline



Set: KeySpline(self: SplineSizeKeyFrame)=value
