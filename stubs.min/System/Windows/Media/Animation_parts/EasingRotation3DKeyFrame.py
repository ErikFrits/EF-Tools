class EasingRotation3DKeyFrame(Rotation3DKeyFrame,ISealable,IKeyFrame):
 """
 A class that enables you to associate easing functions with a System.Windows.Media.Animation.Rotation3DAnimationUsingKeyFrames key frame animation.

 

 EasingRotation3DKeyFrame()

 EasingRotation3DKeyFrame(value: Rotation3D)

 EasingRotation3DKeyFrame(value: Rotation3D,keyTime: KeyTime)

 EasingRotation3DKeyFrame(value: Rotation3D,keyTime: KeyTime,easingFunction: IEasingFunction)
 """
 ...
 def CreateInstanceCore(self,*args):
  """
  CreateInstanceCore(self: EasingRotation3DKeyFrame) -> Freezable
 ...
 def InterpolateValueCore(self,*args):
  """
  InterpolateValueCore(self: EasingRotation3DKeyFrame,baseValue: Rotation3D,keyFrameProgress: float) -> Rotation3D
 ...
 def __new__(self,value=None,keyTime=None,easingFunction=None):
  ...
  __new__(cls: type,value: Rotation3D,keyTime: KeyTime,easingFunction: IEasingFunction)
  """
  pass
...
Get: EasingFunction(self: EasingRotation3DKeyFrame) -> IEasingFunction



Set: EasingFunction(self: EasingRotation3DKeyFrame)=value
