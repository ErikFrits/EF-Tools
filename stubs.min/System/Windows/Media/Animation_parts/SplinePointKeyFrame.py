class SplinePointKeyFrame(PointKeyFrame,ISealable,IKeyFrame):
 """
 Animates from the System.Windows.Point value of the previous key frame to its own System.Windows.Media.Animation.PointKeyFrame.Value using splined interpolation.

 

 SplinePointKeyFrame()

 SplinePointKeyFrame(value: Point)

 SplinePointKeyFrame(value: Point,keyTime: KeyTime)

 SplinePointKeyFrame(value: Point,keyTime: KeyTime,keySpline: KeySpline)
 """
 ...
 def CreateInstanceCore(self,*args):
  """
  CreateInstanceCore(self: SplinePointKeyFrame) -> Freezable

  

   Creates a new instance of System.Windows.Media.Animation.SplinePointKeyFrame.

   Returns: A new System.Windows.Media.Animation.SplinePointKeyFrame.
  """
  pass
 ...
 def InterpolateValueCore(self,*args):
  """
  InterpolateValueCore(self: SplinePointKeyFrame,baseValue: Point,keyFrameProgress: float) -> Point
 ...
 def __new__(self,value=None,keyTime=None,keySpline=None):
  ...
  __new__(cls: type,value: Point)

  __new__(cls: type,value: Point,keyTime: KeyTime)

  __new__(cls: type,value: Point,keyTime: KeyTime,keySpline: KeySpline)
  """
  pass
...
Get: KeySpline(self: SplinePointKeyFrame) -> KeySpline



Set: KeySpline(self: SplinePointKeyFrame)=value
