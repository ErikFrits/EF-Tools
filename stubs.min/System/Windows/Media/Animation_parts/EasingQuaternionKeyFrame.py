class EasingQuaternionKeyFrame(QuaternionKeyFrame,ISealable,IKeyFrame):
 """
 A class that enables you to associate easing functions with a System.Windows.Media.Animation.QuaternionAnimationUsingKeyFrames key frame animation.

 

 EasingQuaternionKeyFrame()

 EasingQuaternionKeyFrame(value: Quaternion)

 EasingQuaternionKeyFrame(value: Quaternion,keyTime: KeyTime)

 EasingQuaternionKeyFrame(value: Quaternion,keyTime: KeyTime,easingFunction: IEasingFunction)
 """
 ...
 def CreateInstanceCore(self,*args):
  """
  CreateInstanceCore(self: EasingQuaternionKeyFrame) -> Freezable
 ...
 def InterpolateValueCore(self,*args):
  """
  InterpolateValueCore(self: EasingQuaternionKeyFrame,baseValue: Quaternion,keyFrameProgress: float) -> Quaternion
 ...
 def __new__(self,value=None,keyTime=None,easingFunction=None):
  ...
  __new__(cls: type,value: Quaternion,keyTime: KeyTime,easingFunction: IEasingFunction)
  """
  pass
...
Get: EasingFunction(self: EasingQuaternionKeyFrame) -> IEasingFunction



Set: EasingFunction(self: EasingQuaternionKeyFrame)=value
...
Get: UseShortestPath(self: EasingQuaternionKeyFrame) -> bool



Set: UseShortestPath(self: EasingQuaternionKeyFrame)=value
