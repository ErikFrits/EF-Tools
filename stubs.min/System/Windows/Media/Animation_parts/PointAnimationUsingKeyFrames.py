class PointAnimationUsingKeyFrames(PointAnimationBase,ISealable,IAnimatable,IResource,IKeyFrameAnimation,IAddChild):
 """
 Animates the value of a System.Windows.Point property along a set of System.Windows.Media.Animation.PointAnimationUsingKeyFrames.KeyFrames.
 ...
 def AddChild(self,*args):
  """
  AddChild(self: PointAnimationUsingKeyFrames,child: object)

   Adds a child System.Windows.Media.Animation.PointKeyFrame to this 
 ...
 def AddText(self,*args):
  """
  AddText(self: PointAnimationUsingKeyFrames,childText: str)
   ...
   childText: The text added to the System.Windows.Media.Animation.PointAnimationUsingKeyFrames.
  """
  pass
 ...
 def Clone(self):
  """
  Clone(self: PointAnimationUsingKeyFrames) -> PointAnimationUsingKeyFrames

  

   Creates a modifiable clone of this System.Windows.Media.Animation.PointAnimationUsingKeyFrames,
 ...
 def CloneCore(self,*args):
  """
  CloneCore(self: PointAnimationUsingKeyFrames,sourceFreezable: Freezable)

   Makes this instance a deep copy of the specified 

    System.Windows.Media.Animation.PointAnimationUsingKeyFrames. When copying dependency properties,
   ...
   sourceFreezable: The System.Windows.Media.Animation.PointAnimationUsingKeyFrames to clone.
  """
  pass
 def CloneCurrentValue(self):
  """
  CloneCurrentValue(self: PointAnimationUsingKeyFrames) -> PointAnimationUsingKeyFrames
 ...
 def CloneCurrentValueCore(self,*args):
  """
  CloneCurrentValueCore(self: PointAnimationUsingKeyFrames,sourceFreezable: Freezable)

   Makes this instance a modifiable deep copy of the specified 

    System.Windows.Media.Animation.PointAnimationUsingKeyFrames using current property values. 
 ...
 def CreateInstanceCore(self,*args):
  """
  CreateInstanceCore(self: PointAnimationUsingKeyFrames) -> Freezable

  

   Creates a new instance of System.Windows.Media.Animation.PointAnimationUsingKeyFrames.

   Returns: A new instance of System.Windows.Media.Animation.PointAnimationUsingKeyFrames.
  """
  pass
 def FreezeCore(self,*args):
  """
  FreezeCore(self: PointAnimationUsingKeyFrames,isChecking: bool) -> bool

  

   Makes this instance of System.Windows.Media.Animation.PointAnimationUsingKeyFrames object 
 ...
 def GetAsFrozenCore(self,*args):
  """
  GetAsFrozenCore(self: PointAnimationUsingKeyFrames,source: Freezable)

   Makes this instance a clone of the specified 

    System.Windows.Media.Animation.PointAnimationUsingKeyFrames object.

  

  

   source: The System.Windows.Media.Animation.PointAnimationUsingKeyFrames object to clone.
  """
  pass
 def GetCurrentValueAsFrozenCore(self,*args):
  """
  GetCurrentValueAsFrozenCore(self: PointAnimationUsingKeyFrames,source: Freezable)

   Makes this instance a frozen clone of the specified 

    System.Windows.Media.Animation.PointAnimationUsingKeyFrames. Resource references,data bindings,
   ...
   source: The System.Windows.Media.Animation.PointAnimationUsingKeyFrames to copy and freeze.
  """
  pass
 def GetCurrentValueCore(self,*args):
  """
  GetCurrentValueCore(self: PointAnimationUsingKeyFrames,defaultOriginValue: Point,defaultDestinationValue: Point,animationClock: AnimationClock) -> Point

  

   Calculates a value that represents the current value of the property being animated,as 

    determined by this instance of System.Windows.Media.Animation.PointAnimationUsingKeyFrames.
 ...
 def GetNaturalDurationCore(self,*args):
  """
  GetNaturalDurationCore(self: PointAnimationUsingKeyFrames,clock: Clock) -> Duration
 ...
 def OnChanged(self,*args):
  """
  OnChanged(self: PointAnimationUsingKeyFrames)

   Called when the current System.Windows.Media.Animation.PointAnimationUsingKeyFrames object is 
 ...
 def ShouldSerializeKeyFrames(self):
  """
  ShouldSerializeKeyFrames(self: PointAnimationUsingKeyFrames) -> bool

  

   Returns true if the value of the 

    System.Windows.Media.Animation.PointAnimationUsingKeyFrames.KeyFrames property of this instance 

    of System.Windows.Media.Animation.PointAnimationUsingKeyFrames should be value-serialized.
...
Get: IsAdditive(self: PointAnimationUsingKeyFrames) -> bool



Set: IsAdditive(self: PointAnimationUsingKeyFrames)=value
...
Get: IsCumulative(self: PointAnimationUsingKeyFrames) -> bool



Set: IsCumulative(self: PointAnimationUsingKeyFrames)=value

"""

 KeyFrames=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets the collection of System.Windows.Media.Animation.PointKeyFrame objects that define the animation.



Get: KeyFrames(self: PointAnimationUsingKeyFrames) -> PointKeyFrameCollection



Set: KeyFrames(self: PointAnimationUsingKeyFrames)=value
