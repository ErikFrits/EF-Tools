class SplineVector3DKeyFrame(Vector3DKeyFrame,ISealable,IKeyFrame):
 """
 Animates from the System.Windows.Media.Media3D.Vector3D value of the previous key frame to its own System.Windows.Media.Animation.Vector3DKeyFrame.Value using splined interpolation.

 

 SplineVector3DKeyFrame()

 SplineVector3DKeyFrame(value: Vector3D)

 SplineVector3DKeyFrame(value: Vector3D,keyTime: KeyTime)

 SplineVector3DKeyFrame(value: Vector3D,keyTime: KeyTime,keySpline: KeySpline)
 """
 ...
 def CreateInstanceCore(self,*args):
  """
  CreateInstanceCore(self: SplineVector3DKeyFrame) -> Freezable

  

   Creates a new instance of System.Windows.Media.Animation.SplineVector3DKeyFrame.

   Returns: A new System.Windows.Media.Animation.SplineVector3DKeyFrame.
  """
  pass
 ...
 def InterpolateValueCore(self,*args):
  """
  InterpolateValueCore(self: SplineVector3DKeyFrame,baseValue: Vector3D,keyFrameProgress: float) -> Vector3D
 ...
 def __new__(self,value=None,keyTime=None,keySpline=None):
  ...
  __new__(cls: type,value: Vector3D,keyTime: KeyTime,keySpline: KeySpline)
  """
  pass
...
Get: KeySpline(self: SplineVector3DKeyFrame) -> KeySpline



Set: KeySpline(self: SplineVector3DKeyFrame)=value
