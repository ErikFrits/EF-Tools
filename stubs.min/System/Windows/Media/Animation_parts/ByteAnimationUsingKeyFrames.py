class ByteAnimationUsingKeyFrames(ByteAnimationBase,ISealable,IAnimatable,IResource,IKeyFrameAnimation,IAddChild):
 """
 Animates the value of a System.Byte property along a set of System.Windows.Media.Animation.ByteAnimationUsingKeyFrames.KeyFrames.
 ...
 def AddChild(self,*args):
  """
  AddChild(self: ByteAnimationUsingKeyFrames,child: object)

   Adds a child System.Windows.Media.Animation.ByteKeyFrame to this 
 ...
 def AddText(self,*args):
  """
  AddText(self: ByteAnimationUsingKeyFrames,childText: str)

   Adds a text string as a child of this System.Windows.Media.Animation.ByteAnimationUsingKeyFrames.

  

   childText: The text added to the System.Windows.Media.Animation.ByteAnimationUsingKeyFrames.
  """
  pass
 ...
 def Clone(self):
  """
  Clone(self: ByteAnimationUsingKeyFrames) -> ByteAnimationUsingKeyFrames
 ...
 def CloneCore(self,*args):
  """
  CloneCore(self: ByteAnimationUsingKeyFrames,sourceFreezable: Freezable)

   Makes this instance a deep copy of the specified 

    System.Windows.Media.Animation.ByteAnimationUsingKeyFrames. When copying dependency properties,
   ...
   sourceFreezable: The System.Windows.Media.Animation.ByteAnimationUsingKeyFrames to clone.
  """
  pass
 def CloneCurrentValue(self):
  """
  CloneCurrentValue(self: ByteAnimationUsingKeyFrames) -> ByteAnimationUsingKeyFrames
 ...
 def CloneCurrentValueCore(self,*args):
  """
  CloneCurrentValueCore(self: ByteAnimationUsingKeyFrames,sourceFreezable: Freezable)

   Makes this instance a modifiable deep copy of the specified 

    System.Windows.Media.Animation.ByteAnimationUsingKeyFrames using current property values. 
 ...
 def CreateInstanceCore(self,*args):
  """
  CreateInstanceCore(self: ByteAnimationUsingKeyFrames) -> Freezable

  

   Creates a new instance of System.Windows.Media.Animation.ByteAnimationUsingKeyFrames.

   Returns: A new instance of System.Windows.Media.Animation.ByteAnimationUsingKeyFrames.
  """
  pass
 def FreezeCore(self,*args):
  """
  FreezeCore(self: ByteAnimationUsingKeyFrames,isChecking: bool) -> bool

  

   Makes this instance of System.Windows.Media.Animation.ByteAnimationUsingKeyFrames object 
 ...
 def GetAsFrozenCore(self,*args):
  """
  GetAsFrozenCore(self: ByteAnimationUsingKeyFrames,source: Freezable)

   Makes this instance a clone of the specified 

    System.Windows.Media.Animation.ByteAnimationUsingKeyFrames object.
 ...
 def GetCurrentValueAsFrozenCore(self,*args):
  """
  GetCurrentValueAsFrozenCore(self: ByteAnimationUsingKeyFrames,source: Freezable)

   Makes this instance a frozen clone of the specified 

    System.Windows.Media.Animation.ByteAnimationUsingKeyFrames. Resource references,data bindings,
   ...
   source: The System.Windows.Media.Animation.ByteAnimationUsingKeyFrames to copy and freeze.
  """
  pass
 def GetCurrentValueCore(self,*args):
  """
  GetCurrentValueCore(self: ByteAnimationUsingKeyFrames,defaultOriginValue: Byte,defaultDestinationValue: Byte,animationClock: AnimationClock) -> Byte

  

   Calculates a value that represents the current value of the property being animated,as 

    determined by this instance of System.Windows.Media.Animation.ByteAnimationUsingKeyFrames.
 ...
 def GetNaturalDurationCore(self,*args):
  """
  GetNaturalDurationCore(self: ByteAnimationUsingKeyFrames,clock: Clock) -> Duration
 ...
 def OnChanged(self,*args):
  """
  OnChanged(self: ByteAnimationUsingKeyFrames)

   Called when the current System.Windows.Media.Animation.ByteAnimationUsingKeyFrames object is 
 ...
 def ShouldSerializeKeyFrames(self):
  """
  ShouldSerializeKeyFrames(self: ByteAnimationUsingKeyFrames) -> bool

  

   Returns true if the value of the 

    System.Windows.Media.Animation.ByteAnimationUsingKeyFrames.KeyFrames property of this instance 

    of System.Windows.Media.Animation.ByteAnimationUsingKeyFrames should be value-serialized.
...
Get: IsAdditive(self: ByteAnimationUsingKeyFrames) -> bool



Set: IsAdditive(self: ByteAnimationUsingKeyFrames)=value
...
Get: IsCumulative(self: ByteAnimationUsingKeyFrames) -> bool



Set: IsCumulative(self: ByteAnimationUsingKeyFrames)=value

"""

 KeyFrames=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets the collection of System.Windows.Media.Animation.ByteKeyFrame objects that define the animation.



Get: KeyFrames(self: ByteAnimationUsingKeyFrames) -> ByteKeyFrameCollection



Set: KeyFrames(self: ByteAnimationUsingKeyFrames)=value
