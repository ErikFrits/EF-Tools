class CircleEase(EasingFunctionBase,ISealable,IEasingFunction):
 """
 ...
 def CreateInstanceCore(self,*args):
  """
  CreateInstanceCore(self: CircleEase) -> Freezable
 ...
 def EaseInCore(self,*args):
  """
  EaseInCore(self: CircleEase,normalizedTime: float) -> float
