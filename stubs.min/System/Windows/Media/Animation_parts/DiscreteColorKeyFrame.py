class DiscreteColorKeyFrame(ColorKeyFrame,ISealable,IKeyFrame):
 """
 Animates from the System.Windows.Media.Color value of the previous key frame to its own System.Windows.Media.Animation.ColorKeyFrame.Value using discrete interpolation.

 

 DiscreteColorKeyFrame()

 DiscreteColorKeyFrame(value: Color)

 DiscreteColorKeyFrame(value: Color,keyTime: KeyTime)
 """
 ...
 def CreateInstanceCore(self,*args):
  """
  CreateInstanceCore(self: DiscreteColorKeyFrame) -> Freezable

  

   Creates a new instance of System.Windows.Media.Animation.DiscreteColorKeyFrame.

   Returns: A new System.Windows.Media.Animation.DiscreteColorKeyFrame.
  """
  pass
 ...
 def InterpolateValueCore(self,*args):
  """
  InterpolateValueCore(self: DiscreteColorKeyFrame,baseValue: Color,keyFrameProgress: float) -> Color

  

   Interpolates between the previous key frame value and the value of the current key frame using 
