class Int16AnimationUsingKeyFrames(Int16AnimationBase,ISealable,IAnimatable,IResource,IKeyFrameAnimation,IAddChild):
 """
 Animates the value of a System.Int16 property along a set of System.Windows.Media.Animation.Int16AnimationUsingKeyFrames.KeyFrames.
 ...
 def AddChild(self,*args):
  """
  AddChild(self: Int16AnimationUsingKeyFrames,child: object)

   Adds a child System.Windows.Media.Animation.Int16KeyFrame to this 
 ...
 def AddText(self,*args):
  """
  AddText(self: Int16AnimationUsingKeyFrames,childText: str)
   ...
   childText: The text added to the System.Windows.Media.Animation.Int16AnimationUsingKeyFrames.
  """
  pass
 ...
 def Clone(self):
  """
  Clone(self: Int16AnimationUsingKeyFrames) -> Int16AnimationUsingKeyFrames

  

   Creates a modifiable clone of this System.Windows.Media.Animation.Int16AnimationUsingKeyFrames,
 ...
 def CloneCore(self,*args):
  """
  CloneCore(self: Int16AnimationUsingKeyFrames,sourceFreezable: Freezable)

   Makes this instance a deep copy of the specified 

    System.Windows.Media.Animation.Int16AnimationUsingKeyFrames. When copying dependency properties,
   ...
   sourceFreezable: The System.Windows.Media.Animation.Int16AnimationUsingKeyFrames to clone.
  """
  pass
 def CloneCurrentValue(self):
  """
  CloneCurrentValue(self: Int16AnimationUsingKeyFrames) -> Int16AnimationUsingKeyFrames
 ...
 def CloneCurrentValueCore(self,*args):
  """
  CloneCurrentValueCore(self: Int16AnimationUsingKeyFrames,sourceFreezable: Freezable)

   Makes this instance a modifiable deep copy of the specified 

    System.Windows.Media.Animation.Int16AnimationUsingKeyFrames using current property values. 
 ...
 def CreateInstanceCore(self,*args):
  """
  CreateInstanceCore(self: Int16AnimationUsingKeyFrames) -> Freezable

  

   Creates a new instance of System.Windows.Media.Animation.Int16AnimationUsingKeyFrames.

   Returns: A new instance of System.Windows.Media.Animation.Int16AnimationUsingKeyFrames.
  """
  pass
 def FreezeCore(self,*args):
  """
  FreezeCore(self: Int16AnimationUsingKeyFrames,isChecking: bool) -> bool

  

   Makes this instance of System.Windows.Media.Animation.Int16AnimationUsingKeyFrames object 
 ...
 def GetAsFrozenCore(self,*args):
  """
  GetAsFrozenCore(self: Int16AnimationUsingKeyFrames,source: Freezable)

   Makes this instance a clone of the specified 

    System.Windows.Media.Animation.Int16AnimationUsingKeyFrames object.

  

  

   source: The System.Windows.Media.Animation.ByteAnimationUsingKeyFrames object to clone and freeze.
  """
  pass
 def GetCurrentValueAsFrozenCore(self,*args):
  """
  GetCurrentValueAsFrozenCore(self: Int16AnimationUsingKeyFrames,source: Freezable)

   Makes this instance a frozen clone of the specified 

    System.Windows.Media.Animation.Int16AnimationUsingKeyFrames. Resource references,data bindings,
   ...
   source: The System.Windows.Media.Animation.Int16AnimationUsingKeyFrames to copy and freeze
  """
  pass
 def GetCurrentValueCore(self,*args):
  """
  GetCurrentValueCore(self: Int16AnimationUsingKeyFrames,defaultOriginValue: Int16,defaultDestinationValue: Int16,animationClock: AnimationClock) -> Int16

  

   Calculates a value that represents the current value of the property being animated,as 

    determined by this instance of System.Windows.Media.Animation.Int16AnimationUsingKeyFrames.
 ...
 def GetNaturalDurationCore(self,*args):
  """
  GetNaturalDurationCore(self: Int16AnimationUsingKeyFrames,clock: Clock) -> Duration
 ...
 def OnChanged(self,*args):
  """
  OnChanged(self: Int16AnimationUsingKeyFrames)

   Called when the current System.Windows.Media.Animation.Int16AnimationUsingKeyFrames object is 
 ...
 def ShouldSerializeKeyFrames(self):
  """
  ShouldSerializeKeyFrames(self: Int16AnimationUsingKeyFrames) -> bool

  

   Returns true if the value of the 

    System.Windows.Media.Animation.Int16AnimationUsingKeyFrames.KeyFrames property of this instance 

    of System.Windows.Media.Animation.Int16AnimationUsingKeyFrames should be value-serialized.
...
Get: IsAdditive(self: Int16AnimationUsingKeyFrames) -> bool



Set: IsAdditive(self: Int16AnimationUsingKeyFrames)=value
...
Get: IsCumulative(self: Int16AnimationUsingKeyFrames) -> bool



Set: IsCumulative(self: Int16AnimationUsingKeyFrames)=value

"""

 KeyFrames=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets the collection of System.Windows.Media.Animation.Int16KeyFrame objects that define the animation.



Get: KeyFrames(self: Int16AnimationUsingKeyFrames) -> Int16KeyFrameCollection



Set: KeyFrames(self: Int16AnimationUsingKeyFrames)=value
