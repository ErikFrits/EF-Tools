class Int32KeyFrame(Freezable,ISealable,IKeyFrame):
 """ Abstract class that,when implemented,defines an animation segment with its own target value and interpolation method for a System.Windows.Media.Animation.Int32AnimationUsingKeyFrames. """
 ...
 def InterpolateValue(self,baseValue,keyFrameProgress):
  """
  InterpolateValue(self: Int32KeyFrame,baseValue: int,keyFrameProgress: float) -> int
 ...
 def InterpolateValueCore(self,*args):
  """
  InterpolateValueCore(self: Int32KeyFrame,baseValue: int,keyFrameProgress: float) -> int
 ...
 """Gets or sets the time at which the key frame's target System.Windows.Media.Animation.Int32KeyFrame.Value should be reached.



Get: KeyTime(self: Int32KeyFrame) -> KeyTime



Set: KeyTime(self: Int32KeyFrame)=value
...
Get: Value(self: Int32KeyFrame) -> int



Set: Value(self: Int32KeyFrame)=value
