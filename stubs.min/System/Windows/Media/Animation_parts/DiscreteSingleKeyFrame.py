class DiscreteSingleKeyFrame(SingleKeyFrame,ISealable,IKeyFrame):
 """
 Animates from the System.Single value of the previous key frame to its own System.Windows.Media.Animation.SingleKeyFrame.Value using discrete interpolation.

 

 DiscreteSingleKeyFrame()

 DiscreteSingleKeyFrame(value: Single)

 DiscreteSingleKeyFrame(value: Single,keyTime: KeyTime)
 """
 ...
 def CreateInstanceCore(self,*args):
  """
  CreateInstanceCore(self: DiscreteSingleKeyFrame) -> Freezable

  

   Creates a new instance of System.Windows.Media.Animation.DiscreteSingleKeyFrame.

   Returns: A new System.Windows.Media.Animation.DiscreteSingleKeyFrame.
  """
  pass
 ...
 def InterpolateValueCore(self,*args):
  """
  InterpolateValueCore(self: DiscreteSingleKeyFrame,baseValue: Single,keyFrameProgress: float) -> Single
