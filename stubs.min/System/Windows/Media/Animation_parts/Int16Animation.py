class Int16Animation(Int16AnimationBase,ISealable,IAnimatable,IResource):
 """
 Animates the value of a  System.Int16 property between two target values using   linear interpolation over a specified System.Windows.Media.Animation.Timeline.Duration.

 

 Int16Animation()

 Int16Animation(toValue: Int16,duration: Duration)

 Int16Animation(toValue: Int16,duration: Duration,fillBehavior: FillBehavior)

 Int16Animation(fromValue: Int16,toValue: Int16,duration: Duration)

 Int16Animation(fromValue: Int16,toValue: Int16,duration: Duration,fillBehavior: FillBehavior)
 """
 ...
 def Clone(self):
  """
  Clone(self: Int16Animation) -> Int16Animation

  

   Creates a modifiable clone of this System.Windows.Media.Animation.Int16Animation,making deep 
 ...
 def CreateInstanceCore(self,*args):
  """
  CreateInstanceCore(self: Int16Animation) -> Freezable

  

   Creates a new instance of the System.Windows.Media.Animation.Int16Animation.
 ...
 def GetCurrentValueCore(self,*args):
  """
  GetCurrentValueCore(self: Int16Animation,defaultOriginValue: Int16,defaultDestinationValue: Int16,animationClock: AnimationClock) -> Int16

  

   Calculates a value that represents the current value of the property being animated,as 

    determined by the System.Windows.Media.Animation.Int16Animation.
 ...
 def __new__(self,*__args):
  ...
  __new__(cls: type,toValue: Int16,duration: Duration)

  __new__(cls: type,toValue: Int16,duration: Duration,fillBehavior: FillBehavior)

  __new__(cls: type,fromValue: Int16,toValue: Int16,duration: Duration)

  __new__(cls: type,fromValue: Int16,toValue: Int16,duration: Duration,fillBehavior: FillBehavior)
  """
  pass
...
Get: By(self: Int16Animation) -> Nullable[Int16]



Set: By(self: Int16Animation)=value
...
Get: EasingFunction(self: Int16Animation) -> IEasingFunction



Set: EasingFunction(self: Int16Animation)=value
...
Get: From(self: Int16Animation) -> Nullable[Int16]



Set: From(self: Int16Animation)=value
...
Get: IsAdditive(self: Int16Animation) -> bool



Set: IsAdditive(self: Int16Animation)=value
...
Get: IsCumulative(self: Int16Animation) -> bool



Set: IsCumulative(self: Int16Animation)=value
...
Get: To(self: Int16Animation) -> Nullable[Int16]



Set: To(self: Int16Animation)=value
