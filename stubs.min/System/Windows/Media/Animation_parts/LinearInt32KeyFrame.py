class LinearInt32KeyFrame(Int32KeyFrame,ISealable,IKeyFrame):
 """
 Animates from the System.Int32 value of the previous key frame to its own System.Windows.Media.Animation.Int32KeyFrame.Value using linear interpolation.

 

 LinearInt32KeyFrame()

 LinearInt32KeyFrame(value: int)

 LinearInt32KeyFrame(value: int,keyTime: KeyTime)
 """
 ...
 def CreateInstanceCore(self,*args):
  """
  CreateInstanceCore(self: LinearInt32KeyFrame) -> Freezable

  

   Creates a new instance of System.Windows.Media.Animation.LinearInt32KeyFrame.

   Returns: A new System.Windows.Media.Animation.LinearInt32KeyFrame.
  """
  pass
 ...
 def InterpolateValueCore(self,*args):
  """
  InterpolateValueCore(self: LinearInt32KeyFrame,baseValue: int,keyFrameProgress: float) -> int
