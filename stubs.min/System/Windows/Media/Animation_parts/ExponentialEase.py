class ExponentialEase(EasingFunctionBase,ISealable,IEasingFunction):
 """
 ...
 def CreateInstanceCore(self,*args):
  """
  CreateInstanceCore(self: ExponentialEase) -> Freezable
 ...
 def EaseInCore(self,*args):
  """
  EaseInCore(self: ExponentialEase,normalizedTime: float) -> float
 ...
 def __init__(self,*args):
  ...
  pass
 Exponent=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets the exponent used to determine the interpolation of the animation.



Get: Exponent(self: ExponentialEase) -> float



Set: Exponent(self: ExponentialEase)=value

"""


 ExponentProperty=None
