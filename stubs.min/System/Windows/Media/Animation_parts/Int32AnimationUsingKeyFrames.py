class Int32AnimationUsingKeyFrames(Int32AnimationBase,ISealable,IAnimatable,IResource,IKeyFrameAnimation,IAddChild):
 """
 Animates the value of a System.Int32 property along a set of System.Windows.Media.Animation.Int32AnimationUsingKeyFrames.KeyFrames.
 ...
 def AddChild(self,*args):
  """
  AddChild(self: Int32AnimationUsingKeyFrames,child: object)

   Adds a child System.Windows.Media.Animation.Int32KeyFrame to this 
 ...
 def AddText(self,*args):
  """
  AddText(self: Int32AnimationUsingKeyFrames,childText: str)
 ...
 def GetAsFrozenCore(self,*args):
  """
  GetAsFrozenCore(self: Int32AnimationUsingKeyFrames,source: Freezable)

   Makes this instance a clone of the specified 

    System.Windows.Media.Animation.Int32AnimationUsingKeyFrames object.

  

  

   source: The System.Windows.Media.Animation.Int32AnimationUsingKeyFrames object to clone.
  """
  pass
...
Get: IsAdditive(self: Int32AnimationUsingKeyFrames) -> bool



Set: IsAdditive(self: Int32AnimationUsingKeyFrames)=value
...
Get: IsCumulative(self: Int32AnimationUsingKeyFrames) -> bool



Set: IsCumulative(self: Int32AnimationUsingKeyFrames)=value

"""

 KeyFrames=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets the collection of System.Windows.Media.Animation.Int32KeyFrame objects that define the animation.



Get: KeyFrames(self: Int32AnimationUsingKeyFrames) -> Int32KeyFrameCollection



Set: KeyFrames(self: Int32AnimationUsingKeyFrames)=value
