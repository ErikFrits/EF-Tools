class Rotation3DAnimation(Rotation3DAnimationBase,ISealable,IAnimatable,IResource):
 """
 Animates the value of a System.Windows.Media.Media3D.Rotation3D property using linear interpolation between two values determined by the combination of System.Windows.Media.Animation.Rotation3DAnimation.From,System.Windows.Media.Animation.Rotation3DAnimation.To,or System.Windows.Media.Animation.Rotation3DAnimation.By properties that are set for the animation.

 

 Rotation3DAnimation()

 Rotation3DAnimation(toValue: Rotation3D,duration: Duration)

 Rotation3DAnimation(toValue: Rotation3D,duration: Duration,fillBehavior: FillBehavior)

 Rotation3DAnimation(fromValue: Rotation3D,toValue: Rotation3D,duration: Duration)

 Rotation3DAnimation(fromValue: Rotation3D,toValue: Rotation3D,duration: Duration,fillBehavior: FillBehavior)
 """
 ...
 def Clone(self):
  """
  Clone(self: Rotation3DAnimation) -> Rotation3DAnimation

  

   Creates a modifiable clone of this System.Windows.Media.Animation.Rotation3DAnimation,making 
 ...
 def CreateInstanceCore(self,*args):
  """
  CreateInstanceCore(self: Rotation3DAnimation) -> Freezable

  

   Creates a new instance of the System.Windows.Media.Animation.Rotation3DAnimation.
 ...
 def GetCurrentValueCore(self,*args):
  """
  GetCurrentValueCore(self: Rotation3DAnimation,defaultOriginValue: Rotation3D,defaultDestinationValue: Rotation3D,animationClock: AnimationClock) -> Rotation3D

  

   Calculates a value that represents the current value of the property being animated,as 

    determined by the System.Windows.Media.Animation.Rotation3DAnimation.
 ...
 def __new__(self,*__args):
  ...
  __new__(cls: type,toValue: Rotation3D,duration: Duration)

  __new__(cls: type,toValue: Rotation3D,duration: Duration,fillBehavior: FillBehavior)

  __new__(cls: type,fromValue: Rotation3D,toValue: Rotation3D,duration: Duration)

  __new__(cls: type,fromValue: Rotation3D,toValue: Rotation3D,duration: Duration,fillBehavior: FillBehavior)
  """
  pass
...
Get: By(self: Rotation3DAnimation) -> Rotation3D



Set: By(self: Rotation3DAnimation)=value
...
Get: EasingFunction(self: Rotation3DAnimation) -> IEasingFunction



Set: EasingFunction(self: Rotation3DAnimation)=value
...
Get: From(self: Rotation3DAnimation) -> Rotation3D



Set: From(self: Rotation3DAnimation)=value
...
Get: IsAdditive(self: Rotation3DAnimation) -> bool



Set: IsAdditive(self: Rotation3DAnimation)=value
...
Get: IsCumulative(self: Rotation3DAnimation) -> bool



Set: IsCumulative(self: Rotation3DAnimation)=value
...
Get: To(self: Rotation3DAnimation) -> Rotation3D



Set: To(self: Rotation3DAnimation)=value
