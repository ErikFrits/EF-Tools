class SingleAnimationBase(AnimationTimeline,ISealable,IAnimatable,IResource):
 """ Abstract class that,when implemented,animates a System.Single value. """
 ...
 def Clone(self):
  """
  Clone(self: SingleAnimationBase) -> SingleAnimationBase

  

   Creates a modifiable clone of this System.Windows.Media.Animation.SingleAnimationBase,making 
 ...
 def GetCurrentValue(self,defaultOriginValue,defaultDestinationValue,animationClock):
  """
  GetCurrentValue(self: SingleAnimationBase,defaultOriginValue: Single,defaultDestinationValue: Single,animationClock: AnimationClock) -> Single
  ...
  GetCurrentValue(self: SingleAnimationBase,defaultOriginValue: object,defaultDestinationValue: object,animationClock: AnimationClock) -> object
 ...
 def GetCurrentValueCore(self,*args):
  """
  GetCurrentValueCore(self: SingleAnimationBase,defaultOriginValue: Single,defaultDestinationValue: Single,animationClock: AnimationClock) -> Single
...
Get: TargetPropertyType(self: SingleAnimationBase) -> Type
