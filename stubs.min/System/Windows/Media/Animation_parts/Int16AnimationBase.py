class Int16AnimationBase(AnimationTimeline,ISealable,IAnimatable,IResource):
 """ Abstract class that,when implemented,animates a System.Int16 value. """
 ...
 def Clone(self):
  """
  Clone(self: Int16AnimationBase) -> Int16AnimationBase

  

   Creates a modifiable clone of this System.Windows.Media.Animation.Int16AnimationBase,making 
 ...
 def GetCurrentValue(self,defaultOriginValue,defaultDestinationValue,animationClock):
  """
  GetCurrentValue(self: Int16AnimationBase,defaultOriginValue: Int16,defaultDestinationValue: Int16,animationClock: AnimationClock) -> Int16
  ...
  GetCurrentValue(self: Int16AnimationBase,defaultOriginValue: object,defaultDestinationValue: object,animationClock: AnimationClock) -> object
 ...
 def GetCurrentValueCore(self,*args):
  """
  GetCurrentValueCore(self: Int16AnimationBase,defaultOriginValue: Int16,defaultDestinationValue: Int16,animationClock: AnimationClock) -> Int16
...
Get: TargetPropertyType(self: Int16AnimationBase) -> Type
