class QuaternionKeyFrameCollection(Freezable,ISealable,IList,ICollection,IEnumerable):
 ...
 def Add(self,keyFrame):
  ...
  Add(self: QuaternionKeyFrameCollection,keyFrame: QuaternionKeyFrame) -> int
   ...
   Adds a System.Windows.Media.Animation.QuaternionKeyFrame to the end of the collection.

  

   keyFrame: The System.Windows.Media.Animation.QuaternionKeyFrame to add to the end of the collection.
 ...
 def Clone(self):
  ...
  Clone(self: QuaternionKeyFrameCollection) -> QuaternionKeyFrameCollection
   ...
   Creates a modifiable clone of this System.Windows.Media.Animation.QuaternionKeyFrameCollection,
 ...
 def CloneCore(self,*args):
  ...
  CloneCore(self: QuaternionKeyFrameCollection,sourceFreezable: Freezable)
   ...
   Makes this instance a deep copy of the specified 
    ...
    System.Windows.Media.Animation.QuaternionKeyFrameCollection. When copying dependency properties,
 ...
 def CloneCurrentValueCore(self,*args):
  ...
  CloneCurrentValueCore(self: QuaternionKeyFrameCollection,sourceFreezable: Freezable)
   ...
   Makes this instance a modifiable deep copy of the specified 
    ...
    System.Windows.Media.Animation.QuaternionKeyFrameCollection using current property values. 
 ...
 def Contains(self,keyFrame):
  ...
  Contains(self: QuaternionKeyFrameCollection,keyFrame: QuaternionKeyFrame) -> bool
   ...
   keyFrame: The System.Windows.Media.Animation.QuaternionKeyFrame to locate in the collection.
 ...
 def CreateInstanceCore(self,*args):
  ...
  CreateInstanceCore(self: QuaternionKeyFrameCollection) -> Freezable
   ...
   Creates a new,frozen instance of System.Windows.Media.Animation.QuaternionKeyFrameCollection.
 ...
 def FreezeCore(self,*args):
  ...
  FreezeCore(self: QuaternionKeyFrameCollection,isChecking: bool) -> bool
   ...
   Makes this instance of System.Windows.Media.Animation.QuaternionKeyFrameCollection read-only or 
 ...
 def GetAsFrozenCore(self,*args):
  ...
  GetAsFrozenCore(self: QuaternionKeyFrameCollection,sourceFreezable: Freezable)
   ...
   Makes this instance a clone of the specified 
    ...
    System.Windows.Media.Animation.QuaternionKeyFrameCollection object.
 ...
 def GetCurrentValueAsFrozenCore(self,*args):
  ...
  GetCurrentValueAsFrozenCore(self: QuaternionKeyFrameCollection,sourceFreezable: Freezable)
   ...
   Makes this instance a frozen clone of the specified 
    ...
    System.Windows.Media.Animation.QuaternionKeyFrameCollection. Resource references,data bindings,
 ...
 def IndexOf(self,keyFrame):
  ...
  IndexOf(self: QuaternionKeyFrameCollection,keyFrame: QuaternionKeyFrame) -> int
   ...
   Searches for the specified System.Windows.Media.Animation.QuaternionKeyFrame and returns the 
 ...
 def Insert(self,index,keyFrame):
  ...
  Insert(self: QuaternionKeyFrameCollection,index: int,keyFrame: QuaternionKeyFrame)
   ...
   index: The index position at which the System.Windows.Media.Animation.QuaternionKeyFrame is inserted.
...
Get: Count(self: QuaternionKeyFrameCollection) -> int
...
Get: IsFixedSize(self: QuaternionKeyFrameCollection) -> bool
...
Get: IsReadOnly(self: QuaternionKeyFrameCollection) -> bool
...
Get: IsSynchronized(self: QuaternionKeyFrameCollection) -> bool
...
Get: SyncRoot(self: QuaternionKeyFrameCollection) -> object
