class StringAnimationBase(AnimationTimeline,ISealable,IAnimatable,IResource):
 """ Abstract class that,when implemented,animates a System.String value. """
 ...
 def Clone(self):
  """
  Clone(self: StringAnimationBase) -> StringAnimationBase

  

   Creates a modifiable clone of this System.Windows.Media.Animation.StringAnimationBase,making 
 ...
 def GetCurrentValue(self,defaultOriginValue,defaultDestinationValue,animationClock):
  """
  GetCurrentValue(self: StringAnimationBase,defaultOriginValue: str,defaultDestinationValue: str,animationClock: AnimationClock) -> str
  ...
  GetCurrentValue(self: StringAnimationBase,defaultOriginValue: object,defaultDestinationValue: object,animationClock: AnimationClock) -> object
 ...
 def GetCurrentValueCore(self,*args):
  """
  GetCurrentValueCore(self: StringAnimationBase,defaultOriginValue: str,defaultDestinationValue: str,animationClock: AnimationClock) -> str
...
Get: TargetPropertyType(self: StringAnimationBase) -> Type
