class RectAnimationBase(AnimationTimeline,ISealable,IAnimatable,IResource):
 """ Abstract class that,when implemented,animates a System.Windows.Rect value. """
 ...
 def Clone(self):
  """
  Clone(self: RectAnimationBase) -> RectAnimationBase

  

   Creates a modifiable clone of this System.Windows.Media.Animation.RectAnimationBase,making deep 
 ...
 def GetCurrentValue(self,defaultOriginValue,defaultDestinationValue,animationClock):
  """
  GetCurrentValue(self: RectAnimationBase,defaultOriginValue: Rect,defaultDestinationValue: Rect,animationClock: AnimationClock) -> Rect
  ...
  GetCurrentValue(self: RectAnimationBase,defaultOriginValue: object,defaultDestinationValue: object,animationClock: AnimationClock) -> object
 ...
 def GetCurrentValueCore(self,*args):
  """
  GetCurrentValueCore(self: RectAnimationBase,defaultOriginValue: Rect,defaultDestinationValue: Rect,animationClock: AnimationClock) -> Rect
...
Get: TargetPropertyType(self: RectAnimationBase) -> Type
