class QuaternionAnimationBase(AnimationTimeline,ISealable,IAnimatable,IResource):
 """ Abstract class that,when implemented,animates a System.Windows.Media.Media3D.Quaternion value. """
 ...
 def Clone(self):
  """
  Clone(self: QuaternionAnimationBase) -> QuaternionAnimationBase

  

   Creates a modifiable clone of this System.Windows.Media.Animation.QuaternionAnimationBase,
 ...
 def GetCurrentValue(self,defaultOriginValue,defaultDestinationValue,animationClock):
  """
  GetCurrentValue(self: QuaternionAnimationBase,defaultOriginValue: Quaternion,defaultDestinationValue: Quaternion,animationClock: AnimationClock) -> Quaternion
  ...
  GetCurrentValue(self: QuaternionAnimationBase,defaultOriginValue: object,defaultDestinationValue: object,animationClock: AnimationClock) -> object
 ...
 def GetCurrentValueCore(self,*args):
  """
  GetCurrentValueCore(self: QuaternionAnimationBase,defaultOriginValue: Quaternion,defaultDestinationValue: Quaternion,animationClock: AnimationClock) -> Quaternion
...
Get: TargetPropertyType(self: QuaternionAnimationBase) -> Type
