class LinearRectKeyFrame(RectKeyFrame,ISealable,IKeyFrame):
 """
 Animates from the System.Windows.Rect value of the previous key frame to its own System.Windows.Media.Animation.RectKeyFrame.Value using linear interpolation.

 

 LinearRectKeyFrame()

 LinearRectKeyFrame(value: Rect)

 LinearRectKeyFrame(value: Rect,keyTime: KeyTime)
 """
 ...
 def CreateInstanceCore(self,*args):
  """
  CreateInstanceCore(self: LinearRectKeyFrame) -> Freezable

  

   Creates a new instance of System.Windows.Media.Animation.LinearRectKeyFrame.

   Returns: A new System.Windows.Media.Animation.LinearRectKeyFrame.
  """
  pass
 ...
 def InterpolateValueCore(self,*args):
  """
  InterpolateValueCore(self: LinearRectKeyFrame,baseValue: Rect,keyFrameProgress: float) -> Rect
