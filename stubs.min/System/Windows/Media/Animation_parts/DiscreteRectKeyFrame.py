class DiscreteRectKeyFrame(RectKeyFrame,ISealable,IKeyFrame):
 """
 Animates from the System.Windows.Rect value of the previous key frame to its own System.Windows.Media.Animation.RectKeyFrame.Value using discrete interpolation.

 

 DiscreteRectKeyFrame()

 DiscreteRectKeyFrame(value: Rect)

 DiscreteRectKeyFrame(value: Rect,keyTime: KeyTime)
 """
 ...
 def CreateInstanceCore(self,*args):
  """
  CreateInstanceCore(self: DiscreteRectKeyFrame) -> Freezable

  

   Creates a new instance of System.Windows.Media.Animation.DiscreteRectKeyFrame.

   Returns: A new System.Windows.Media.Animation.DiscreteRectKeyFrame.
  """
  pass
 ...
 def InterpolateValueCore(self,*args):
  """
  InterpolateValueCore(self: DiscreteRectKeyFrame,baseValue: Rect,keyFrameProgress: float) -> Rect
