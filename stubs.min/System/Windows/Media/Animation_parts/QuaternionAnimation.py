class QuaternionAnimation(QuaternionAnimationBase,ISealable,IAnimatable,IResource):
 """
 Animates the value of a System.Windows.Media.Media3D.Quaternion property between two target values using linear interpolation over a specified System.Windows.Media.Animation.Timeline.Duration.

 

 QuaternionAnimation()

 QuaternionAnimation(toValue: Quaternion,duration: Duration)

 QuaternionAnimation(toValue: Quaternion,duration: Duration,fillBehavior: FillBehavior)

 QuaternionAnimation(fromValue: Quaternion,toValue: Quaternion,duration: Duration)

 QuaternionAnimation(fromValue: Quaternion,toValue: Quaternion,duration: Duration,fillBehavior: FillBehavior)
 """
 ...
 def Clone(self):
  """
  Clone(self: QuaternionAnimation) -> QuaternionAnimation

  

   Creates a modifiable clone of this System.Windows.Media.Media3D.Quaternion,making deep copies 
 ...
 def CreateInstanceCore(self,*args):
  """
  CreateInstanceCore(self: QuaternionAnimation) -> Freezable

  

   Creates a new instance of the System.Windows.Media.Animation.QuaternionAnimation.
 ...
 def GetCurrentValueCore(self,*args):
  """
  GetCurrentValueCore(self: QuaternionAnimation,defaultOriginValue: Quaternion,defaultDestinationValue: Quaternion,animationClock: AnimationClock) -> Quaternion

  

   Calculates a value that represents the current value of the property being animated,as 

    determined by the System.Windows.Media.Animation.QuaternionAnimation.
 ...
 def __new__(self,*__args):
  ...
  __new__(cls: type,toValue: Quaternion,duration: Duration)

  __new__(cls: type,toValue: Quaternion,duration: Duration,fillBehavior: FillBehavior)

  __new__(cls: type,fromValue: Quaternion,toValue: Quaternion,duration: Duration)

  __new__(cls: type,fromValue: Quaternion,toValue: Quaternion,duration: Duration,fillBehavior: FillBehavior)
  """
  pass
...
Get: By(self: QuaternionAnimation) -> Nullable[Quaternion]



Set: By(self: QuaternionAnimation)=value
...
Get: EasingFunction(self: QuaternionAnimation) -> IEasingFunction



Set: EasingFunction(self: QuaternionAnimation)=value
...
Get: From(self: QuaternionAnimation) -> Nullable[Quaternion]



Set: From(self: QuaternionAnimation)=value
...
Get: IsAdditive(self: QuaternionAnimation) -> bool



Set: IsAdditive(self: QuaternionAnimation)=value
...
Get: IsCumulative(self: QuaternionAnimation) -> bool



Set: IsCumulative(self: QuaternionAnimation)=value
...
Get: To(self: QuaternionAnimation) -> Nullable[Quaternion]



Set: To(self: QuaternionAnimation)=value

"""

 UseShortestPath=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
Get: UseShortestPath(self: QuaternionAnimation) -> bool



Set: UseShortestPath(self: QuaternionAnimation)=value
