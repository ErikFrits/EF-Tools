class LinearColorKeyFrame(ColorKeyFrame,ISealable,IKeyFrame):
 """
 Animates from the System.Windows.Media.Color value of the previous key frame to its own System.Windows.Media.Animation.ColorKeyFrame.Value using linear interpolation.

 

 LinearColorKeyFrame()

 LinearColorKeyFrame(value: Color)

 LinearColorKeyFrame(value: Color,keyTime: KeyTime)
 """
 ...
 def CreateInstanceCore(self,*args):
  """
  CreateInstanceCore(self: LinearColorKeyFrame) -> Freezable

  

   Creates a new instance of System.Windows.Media.Animation.LinearColorKeyFrame.

   Returns: A new System.Windows.Media.Animation.LinearColorKeyFrame.
  """
  pass
 ...
 def InterpolateValueCore(self,*args):
  """
  InterpolateValueCore(self: LinearColorKeyFrame,baseValue: Color,keyFrameProgress: float) -> Color
