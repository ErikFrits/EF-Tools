class EasingColorKeyFrame(ColorKeyFrame,ISealable,IKeyFrame):
 """
 A class that enables you to associate easing functions with a System.Windows.Media.Animation.ColorAnimationUsingKeyFrames key frame animation.

 

 EasingColorKeyFrame()

 EasingColorKeyFrame(value: Color)

 EasingColorKeyFrame(value: Color,keyTime: KeyTime)

 EasingColorKeyFrame(value: Color,keyTime: KeyTime,easingFunction: IEasingFunction)
 """
 ...
 def CreateInstanceCore(self,*args):
  """
  CreateInstanceCore(self: EasingColorKeyFrame) -> Freezable
 ...
 def InterpolateValueCore(self,*args):
  """
  InterpolateValueCore(self: EasingColorKeyFrame,baseValue: Color,keyFrameProgress: float) -> Color
 ...
 def __new__(self,value=None,keyTime=None,easingFunction=None):
  ...
  __new__(cls: type,value: Color,keyTime: KeyTime,easingFunction: IEasingFunction)
  """
  pass
...
Get: EasingFunction(self: EasingColorKeyFrame) -> IEasingFunction



Set: EasingFunction(self: EasingColorKeyFrame)=value
