class EasingSizeKeyFrame(SizeKeyFrame,ISealable,IKeyFrame):
 """
 A class that enables you to associate easing functions with a System.Windows.Media.Animation.SizeAnimationUsingKeyFrames key frame animation.

 

 EasingSizeKeyFrame()

 EasingSizeKeyFrame(value: Size)

 EasingSizeKeyFrame(value: Size,keyTime: KeyTime)

 EasingSizeKeyFrame(value: Size,keyTime: KeyTime,easingFunction: IEasingFunction)
 """
 ...
 def CreateInstanceCore(self,*args):
  """
  CreateInstanceCore(self: EasingSizeKeyFrame) -> Freezable
 ...
 def InterpolateValueCore(self,*args):
  """
  InterpolateValueCore(self: EasingSizeKeyFrame,baseValue: Size,keyFrameProgress: float) -> Size
 ...
 def __new__(self,value=None,keyTime=None,easingFunction=None):
  ...
  __new__(cls: type,value: Size,keyTime: KeyTime,easingFunction: IEasingFunction)
  """
  pass
...
Get: EasingFunction(self: EasingSizeKeyFrame) -> IEasingFunction



Set: EasingFunction(self: EasingSizeKeyFrame)=value
