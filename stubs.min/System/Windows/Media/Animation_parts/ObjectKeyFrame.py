class ObjectKeyFrame(Freezable,ISealable,IKeyFrame):
 """ Abstract class that,when implemented,defines an animation segment with its own target value and interpolation method for a System.Windows.Media.Animation.ObjectAnimationUsingKeyFrames. """
 ...
 def InterpolateValue(self,baseValue,keyFrameProgress):
  """
  InterpolateValue(self: ObjectKeyFrame,baseValue: object,keyFrameProgress: float) -> object
 ...
 def InterpolateValueCore(self,*args):
  """
  InterpolateValueCore(self: ObjectKeyFrame,baseValue: object,keyFrameProgress: float) -> object
 ...
 def __new__(self,*args): #cannot find CLR constructor
  ...
  __new__(cls: type,value: object,keyTime: KeyTime)
  """
  pass
 KeyTime=property(lambda self: object(),lambda self,v: None,lambda self: None)
 """Gets or sets the time at which the key frame's target System.Windows.Media.Animation.ObjectKeyFrame.Value should be reached.



Get: KeyTime(self: ObjectKeyFrame) -> KeyTime



Set: KeyTime(self: ObjectKeyFrame)=value
...
Get: Value(self: ObjectKeyFrame) -> object



Set: Value(self: ObjectKeyFrame)=value
