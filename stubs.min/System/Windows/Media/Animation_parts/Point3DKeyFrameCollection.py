class Point3DKeyFrameCollection(Freezable,ISealable,IList,ICollection,IEnumerable):
 ...
 def Add(self,keyFrame):
  ...
  Add(self: Point3DKeyFrameCollection,keyFrame: Point3DKeyFrame) -> int
   ...
   Adds a System.Windows.Media.Animation.Point3DKeyFrame to the end of the collection.

  

   keyFrame: The System.Windows.Media.Animation.Point3DKeyFrame to add to the end of the collection.
 ...
 def Clone(self):
  ...
  Clone(self: Point3DKeyFrameCollection) -> Point3DKeyFrameCollection
   ...
   Creates a modifiable clone of this System.Windows.Media.Animation.Point3DKeyFrameCollection,
 ...
 def CloneCore(self,*args):
  ...
  CloneCore(self: Point3DKeyFrameCollection,sourceFreezable: Freezable)
   ...
   Makes this instance a deep copy of the specified 
    ...
    System.Windows.Media.Animation.Point3DKeyFrameCollection. When copying dependency properties,
 ...
 def CloneCurrentValueCore(self,*args):
  ...
  CloneCurrentValueCore(self: Point3DKeyFrameCollection,sourceFreezable: Freezable)
   ...
   Makes this instance a modifiable deep copy of the specified 
    ...
    System.Windows.Media.Animation.Point3DKeyFrameCollection using current property values. Resource 
 ...
 def Contains(self,keyFrame):
  ...
  Contains(self: Point3DKeyFrameCollection,keyFrame: Point3DKeyFrame) -> bool
   ...
   keyFrame: The System.Windows.Media.Animation.Point3DKeyFrame to locate in the collection.
 ...
 def CreateInstanceCore(self,*args):
  ...
  CreateInstanceCore(self: Point3DKeyFrameCollection) -> Freezable
   ...
   Creates a new,frozen instance of System.Windows.Media.Animation.Point3DKeyFrameCollection.
 ...
 def FreezeCore(self,*args):
  ...
  FreezeCore(self: Point3DKeyFrameCollection,isChecking: bool) -> bool
   ...
   Makes this instance of System.Windows.Media.Animation.Point3DKeyFrameCollection unmodifiable or 
   ...
   isChecking: true if the System.Windows.Freezable instance should actually freeze itself when this method is 

    called. false if the System.Windows.Freezable should simply return whether it can be frozen.

  

   Returns: If isChecking is true,this method returns true if the specified System.Windows.Freezable can be 

    made unmodifiable,or false if it cannot be made unmodifiable. If isChecking is false,this 

    method returns true if the if the specified System.Windows.Freezable is now unmodifiable,or 

    false if it cannot be made unmodifiable,with the side effect of having made the actual change 
 ...
 def GetAsFrozenCore(self,*args):
  ...
  GetAsFrozenCore(self: Point3DKeyFrameCollection,sourceFreezable: Freezable)
   ...
   Makes this instance a clone of the specified 
    ...
    System.Windows.Media.Animation.Point3DKeyFrameCollection object.
 ...
 def GetCurrentValueAsFrozenCore(self,*args):
  ...
  GetCurrentValueAsFrozenCore(self: Point3DKeyFrameCollection,sourceFreezable: Freezable)
   ...
   Makes this instance a frozen clone of the specified 
    ...
    System.Windows.Media.Animation.Point3DKeyFrameCollection. Resource references,data bindings,
 ...
 def IndexOf(self,keyFrame):
  ...
  IndexOf(self: Point3DKeyFrameCollection,keyFrame: Point3DKeyFrame) -> int
   ...
   Searches for the specified System.Windows.Media.Animation.Point3DKeyFrame and returns the 
 ...
 def Insert(self,index,keyFrame):
  ...
  Insert(self: Point3DKeyFrameCollection,index: int,keyFrame: Point3DKeyFrame)
   ...
   index: The index position at which the System.Windows.Media.Animation.Point3DKeyFrame is inserted.
...
Get: Count(self: Point3DKeyFrameCollection) -> int
...
Get: IsFixedSize(self: Point3DKeyFrameCollection) -> bool
...
Get: IsReadOnly(self: Point3DKeyFrameCollection) -> bool
...
Get: IsSynchronized(self: Point3DKeyFrameCollection) -> bool
...
Get: SyncRoot(self: Point3DKeyFrameCollection) -> object
