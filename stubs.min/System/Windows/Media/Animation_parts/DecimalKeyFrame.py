class DecimalKeyFrame(Freezable,ISealable,IKeyFrame):
 """ Abstract class that,when implemented,defines an animation segment with its own target value and interpolation method for a System.Windows.Media.Animation.DecimalAnimationUsingKeyFrames. """
 ...
 def InterpolateValue(self,baseValue,keyFrameProgress):
  """
  InterpolateValue(self: DecimalKeyFrame,baseValue: Decimal,keyFrameProgress: float) -> Decimal
 ...
 def InterpolateValueCore(self,*args):
  """
  InterpolateValueCore(self: DecimalKeyFrame,baseValue: Decimal,keyFrameProgress: float) -> Decimal
 ...
 """Gets or sets the time at which the key frame's target System.Windows.Media.Animation.DecimalKeyFrame.Value should be reached.



Get: KeyTime(self: DecimalKeyFrame) -> KeyTime



Set: KeyTime(self: DecimalKeyFrame)=value
...
Get: Value(self: DecimalKeyFrame) -> Decimal



Set: Value(self: DecimalKeyFrame)=value
