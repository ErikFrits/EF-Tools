class VectorKeyFrame(Freezable,ISealable,IKeyFrame):
 """ Abstract class that,when implemented,defines an animation segment with its own target value and interpolation method for a System.Windows.Media.Animation.VectorAnimationUsingKeyFrames. """
 ...
 def InterpolateValue(self,baseValue,keyFrameProgress):
  """
  InterpolateValue(self: VectorKeyFrame,baseValue: Vector,keyFrameProgress: float) -> Vector
 ...
 def InterpolateValueCore(self,*args):
  """
  InterpolateValueCore(self: VectorKeyFrame,baseValue: Vector,keyFrameProgress: float) -> Vector
 ...
 """Gets or sets the time at which the key frame's target System.Windows.Media.Animation.VectorKeyFrame.Value should be reached.



Get: KeyTime(self: VectorKeyFrame) -> KeyTime



Set: KeyTime(self: VectorKeyFrame)=value
...
Get: Value(self: VectorKeyFrame) -> Vector



Set: Value(self: VectorKeyFrame)=value
