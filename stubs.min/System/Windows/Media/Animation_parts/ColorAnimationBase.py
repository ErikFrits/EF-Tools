class ColorAnimationBase(AnimationTimeline,ISealable,IAnimatable,IResource):
 """ Abstract class that,when implemented,animates a System.Windows.Media.Color value. """
 ...
 def Clone(self):
  """
  Clone(self: ColorAnimationBase) -> ColorAnimationBase

  

   Creates a modifiable clone of this System.Windows.Media.Animation.ColorAnimationBase,making 
 ...
 def GetCurrentValue(self,defaultOriginValue,defaultDestinationValue,animationClock):
  """
  GetCurrentValue(self: ColorAnimationBase,defaultOriginValue: Color,defaultDestinationValue: Color,animationClock: AnimationClock) -> Color
  ...
  GetCurrentValue(self: ColorAnimationBase,defaultOriginValue: object,defaultDestinationValue: object,animationClock: AnimationClock) -> object
 ...
 def GetCurrentValueCore(self,*args):
  """
  GetCurrentValueCore(self: ColorAnimationBase,defaultOriginValue: Color,defaultDestinationValue: Color,animationClock: AnimationClock) -> Color
...
Get: TargetPropertyType(self: ColorAnimationBase) -> Type
