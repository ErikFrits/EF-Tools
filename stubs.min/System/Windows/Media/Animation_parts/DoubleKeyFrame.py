class DoubleKeyFrame(Freezable,ISealable,IKeyFrame):
 """ Abstract class that,when implemented,defines an animation segment with its own target value and interpolation method for a System.Windows.Media.Animation.DoubleAnimationUsingKeyFrames. """
 ...
 def InterpolateValue(self,baseValue,keyFrameProgress):
  """
  InterpolateValue(self: DoubleKeyFrame,baseValue: float,keyFrameProgress: float) -> float
 ...
 def InterpolateValueCore(self,*args):
  """
  InterpolateValueCore(self: DoubleKeyFrame,baseValue: float,keyFrameProgress: float) -> float
 ...
 """Gets or sets the time at which the key frame's target System.Windows.Media.Animation.DoubleKeyFrame.Value should be reached.



Get: KeyTime(self: DoubleKeyFrame) -> KeyTime



Set: KeyTime(self: DoubleKeyFrame)=value
...
Get: Value(self: DoubleKeyFrame) -> float



Set: Value(self: DoubleKeyFrame)=value
