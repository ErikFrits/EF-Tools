class LinearVectorKeyFrame(VectorKeyFrame,ISealable,IKeyFrame):
 """
 Animates from the System.Windows.Vector value of the previous key frame to its own System.Windows.Media.Animation.VectorKeyFrame.Value using linear interpolation.

 

 LinearVectorKeyFrame()

 LinearVectorKeyFrame(value: Vector)

 LinearVectorKeyFrame(value: Vector,keyTime: KeyTime)
 """
 ...
 def CreateInstanceCore(self,*args):
  """
  CreateInstanceCore(self: LinearVectorKeyFrame) -> Freezable

  

   Creates a new instance of System.Windows.Media.Animation.LinearVectorKeyFrame.

   Returns: A new System.Windows.Media.Animation.LinearVectorKeyFrame.
  """
  pass
 ...
 def InterpolateValueCore(self,*args):
  """
  InterpolateValueCore(self: LinearVectorKeyFrame,baseValue: Vector,keyFrameProgress: float) -> Vector
