class EasingPointKeyFrame(PointKeyFrame,ISealable,IKeyFrame):
 """
 A class that enables you to associate easing functions with a System.Windows.Media.Animation.PointAnimationUsingKeyFrames key frame animation.

 

 EasingPointKeyFrame()

 EasingPointKeyFrame(value: Point)

 EasingPointKeyFrame(value: Point,keyTime: KeyTime)

 EasingPointKeyFrame(value: Point,keyTime: KeyTime,easingFunction: IEasingFunction)
 """
 ...
 def CreateInstanceCore(self,*args):
  """
  CreateInstanceCore(self: EasingPointKeyFrame) -> Freezable
 ...
 def InterpolateValueCore(self,*args):
  """
  InterpolateValueCore(self: EasingPointKeyFrame,baseValue: Point,keyFrameProgress: float) -> Point
 ...
 def __new__(self,value=None,keyTime=None,easingFunction=None):
  ...
  __new__(cls: type,value: Point,keyTime: KeyTime,easingFunction: IEasingFunction)
  """
  pass
...
Get: EasingFunction(self: EasingPointKeyFrame) -> IEasingFunction



Set: EasingFunction(self: EasingPointKeyFrame)=value
