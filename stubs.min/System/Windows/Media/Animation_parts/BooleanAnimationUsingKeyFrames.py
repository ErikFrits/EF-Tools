class BooleanAnimationUsingKeyFrames(BooleanAnimationBase,ISealable,IAnimatable,IResource,IKeyFrameAnimation,IAddChild):
 ...
 def Clone(self):
  ...
  Clone(self: BooleanAnimationUsingKeyFrames) -> BooleanAnimationUsingKeyFrames
   ...
   Creates a modifiable clone of this 
    ...
    System.Windows.Media.Animation.BooleanAnimationUsingKeyFrames,making deep copies of this 
 ...
 def CloneCore(self,*args):
  ...
  CloneCore(self: BooleanAnimationUsingKeyFrames,sourceFreezable: Freezable)
   ...
   Makes this instance a deep copy of the specified 
    ...
    System.Windows.Media.Animation.BooleanAnimationUsingKeyFrames. When copying dependency 
 ...
 def CloneCurrentValue(self):
  ...
  CloneCurrentValue(self: BooleanAnimationUsingKeyFrames) -> BooleanAnimationUsingKeyFrames
   ...
   Creates a modifiable clone of this System.Windows.Media.Animation.BooleanAnimationUsingKeyFrames 
 ...
 def CloneCurrentValueCore(self,*args):
  ...
  CloneCurrentValueCore(self: BooleanAnimationUsingKeyFrames,sourceFreezable: Freezable)
   ...
   Makes this instance a modifiable deep copy of the specified 
    ...
    System.Windows.Media.Animation.BooleanAnimationUsingKeyFrames using current property values. 
 ...
 def CreateInstanceCore(self,*args):
  ...
  CreateInstanceCore(self: BooleanAnimationUsingKeyFrames) -> Freezable
   ...
   Creates a new instance of System.Windows.Media.Animation.BooleanAnimationUsingKeyFrames.
 ...
 def FreezeCore(self,*args):
  ...
  FreezeCore(self: BooleanAnimationUsingKeyFrames,isChecking: bool) -> bool
   ...
   Makes this instance of System.Windows.Media.Animation.BooleanAnimationUsingKeyFrames object 
   ...
   Returns: If isChecking is true,this method returns true if this object can be made read-only,or false 

    if it cannot be made read-only. If isChecking is false,this method returns true if this object 

    is now read-only,or false if it cannot be made read-only,with the side effect of having begun 
 ...
 def GetAsFrozenCore(self,*args):
  ...
  GetAsFrozenCore(self: BooleanAnimationUsingKeyFrames,source: Freezable)
   ...
   Makes this instance a clone of the specified 
    ...
    System.Windows.Media.Animation.BooleanAnimationUsingKeyFrames object.
 ...
 def GetCurrentValueAsFrozenCore(self,*args):
  ...
  GetCurrentValueAsFrozenCore(self: BooleanAnimationUsingKeyFrames,source: Freezable)
   ...
   Makes this instance a frozen clone of the specified 
    ...
    System.Windows.Media.Animation.BooleanAnimationUsingKeyFrames. Resource references,data 
 ...
 def GetCurrentValueCore(self,*args):
  ...
  GetCurrentValueCore(self: BooleanAnimationUsingKeyFrames,defaultOriginValue: bool,defaultDestinationValue: bool,animationClock: AnimationClock) -> bool
   ...
   Calculates a value that represents the current value of the property being animated,as 
    ...
    determined by this instance of System.Windows.Media.Animation.BooleanAnimationUsingKeyFrames.
 ...
 def ShouldSerializeKeyFrames(self):
  ...
  ShouldSerializeKeyFrames(self: BooleanAnimationUsingKeyFrames) -> bool
   ...
   Returns true if the value of the 
    ...
    System.Windows.Media.Animation.BooleanAnimationUsingKeyFrames.KeyFrames property of this 

    instance of System.Windows.Media.Animation.BooleanAnimationUsingKeyFrames should be 
...
Get: KeyFrames(self: BooleanAnimationUsingKeyFrames) -> BooleanKeyFrameCollection
