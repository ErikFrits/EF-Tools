class CubicEase(EasingFunctionBase,ISealable,IEasingFunction):
 """
 ...
 def CreateInstanceCore(self,*args):
  """
  CreateInstanceCore(self: CubicEase) -> Freezable
 ...
 def EaseInCore(self,*args):
  """
  EaseInCore(self: CubicEase,normalizedTime: float) -> float
