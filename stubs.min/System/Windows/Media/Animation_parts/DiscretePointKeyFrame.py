class DiscretePointKeyFrame(PointKeyFrame,ISealable,IKeyFrame):
 """
 Animates from the System.Windows.Point value of the previous key frame to its own System.Windows.Media.Animation.PointKeyFrame.Value using discrete interpolation.

 

 DiscretePointKeyFrame()

 DiscretePointKeyFrame(value: Point)

 DiscretePointKeyFrame(value: Point,keyTime: KeyTime)
 """
 ...
 def CreateInstanceCore(self,*args):
  """
  CreateInstanceCore(self: DiscretePointKeyFrame) -> Freezable

  

   Creates a new instance of System.Windows.Media.Animation.DiscretePointKeyFrame.

   Returns: A new System.Windows.Media.Animation.DiscretePointKeyFrame.
  """
  pass
 ...
 def InterpolateValueCore(self,*args):
  """
  InterpolateValueCore(self: DiscretePointKeyFrame,baseValue: Point,keyFrameProgress: float) -> Point
