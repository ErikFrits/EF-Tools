class PointKeyFrame(Freezable,ISealable,IKeyFrame):
 """ Defines an animation segment with its own target value and interpolation method for a System.Windows.Media.Animation.PointAnimationUsingKeyFrames. """
 ...
 def InterpolateValue(self,baseValue,keyFrameProgress):
  """
  InterpolateValue(self: PointKeyFrame,baseValue: Point,keyFrameProgress: float) -> Point
 ...
 def InterpolateValueCore(self,*args):
  """
  InterpolateValueCore(self: PointKeyFrame,baseValue: Point,keyFrameProgress: float) -> Point
 ...
 """Gets or sets the time at which the key frame's target System.Windows.Media.Animation.PointKeyFrame.Value should be reached.



Get: KeyTime(self: PointKeyFrame) -> KeyTime



Set: KeyTime(self: PointKeyFrame)=value
...
Get: Value(self: PointKeyFrame) -> Point



Set: Value(self: PointKeyFrame)=value
