class VectorAnimationBase(AnimationTimeline,ISealable,IAnimatable,IResource):
 """ Abstract class that,when implemented,animates a System.Windows.Vector value. """
 ...
 def Clone(self):
  """
  Clone(self: VectorAnimationBase) -> VectorAnimationBase

  

   Creates a modifiable clone of this System.Windows.Media.Animation.VectorAnimationBase,making 
 ...
 def GetCurrentValue(self,defaultOriginValue,defaultDestinationValue,animationClock):
  """
  GetCurrentValue(self: VectorAnimationBase,defaultOriginValue: Vector,defaultDestinationValue: Vector,animationClock: AnimationClock) -> Vector
  ...
  GetCurrentValue(self: VectorAnimationBase,defaultOriginValue: object,defaultDestinationValue: object,animationClock: AnimationClock) -> object
 ...
 def GetCurrentValueCore(self,*args):
  """
  GetCurrentValueCore(self: VectorAnimationBase,defaultOriginValue: Vector,defaultDestinationValue: Vector,animationClock: AnimationClock) -> Vector
...
Get: TargetPropertyType(self: VectorAnimationBase) -> Type
