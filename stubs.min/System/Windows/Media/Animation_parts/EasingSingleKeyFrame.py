class EasingSingleKeyFrame(SingleKeyFrame,ISealable,IKeyFrame):
 """
 A class that enables you to associate easing functions with a System.Windows.Media.Animation.SingleAnimationUsingKeyFrames key frame animation.

 

 EasingSingleKeyFrame()

 EasingSingleKeyFrame(value: Single)

 EasingSingleKeyFrame(value: Single,keyTime: KeyTime)

 EasingSingleKeyFrame(value: Single,keyTime: KeyTime,easingFunction: IEasingFunction)
 """
 ...
 def CreateInstanceCore(self,*args):
  """
  CreateInstanceCore(self: EasingSingleKeyFrame) -> Freezable
 ...
 def InterpolateValueCore(self,*args):
  """
  InterpolateValueCore(self: EasingSingleKeyFrame,baseValue: Single,keyFrameProgress: float) -> Single
 ...
 def __new__(self,value=None,keyTime=None,easingFunction=None):
  ...
  __new__(cls: type,value: Single,keyTime: KeyTime,easingFunction: IEasingFunction)
  """
  pass
...
Get: EasingFunction(self: EasingSingleKeyFrame) -> IEasingFunction



Set: EasingFunction(self: EasingSingleKeyFrame)=value
