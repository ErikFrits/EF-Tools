class Int16KeyFrame(Freezable,ISealable,IKeyFrame):
 """ Abstract class that,when implemented,defines an animation segment with its own target value and interpolation method for a System.Windows.Media.Animation.Int16AnimationUsingKeyFrames. """
 ...
 def InterpolateValue(self,baseValue,keyFrameProgress):
  """
  InterpolateValue(self: Int16KeyFrame,baseValue: Int16,keyFrameProgress: float) -> Int16
 ...
 def InterpolateValueCore(self,*args):
  """
  InterpolateValueCore(self: Int16KeyFrame,baseValue: Int16,keyFrameProgress: float) -> Int16
 ...
 """Gets or sets the time at which the key frame's target System.Windows.Media.Animation.Int16KeyFrame.Value should be reached.



Get: KeyTime(self: Int16KeyFrame) -> KeyTime



Set: KeyTime(self: Int16KeyFrame)=value
...
Get: Value(self: Int16KeyFrame) -> Int16



Set: Value(self: Int16KeyFrame)=value
