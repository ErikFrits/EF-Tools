class ParallelTimeline(TimelineGroup,ISealable,IAnimatable,IResource,IAddChild):
 ...
 ParallelTimeline(beginTime: Nullable[TimeSpan])

 ParallelTimeline(beginTime: Nullable[TimeSpan],duration: Duration)
 ...
 def Clone(self):
  ...
  Clone(self: ParallelTimeline) -> ParallelTimeline
   ...
   Creates a modifiable clone of this System.Windows.Media.Animation.ParallelTimeline,making deep 
 ...
 def CloneCurrentValue(self):
  ...
  CloneCurrentValue(self: ParallelTimeline) -> ParallelTimeline
   ...
   Creates a modifiable clone of this System.Windows.Media.Animation.ParallelTimeline object,
 ...
 def CreateInstanceCore(self,*args):
  ...
  CreateInstanceCore(self: ParallelTimeline) -> Freezable
   ...
   Creates a new instance of this System.Windows.Freezable.
 ...
 def GetNaturalDurationCore(self,*args):
  ...
  GetNaturalDurationCore(self: ParallelTimeline,clock: Clock) -> Duration
   ...
   Return the natural duration (duration of a single iteration) from a specified 
...
Get: SlipBehavior(self: ParallelTimeline) -> SlipBehavior



Set: SlipBehavior(self: ParallelTimeline)=value
