class AnimationTimeline(Timeline,ISealable,IAnimatable,IResource):
 ...
 def Clone(self):
  ...
  Clone(self: AnimationTimeline) -> AnimationTimeline
   ...
   Creates a modifiable clone of this System.Windows.Media.Animation.AnimationTimeline,making deep 
 ...
 def CreateClock(self,hasControllableRoot=None):
  ...
  CreateClock(self: AnimationTimeline) -> AnimationClock
   ...
   Creates a new System.Windows.Media.Animation.AnimationClock from this 
...
Get: IsDestinationDefault(self: AnimationTimeline) -> bool
...
Get: TargetPropertyType(self: AnimationTimeline) -> Type
