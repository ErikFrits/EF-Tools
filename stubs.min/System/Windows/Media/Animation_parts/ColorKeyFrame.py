class ColorKeyFrame(Freezable,ISealable,IKeyFrame):
 """ Abstract class that,when implemented,defines an animation segment with its own target value and interpolation method for a System.Windows.Media.Animation.ColorAnimationUsingKeyFrames. """
 ...
 def InterpolateValue(self,baseValue,keyFrameProgress):
  """
  InterpolateValue(self: ColorKeyFrame,baseValue: Color,keyFrameProgress: float) -> Color
 ...
 def InterpolateValueCore(self,*args):
  """
  InterpolateValueCore(self: ColorKeyFrame,baseValue: Color,keyFrameProgress: float) -> Color
 ...
 """Gets or sets the time at which the key frame's target System.Windows.Media.Animation.ColorKeyFrame.Value should be reached.



Get: KeyTime(self: ColorKeyFrame) -> KeyTime



Set: KeyTime(self: ColorKeyFrame)=value
...
Get: Value(self: ColorKeyFrame) -> Color



Set: Value(self: ColorKeyFrame)=value
