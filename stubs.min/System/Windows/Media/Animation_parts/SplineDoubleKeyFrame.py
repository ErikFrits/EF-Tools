class SplineDoubleKeyFrame(DoubleKeyFrame,ISealable,IKeyFrame):
 """
 ...
 SplineDoubleKeyFrame(value: float)

 SplineDoubleKeyFrame(value: float,keyTime: KeyTime)

 SplineDoubleKeyFrame(value: float,keyTime: KeyTime,keySpline: KeySpline)
 """
 ...
 def CreateInstanceCore(self,*args):
  """
  CreateInstanceCore(self: SplineDoubleKeyFrame) -> Freezable

  

   Creates a new instance of System.Windows.Media.Animation.SplineDoubleKeyFrame.

   Returns: A new System.Windows.Media.Animation.SplineDoubleKeyFrame.
  """
  pass
 ...
 def InterpolateValueCore(self,*args):
  """
  InterpolateValueCore(self: SplineDoubleKeyFrame,baseValue: float,keyFrameProgress: float) -> float
 ...
 def __new__(self,value=None,keyTime=None,keySpline=None):
  ...
  __new__(cls: type,value: float,keyTime: KeyTime,keySpline: KeySpline)
  """
  pass
...
Get: KeySpline(self: SplineDoubleKeyFrame) -> KeySpline



Set: KeySpline(self: SplineDoubleKeyFrame)=value
