class DiscretePoint3DKeyFrame(Point3DKeyFrame,ISealable,IKeyFrame):
 """
 Animates from the System.Windows.Media.Media3D.Point3D value of the previous key frame to its own System.Windows.Media.Animation.Point3DKeyFrame.Value using discrete interpolation.

 

 DiscretePoint3DKeyFrame()

 DiscretePoint3DKeyFrame(value: Point3D)

 DiscretePoint3DKeyFrame(value: Point3D,keyTime: KeyTime)
 """
 ...
 def CreateInstanceCore(self,*args):
  """
  CreateInstanceCore(self: DiscretePoint3DKeyFrame) -> Freezable

  

   Creates a new instance of the System.Windows.Media.Animation.DiscretePoint3DKeyFrame class.

   Returns: A new System.Windows.Media.Animation.DiscretePoint3DKeyFrame.
  """
  pass
 ...
 def InterpolateValueCore(self,*args):
  """
  InterpolateValueCore(self: DiscretePoint3DKeyFrame,baseValue: Point3D,keyFrameProgress: float) -> Point3D

  

   Interpolates,in a discrete fashion,between the previous key frame value and the value of the 

    current key frame,using the specified progress increment.

  

  

   baseValue: The value from which to animate.
