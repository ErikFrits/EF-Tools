class DiscreteByteKeyFrame(ByteKeyFrame,ISealable,IKeyFrame):
 """
 Animates from the System.Byte value of the previous key frame to its own System.Windows.Media.Animation.ByteKeyFrame.Value using discrete interpolation.

 

 DiscreteByteKeyFrame()

 DiscreteByteKeyFrame(value: Byte)

 DiscreteByteKeyFrame(value: Byte,keyTime: KeyTime)
 """
 ...
 def CreateInstanceCore(self,*args):
  """
  CreateInstanceCore(self: DiscreteByteKeyFrame) -> Freezable

  

   Creates a new instance of System.Windows.Media.Animation.DiscreteByteKeyFrame.

   Returns: A new System.Windows.Media.Animation.DiscreteByteKeyFrame.
  """
  pass
 ...
 def InterpolateValueCore(self,*args):
  """
  InterpolateValueCore(self: DiscreteByteKeyFrame,baseValue: Byte,keyFrameProgress: float) -> Byte
