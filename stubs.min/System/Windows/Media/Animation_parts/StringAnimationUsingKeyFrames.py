class StringAnimationUsingKeyFrames(StringAnimationBase,ISealable,IAnimatable,IResource,IKeyFrameAnimation,IAddChild):
 ...
 def AddText(self,*args):
  ...
  AddText(self: StringAnimationUsingKeyFrames,childText: str)
   ...
   childText: The text added to the System.Windows.Media.Animation.StringAnimationUsingKeyFrames.
  """
  pass
 ...
 def Clone(self):
  ...
  Clone(self: StringAnimationUsingKeyFrames) -> StringAnimationUsingKeyFrames
   ...
   Creates a modifiable clone of this System.Windows.Media.Animation.StringAnimationUsingKeyFrames,
 ...
 def CloneCore(self,*args):
  ...
  CloneCore(self: StringAnimationUsingKeyFrames,sourceFreezable: Freezable)
   ...
   Makes this instance a deep copy of the specified 
    ...
    System.Windows.Media.Animation.StringAnimationUsingKeyFrames. When copying dependency 
 ...
 def CloneCurrentValueCore(self,*args):
  ...
  CloneCurrentValueCore(self: StringAnimationUsingKeyFrames,sourceFreezable: Freezable)
   ...
   Makes this instance a modifiable deep copy of the specified 
    ...
    System.Windows.Media.Animation.StringAnimationUsingKeyFrames using current property values. 
 ...
 def CreateInstanceCore(self,*args):
  ...
  CreateInstanceCore(self: StringAnimationUsingKeyFrames) -> Freezable
   ...
   Creates a new instance of System.Windows.Media.Animation.StringAnimationUsingKeyFrames.
 ...
 def FreezeCore(self,*args):
  ...
  FreezeCore(self: StringAnimationUsingKeyFrames,isChecking: bool) -> bool
   ...
   Makes this instance of System.Windows.Media.Animation.StringAnimationUsingKeyFrames object 
 ...
 def GetAsFrozenCore(self,*args):
  ...
  GetAsFrozenCore(self: StringAnimationUsingKeyFrames,source: Freezable)
   ...
   source: The System.Windows.Media.Animation.StringAnimationUsingKeyFrames object to clone.
  """
  pass
 def GetCurrentValueAsFrozenCore(self,*args):
  ...
  GetCurrentValueAsFrozenCore(self: StringAnimationUsingKeyFrames,source: Freezable)
   ...
   Makes this instance a frozen clone of the specified 
    ...
    System.Windows.Media.Animation.StringAnimationUsingKeyFrames. Resource references,data 
   ...
   source: The System.Windows.Media.Animation.StringAnimationUsingKeyFrames to copy and freeze.
  """
  pass
 def GetCurrentValueCore(self,*args):
  ...
  GetCurrentValueCore(self: StringAnimationUsingKeyFrames,defaultOriginValue: str,defaultDestinationValue: str,animationClock: AnimationClock) -> str
   ...
   Calculates a value that represents the current value of the property being animated,as 
    ...
    determined by this instance of System.Windows.Media.Animation.StringAnimationUsingKeyFrames.
 ...
 def OnChanged(self,*args):
  ...
  OnChanged(self: StringAnimationUsingKeyFrames)
   ...
   Called when the current System.Windows.Media.Animation.StringAnimationUsingKeyFrames object is 
 ...
 def ShouldSerializeKeyFrames(self):
  ...
  ShouldSerializeKeyFrames(self: StringAnimationUsingKeyFrames) -> bool
   ...
   Returns true if the value of the 
    ...
    System.Windows.Media.Animation.StringAnimationUsingKeyFrames.KeyFrames property of this instance 

    of System.Windows.Media.Animation.StringAnimationUsingKeyFrames should be value-serialized.
