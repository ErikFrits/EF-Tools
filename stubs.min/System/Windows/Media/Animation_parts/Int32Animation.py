class Int32Animation(Int32AnimationBase,ISealable,IAnimatable,IResource):
 ...
 Int32Animation(toValue: int,duration: Duration)

 Int32Animation(toValue: int,duration: Duration,fillBehavior: FillBehavior)

 Int32Animation(fromValue: int,toValue: int,duration: Duration)
 ...
 def Clone(self):
  ...
  Clone(self: Int32Animation) -> Int32Animation
   ...
   Creates a modifiable clone of this System.Windows.Media.Animation.Int32Animation,making deep 
 ...
 def CreateInstanceCore(self,*args):
  ...
  CreateInstanceCore(self: Int32Animation) -> Freezable
   ...
   Creates a new instance of the System.Windows.Media.Animation.Int32Animation.
 ...
 def GetCurrentValueCore(self,*args):
  ...
  GetCurrentValueCore(self: Int32Animation,defaultOriginValue: int,defaultDestinationValue: int,animationClock: AnimationClock) -> int
   ...
   Calculates a value that represents the current value of the property being animated,as 
    ...
    determined by the System.Windows.Media.Animation.Int32Animation.
 ...
 def __new__(self,*__args):
  ...
  __new__(cls: type,toValue: int,duration: Duration,fillBehavior: FillBehavior)

  __new__(cls: type,fromValue: int,toValue: int,duration: Duration)
...
Get: By(self: Int32Animation) -> Nullable[int]



Set: By(self: Int32Animation)=value
...
Get: EasingFunction(self: Int32Animation) -> IEasingFunction



Set: EasingFunction(self: Int32Animation)=value
...
Get: From(self: Int32Animation) -> Nullable[int]



Set: From(self: Int32Animation)=value
...
Get: IsAdditive(self: Int32Animation) -> bool



Set: IsAdditive(self: Int32Animation)=value
...
Get: IsCumulative(self: Int32Animation) -> bool



Set: IsCumulative(self: Int32Animation)=value
...
Get: To(self: Int32Animation) -> Nullable[int]



Set: To(self: Int32Animation)=value
