class Rotation3DKeyFrame(Freezable,ISealable,IKeyFrame):
 """ Abstract class that,when implemented,defines an animation segment with its own target value and interpolation method for a System.Windows.Media.Animation.Rotation3DAnimationUsingKeyFrames. """
 ...
 def InterpolateValue(self,baseValue,keyFrameProgress):
  """
  InterpolateValue(self: Rotation3DKeyFrame,baseValue: Rotation3D,keyFrameProgress: float) -> Rotation3D
 ...
 def InterpolateValueCore(self,*args):
  """
  InterpolateValueCore(self: Rotation3DKeyFrame,baseValue: Rotation3D,keyFrameProgress: float) -> Rotation3D
 ...
 """Gets or sets the time at which the key frame's target System.Windows.Media.Animation.Rotation3DKeyFrame.Value should be reached.



Get: KeyTime(self: Rotation3DKeyFrame) -> KeyTime



Set: KeyTime(self: Rotation3DKeyFrame)=value
...
Get: Value(self: Rotation3DKeyFrame) -> Rotation3D



Set: Value(self: Rotation3DKeyFrame)=value
