class Int64AnimationBase(AnimationTimeline,ISealable,IAnimatable,IResource):
 """ Abstract class that,when implemented,animates a System.Int64 value. """
 ...
 def Clone(self):
  """
  Clone(self: Int64AnimationBase) -> Int64AnimationBase

  

   Creates a modifiable clone of this System.Windows.Media.Animation.Int64AnimationBase,making 
 ...
 def GetCurrentValue(self,defaultOriginValue,defaultDestinationValue,animationClock):
  """
  GetCurrentValue(self: Int64AnimationBase,defaultOriginValue: Int64,defaultDestinationValue: Int64,animationClock: AnimationClock) -> Int64
  ...
  GetCurrentValue(self: Int64AnimationBase,defaultOriginValue: object,defaultDestinationValue: object,animationClock: AnimationClock) -> object
 ...
 def GetCurrentValueCore(self,*args):
  """
  GetCurrentValueCore(self: Int64AnimationBase,defaultOriginValue: Int64,defaultDestinationValue: Int64,animationClock: AnimationClock) -> Int64
...
Get: TargetPropertyType(self: Int64AnimationBase) -> Type
