# encoding: utf-8
# module Grasshopper.GUI.MRU calls itself MRU
...
Set: Bounds(self: GH_FileEntry)=value
...
Set: FileDate(self: GH_MRU_Entry)=value
...
Set: FileName(self: GH_MRU_Entry)=value
...
Set: FilePath(self: GH_MRU_Entry)=value
...
Set: ActiveEntry(self: GH_TimeLine)=value
...
Set: Bounds(self: GH_TimeSpan)=value
...
Set: SpanEnd(self: GH_TimeSpan)=value
...
Set: SpanStart(self: GH_TimeSpan)=value
...
Set: SpanText(self: GH_TimeSpan)=value
