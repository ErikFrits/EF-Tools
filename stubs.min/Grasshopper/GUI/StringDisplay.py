...
"""
 ...
 IsCached=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 StackAlignment=property(lambda self: object(),lambda self,v: None,lambda self: None)
