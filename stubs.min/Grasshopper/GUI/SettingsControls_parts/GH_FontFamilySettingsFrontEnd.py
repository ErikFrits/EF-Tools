class GH_FontFamilySettingsFrontEnd(UserControl,IComponent,IDisposable,IOleControl,IOleObject,IOleInPlaceObject,IOleInPlaceActiveObject,IOleWindow,IViewObject,IViewObject2,IPersist,IPersistStreamInit,IPersistPropertyBag,IPersistStorage,IQuickActivate,ISupportOleDropSource,IDropTarget,ISynchronizeInvoke,IWin32Window,IArrangedElement,IBindableComponent,IContainerControl):
 """ GH_FontFamilySettingsFrontEnd() """
 ...
 def DestroyHandle(self,*args):
  ...
  pass
 def Dispose(self):
  """ Dispose(self: GH_FontFamilySettingsFrontEnd,disposing: bool) """
  pass
 ...
 def RecreateHandle(self,*args):
  ...
  """
  pass
 def RepresentsConsoleFamily(self):
  """ RepresentsConsoleFamily(self: GH_FontFamilySettingsFrontEnd) """
  pass
 def RepresentsScriptFamily(self):
  """ RepresentsScriptFamily(self: GH_FontFamilySettingsFrontEnd) """
  pass
 def RepresentsStandardFamily(self):
  """ RepresentsStandardFamily(self: GH_FontFamilySettingsFrontEnd) """
  pass
