class GH_MenuShortcutFrontEnd(UserControl,IComponent,IDisposable,IOleControl,IOleObject,IOleInPlaceObject,IOleInPlaceActiveObject,IOleWindow,IViewObject,IViewObject2,IPersist,IPersistStreamInit,IPersistPropertyBag,IPersistStorage,IQuickActivate,ISupportOleDropSource,IDropTarget,ISynchronizeInvoke,IWin32Window,IArrangedElement,IBindableComponent,IContainerControl):
 ...
 def DestroyHandle(self,*args):
  ...
  pass
 def Dispose(self):
  """ Dispose(self: GH_MenuShortcutFrontEnd,disposing: bool) """
  pass
 ...
 def OnPaint(self,*args):
  """ OnPaint(self: GH_MenuShortcutFrontEnd,e: PaintEventArgs) """
  pass
 def OnPaintBackground(self,*args):
  """ OnPaintBackground(self: GH_MenuShortcutFrontEnd,e: PaintEventArgs) """
  pass
