class GH_PreviewSettingsFrontEnd(UserControl,IComponent,IDisposable,IOleControl,IOleObject,IOleInPlaceObject,IOleInPlaceActiveObject,IOleWindow,IViewObject,IViewObject2,IPersist,IPersistStreamInit,IPersistPropertyBag,IPersistStorage,IQuickActivate,ISupportOleDropSource,IDropTarget,ISynchronizeInvoke,IWin32Window,IArrangedElement,IBindableComponent,IContainerControl):
 """ GH_PreviewSettingsFrontEnd() """
 ...
 def DestroyHandle(self,*args):
  ...
  pass
 def Dispose(self):
  """ Dispose(self: GH_PreviewSettingsFrontEnd,disposing: bool) """
  pass
