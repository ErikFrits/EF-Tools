...
class GH_AbstractInteraction(object,IGH_MouseInteraction,IGH_ResponsiveObject,IGH_TooltipAwareObject):
 ...
 def __repr__(self,*args):
  ...
  pass
 Canvas=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 CanvasPointDown=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 ControlPointDown=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 DeactivateOnFocusLoss=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
class GH_DragInteraction(GH_AbstractInteraction,IGH_MouseInteraction,IGH_ResponsiveObject,IGH_TooltipAwareObject):
 ...
 def __new__(self,canvas,e):
  ...
  pass
 AttributeCount=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
class GH_DumpInteraction(GH_AbstractInteraction,IGH_MouseInteraction,IGH_ResponsiveObject,IGH_TooltipAwareObject):
 ...
 def __new__(self,parent,objectId=None):
  ...
  """
  pass
 IsAggregating=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
class GH_SketchInteraction(GH_AbstractInteraction,IGH_MouseInteraction,IGH_ResponsiveObject,IGH_TooltipAwareObject):
 ...
 def AttributesChanged(self,*args):
 ...
 def __new__(self,iParent):
  ...
  pass
 Att=property(lambda self: object(),lambda self,v: None,lambda self: None)
