...
class GH_Motion(object):
 ...
 def __new__(self,rec_0,rec_1,*__args):
  ...
  """
  pass
 CurrentBox=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 FinalBox=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 InitialBox=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 InMotion=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 Interpolation=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 UpdateInterval=property(lambda self: object(),lambda self,v: None,lambda self: None)
