...
"""
 ...
 HasInputGrip=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 HasOutputGrip=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
class GH_ResizableAttributes(GH_Attributes[T],IGH_Attributes,GH_ISerializable,IGH_ResponsiveObject,IGH_TooltipAwareObject):
 ...
 SizingBorders=property(lambda self: object(),lambda self,v: None,lambda self: None)
