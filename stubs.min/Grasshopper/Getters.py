...
class GH_PointGetter(object):
 ...
 def RecreateSetup(self,pt):
  ...
  pass
 AcceptPreselected=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 PointRefType=property(lambda self: object(),lambda self,v: None,lambda self: None)
