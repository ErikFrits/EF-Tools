...
"""
 ...
 Pronunciation=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 Synonyms=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 Word=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
class GH_Link(object,IGH_Content):
 ...
 def __str__(self,*args):
  pass
 Destination=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 IsSharedLink=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 LinkId=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 Ordered=property(lambda self: object(),lambda self,v: None,lambda self: None)
