...
if __name__ == '__main__':
    ...
    selected_attached_groups        = select_attached_groups(selected_group_types, title=__title__, label='Select Attached Groups to duplicate:', uidoc=uidoc, version=__version__, exit_if_none=True)
