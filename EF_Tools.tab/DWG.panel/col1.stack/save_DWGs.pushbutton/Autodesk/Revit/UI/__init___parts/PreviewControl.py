...
"""
 ...
 ScrollbarVisibility=property(lambda self: object(),lambda self,v: None,lambda self: None)
...
"""
 ...
 UIView=property(lambda self: object(),lambda self,v: None,lambda self: None)
