# -*- coding: utf-8 -*-
__title__ = "Attached Groups: Rename"
...
-> Click on this tool
-> Select Groups
-> Select Attached Groups you would like to Showw
_____________________________________________________________________
Last update:
...
if __name__ == '__main__':
    ...
    selected_attached_groups        = select_attached_groups(selected_group_types, title=__title__, label='Select AttachedGroups to Rename', uidoc=uidoc, version=__version__, exit_if_none=True)
    ...
    GUI                             = FindReplace(title=__title__, label='New Name for Attached Groups:', button_name="Rename")
    ...
    with ef_Transaction(doc,  __title__, debug=True):
        ...
        for group_type in group_types:
            ...
            for a_group_id in group_type.GetAvailableAttachedDetailGroupTypeIds():
                ...
                # CHECK IF SELECTED ATTACHED GROUP
                a_group_name_param = a_group.get_Parameter(BuiltInParameter.ALL_MODEL_TYPE_NAME)
                orig_a_group_name = a_group_name_param.AsString()
